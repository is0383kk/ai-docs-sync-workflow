...
title: Konfigurieren
x-i18n:
    generated_at: "2026-07-26T18:21:55Z"
    model: gpt-5.6
...
Interaktive Eingabeaufforderungen für gezielte Änderungen an einer bestehenden Einrichtung: Anmeldedaten, Geräte, Agent-Standardwerte, Gateway, Kanäle, Plugins, Skills und Integritätsprüfungen.

Verwenden Sie `openclaw onboard` oder `openclaw setup` für die vollständige geführte Ersteinrichtung, `openclaw setup --baseline` nur für die Basiskonfiguration und den Workspace sowie `openclaw channels add`, wenn Sie lediglich ein Kanalkonto einrichten müssen.
