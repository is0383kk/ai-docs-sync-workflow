---
summary: Detaillierte Referenz zu den Produktbereichen und Prüfungen, die der OpenClaw-Reifegradbewertung zugrunde liegen.
title: Reifegradtaxonomie
x-i18n:
    generated_at: "2026-07-26T18:33:50Z"
    model: gpt-5.6
...
<div className="maturity-hero maturity-hero-compact">
  <p className="maturity-kicker">das Modell hinter der Bewertungskarte</p>
...
Eine Oberfläche ist ein Produktbereich wie die Gateway-Laufzeit, Discord oder die macOS-App. Jede Oberfläche enthält Kategorien, und jede Kategorie enthält Prüfungen auf Fähigkeitsebene, die von QA-Szenarien abgedeckt werden. Verwenden Sie die Bewertungskarte für eine Beurteilung auf Release-Ebene und diese Seite, um das zugrunde liegende Modell zu untersuchen.
...
<div className="maturity-level-list">
  ...
  <div className="maturity-level-row"><span className="maturity-level-title"><span className="maturity-level-pill maturity-level-experimental"><span className="maturity-level-code">M1</span><span>Experimentell</span></span></span><span>Mit Einschränkungen, Flags, Quellcode-Builds oder ausschließlich für Maintainer vorgesehenen Abläufen implementiert.</span><span className="maturity-level-promotion">Aufstieg: Ein Maintainer kann das Szenario auf dem aktuellen Stand von main ausführen.</span></div>
  <div className="maturity-level-row"><span className="maturity-level-title"><span className="maturity-level-pill maturity-level-alpha"><span className="maturity-level-code">M2</span><span>Alpha</span></span></span><span>Echte Benutzer können die Funktion ausprobieren, müssen jedoch mit inkompatiblen Änderungen und einer unvollständigen Benutzerführung rechnen.</span><span className="maturity-level-promotion">Aufstieg: Dokumentierte Einrichtung, grundlegende Tests, bekannte Einschränkungen und mindestens ein Nachweis aus einer realen Umgebung.</span></div>
  <div className="maturity-level-row"><span className="maturity-level-title"><span className="maturity-level-pill maturity-level-beta"><span className="maturity-level-code">M3</span><span>Beta</span></span></span><span>Ein öffentlicher Pfad ist vorhanden, und der Hauptarbeitsablauf ist mit klar begrenzten Einschränkungen nutzbar.</span><span className="maturity-level-promotion">Aufstieg: Dokumentation für Installation und Aktualisierung, Regressionstests, Support-Runbook und erfolgreicher Szenarienachweis in der erwarteten Umgebung.</span></div>
  ...
  <div className="maturity-level-row"><span className="maturity-level-title"><span className="maturity-level-pill maturity-level-clawesome"><span className="maturity-level-code">M5</span><span>Clawesome</span></span></span><span>Ausgereift, angenehm, umfassend instrumentiert und mit dem besten vergleichbaren Arbeitsablauf konkurrenzfähig.</span><span className="maturity-level-promotion">Aufstieg: Stabil sowie bestandene Benutzerbewertungskarte für repräsentative Benutzer.</span></div>
</div>
...
<Tabs>
  ...
  <Tab title="Provider und Tool">
    ...
    <a className="maturity-surface-link" href="#web-search-tools">
      <span className="maturity-surface-title">Websuch-Tools</span>
...
<AccordionGroup>
  <Accordion title="CLI – M4 Stabil – 7 Bereiche">
    ...
    Normale Einrichtungs- und Reparaturpfade sind in der Installations-, CLI- und Gateway-Dokumentation beschrieben. Plattformspezifische Windows-Pfade werden in den Zeilen „Windows über WSL2“ und „Natives Windows“ erfasst.
    ...
    [Onboarding](/de/cli/onboard), [Konfiguration](/de/cli/configure), [Onboarding-Übersicht](/de/start/onboarding-overview)
    ...
    [Aktualisierung](/de/install/updating), [Aktualisieren](/de/cli/update), [Fehlerbehebung](/de/gateway/troubleshooting)
  ...
  <Accordion title="Gateway-Laufzeit – M4 Stabil – 13 Bereiche">
    ...
    Die Kernarchitektur, Authentifizierung, Kopplung, Protokolldokumentation, Daemon-Dokumentation und CLI-Betriebshandbücher sind umfassend und aktuell.
    ...
    [Protokoll](/de/gateway/protocol), [Architektur](/de/concepts/architecture), [Index](/de/nodes/index)
      ...
      <div className="maturity-category-row">
        <div className="maturity-category-area">
          <span className="maturity-category-title">Integritätsprüfung, Diagnose und Reparatur</span>
  ...
  <Accordion title="Agent-Laufzeit – M3 Beta – 9 Bereiche">
    <a id="agent-runtime" />

    Hauptschleife, Modelle, Provider-Routing und Tool-Streaming sind erstklassig unterstützt, das Provider-Verhalten ändert sich jedoch wöchentlich und erfordert für jede Version einen Szenarionachweis.
    ...
    [Agent-Schleife](/de/concepts/agent-loop), [Agent](/de/cli/agent), [Agent-Laufzeiten](/de/concepts/agent-runtimes)

    </div>
      </div>
      <div className="maturity-category-row">
        <div className="maturity-category-area">
          <span className="maturity-category-title">Externe Laufzeiten und Subagenten</span>
    ...
    [Agent-Laufzeiten](/de/concepts/agent-runtimes), [Anthropic](/de/providers/anthropic), [Google](/de/providers/google), [Subagenten](/de/tools/subagents)
    ...
    [Streaming](/de/concepts/streaming), [Agent-Schleife](/de/concepts/agent-loop)
    ...
    [Agent-Schleife](/de/concepts/agent-loop), [Ollama](/de/providers/ollama)
    ...
    [Sandbox vs. Tool-Richtlinie vs. erhöhte Berechtigungen](/de/gateway/sandbox-vs-tool-policy-vs-elevated), [Agent-Schleife](/de/concepts/agent-loop), [Subagenten](/de/tools/subagents)
  ...
  <Accordion title="Sitzungs-, Speicher- und Kontext-Engine – M3 Beta – 9 Bereiche">
    ...
    Aussagekräftige Dokumentation und aktive Implementierung. Der Reifegrad hängt von der Beständigkeit der Transkripte, der Qualität der Compaction und der Gleichwertigkeit zwischen Clients ab.
    ...
    [Sitzung](/de/concepts/session), [Compaction der Sitzungsverwaltung](/de/reference/session-management-compaction), [Sitzungen](/de/cli/sessions)
      ...
      <div className="maturity-category-row">
        <div className="maturity-category-area">
          <span className="maturity-category-title">Tokenverwaltung</span>
          <span>3 Funktionen / LTS-unterstützt</span>
        </div>
        <div><span className="maturity-score maturity-score-experimental"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-experimental">Experimentell</span><span>20%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "20%" }} /></span></span></div>
        <div><span className="maturity-score maturity-score-beta"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-beta">Beta</span><span>79%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "79%" }} /></span></span></div>
    ...
    [Kontext](/de/concepts/context), [Kontext-Engine](/de/concepts/context-engine)
      ...
      <div className="maturity-category-row">
        <div className="maturity-category-area">
          <span className="maturity-category-title">Clientübergreifender Verlauf und Sitzungsgleichheit</span>
    ...
    [Webchat](/de/web/webchat), [Android](/de/platforms/android), [Kanal-Routing](/de/channels/channel-routing)
    ...
    [Sitzung](/de/concepts/session), [Kanal-Routing](/de/channels/channel-routing), [Discord](/de/channels/discord)
  ...
  <Accordion title="Channel-Framework – M3 Beta – 8 Bereiche">
    ...
    Viele Channels verwenden dieselben Gateway-Verträge für Zustellung und Routing, doch das Channel-Verhalten variiert je nach vorgelagerter API und Einschränkungen der Kontorichtlinien.
    ...
    [Übersicht](/de/channels/index), [Kopplung](/de/channels/pairing), [Fehlerbehebung](/de/channels/troubleshooting), [SDK-Channel-Plugins](/de/plugins/sdk-channel-plugins)
      ...
      <div className="maturity-category-row">
        <div className="maturity-category-area">
          <span className="maturity-category-title">Verhalten bei Gruppen-Threads und Umgebungsräumen</span>
          <span>5 Funktionen</span>
        </div>
    ...
    [Gruppen](/de/channels/groups), [Gruppennachrichten](/de/channels/group-messages), [Umgebungsraum-Ereignisse](/de/channels/ambient-room-events), [Broadcast-Gruppen](/de/channels/broadcast-groups), [Discord](/de/channels/discord)
    ...
    [Gruppen](/de/channels/groups), [Umgebungsraum-Ereignisse](/de/channels/ambient-room-events), [Discord](/de/channels/discord), [Matrix](/de/channels/matrix), [Kanalkonfiguration](/de/gateway/config-channels)
    ...
    [Kanalrouting](/de/channels/channel-routing), [Gruppen](/de/channels/groups), [Discord](/de/channels/discord), [Matrix](/de/channels/matrix), [Fehlerbehebung](/de/channels/troubleshooting), [Konfigurationsreferenz](/de/gateway/configuration-reference)
      ...
      <div className="maturity-category-row">
        <div className="maturity-category-area">
          <span className="maturity-category-title">Statuszustand und Bedienelemente für Operatoren</span>
          <span>4 Funktionen / LTS-unterstützt</span>
        </div>
        <div><span className="maturity-score maturity-score-experimental"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-experimental">Experimentell</span><span>0%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "0%" }} /></span></span></div>
        <div><span className="maturity-score maturity-score-beta"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-beta">Beta</span><span>79%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "79%" }} /></span></span></div>
  ...
  <Accordion title="Beobachtbarkeit – M3 Beta – 5 Bereiche">
    ...
    Dokumentation zu OTel, Prometheus, Protokollierung und Diagnose ist vorhanden. Benötigt einen öffentlichen Reifegrad-Durchlauf zum Thema „Worauf Operatoren zuerst achten sollten“.
    ...
    [Hooks](/de/plugins/hooks), [Opentelemetry](/de/gateway/opentelemetry), [Protokollierung](/de/logging), [SDK-Unterpfade](/de/plugins/sdk-subpaths), [Diagnose mit Otel](/de/plugins/reference/diagnostics-otel), [Prometheus](/de/gateway/prometheus), [Diagnose mit Prometheus](/de/plugins/reference/diagnostics-prometheus)
  ...
  <Accordion title="Gateway-Web-App – M3 Beta – 6 Bereiche">
    ...
    Die Web-Benutzeroberfläche ist mit Abläufen für Kopplung, Chat, PWA, Talk, Push-Benachrichtigungen und den Remote-Gateway dokumentiert. Die Hochstufung erfolgt nach Scorecards für verschiedene Browser und mobile PWAs.
    ...
    <div className="maturity-category-list">
      ...
      <div className="maturity-category-row">
        <div className="maturity-category-area">
          <span className="maturity-category-title">Browser-Echtzeitkommunikation</span>
          <span>5 Funktionen</span>
        </div>
        <div><span className="maturity-score maturity-score-experimental"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-experimental">Experimentell</span><span>0%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "0%" }} /></span></span></div>
        <div><span className="maturity-score maturity-score-alpha"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-alpha">Alpha</span><span>68%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "68%" }} /></span></span></div>
    ...
    [Steuerungsoberfläche](/de/web/control-ui), [Protokoll](/de/gateway/protocol), [Sprachkommunikation](/de/nodes/talk)
    ...
    [Steuerungsoberfläche](/de/web/control-ui), [Konfiguration](/de/gateway/configuration)
      ...
      <div className="maturity-category-row">
        <div className="maturity-category-area">
          <span className="maturity-category-title">Browseroberfläche</span>
    ...
    [Steuerungsoberfläche](/de/web/control-ui), [Webchat](/de/web/webchat), [Erste Schritte](/de/start/getting-started), [Kanal-Routing](/de/channels/channel-routing), [Sichere Dateioperationen](/de/gateway/security/secure-file-operations)
  ...
  <Accordion title="Plugins – M3 Beta – 9 Bereiche">
    ...
    Für Manifeste, Erkennung, Laden, die Provider-/Tool-Architektur und Genehmigungsgrenzen liegen eine umfassende Dokumentation und aussagekräftige interne Laufzeitnachweise vor. Behalten Sie die Zeile auf Beta, bis überzeugendere Nachweise für die öffentlichen SDK-APIs/-Unterpfade und die externe Distribution vorliegen.
  ...
  <Accordion title="Sicherheit, Authentifizierung, Kopplung und Geheimnisse – M3 Beta – 6 Bereiche">
    ...
    <div className="maturity-category-list">
      ...
      <div className="maturity-category-row">
        <div className="maturity-category-area">
          <span className="maturity-category-title">Genehmigungsrichtlinie und Schutzmaßnahmen für Werkzeuge</span>
          <span>2 Funktionen / LTS-unterstützt</span>
        </div>
        <div><span className="maturity-score maturity-score-alpha"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-alpha">Alpha</span><span>50%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "50%" }} /></span></span></div>
        <div><span className="maturity-score maturity-score-beta"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-beta">Beta</span><span>79%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "79%" }} /></span></span></div>
    ...
    [Manifest](/de/plugins/manifest), [Plugin-Berechtigungsanfragen](/de/plugins/plugin-permission-requests), [Plugins verwalten](/de/plugins/manage-plugins), [Auditprüfungen](/de/gateway/security/audit-checks)
      ...
      <div className="maturity-category-row">
        <div className="maturity-category-area">
          <span className="maturity-category-title">Hygiene bei Zugangsdaten und Geheimnissen</span>
          <span>5 Funktionen / LTS-unterstützt</span>
        </div>
        <div><span className="maturity-score maturity-score-experimental"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-experimental">Experimentell</span><span>46%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "46%" }} /></span></span></div>
        <div><span className="maturity-score maturity-score-beta"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-beta">Beta</span><span>79%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "79%" }} /></span></span></div>
    ...
    [Authentifizierung](/de/gateway/authentication), [Modelle](/de/cli/models), [OpenAI](/de/providers/openai), [OAuth](/de/concepts/oauth), [Geheimnisse](/de/gateway/secrets), [Geheimnisse](/de/cli/secrets), [Secretref-Zugangsdatenoberfläche](/de/reference/secretref-credential-surface), [Auditprüfungen](/de/gateway/security/audit-checks)
  ...
  <Accordion title="Automatisierung: Cron, Hooks, Aufgaben, Polling – M3 Beta – 6 Bereiche">
    ...
    Dokumentiert und nutzbar, aber Szenarionachweise sollten die unbeaufsichtigte Zustellung, Wiederholungsversuche und die Sichtbarkeit von Fehlern abdecken.
  ...
  <Accordion title="Medienverständnis und Mediengenerierung – M2 Alpha – 6 Bereiche">
    ...
    Es gibt ein breites Funktionsspektrum, aber Unterschiede zwischen Providern, Dateibeschränkungen sowie die fehlende Parität zwischen Node und App verhindern derzeit noch die Stabilität.
    ...
    [Medienübersicht](/de/tools/media-overview), [Bilderzeugung](/de/tools/image-generation), [Manifest](/de/plugins/manifest), [Codex-Harness](/de/plugins/codex-harness)
  ...
  <Accordion title="Sprache und Echtzeitgespräche – M2 Alpha – 6 Bereiche">
    ...
    Für Control UI, Apps und Provider existieren mehrere Implementierungen. Vor der Betaphase werden Bewertungskarten für Latenz, Fehlermodi und Einrichtung benötigt.
    ...
    [OpenAI](/de/providers/openai), [Google](/de/providers/google), [SDK-Provider-Plugins](/de/plugins/sdk-provider-plugins), [Gespräche](/de/nodes/talk), [Control UI](/de/web/control-ui)
      ...
      <div className="maturity-category-row">
        <div className="maturity-category-area">
          <span className="maturity-category-title">Echtzeit-Gesprächssitzungen</span>
          <span>11 Funktionen</span>
        </div>
        <div><span className="maturity-score maturity-score-experimental"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-experimental">Experimentell</span><span>0%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "0%" }} /></span></span></div>
        <div><span className="maturity-score maturity-score-alpha"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-alpha">Alpha</span><span>61%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "61%" }} /></span></span></div>
    ...
    [Gespräch](/de/nodes/talk), [Steuerungsoberfläche](/de/web/control-ui)
    ...
    [Gespräch](/de/nodes/talk), [OpenAI](/de/providers/openai), [Google](/de/providers/google)

    </div>
      </div>
      <div className="maturity-category-row">
        <div className="maturity-category-area">
          <span className="maturity-category-title">Gespräche in nativen Apps</span>
          <span>4 Funktionen</span>
        </div>
        <div><span className="maturity-score maturity-score-experimental"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-experimental">Experimentell</span><span>0%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "0%" }} /></span></span></div>
        <div><span className="maturity-score maturity-score-alpha"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-alpha">Alpha</span><span>61%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "61%" }} /></span></span></div>
    ...
    [Gespräch](/de/nodes/talk), [Sprachaktivierung](/de/platforms/mac/voicewake)
    ...
    [Sprachaktivierung](/de/nodes/voicewake), [Sprachaktivierung](/de/platforms/mac/voicewake), [Sprach-Overlay](/de/platforms/mac/voice-overlay)
      ...
      <div className="maturity-category-row">
        <div className="maturity-category-area">
          <span className="maturity-category-title">Beobachtbarkeit von Gesprächen</span>
          <span>5 Funktionen</span>
        </div>
        <div><span className="maturity-score maturity-score-experimental"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-experimental">Experimentell</span><span>0%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "0%" }} /></span></span></div>
        <div><span className="maturity-score maturity-score-alpha"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-alpha">Alpha</span><span>61%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "61%" }} /></span></span></div>
    ...
    [Steuerungsoberfläche](/de/web/control-ui), [Sprach-Overlay](/de/platforms/mac/voice-overlay), [Gespräch](/de/nodes/talk)
  ...
  <Accordion title="ClawHub – M2 Alpha – 4 Bereiche">
    ...
    Öffentliche Dokumentation und ein Ökosystemkonzept sind vorhanden. Benötigt Bewertungsübersichten für Installation, Vertrauen, Aktualisierung, Rollback und Kompatibilität.
  ...
  <Accordion title="OpenClaw App SDK – M2 Alpha – 6 Bereiche">
    ...
    [OpenClaw SDK](/de/gateway/external-apps), [OpenClaw-SDK-API-Design](/de/gateway/external-apps), [Protokoll](/de/gateway/protocol), [Index](/de/gateway/security/index)

    </div>
      </div>
      <div className="maturity-category-row">
        <div className="maturity-category-area">
          <span className="maturity-category-title">Agentenkonversationen</span>
          <span>6 Funktionen</span>
        </div>
        <div><span className="maturity-score maturity-score-experimental"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-experimental">Experimentell</span><span>0%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "0%" }} /></span></span></div>
    ...
    [OpenClaw SDK](/de/gateway/external-apps), [OpenClaw-SDK-API-Design](/de/gateway/external-apps), [Protokoll](/de/gateway/protocol)
      ...
      <div className="maturity-category-row">
        <div className="maturity-category-area">
          <span className="maturity-category-title">Ressourcenhilfen</span>
          <span>5 Funktionen</span>
        </div>
        <div><span className="maturity-score maturity-score-experimental"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-experimental">Experimentell</span><span>17%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "17%" }} /></span></span></div>
...
<AccordionGroup>
  ...
  <Accordion title="macOS-Gateway-Host – M4 Stabil – 7 Bereiche">
    ...
    [macOS](/de/platforms/macos), [Gebündelter Gateway](/de/platforms/mac/bundled-gateway), [Gateway](/de/cli/gateway), [Übersicht](/de/gateway/index), [Aktualisierung](/de/cli/update), [Aktualisieren](/de/install/updating), [Deinstallation](/de/install/uninstall), [Fehlerbehebung](/de/gateway/troubleshooting)
  ...
  <Accordion title="Android-App – M4 Stabil – 7 Bereiche">
    ...
    Eine offizielle Distribution über Google Play ist verfügbar, die Dokumentation zum Erstellen und Ausführen aus dem Quellcode wird gepflegt, und die Android-App ist als regulärer Begleit-Node für Benutzer dokumentiert.
  ...
  <Accordion title="iOS-App – M4 Stabil – 8 Bereiche">
    ...
    Eine offizielle Verteilung über den App Store ist vorhanden, Relay-gestützte Push-Benachrichtigungen sind dokumentiert und die iOS-App ist als regulärer Begleit-Node für Benutzer dokumentiert.
    ...
    <div className="maturity-category-list">
      ...
      <div className="maturity-category-row">
        <div className="maturity-category-area">
          <span className="maturity-category-title">Medien und Freigabe</span>
          <span>1 Funktion</span>
        </div>
        <div><span className="maturity-score maturity-score-experimental"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-experimental">Experimentell</span><span>0%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "0%" }} /></span></span></div>
        <div><span className="maturity-score maturity-score-stable"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-stable">Stabil</span><span>80%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "80%" }} /></span></span></div>
  ...
  <Accordion title="Docker- und Podman-Hosting – M3 Beta – 4 Bereiche">
    ...
    Installationsdokumentation ist vorhanden, und diese Hosting-Varianten sind gängige Bereitstellungswege. Hochstufen, nachdem wiederkehrende Smoke-Tests bei Releases das Upgrade- und Volume-Verhalten erfassen.
  ...
  <Accordion title="Windows über WSL2 - M3 Beta - 6 Bereiche">
    ...
    Empfohlener Windows-Pfad mit Anleitung zu systemd/Benutzerdiensten und Dokumentation der Boot-Kette. Nach wiederholten Bewertungsübersichten für Installation und Aktualisierung höherstufen.
    ...
    [Fehlerbehebung für Browser-Remote-CDP unter WSL2 und Windows](/de/tools/browser-wsl2-windows-remote-cdp-troubleshooting), [Browser](/de/tools/browser), [Control UI](/de/web/control-ui)
  ...
  <Accordion title="Raspberry Pi und kleine Linux-Geräte – M3 Beta – 4 Bereiche">
    ...
    Plattformdokumentation ist vorhanden, und der Gateway-Pfad basiert auf Linux. Für eine höhere Einstufung sind hardwarespezifische Smoke-Test-Nachweise für Releases erforderlich.
    ...
    [Raspberry Pi](/de/install/raspberry-pi), [Authentifizierung](/de/gateway/authentication), [Geheimnisse](/de/gateway/secrets), [Kopplung](/de/gateway/pairing), [Geräte](/de/cli/devices), [Remotezugriff](/de/gateway/remote), [Tailscale](/de/gateway/tailscale)
  ...
  <Accordion title="macOS-Begleit-App – M3 Beta – 8 Bereiche">
    ...
    Eine umfangreiche Menüleisten-App, Berechtigungen, Node-Modus, Canvas, Sprachaktivierung, WebChat und Remotemodus sind vorhanden. Die Entwicklung schreitet jedoch noch zu schnell voran, um die Einstufung „Stabil“ zu erhalten.
    ...
    [Gebündelter Gateway](/de/platforms/mac/bundled-gateway), [macOS](/de/platforms/macos), [Untergeordneter Prozess](/de/platforms/mac/child-process), [Entwicklungsumgebung](/de/platforms/mac/dev-setup)
    ...
    [Menüleiste](/de/platforms/mac/menu-bar), [Symbol](/de/platforms/mac/icon), [macOS](/de/platforms/macos), [Systemzustand](/de/platforms/mac/health), [Protokollierung](/de/platforms/mac/logging), [Fernzugriff](/de/platforms/mac/remote)
    ...
    [Fernzugriff](/de/platforms/mac/remote), [macOS](/de/platforms/macos), [Fernzugriff](/de/gateway/remote)
    ...
    [Sprachaktivierung](/de/platforms/mac/voicewake), [Sprach-Overlay](/de/platforms/mac/voice-overlay), [Sprechen](/de/nodes/talk), [macOS](/de/platforms/macos)
  ...
  <Accordion title="Natives Windows – M2 Alpha – 4 Bereiche">
    ...
    Die grundlegenden CLI-/Gateway-Abläufe funktionieren, die Dokumentation empfiehlt jedoch weiterhin WSL2 für den vollständigen Funktionsumfang und führt Einschränkungen der nativen Ausführung auf.
    ...
    [Windows](/de/platforms/windows), [Übersicht](/de/gateway/index), [Gateway](/de/cli/gateway), [Diagnose](/de/cli/doctor)
  ...
  <Accordion title="Kubernetes-Hosting – M2 Alpha – 4 Bereiche">
    ...
    Kubernetes-Hosting ist ein eigenständiger, auf Kustomize basierender Bereitstellungspfad für Cluster. Die aktuelle Bewertung zeigt einen tatsächlich nutzbaren minimalen Bereitstellungspfad mit Lücken bei Kubernetes-spezifischer CI, der Paketierung von Ingress/TLS/NetworkPolicy, Sicherung/Wiederherstellung und der Absicherung für die Bereitstellung in Produktionsumgebungen.
    ...
    [Kubernetes](/de/install/kubernetes), [Secrets](/de/gateway/secrets), [Umgebung](/de/help/environment)
      ...
      <div className="maturity-category-row">
        <div className="maturity-category-area">
          <span className="maturity-category-title">Zugriff und Erreichbarkeit</span>
          <span>5 Funktionen</span>
        </div>
        <div><span className="maturity-score maturity-score-experimental"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-experimental">Experimentell</span><span>0%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "0%" }} /></span></span></div>
        <div><span className="maturity-score maturity-score-alpha"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-alpha">Alpha</span><span>55%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "55%" }} /></span></span></div>
    ...
    [Kubernetes](/de/install/kubernetes), [Authentifizierung](/de/gateway/authentication), [Fernzugriff](/de/gateway/remote), [Runbook zur Erreichbarkeit](/de/gateway/security/exposure-runbook)
  ...
  <Accordion title="Nix-Installationspfad – M1 Experimentell – 5 Bereiche">
    ...
    [Nix](/de/install/nix), [Übersicht](/de/install/index), [Dokumentationsverzeichnis](/de/start/docs-directory)
  ...
  <Accordion title="Linux-Begleit-App – M0 geplant – 5 Bereiche">
    ...
    [Linux](/de/platforms/linux), [Übersicht](/de/gateway/index), [Kopplung](/de/gateway/pairing), [Remotezugriff](/de/gateway/remote)
...
<AccordionGroup>
  <Accordion title="Discord – M4 Stabil – 6 Bereiche">
    ...
    Ausführliche Dokumentation und breite Funktionsabdeckung. Sprach- und Delegationspfade sollten weiterhin separat als Beta bzw. Alpha bewertet werden.
  ...
  <Accordion title="Telegram - M3 Beta - 5 Bereiche">
    ...
    Der Kernkanal ist für die regelmäßige Nutzung ausgereift genug, doch stark variierende UX- und Medienrandfälle erfordern wiederkehrende Szenarionachweise.
    ...
    [Telegram](/de/channels/telegram), [Kanäle konfigurieren](/de/gateway/config-channels), [Kanäle](/de/cli/channels)
  ...
  <Accordion title="iMessage und BlueBubbles - M3 Beta - 5 Bereiche">
    ...
    Unterstütztes iMessage wird über imsg auf einem macOS-Messages-Host mit angemeldetem Konto ausgeführt; ältere BlueBubbles-Konfigurationen müssen migriert werden. Hinweise zu macOS-Berechtigungen, SSH-Wrapper, SIP/privater API und Migration müssen sichtbar bleiben.
  ...
  <Accordion title="WhatsApp – M3 Beta – 5 Bereiche">
    ...
    Der zentrale Pfad ist wichtig und dokumentiert; die Volatilität von Baileys und Sitzungen im Upstream verhindert jedoch eine Einstufung als stabil.
    ...
    [WhatsApp](/de/channels/whatsapp), [Konfigurationskanäle](/de/gateway/config-channels), [QA-E2E-Automatisierung](/de/concepts/qa-e2e-automation), [Kopplung](/de/channels/pairing)
  ...
  <Accordion title="Matrix - M2 Alpha - 6 Bereiche">
    ...
    Unterstützung über ein gebündeltes Plugin. Benötigt Scorecards für Bridge, Authentifizierung und Raumlebenszyklus.
  ...
  <Accordion title="Google Chat – M2 Alpha – 5 Bereiche">
    ...
    Dokumentierter Kanal, aber die Einrichtung für Unternehmen und Administratoren erhöht das Reifegradrisiko.
    ...
    [Google Chat](/de/channels/googlechat), [Google Chat](/de/plugins/reference/googlechat), [Kanalkonfiguration](/de/gateway/config-channels), [CLI-Referenz des Assistenten](/de/start/wizard-cli-reference), [Geheimnisse](/de/gateway/secrets), [Secretref-Anmeldedatenoberfläche](/de/reference/secretref-credential-surface), [Systemzustand](/de/gateway/health), [Plugin-Inventar](/de/plugins/plugin-inventory), [Übersicht](/de/channels/index)
    ...
    [Google Chat](/de/channels/googlechat), [Kopplung](/de/channels/pairing), [Zugriffsgruppen](/de/channels/access-groups), [Kanalkonfiguration](/de/gateway/config-channels), [Schutz vor Bot-Schleifen](/de/channels/bot-loop-protection), [Kanalrouting](/de/channels/channel-routing)
  ...
  <Accordion title="Microsoft Teams – M2 Alpha – 5 Bereiche">
    ...
    Authentifizierungs- und Administrationsabläufe für Unternehmen benötigen explizite Szenarionachweise.
    ...
    [Microsoft Teams](/de/channels/msteams), [Microsoft Teams](/de/plugins/reference/msteams), [Kanalkonfiguration](/de/gateway/config-channels), [Systemzustand](/de/gateway/health)
  ...
  <Accordion title="Signal – M2 Alpha – 5 Bereiche">
    ...
    Dokumentation für den unterstützten Kanal ist vorhanden; es sind aussagekräftigere Nachweise für Installation und erneute Verbindungsherstellung erforderlich.
  ...
  <Accordion title="Feishu, QQ Bot, WeChat, Yuanbao, Zalo, Zalo Personal, regionale Kanäle – M2 Alpha – 4 Bereiche">
    ...
    Wichtige regionale Abdeckung, aber der öffentliche Supportumfang sollte je nach Kontotyp, vorgelagerter Genehmigung und Nachweis durch die Maintainer abgestimmt werden.
  ...
  <Accordion title="Sprachanruf-Kanal – M1 Experimentell – 5 Bereiche">
    ...
    Optionaler Plugin-Pfad mit komplexem Echtzeitverhalten. Vor der öffentlichen Betaversion ist eine Szenario-Scorecard erforderlich.
...
<AccordionGroup>
  <Accordion title="Browserautomatisierung, Ausführung und Sandbox-Tools – M3 Beta – 3 Bereiche">
    ...
    Die zentralen Tools sind dokumentiert, doch die Host-Sicherheit und die Benutzerführung für Berechtigungen sollten weiterhin aktiv anhand der Scorecard überprüft werden.
    ...
    [Browsersteuerung](/de/tools/browser-control), [Tests](/de/help/testing), [Browser](/de/tools/browser), [Index](/de/gateway/security/index), [Audit-Prüfungen](/de/gateway/security/audit-checks)
    ...
    [Ausführung](/de/tools/exec), [Hintergrundprozess](/de/gateway/background-process), [Werkzeugaufruf über HTTP-API](/de/gateway/tools-invoke-http-api), [Operatorbereiche](/de/gateway/operator-scopes), [Protokoll](/de/gateway/protocol), [Ausführungsgenehmigungen](/de/tools/exec-approvals), [Erweiterte Ausführungsgenehmigungen](/de/tools/exec-approvals-advanced), [Erhöhte Berechtigungen](/de/tools/elevated)
    ...
    [Sandboxing](/de/gateway/sandboxing), [Sandbox vs. Werkzeugrichtlinie vs. erhöhte Berechtigungen](/de/gateway/sandbox-vs-tool-policy-vs-elevated), [Multi-Agent-Sandbox-Werkzeuge](/de/tools/multi-agent-sandbox-tools), [Codex-Harness-Referenz](/de/plugins/codex-harness-reference), [Konfigurationswerkzeuge](/de/gateway/config-tools)
  ...
  <Accordion title="OpenAI- und Codex-Provider-Pfad – M3 Beta – 5 Bereiche">
    ...
    Ausführliche Dokumentation, OAuth-/Abonnementpfad, Echtzeitsprachübertragung, Bilder und Kompatibilitätsverhalten. Häufige Änderungen am Provider verhindern ohne Nachweis durch die Release-Scorecard eine Einstufung als stabil.
    ...
    [OpenAI](/de/providers/openai), [Codex Harness](/de/plugins/codex-harness), [Modelle](/de/concepts/models), [OAuth](/de/concepts/oauth), [Codex-Harness-Referenz](/de/plugins/codex-harness-reference), [Authentifizierungsüberwachung](/de/gateway/authentication)
      ...
      <div className="maturity-category-row">
        <div className="maturity-category-area">
          <span className="maturity-category-title">Antwort- und Werkzeugkompatibilität</span>
          <span>4 Fähigkeiten / LTS-unterstützt</span>
        </div>
        <div><span className="maturity-score maturity-score-experimental"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-experimental">Experimentell</span><span>40%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "40%" }} /></span></span></div>
        <div><span className="maturity-score maturity-score-beta"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-beta">Beta</span><span>79%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "79%" }} /></span></span></div>
    ...
    [Codex-Harness](/de/plugins/codex-harness), [Codex-Harness-Runtime](/de/plugins/codex-harness-runtime), [Codex-Harness-Referenz](/de/plugins/codex-harness-reference), [Native Codex-Plugins](/de/plugins/codex-native-plugins)
  ...
  <Accordion title="Websuchwerkzeuge – M3 Beta – 4 Bereiche">
    ...
    Es sind mehrere Provider und Dokumentationen vorhanden. Für jede Provider-Familie sind Nachweise zu Kontingenten, Fehlern und SSRF erforderlich.
    ...
    [Web](/de/tools/web), [Webabruf](/de/tools/web-fetch), [Häufig gestellte Fragen](/de/help/faq), [Kosten der API-Nutzung](/de/reference/api-usage-costs), [Brave-Suche](/de/tools/brave-search), [Perplexity-Suche](/de/tools/perplexity-search), [Tavily](/de/tools/tavily), [Firecrawl](/de/tools/firecrawl)
    ...
    [Web](/de/tools/web), [Webabruf](/de/tools/web-fetch), [Firecrawl](/de/tools/firecrawl), [SearxNG-Suche](/de/tools/searxng-search)
    ...
    [Konfigurationswerkzeuge](/de/gateway/config-tools), [Webabruf](/de/tools/web-fetch), [Web](/de/tools/web), [Häufig gestellte Fragen](/de/help/faq)
  ...
  <Accordion title="Anthropic-Provider-Pfad – M3 Beta – 5 Bereiche">
    ...
    Erstklassiger Modell-Provider. Wiederkehrende Szenarionachweise für Authentifizierung, Katalog und Werkzeugaufrufe sind erforderlich.
    ...
    [Anthropic](/de/providers/anthropic), [Agenten konfigurieren](/de/gateway/config-agents), [Modelle](/de/concepts/models), [CLI-Backends](/de/gateway/cli-backends)
      ...
      <div className="maturity-category-row">
        <div className="maturity-category-area">
          <span className="maturity-category-title">Anfragetransport und Zugsemantik</span>
          <span>10 Funktionen</span>
        </div>
        <div><span className="maturity-score maturity-score-experimental"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-experimental">Experimentell</span><span>0%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "0%" }} /></span></span></div>
        <div><span className="maturity-score maturity-score-beta"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-beta">Beta</span><span>77%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "77%" }} /></span></span></div>
  ...
  <Accordion title="Tools zur Bild-, Video- und Musikgenerierung – M2 Alpha – 5 Bereiche">
    ...
    Die Funktion ist bei verschiedenen Providern vorhanden, doch Qualität, Latenz und Parameterkompatibilität variieren zu stark, um ohne einen Nachweis für jeden einzelnen Provider den Beta-Status zu erreichen.
    ...
    [Agentenkonfiguration](/de/gateway/config-agents), [Bildgenerierung](/de/tools/image-generation), [Videogenerierung](/de/tools/video-generation), [Musikgenerierung](/de/tools/music-generation)
  ...
  <Accordion title="Lokale Modell-Provider: Ollama, vLLM, SGLang, LM Studio – M2 Alpha – 5 Bereiche">
    ...
    Nützlich und dokumentiert, aber die Umgebungsunterschiede sind groß.
  ...
  <Accordion title="Weniger verbreitete gehostete Provider – M2 Alpha – 3 Bereiche">
    ...
    Es gibt viele Dokumentations- und Referenzseiten; die Bewertung sollte aus Provider-Metadaten und der Abdeckung durch Live-Smoke-Tests generiert werden.
