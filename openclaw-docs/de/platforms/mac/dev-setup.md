...
summary: Einrichtungsleitfaden für Entwickler, die an der OpenClaw-App für macOS arbeiten
title: macOS-Entwicklungsumgebung
x-i18n:
    generated_at: "2026-07-26T19:04:07Z"
    model: gpt-5.6
...
- **Node.js 24.15+ und pnpm** für das Gateway, die CLI und die Paketierungsskripte. Node
...
**Microphone** zu erlauben, kann die Ursache ein beschädigter TCC-Cache oder eine nicht übereinstimmende Signatur sein.
...
2. Falls dies fehlschlägt, ändern Sie vorübergehend `BUNDLE_ID` in
   ...
   um einen vollständig neuen Ausgangszustand unter macOS zu erzwingen.
