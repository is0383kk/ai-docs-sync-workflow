...
read_when:
    ...
    - OpenClaw rund um die Uhr auf einem kleinen Server betreiben möchten
summary: OpenClaw auf der „Always Free“-ARM-Stufe von Oracle Cloud hosten
title: Oracle Cloud
x-i18n:
    generated_at: "2026-07-26T17:55:09Z"
    model: gpt-5.6
...
<Steps>
  <Step title="OCI-Instanz erstellen">
    ...
    <Tip>
    Wenn die Instanzerstellung mit „Out of capacity“ fehlschlägt, versuchen Sie eine andere Verfügbarkeitsdomäne oder wiederholen Sie den Vorgang später. Die Kapazität der kostenlosen Stufe ist begrenzt.
    </Tip>

  </Step>

  <Step title="Verbinden und System aktualisieren">
    ```bash
