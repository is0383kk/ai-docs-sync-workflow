...
title: Präsentation
x-i18n:
    generated_at: "2026-07-26T18:11:45Z"
    model: gpt-5.6
...
Von der Community entwickelte OpenClaw-Projekte: PR-Review-Schleifen, mobile Apps, Heimautomatisierung, Sprachsysteme, Entwicklertools und Memory-Workflows, die nativ für Chats auf Telegram, WhatsApp, Discord und in Terminals entwickelt wurden.
...
Aktuelle Highlights aus den Bereichen Programmierung, Entwicklertools, Mobilgeräte und chatnative Produktentwicklung.
...
Sagen Sie Ihrem Agenten „Stelle dieses HTML bereit“, und Sie erhalten in etwa einer Sekunde eine öffentliche URL. Seiten laufen nach einer Stunde automatisch ab – kein Server, keine Konfiguration, keine Registrierung.
</Card>
...
Fügen Sie eine beliebige URL ein und erhalten Sie eine Bewertung. Über 2,5 Mio. Betrugsdomains aus 38 Feeds (PhishTank, OpenPhish, CERT.PL und weitere) werden lokal abgeglichen, sodass der Browserverlauf das Gerät nie verlässt.
</Card>

<Card title="Skills für Schlussfolgerungen im Produktdesign" icon="pen-ruler" href="https://clawhub.ai/monikazapisekstudio/skills/socratic-dialog">
  **@monikazapisekstudio** • `product` `reasoning` `skills`

Ein Trio für die Produktarbeit: [Sokratischer Dialog](https://clawhub.ai/monikazapisekstudio/skills/socratic-dialog) hinterfragt eine Frage vor der Beantwortung, [Kano-Modell-Stratege](https://clawhub.ai/monikazapisekstudio/skills/kano-model-strategist) ordnet Funktionen danach, ob sie ihren Platz verdienen, und [Verständliche Agentenausgabe](https://clawhub.ai/monikazapisekstudio/skills/legible-agent-output) formuliert Agentenausgaben in verständlicher Sprache um.
</Card>
...
<Card title="lite-mode für Geräte mit wenig RAM" icon="feather" href="https://clawhub.ai/skills/lite-mode">
  **@mirajmahmudul** • `performance` `skill`

Hält OpenClaw auf Geräten mit 2-4 GB nutzbar: Prüft den freien Arbeitsspeicher und reduziert ressourcenintensive Funktionen, bevor das Gerät mit der Auslagerung beginnt. [Quellcode auf GitHub](https://github.com/mirajmahmudul/openclaw-lite-mode).
</Card>

<Card title="tokenomics-Kostentracker" icon="coins" href="https://github.com/ncz-os/tokenomics">
  **@ncz-os** • `devtools` `costs` `tokens`

Token-Kostentracker eines NVIDIA-Ingenieurs mit erstklassiger OpenClaw-Unterstützung: Sehen Sie exakt, wohin die Ausgaben Ihres Agenten fließen – aufgeschlüsselt nach Modell und Sitzung.
</Card>
...
OpenClaw erstellte sein eigenes Abfragewerkzeug für Google Analytics, das anschließend paketiert und auf ClawHub veröffentlicht wurde.
</Card>
...
Vergleicht Modelle für 59 Agentenrollen, um die Frage „Welches LLM eignet sich für meine GPU?“ zu beantworten. Ein Favorit der Community bei der Auswahl lokaler Modelle.
</Card>
...
<Card title="Vom PR-Review zum Telegram-Feedback" icon="code-pull-request" href="https://x.com/i/status/2010878524543131691">
...
OpenCode schließt die Änderung ab und öffnet einen PR; OpenClaw prüft den Diff und antwortet in Telegram mit Vorschlägen sowie einem eindeutigen Urteil zur Zusammenführung.
  ...
  <img src="/assets/showcase/pr-review-telegram.jpg" alt="In Telegram bereitgestelltes OpenClaw-Feedback zum PR-Review" />
</Card>

<Card title="Weinkeller-Skill in wenigen Minuten" icon="wine-glass" href="https://x.com/i/status/2010916352454791216">
  **@prades_maxime** • `skills` `local` `csv`

„Robby“ (@openclaw) wurde um einen lokalen Weinkeller-Skill gebeten. Er fordert einen CSV-Beispielexport und einen Speicherpfad an und erstellt und testet anschließend den Skill (962 Flaschen im Beispiel).
...
Wöchentlicher Speiseplan, regelmäßige Einkäufe, Lieferzeitfenster buchen, Bestellung bestätigen. Keine APIs, nur Browsersteuerung.

  <img src="/assets/showcase/tesco-shop.jpg" alt="Automatisierung von Tesco-Einkäufen per Chat" />
</Card>

<Card title="SNAG: vom Screenshot zu Markdown" icon="scissors" href="https://github.com/am-will/snag">
  **@am-will** • `devtools` `screenshots` `markdown`

Wählen Sie per Tastenkürzel einen Bildschirmbereich aus, lassen Sie ihn durch Gemini Vision verarbeiten und erhalten Sie sofort Markdown in Ihrer Zwischenablage.
...
Bindet TTS von papla.media ein und sendet die Ergebnisse als Telegram-Sprachnachrichten (ohne störende automatische Wiedergabe).

  <img src="/assets/showcase/papla-tts.jpg" alt="Als Telegram-Sprachnachricht ausgegebene TTS-Audioausgabe" />
</Card>
...
Steuern Sie BambuLab-Drucker und beheben Sie Fehler: Status, Aufträge, Kamera, AMS, Kalibrierung und mehr.
...
Echtzeitabfahrten, Störungen, Aufzugstatus und Routenplanung für den öffentlichen Verkehr in Wien.
...
Automatisierte Buchung von Schulmahlzeiten im Vereinigten Königreich über ParentPay. Verwendet Mauskoordinaten, um zuverlässig auf Tabellenzellen zu klicken.
</Card>
...
<Card title="Kev's Dream Team (mehr als 14 Agenten)" icon="robot" href="https://github.com/adam91holt/orchestrated-ai-articles">
  **@adam91holt** • `multi-agent` `orchestration`

Mehr als 14 Agenten unter einem Gateway, wobei ein Opus-4.5-Orchestrator Aufgaben an Codex-Worker delegiert. Weitere Informationen finden Sie in der [technischen Ausarbeitung](https://github.com/adam91holt/orchestrated-ai-articles) und in [Clawdspace](https://github.com/adam91holt/clawdspace) zur Sandbox-Isolierung von Agenten.
</Card>

<Card title="Linear CLI" icon="terminal" href="https://github.com/Finesssee/linear-cli">
  **@NessZerra** • `devtools` `linear` `cli`

CLI für Linear, die sich in agentische Workflows integriert (Claude Code, OpenClaw). Verwalten Sie Issues, Projekte und Workflows über das Terminal.
</Card>

<Card title="Beeper CLI" icon="message" href="https://github.com/blqke/beepcli">
  **@jules** • `messaging` `beeper` `cli`

Lesen, senden und archivieren Sie Nachrichten über Beeper Desktop. Verwendet die lokale MCP-API von Beeper, damit Agenten alle Ihre Chats (iMessage, WhatsApp und weitere) an einem Ort verwalten können.
</Card>
...
<Card title="Steuerung von Winix-Luftreinigern" icon="wind" href="https://x.com/antonplex/status/2010518442471006253">
...
Ausgelöst durch eine Dachkamera: Bitten Sie OpenClaw, ein Foto des Himmels aufzunehmen, sobald er schön aussieht. OpenClaw entwickelte einen Skill und nahm das Foto auf.
...
Ein geplanter Prompt erzeugt jeden Morgen über eine OpenClaw-Persona ein Szenenbild (Wetter, Aufgaben, Datum, bevorzugter Beitrag oder bevorzugtes Zitat).
</Card>

<Card title="Buchung von Padel-Plätzen" icon="calendar-check" href="https://github.com/joshp123/padel-cli">
  **@joshp123** • `automation` `booking` `cli`

Verfügbarkeitsprüfung für Playtomic plus Buchungs-CLI. Verpassen Sie nie wieder einen freien Platz.

  <img src="/assets/showcase/padel-screenshot.jpg" alt="Screenshot von padel-cli" />
</Card>

<Card title="Erfassung für die Buchhaltung" icon="file-invoice-dollar">
  **Community** • `automation` `email` `pdf`

Sammelt PDFs aus E-Mails und bereitet Dokumente für eine Steuerberatung vor. Monatliche Buchhaltung auf Autopilot.
</Card>

<Card title="Entwicklermodus vom Sofa aus" icon="couch" href="https://davekiss.com">
  **@davekiss** • `telegram` `migration` `astro`

Hat beim Netflix-Schauen eine komplette persönliche Website über Telegram neu erstellt – von Notion zu Astro, 18 Beiträge migriert und DNS zu Cloudflare umgezogen. Dabei wurde nie ein Laptop geöffnet.
</Card>

<Card title="Agent für die Jobsuche" icon="briefcase">
  **@attol8** • `automation` `api` `skill`

Durchsucht Stellenanzeigen, gleicht sie mit Schlüsselwörtern aus dem Lebenslauf ab und liefert passende Angebote mit Links zurück. In 30 Minuten mit der JSearch API erstellt.
</Card>
...
Ließ OpenClaw mit Autohändlern verhandeln: Es übernahm die gesamte Verhandlung und drückte den Preis um $4,200.
</Card>
...
Findet den nächsten Flug in E-Mails, führt den Online-Check-in durch und wählt einen Fensterplatz aus – ohne dass eine App der Fluggesellschaft erforderlich ist.
</Card>
...
Überwacht Gmail auf Arbeitsaufträge, analysiert über Telegram gesendete Immobilienfotos, erstellt mehrseitige Angebots-PDFs mit LaTeX und stellt Rechnungen über Xero.
</Card>

<Card title="Automatischer Support in Slack" icon="slack">
  **@henrymascot** • `slack` `automation` `support`

Überwacht einen Slack-Kanal des Unternehmens, antwortet hilfreich und leitet Benachrichtigungen an Telegram weiter. Behebte selbstständig und unaufgefordert einen Produktionsfehler in einer bereitgestellten App.
</Card>
...
Systeme, die persönliches oder teaminternes Wissen indexieren, durchsuchen, speichern und analysieren.
...
Lernsystem für Chinesisch mit Aussprachefeedback und Lernabläufen über OpenClaw.
  ...
  <img src="/assets/showcase/xuezh-pronunciation.jpeg" alt="Aussprachefeedback in xuezh" />
</Card>

<Card title="Analysepipeline für X-Beiträge" icon="hashtag" href="https://x.com/andrewjiang/status/2008388427180630155">
  **@andrewjiang** • `analysis` `x` `pipeline`

Rief 4 Millionen Beiträge aus 100 führenden X-Konten ab und wandelte sie in eine abfragbare Analysepipeline um.
</Card>
...
Assistent für den täglichen Einsatz auf WhatsApp, dessen gesamtes Gedächtnis als Markdown in einem versionsverwalteten Obsidian-Vault gespeichert ist: Kalorien- und Trainingserfassung, Aufgabenlisten und private Verwaltungsaufgaben.
</Card>
...
Ist in einem Telegram-Gruppenchat der Familie aktiv, dokumentiert Geschichten von mehr als 50 Verwandten und stellt fundierte Rückfragen – mit Antworten auf Nepali für Muttersprachler.
</Card>
...
Ergänzt Karakeep-Lesezeichen um eine Vektorsuche mit Qdrant sowie Embeddings von OpenAI oder Ollama.
</Card>
...
Sprachzentrierte Einstiegspunkte, Telefonbrücken und Workflows mit hohem Transkriptionsanteil.

<CardGroup cols={2}>

<Card title="Sprachsteuerung mit einem Tippen auf den Pebble Ring" icon="ring" href="https://x.com/thekitze/status/2014765279650189578">
  **@thekitze** • `voice` `wearable` `hardware`

Ein Tippen auf einen Pebble Ring startet ein Sprachgespräch mit OpenClaw – Agent-Zugriff über ein Wearable.
</Card>
...
HTTP-Brücke vom Vapi-Sprachassistenten zu OpenClaw. Nahezu Echtzeit-Telefonate mit Ihrem Agenten.
</Card>
...
<Card title="macOS-Menüleisten-Manager" icon="desktop" href="https://x.com/MagiMetal/status/2009424267801485362">
  **@MagiMetal** • `macos` `swift` `ui`

Native Swift-Menüleisten-App, die den Agent-Status mit Schnellsteuerungen anzeigt.
</Card>
...
OpenClaw fand die HomePods im lokalen Netzwerk und schrieb sich selbst einen Skill zu ihrer Steuerung.
</Card>

<Card title="$35-Hologrammwürfel als Oberfläche" icon="cube" href="https://x.com/andrewjiang/status/2013140793649734032">
...
Nix-native Hausautomatisierung mit OpenClaw als Schnittstelle sowie Grafana-Dashboards.
...
Projekte, die über einen einzelnen Workflow hinaus zu umfassenderen Produkten oder Ökosystemen gewachsen sind.
...
Offene Verhandlungen zwischen Agenten: Ihr Agent handelt mit anderen Nodes Geschäfte, Termine und Dienstleistungsvereinbarungen aus und signiert das Ergebnis kryptografisch – Sie müssen nur zustimmen oder ablehnen.
</Card>
...
<Steps>
  <Step title="Teilen">
    Posten Sie in [#self-promotion auf Discord](https://discord.gg/clawd) oder [twittern Sie an @openclaw](https://x.com/openclaw).
  </Step>
  <Step title="Details angeben">
    Beschreiben Sie, was das Projekt macht, verlinken Sie das Repository oder die Demo und teilen Sie einen Screenshot, falls vorhanden.
  </Step>
