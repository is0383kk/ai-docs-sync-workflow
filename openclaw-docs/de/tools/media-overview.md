...
x-i18n:
    generated_at: "2026-07-26T19:16:48Z"
    model: gpt-5.6
...
(Bilder, Audio, Video) und spricht Antworten mithilfe von Text-to-Speech laut aus. Alle
Medienfunktionen werden durch Tools gesteuert: Der Agent entscheidet anhand
der Konversation, wann sie verwendet werden, und jedes Tool wird nur angezeigt, wenn mindestens ein unterstützender
...
Modus `realtime`, z. B. Gemini Live oder die OpenAI Realtime API) — derzeit registrieren sie nur Google
...
OpenClaw registriert, wenn der gemeinsame Vertrag für Echtzeit-Sprache sie abbilden kann.
</Note>
...
Für Live-Unterhaltungen mit Benutzern sollte der [Talk-Modus](/de/nodes/talk) bevorzugt werden. Batch-Audioanhänge
