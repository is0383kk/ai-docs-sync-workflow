...
title: Plugin آنتروپیک Vertex
x-i18n:
    generated_at: "2026-07-27T14:22:08Z"
    model: gpt-5.6
...
Fable 5 همیشه از تفکر تطبیقی استفاده می‌کند و مقدار پیش‌فرض تلاش آن `high` است. `/think off` و
...
در Vertex استفاده کنید. مقدار پیش‌فرض Sonnet 5 تفکر تطبیقی با تلاش `high` است و از
...
قیمت‌گذاری کاتالوگ تا 31 اوت 2026 از نرخ مقدماتی جهانی Vertex، یعنی `$2/$10` به‌ازای
هر یک میلیون توکن ورودی/خروجی، پیروی می‌کند و سپس از 1 سپتامبر به `$3/$15` تغییر می‌یابد.
نقاط پایانی چندمنطقه‌ای `us` و `eu` شامل 10٪ هزینه افزوده مستندشده Vertex هستند.
