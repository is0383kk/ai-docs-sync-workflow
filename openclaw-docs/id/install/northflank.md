---
read_when:
    - Mendeploy OpenClaw ke Northflank
...
title: Northflank
x-i18n:
    generated_at: "2026-04-23T09:22:42Z"
    model: gpt-5.4
    provider: openai
...
Deploy OpenClaw di Northflank dengan template sekali klik dan akses melalui Control UI web.
...
- Penyimpanan persisten melalui Northflank Volume (`/data`) sehingga `openclaw.json`,
  `auth-profiles.json` per agent, state saluran/provider, sesi, dan
  workspace tetap bertahan setelah redeploy
