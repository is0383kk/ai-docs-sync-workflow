...
read_when:
    ...
    - Necesita las referencias de modelos en tiempo de ejecución para los modelos alojados en Go
summary: Usa el catálogo de OpenCode Go con la configuración compartida de OpenCode
title: OpenCode Go
x-i18n:
    generated_at: "2026-07-26T05:27:31Z"
    model: gpt-5.6
...
id de proveedor de runtime (`opencode-go`) para que el enrutamiento ascendente por modelo siga siendo
correcto.
...
| Configuración base   | [OpenCode](/es/providers/opencode)                    |
...
<AccordionGroup>
  ...
  <Accordion title="Convención de referencias de runtime">
    Las referencias de runtime permanecen explícitas: `opencode/...` para Zen y `opencode-go/...` para
  ...
  <Accordion title="Credenciales compartidas">
    Un único `OPENCODE_API_KEY` abarca los catálogos Zen y Go. Al introducir la
    clave durante la configuración, se almacenan las credenciales para ambos proveedores de runtime.
  </Accordion>
</AccordionGroup>

<Tip>
Consulte [OpenCode](/es/providers/opencode) para obtener la descripción general de la incorporación compartida y la referencia
...
<CardGroup cols={2}>
  <Card title="OpenCode (base)" href="/es/providers/opencode" icon="server">
