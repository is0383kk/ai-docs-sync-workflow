...
read_when:
    ...
    - Necesita configurar NVIDIA_API_KEY
    - Quieres usar Nemotron 3 Ultra a través de NVIDIA
summary: Usar la API de NVIDIA compatible con OpenAI en OpenClaw
title: NVIDIA
x-i18n:
    generated_at: "2026-07-26T04:49:49Z"
    model: gpt-5.6
...
<Warning>
`--nvidia-api-key` guarda la clave en el historial del shell y en la salida de `ps`. Siempre que sea posible, es preferible usar la
...
compatibilidad obsoletas siguen siendo accesibles mediante la referencia exacta, pero no aparecen en los
...
<Tip>
Actualmente, los modelos de NVIDIA se pueden usar gratuitamente. Consulte
[build.nvidia.com](https://build.nvidia.com/) para conocer la disponibilidad más reciente y
los detalles de los límites de solicitudes.
</Tip>
