...
title: Nostr
x-i18n:
    generated_at: "2026-07-26T04:30:40Z"
    model: gpt-5.6
  ...
  channels: {
    nostr: {
      ...
      profile: {
        ...
        about: "Bot asistente personal para mensajes directos",
...
- [Grupos](/es/channels/groups) — comportamiento de los chats grupales y restricción mediante menciones
