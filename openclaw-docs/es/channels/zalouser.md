...
title: Zalo personal
x-i18n:
    generated_at: "2026-07-26T05:33:01Z"
    model: gpt-5.6
...
<Note>
`channels.zalouser.groups.<id>.allow` es un nombre de campo heredado; la configuración actual utiliza `enabled`. `openclaw doctor --fix` migra automáticamente `allow` a `enabled`.
</Note>
...
- [Grupos](/es/channels/groups) - comportamiento de los chats de grupo y restricción por mención
