...
```json5
{
  channels: {
    telegram: {
      ...
      groups: {
        "-1001234567890": {
          errorPolicy: "silent", // suprimir los errores en este grupo
        },
      },
    },
  },
...
<AccordionGroup>
  ...
  <Accordion title="El bot no recibe ningún mensaje de grupo">
...
<Accordion title="Campos de Telegram más relevantes">
