...
read_when:
    ...
    - Cambio del control de acceso o del comportamiento de instalación de Skills
summary: Interfaz de configuración de Skills en macOS y estado respaldado por el gateway
title: Skills (macOS)
x-i18n:
    generated_at: "2026-07-26T04:42:53Z"
    model: gpt-5.6
...
La aplicación de macOS muestra las Skills de OpenClaw a través del Gateway; no analiza las Skills localmente.
