...
summary: ClawHub 的举报、审核暂缓、隐藏条目、封禁和账户状态如何运作。
title: 审核与账号安全
x-i18n:
    generated_at: "2026-07-26T06:08:18Z"
    model: gpt-5.6
...
组织、品牌、软件包作用域、所有者用户名或命名空间的所有权争议应使用[组织和命名空间声明](/clawhub/namespace-claims)流程，而不是产品内举报流程或账号申诉表单。
...
已删除、被封禁或已停用的账号无法使用 ClawHub API 令牌。如果账号处置后 CLI 身份验证开始失败，请登录 Web UI 查看账号状态。如果因账号被封禁或停用而无法登录或正常访问 CLI，请使用 [ClawHub 申诉表单](https://appeals.openclaw.ai/)申请恢复审核。
