...
title: Diffs 语言包插件
x-i18n:
    generated_at: "2026-07-26T06:57:07Z"
    model: gpt-5.6
...
基础 `diffs` 插件已支持 [Diffs](/zh-CN/tools/diffs) 中记录的常用语言语法高亮。如果希望为更多 Shiki 支持的语言启用语法高亮，请安装此语言包。如果未安装该语言包，这些文件仍会以易读的纯文本形式呈现。
...
有关 Shiki 的上游语言和别名目录，请参阅 [Shiki 语言](https://shiki.style/languages)。
