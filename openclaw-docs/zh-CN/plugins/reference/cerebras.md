---
read_when:
    - 你正在安装、配置或审计 cerebras 插件
summary: 为 OpenClaw 添加 Cerebras 模型提供商支持。
title: Cerebras 插件
x-i18n:
    generated_at: "2026-07-26T06:21:22Z"
    model: gpt-5.6
...
为 OpenClaw 添加 Cerebras 模型提供商支持。

## 分发

- 软件包：`@openclaw/cerebras-provider`
