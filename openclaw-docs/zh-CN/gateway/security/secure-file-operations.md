...
title: 安全文件操作
x-i18n:
    generated_at: "2026-07-26T06:16:54Z"
    model: gpt-5.6
...
相关内容：[安全](/zh-CN/gateway/security)、[沙箱隔离](/zh-CN/gateway/sandboxing)、[Exec 审批](/zh-CN/tools/exec-approvals)、[机密信息](/zh-CN/gateway/secrets)。
