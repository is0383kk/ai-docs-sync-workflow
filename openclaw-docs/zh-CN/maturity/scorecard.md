...
title: 成熟度评分卡
x-i18n:
    generated_at: "2026-07-26T06:46:11Z"
    model: gpt-5.6
...
<div className="maturity-hero">
  ...
  <p className="maturity-hero-title">以实用视角了解哪些已就绪、哪些已得到验证，以及哪些仍需完善。</p>
  <p>50 个表面 — 281 个能力领域 — 确定性覆盖范围，以及经人工审查的质量和完整性。</p>
  <p className="maturity-jump-links"><a href="#surface-explorer">浏览表面</a> / <a href="#qa-evidence-summary">查看 QA 证据</a> / <a href="/zh-CN/maturity/taxonomy">阅读分类法</a></p>
</div>

## 本页面的用途

使用本页面回答一个问题：哪些 OpenClaw 表面是值得信赖的发布选择，以及哪些证据支持这一判断？覆盖范围来自确定性 QA 证据；质量和完整性则以经审查的成熟度分数进行维护。
...
覆盖范围有意以证据为导向：某个领域不会仅仅因为实现已经存在就变得“就绪”。覆盖范围不作为成熟度分数的输入，但 OpenClaw 的目标是随着时间推移，让成熟的 Stable 或更高级别功能的端到端覆盖率保持在 90% 以上。
...
各表面按成熟度级别、完整性和质量排序。每行还会显示 LTS 支持情况，便于比较已具备发布条件的选项。
  ...
  <Tab title="所有表面">
    <div className="maturity-surface-table">
      ...
      <div className="maturity-surface-row">
        <a className="maturity-surface-name" href="/zh-CN/maturity/taxonomy#automation-cron-hooks-tasks-polling"><span className="maturity-surface-title">自动化：定时任务、钩子、任务、轮询</span><span className="maturity-surface-meta"><span className="maturity-level-pill maturity-level-beta"><span className="maturity-level-code">M3</span><span>测试版</span></span><span>6 个领域</span></span></a>
      ...
      <div className="maturity-surface-row">
        <a className="maturity-surface-name" href="/zh-CN/maturity/taxonomy#windows-via-wsl2"><span className="maturity-surface-title">通过 WSL2 使用 Windows</span><span className="maturity-surface-meta"><span className="maturity-level-pill maturity-level-beta"><span className="maturity-level-code">M3</span><span>Beta</span></span><span>6 个领域</span></span></a>
        <div className="maturity-surface-metric"><span className="maturity-surface-metric-label">覆盖率</span><span className="maturity-score maturity-score-experimental"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-experimental">实验性</span><span>6%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "6%" }} /></span></span></div>
      ...
      <div className="maturity-surface-row">
        <a className="maturity-surface-name" href="/zh-CN/maturity/taxonomy#raspberry-pi-and-small-linux-devices"><span className="maturity-surface-title">Raspberry Pi 和小型 Linux 设备</span><span className="maturity-surface-meta"><span className="maturity-level-pill maturity-level-beta"><span className="maturity-level-code">M3</span><span>Beta</span></span><span>4 个领域</span></span></a>
        <div className="maturity-surface-metric"><span className="maturity-surface-metric-label">覆盖率</span><span className="maturity-score maturity-score-experimental"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-experimental">实验性</span><span>0%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "0%" }} /></span></span></div>
      ...
      <div className="maturity-surface-row">
        <a className="maturity-surface-name" href="/zh-CN/maturity/taxonomy#anthropic-provider-path"><span className="maturity-surface-title">Anthropic 提供商路径</span><span className="maturity-surface-meta"><span className="maturity-level-pill maturity-level-beta"><span className="maturity-level-code">M3</span><span>Beta</span></span><span>5 个领域</span></span></a>
        <div className="maturity-surface-metric"><span className="maturity-surface-metric-label">覆盖率</span><span className="maturity-score maturity-score-experimental"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-experimental">实验性</span><span>0%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "0%" }} /></span></span></div>
      ...
      <div className="maturity-surface-row">
        <a className="maturity-surface-name" href="/zh-CN/maturity/taxonomy#slack"><span className="maturity-surface-title">Slack</span><span className="maturity-surface-meta"><span className="maturity-level-pill maturity-level-beta"><span className="maturity-level-code">M3</span><span>Beta</span></span><span>5 个领域</span></span></a>
        <div className="maturity-surface-metric"><span className="maturity-surface-metric-label">覆盖率</span><span className="maturity-score maturity-score-experimental"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-experimental">实验性</span><span>0%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "0%" }} /></span></span></div>
      ...
      <div className="maturity-surface-row">
        <a className="maturity-surface-name" href="/zh-CN/maturity/taxonomy#google-provider-path"><span className="maturity-surface-title">Google 提供商路径</span><span className="maturity-surface-meta"><span className="maturity-level-pill maturity-level-beta"><span className="maturity-level-code">M3</span><span>Beta</span></span><span>5 个领域</span></span></a>
        <div className="maturity-surface-metric"><span className="maturity-surface-metric-label">覆盖率</span><span className="maturity-score maturity-score-experimental"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-experimental">实验性</span><span>0%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "0%" }} /></span></span></div>
        <div className="maturity-surface-metric"><span className="maturity-surface-metric-label">质量</span><span className="maturity-score maturity-score-alpha"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-alpha">Alpha</span><span>66%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "66%" }} /></span></span></div>
        <div className="maturity-surface-metric"><span className="maturity-surface-metric-label">完整度</span><span className="maturity-score maturity-score-beta"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-beta">Beta</span><span>78%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "78%" }} /></span></span></div>
        <div className="maturity-surface-support"><span className="maturity-lts maturity-lts-none">无</span></div>
      ...
      <div className="maturity-surface-row">
        <a className="maturity-surface-name" href="/zh-CN/maturity/taxonomy#media-understanding-and-media-generation"><span className="maturity-surface-title">媒体理解与媒体生成</span><span className="maturity-surface-meta"><span className="maturity-level-pill maturity-level-alpha"><span className="maturity-level-code">M2</span><span>Alpha</span></span><span>6 个领域</span></span></a>
        <div className="maturity-surface-metric"><span className="maturity-surface-metric-label">覆盖率</span><span className="maturity-score maturity-score-experimental"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-experimental">实验性</span><span>2%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "2%" }} /></span></span></div>
  ...
  <Tab title="核心">
    <div className="maturity-surface-table">
      ...
      <div className="maturity-surface-row">
        <a className="maturity-surface-name" href="/zh-CN/maturity/taxonomy#gateway-web-app"><span className="maturity-surface-title">Gateway 网关 Web 应用</span><span className="maturity-surface-meta"><span className="maturity-level-pill maturity-level-beta"><span className="maturity-level-code">M3</span><span>Beta</span></span><span>6 个领域</span></span></a>
        <div className="maturity-surface-metric"><span className="maturity-surface-metric-label">覆盖率</span><span className="maturity-score maturity-score-experimental"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-experimental">实验性</span><span>4%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "4%" }} /></span></span></div>
        <div className="maturity-surface-metric"><span className="maturity-surface-metric-label">质量</span><span className="maturity-score maturity-score-beta"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-beta">Beta</span><span>74%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "74%" }} /></span></span></div>
        <div className="maturity-surface-metric"><span className="maturity-surface-metric-label">完整度</span><span className="maturity-score maturity-score-beta"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-beta">Beta</span><span>79%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "79%" }} /></span></span></div>
        <div className="maturity-surface-support"><span className="maturity-lts maturity-lts-none">无</span></div>
      ...
      <div className="maturity-surface-row">
        <a className="maturity-surface-name" href="/zh-CN/maturity/taxonomy#plugins"><span className="maturity-surface-title">插件</span><span className="maturity-surface-meta"><span className="maturity-level-pill maturity-level-beta"><span className="maturity-level-code">M3</span><span>Beta</span></span><span>9 个领域</span></span></a>
        <div className="maturity-surface-metric"><span className="maturity-surface-metric-label">覆盖率</span><span className="maturity-score maturity-score-experimental"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-experimental">实验性</span><span>12%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "12%" }} /></span></span></div>
        <div className="maturity-surface-metric"><span className="maturity-surface-metric-label">质量</span><span className="maturity-score maturity-score-beta"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-beta">Beta</span><span>72%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "72%" }} /></span></span></div>
        <div className="maturity-surface-metric"><span className="maturity-surface-metric-label">完整度</span><span className="maturity-score maturity-score-beta"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-beta">Beta</span><span>79%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "79%" }} /></span></span></div>
        <div className="maturity-surface-support"><span className="maturity-lts maturity-lts-partial">部分支持 - 7</span></div>
      </div>
      <div className="maturity-surface-row">
        <a className="maturity-surface-name" href="/zh-CN/maturity/taxonomy#security-auth-pairing-and-secrets"><span className="maturity-surface-title">安全、身份验证、配对和密钥</span><span className="maturity-surface-meta"><span className="maturity-level-pill maturity-level-beta"><span className="maturity-level-code">M3</span><span>Beta</span></span><span>6 个领域</span></span></a>
        <div className="maturity-surface-metric"><span className="maturity-surface-metric-label">覆盖率</span><span className="maturity-score maturity-score-experimental"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-experimental">实验性</span><span>16%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "16%" }} /></span></span></div>
        <div className="maturity-surface-metric"><span className="maturity-surface-metric-label">质量</span><span className="maturity-score maturity-score-beta"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-beta">Beta</span><span>72%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "72%" }} /></span></span></div>
        <div className="maturity-surface-metric"><span className="maturity-surface-metric-label">完整度</span><span className="maturity-score maturity-score-beta"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-beta">Beta</span><span>79%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "79%" }} /></span></span></div>
        <div className="maturity-surface-support"><span className="maturity-lts maturity-lts-partial">部分支持 - 5</span></div>
      ...
      <div className="maturity-surface-row">
        <a className="maturity-surface-name" href="/zh-CN/maturity/taxonomy#automation-cron-hooks-tasks-polling"><span className="maturity-surface-title">自动化：定时任务、Hooks、任务、轮询</span><span className="maturity-surface-meta"><span className="maturity-level-pill maturity-level-beta"><span className="maturity-level-code">M3</span><span>Beta</span></span><span>6 个领域</span></span></a>
        <div className="maturity-surface-metric"><span className="maturity-surface-metric-label">覆盖率</span><span className="maturity-score maturity-score-experimental"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-experimental">实验性</span><span>2%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "2%" }} /></span></span></div>
        <div className="maturity-surface-metric"><span className="maturity-surface-metric-label">质量</span><span className="maturity-score maturity-score-beta"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-beta">Beta</span><span>72%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "72%" }} /></span></span></div>
        <div className="maturity-surface-metric"><span className="maturity-surface-metric-label">完整度</span><span className="maturity-score maturity-score-beta"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-beta">Beta</span><span>79%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "79%" }} /></span></span></div>
        <div className="maturity-surface-support"><span className="maturity-lts maturity-lts-none">无</span></div>
  ...
  <Tab title="渠道">
    <div className="maturity-surface-table">
      <div className="maturity-surface-row maturity-surface-row-header"><span>功能界面</span><span>覆盖率</span><span>质量</span><span>完整度</span><span>支持</span></div>
      <div className="maturity-surface-row">
        <a className="maturity-surface-name" href="/zh-CN/maturity/taxonomy#discord"><span className="maturity-surface-title">Discord</span><span className="maturity-surface-meta"><span className="maturity-level-pill maturity-level-stable"><span className="maturity-level-code">M4</span><span>稳定</span></span><span>6 个领域</span></span></a>
        <div className="maturity-surface-metric"><span className="maturity-surface-metric-label">覆盖率</span><span className="maturity-score maturity-score-experimental"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-experimental">实验性</span><span>0%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "0%" }} /></span></span></div>
        <div className="maturity-surface-metric"><span className="maturity-surface-metric-label">质量</span><span className="maturity-score maturity-score-beta"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-beta">Beta</span><span>73%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "73%" }} /></span></span></div>
...
打开一个界面以检查每个类别的证据状态。列表默认保持折叠，以便快速浏览页面。
...
<AccordionGroup>
  <Accordion title="Agent 运行时 - 9 个领域">
    ...
    <div className="maturity-readiness-list">
      ...
      <div className="maturity-readiness-row">
        ...
        <span>3 项中的 0 项 (0%) / 24 个中的 7 个 (29.2%)</span>
        <span>17 个能力缺口</span>
      </div>
      <div className="maturity-readiness-row">
        <div className="maturity-readiness-area">
        ...
        <span>4 项中的 0 项 (0%) / 10 个中的 3 个 (30%)</span>
        <span>7 个能力缺口</span>
      </div>
      <div className="maturity-readiness-row">
        <div className="maturity-readiness-area">
        ...
        <span>5 项中的 1 项 (20%) / 5 个中的 1 个 (20%)</span>
        <span>4 个能力缺口</span>
      </div>
      <div className="maturity-readiness-row">
        <div className="maturity-readiness-area">
        ...
        <span>5 项中的 0 项 (0%) / 5 个中的 0 个 (0%)</span>
        <span>5 个能力缺口</span>
      </div>
      <div className="maturity-readiness-row">
        <div className="maturity-readiness-area">
        ...
        <span>4 项中的 0 项 (0%) / 8 个中的 2 个 (25%)</span>
        <span>6 个能力缺口</span>
      </div>
      <div className="maturity-readiness-row">
        <div className="maturity-readiness-area">
        ...
        <span>10 项中的 0 项 (0%) / 17 个中的 4 个 (23.5%)</span>
        <span>13 个能力缺口</span>
      </div>
      <div className="maturity-readiness-row">
        <div className="maturity-readiness-area">
        ...
        <span>2 项中的 0 项 (0%) / 9 个中的 5 个 (55.6%)</span>
        <span>4 个能力缺口</span>
      </div>
      <div className="maturity-readiness-row">
        <div className="maturity-readiness-area">
        ...
        <span>3 项中的 0 项 (0%) / 23 个中的 15 个 (65.2%)</span>
        <span>8 个能力缺口</span>
      </div>
      <div className="maturity-readiness-row">
        <div className="maturity-readiness-area">
        ...
        <span>6 项中的 0 项 (0%) / 12 个中的 6 个 (50%)</span>
        <span>6 个能力缺口</span>
      </div>
    </div>
  </Accordion>
  ...
  <Accordion title="Android 应用 - 7 个领域">
    ...
    <div className="maturity-readiness-list">
      ...
      <div className="maturity-readiness-row">
        ...
        <span>1 项中的 0 项 (0%) / 1 个中的 0 个 (0%)</span>
        <span>1 个能力缺口</span>
      </div>
      <div className="maturity-readiness-row">
        <div className="maturity-readiness-area">
        ...
        <span>2 项中的 0 项 (0%) / 2 个中的 0 个 (0%)</span>
        <span>2 个能力缺口</span>
      </div>
      <div className="maturity-readiness-row">
        <div className="maturity-readiness-area">
        ...
        <span>3 项中的 0 项 (0%) / 3 个中的 0 个 (0%)</span>
        <span>3 个能力缺口</span>
      </div>
      <div className="maturity-readiness-row">
        <div className="maturity-readiness-area">
  ...
  <Accordion title="Anthropic 提供商路径 - 5 个领域">
    ...
    <div className="maturity-readiness-list">
      ...
      <div className="maturity-readiness-row">
        ...
        <span>4 项中的 0 项 (0%) / 4 个中的 0 个 (0%)</span>
        <span>4 个能力缺口</span>
      </div>
      <div className="maturity-readiness-row">
        <div className="maturity-readiness-area">
        ...
        <span>10 项中的 0 项 (0%) / 12 个中的 0 个 (0%)</span>
        <span>12 个能力缺口</span>
      </div>
      <div className="maturity-readiness-row">
        <div className="maturity-readiness-area">
          <span className="maturity-readiness-title">提示词缓存和上下文</span>
          <span className="maturity-readiness-status maturity-readiness-status-needs-review">需要审查 - 完整分类法验证</span>
        </div>
        <span>5 项中的 0 项 (0%) / 5 个中的 0 个 (0%)</span>
        <span>5 个能力缺口</span>
      ...
      <div className="maturity-readiness-row">
        ...
        <span>9 项中的 0 项 (0%) / 9 个中的 0 个 (0%)</span>
        <span>9 个能力缺口</span>
      </div>
      <div className="maturity-readiness-row">
        <div className="maturity-readiness-area">
        ...
        <span>10 项中的 0 项 (0%) / 10 个中的 0 个 (0%)</span>
        <span>10 个能力缺口</span>
      </div>
    </div>
  </Accordion>

  <Accordion title="自动化：定时任务、钩子、任务、轮询 - 6 个领域">
    ...
    <div className="maturity-readiness-list">
      ...
      <div className="maturity-readiness-row">
        <div className="maturity-readiness-area">
          <span className="maturity-readiness-title">定时任务</span>
          <span className="maturity-readiness-status maturity-readiness-status-needs-review">需要审查 - 完整分类法验证</span>
        </div>
        <span>0 / 15（0%）/ 0 / 15（0%）</span>
        <span>15 个能力缺口</span>
      </div>
      <div className="maturity-readiness-row">
        <div className="maturity-readiness-area">
  ...
  <Accordion title="渠道框架 - 8 个领域">
    ...
    <div className="maturity-readiness-list">
      ...
      <div className="maturity-readiness-row">
        ...
        <span>0 / 5（0%）/ 4 / 11（36.4%）</span>
        <span>7 个能力缺口</span>
      </div>
      <div className="maturity-readiness-row">
        <div className="maturity-readiness-area">
          <span className="maturity-readiness-title">入站访问和身份关卡</span>
          <span className="maturity-readiness-status maturity-readiness-status-needs-review">需要审查 - 完整分类法验证</span>
        </div>
        <span>0 / 5（0%）/ 0 / 5（0%）</span>
        <span>5 个能力缺口</span>
      ...
      <div className="maturity-readiness-row">
        <div className="maturity-readiness-area">
          <span className="maturity-readiness-title">媒体附件和渠道富数据</span>
          <span className="maturity-readiness-status maturity-readiness-status-needs-review">需要审查 - 完整分类法验证</span>
        </div>
      ...
      <div className="maturity-readiness-row">
        <div className="maturity-readiness-area">
          <span className="maturity-readiness-title">出站递送和回复流水线</span>
          <span className="maturity-readiness-status maturity-readiness-status-partially-reviewed">已部分审查 - 完整分类法验证</span>
        </div>
        <span>0 / 4（0%）/ 8 / 21（38.1%）</span>
        <span>13 个能力缺口</span>
      </div>
      <div className="maturity-readiness-row">
        <div className="maturity-readiness-area">
  ...
  <Accordion title="CLI - 7 个领域">
    <p className="maturity-readiness-summary">5 个需要审查 / 2 个已部分审查</p>
    <div className="maturity-readiness-list">
      <div className="maturity-readiness-row maturity-readiness-row-header"><span>领域</span><span>功能 / 覆盖范围 ID</span><span>后续工作</span></div>
      <div className="maturity-readiness-row">
        <div className="maturity-readiness-area">
  ...
  <Accordion title="Docker 和 Podman 托管 - 4 个领域">
    <p className="maturity-readiness-summary">3 个需要审查 / 1 个已部分审查</p>
    <div className="maturity-readiness-list">
      <div className="maturity-readiness-row maturity-readiness-row-header"><span>领域</span><span>功能 / 覆盖范围 ID</span><span>后续工作</span></div>
      <div className="maturity-readiness-row">
        <div className="maturity-readiness-area">
  ...
  <Accordion title="Feishu、QQ Bot、微信、腾讯元宝、Zalo、Zalo Personal、区域渠道 - 4 个领域">
    <p className="maturity-readiness-summary">4 个领域需要审查</p>
    <div className="maturity-readiness-list">
      <div className="maturity-readiness-row maturity-readiness-row-header"><span>领域</span><span>功能 / 覆盖范围 ID</span><span>后续工作</span></div>
      <div className="maturity-readiness-row">
        <div className="maturity-readiness-area">
  ...
  <Accordion title="Gateway 网关运行时 - 13 个领域">
    <p className="maturity-readiness-summary">9 个领域需要审查 / 4 个领域已部分审查</p>
    <div className="maturity-readiness-list">
      <div className="maturity-readiness-row maturity-readiness-row-header"><span>领域</span><span>功能 / 覆盖范围 ID</span><span>后续工作</span></div>
      <div className="maturity-readiness-row">
        <div className="maturity-readiness-area">
  ...
  <Accordion title="Google Chat - 5 个领域">
    <p className="maturity-readiness-summary">5 个领域需要审查</p>
    <div className="maturity-readiness-list">
      <div className="maturity-readiness-row maturity-readiness-row-header"><span>领域</span><span>功能 / 覆盖范围 ID</span><span>后续工作</span></div>
      <div className="maturity-readiness-row">
        <div className="maturity-readiness-area">
  ...
  <Accordion title="iMessage 和 BlueBubbles - 5 个领域">
    ...
    <div className="maturity-readiness-list">
      ...
      <div className="maturity-readiness-row">
        <div className="maturity-readiness-area">
          <span className="maturity-readiness-title">会话路由与传递</span>
          <span className="maturity-readiness-status maturity-readiness-status-needs-review">需要审查 - 完整分类法验证</span>
        </div>
        <span>0 of 4 (0%) / 0 of 4 (0%)</span>
        <span>4 个能力缺口</span>
      ...
      <div className="maturity-readiness-row">
        <div className="maturity-readiness-area">
          <span className="maturity-readiness-title">原生控件与审批</span>
          <span className="maturity-readiness-status maturity-readiness-status-needs-review">需要审查 - 完整分类法验证</span>
        </div>
  ...
  <Accordion title="iOS 应用 - 8 个领域">
    <p className="maturity-readiness-summary">8 个需要审查</p>
    <div className="maturity-readiness-list">
      <div className="maturity-readiness-row maturity-readiness-row-header"><span>领域</span><span>功能 / 覆盖范围 ID</span><span>后续工作</span></div>
      <div className="maturity-readiness-row">
        <div className="maturity-readiness-area">
          <span className="maturity-readiness-title">画布与屏幕</span>
          <span className="maturity-readiness-status maturity-readiness-status-needs-review">需要审查 - 完整分类法验证</span>
        </div>
        <span>0 of 1 (0%) / 0 of 1 (0%)</span>
        <span>1 个能力缺口</span>
      ...
      <div className="maturity-readiness-row">
        <div className="maturity-readiness-area">
          <span className="maturity-readiness-title">聊天与会话</span>
          <span className="maturity-readiness-status maturity-readiness-status-needs-review">需要审查 - 完整分类法验证</span>
        </div>
        <span>0 of 1 (0%) / 0 of 1 (0%)</span>
        <span>1 个能力缺口</span>
      ...
      <div className="maturity-readiness-row">
        <div className="maturity-readiness-area">
          <span className="maturity-readiness-title">Gateway 网关设置与诊断</span>
          <span className="maturity-readiness-status maturity-readiness-status-needs-review">需要审查 - 完整分类法验证</span>
        </div>
        <span>0 of 7 (0%) / 0 of 7 (0%)</span>
        <span>7 个能力缺口</span>
      ...
      <div className="maturity-readiness-row">
        <div className="maturity-readiness-area">
          <span className="maturity-readiness-title">媒体与共享</span>
          <span className="maturity-readiness-status maturity-readiness-status-needs-review">需要审查 - 完整分类法验证</span>
        </div>
        <span>0 of 1 (0%) / 0 of 1 (0%)</span>
        <span>1 个能力缺口</span>
      ...
      <div className="maturity-readiness-row">
        <div className="maturity-readiness-area">
          <span className="maturity-readiness-title">通知与后台运行</span>
          <span className="maturity-readiness-status maturity-readiness-status-needs-review">需要审查 - 完整分类法验证</span>
        </div>
        <span>0 of 1 (0%) / 0 of 1 (0%)</span>
        <span>1 个能力缺口</span>
  ...
  <Accordion title="Kubernetes 托管 - 4 个领域">
    ...
    <div className="maturity-readiness-list">
      ...
      <div className="maturity-readiness-row">
        <div className="maturity-readiness-area">
          <span className="maturity-readiness-title">配置和机密</span>
          <span className="maturity-readiness-status maturity-readiness-status-needs-review">需要审查 - 完整分类法验证</span>
        </div>
        <span>0 of 5 (0%) / 0 of 5 (0%)</span>
        <span>5 个能力缺口</span>
  ...
  <Accordion title="长尾托管提供商 - 3 个领域">
    <p className="maturity-readiness-summary">3 个需要审查</p>
    <div className="maturity-readiness-list">
      <div className="maturity-readiness-row maturity-readiness-row-header"><span>领域</span><span>功能 / 覆盖范围 ID</span><span>后续工作</span></div>
      <div className="maturity-readiness-row">
        <div className="maturity-readiness-area">
  ...
  <Accordion title="macOS 配套应用 - 8 个领域">
    <p className="maturity-readiness-summary">8 个领域需要审查</p>
    <div className="maturity-readiness-list">
      <div className="maturity-readiness-row maturity-readiness-row-header"><span>领域</span><span>功能 / 覆盖范围 ID</span><span>后续工作</span></div>
      <div className="maturity-readiness-row">
        <div className="maturity-readiness-area">
  ...
  <Accordion title="macOS Gateway 网关主机 - 7 个领域">
    <p className="maturity-readiness-summary">7 个领域需要审查</p>
    <div className="maturity-readiness-list">
      <div className="maturity-readiness-row maturity-readiness-row-header"><span>领域</span><span>功能 / 覆盖范围 ID</span><span>后续工作</span></div>
      <div className="maturity-readiness-row">
        <div className="maturity-readiness-area">
  ...
  <Accordion title="Matrix - 6 个领域">
    <p className="maturity-readiness-summary">6 个领域需要审查</p>
    <div className="maturity-readiness-list">
      <div className="maturity-readiness-row maturity-readiness-row-header"><span>领域</span><span>功能 / 覆盖范围 ID</span><span>后续工作</span></div>
      <div className="maturity-readiness-row">
        <div className="maturity-readiness-area">
  ...
  <Accordion title="Mattermost、LINE、IRC、Nextcloud Talk、Nostr、Twitch、Tlon、Synology Chat - 4 个领域">
    <p className="maturity-readiness-summary">4 个待审查</p>
    <div className="maturity-readiness-list">
      <div className="maturity-readiness-row maturity-readiness-row-header"><span>领域</span><span>功能 / 覆盖范围 ID</span><span>后续工作</span></div>
      <div className="maturity-readiness-row">
        <div className="maturity-readiness-area">
          <span className="maturity-readiness-title">访问与身份</span>
          <span className="maturity-readiness-status maturity-readiness-status-needs-review">待审查 - 完整分类法验证</span>
        </div>
        <span>0 of 1 (0%) / 0 of 1 (0%)</span>
        <span>1 个能力缺口</span>
      </div>
  ...
  <Accordion title="媒体理解与媒体生成 - 6 个领域">
    <p className="maturity-readiness-summary">4 个待审查 / 2 个已部分审查</p>
    <div className="maturity-readiness-list">
      <div className="maturity-readiness-row maturity-readiness-row-header"><span>领域</span><span>功能 / 覆盖范围 ID</span><span>后续工作</span></div>
      <div className="maturity-readiness-row">
        <div className="maturity-readiness-area">
  ...
  <Accordion title="Microsoft Teams - 5 个领域">
    <p className="maturity-readiness-summary">5 个待审查</p>
    <div className="maturity-readiness-list">
      <div className="maturity-readiness-row maturity-readiness-row-header"><span>领域</span><span>功能 / 覆盖范围 ID</span><span>后续工作</span></div>
      <div className="maturity-readiness-row">
        <div className="maturity-readiness-area">
  ...
  <Accordion title="OpenAI 和 Codex 提供商路径 - 5 个领域">
    <p className="maturity-readiness-summary">2 个需要审查 / 3 个已部分审查</p>
    <div className="maturity-readiness-list">
      <div className="maturity-readiness-row maturity-readiness-row-header"><span>领域</span><span>功能 / 覆盖范围 ID</span><span>后续工作</span></div>
      <div className="maturity-readiness-row">
        <div className="maturity-readiness-area">
  ...
  <Accordion title="插件 - 9 个领域">
    <p className="maturity-readiness-summary">6 个需要审查 / 3 个已部分审查</p>
    <div className="maturity-readiness-list">
      <div className="maturity-readiness-row maturity-readiness-row-header"><span>领域</span><span>功能 / 覆盖范围 ID</span><span>后续工作</span></div>
      <div className="maturity-readiness-row">
        <div className="maturity-readiness-area">
          <span className="maturity-readiness-title">插件编写和打包</span>
          <span className="maturity-readiness-status maturity-readiness-status-needs-review">需要审查 - 完整分类法验证</span>
        </div>
  ...
  <Accordion title="安全、身份验证、配对和密钥 - 6 个领域">
    <p className="maturity-readiness-summary">2 个已部分审查 / 4 个需要审查</p>
    <div className="maturity-readiness-list">
      <div className="maturity-readiness-row maturity-readiness-row-header"><span>领域</span><span>功能 / 覆盖范围 ID</span><span>后续工作</span></div>
      <div className="maturity-readiness-row">
        <div className="maturity-readiness-area">
  ...
  <Accordion title="会话、记忆和上下文引擎 - 9 个领域">
    ...
    <div className="maturity-readiness-list">
      ...
      <div className="maturity-readiness-row">
        <div className="maturity-readiness-area">
          <span className="maturity-readiness-title">Token 管理</span>
          <span className="maturity-readiness-status maturity-readiness-status-partially-reviewed">已部分审查 - 完整分类法验证</span>
        </div>
  ...
  <Accordion title="可观测性 - 5 个领域">
    ...
    <div className="maturity-readiness-list">
      ...
      <div className="maturity-readiness-row">
        ...
        <span>8 项中 1 项（12.5%）/ 10 项中 3 项（30%）</span>
        <span>7 个能力缺口</span>
      </div>
      <div className="maturity-readiness-row">
        <div className="maturity-readiness-area">
        ...
        <span>12 项中 1 项（8.3%）/ 18 项中 5 项（27.8%）</span>
        <span>13 个能力缺口</span>
      </div>
      <div className="maturity-readiness-row">
        <div className="maturity-readiness-area">
      ...
      <div className="maturity-readiness-row">
        ...
        <span>13 项中 1 项（7.7%）/ 21 项中 7 项（33.3%）</span>
        <span>14 个能力缺口</span>
      </div>
    </div>
  </Accordion>
  ...
  <Accordion title="watchOS 配套界面 - 5 个领域">
    ...
    <div className="maturity-readiness-list">
      ...
      <div className="maturity-readiness-row">
        <div className="maturity-readiness-area">
          <span className="maturity-readiness-title">手表应用界面</span>
          <span className="maturity-readiness-status maturity-readiness-status-needs-review">需要审查 - 完整分类法验证</span>
        </div>
        <span>0 of 3 (0%) / 0 of 3 (0%)</span>
        <span>3 个能力缺口</span>
  ...
  <Accordion title="Web 搜索工具 - 4 个领域">
    <p className="maturity-readiness-summary">2 个需要审查 / 2 个已部分审查</p>
    <div className="maturity-readiness-list">
      <div className="maturity-readiness-row maturity-readiness-row-header"><span>领域</span><span>功能 / 覆盖范围 ID</span><span>后续工作</span></div>
      <div className="maturity-readiness-row">
        <div className="maturity-readiness-area">
      ...
      <div className="maturity-readiness-row">
        <div className="maturity-readiness-area">
          <span className="maturity-readiness-title">工具可用性和抓取</span>
          <span className="maturity-readiness-status maturity-readiness-status-partially-reviewed">已部分审查 - 完整分类法验证</span>
        </div>
  ...
  <Accordion title="通过 WSL2 使用 Windows - 6 个领域">
    ...
    <div className="maturity-readiness-list">
      ...
      <div className="maturity-readiness-row">
        <div className="maturity-readiness-area">
          <span className="maturity-readiness-title">诊断与修复</span>
          <span className="maturity-readiness-status maturity-readiness-status-partially-reviewed">已部分审查 - 完整分类法验证</span>
        </div>
      ...
      <div className="maturity-readiness-row">
        <div className="maturity-readiness-area">
          <span className="maturity-readiness-title">Gateway 网关访问与暴露</span>
          <span className="maturity-readiness-status maturity-readiness-status-needs-review">需要审查 - 完整分类法验证</span>
        </div>
        <span>0 / 11 (0%) / 0 / 11 (0%)</span>
        <span>11 个能力缺口</span>
