---
summary: OpenClaw 成熟度评分卡所涵盖的产品领域及其检查项的详细参考。
title: 成熟度分类法
x-i18n:
    generated_at: "2026-07-26T07:07:53Z"
    model: gpt-5.6
...
<div className="maturity-hero maturity-hero-compact">
  ...
  <p className="maturity-hero-title">产品界面 &gt; 类别 &gt; 能力 &gt; 证据。</p>
  <p>50 个产品界面分为 4 个系列，每个类别均关联到规范文档和 QA 覆盖 ID。</p>
...
产品界面是 Gateway 网关运行时、Discord 或 macOS 应用等产品领域。每个产品界面包含多个类别，每个类别又包含 QA 场景所覆盖的能力级检查。使用评分卡进行发布级判断；使用此页面查看其底层模型。

## 成熟度级别

<div className="maturity-level-list">
  <div className="maturity-level-row"><span className="maturity-level-title"><span className="maturity-level-pill maturity-level-experimental"><span className="maturity-level-code">M0</span><span>已规划</span></span></span><span>方向已明确，但尚不存在受支持的用户路径。</span><span className="maturity-level-promotion">晋级条件：已有设计议题、负责人和目标产品界面。</span></div>
  <div className="maturity-level-row"><span className="maturity-level-title"><span className="maturity-level-pill maturity-level-experimental"><span className="maturity-level-code">M1</span><span>实验性</span></span></span><span>已实现，但存在限制条件、需要启用标志或从源码构建，或仅能通过维护者专用流程使用。</span><span className="maturity-level-promotion">晋级条件：维护者可以从当前 main 运行该场景。</span></div>
  <div className="maturity-level-row"><span className="maturity-level-title"><span className="maturity-level-pill maturity-level-alpha"><span className="maturity-level-code">M2</span><span>Alpha</span></span></span><span>真实用户可以试用，但预期会有破坏性变更和不完整的用户体验。</span><span className="maturity-level-promotion">晋级条件：已有设置文档、基本测试、已知限制条件，以及至少一项真实环境验证。</span></div>
  <div className="maturity-level-row"><span className="maturity-level-title"><span className="maturity-level-pill maturity-level-beta"><span className="maturity-level-code">M3</span><span>Beta</span></span></span><span>已有公开路径，主要工作流在有限的限制条件下可用。</span><span className="maturity-level-promotion">晋级条件：已有安装/更新文档、回归测试、支持运行手册，并在预期环境中成功完成场景验证。</span></div>
  <div className="maturity-level-row"><span className="maturity-level-title"><span className="maturity-level-pill maturity-level-stable"><span className="maturity-level-code">M4</span><span>稳定</span></span></span><span>面向普通用户的推荐路径。出现故障时将按回归问题处理。</span><span className="maturity-level-promotion">晋级条件：已有发布门禁、Doctor/故障排除路径、全面的文档，以及反复完成的真实环境验证。</span></div>
  <div className="maturity-level-row"><span className="maturity-level-title"><span className="maturity-level-pill maturity-level-clawesome"><span className="maturity-level-code">M5</span><span>Clawesome</span></span></span><span>完善、令人愉悦、可观测性良好，并可与同类最佳工作流竞争。</span><span className="maturity-level-promotion">晋级条件：达到稳定级别，并通过代表性用户的用户评分卡评估。</span></div>
</div>
...
<Tabs>
  <Tab title="核心">
    ...
    <a className="maturity-surface-link" href="#automation-cron-hooks-tasks-polling">
      <span className="maturity-surface-title">自动化：cron、Hooks、任务、轮询</span>
      <span className="maturity-surface-meta"><span className="maturity-level-pill maturity-level-beta"><span className="maturity-level-code">M3</span><span>Beta</span></span><span>6 个领域 - 完成度 79%</span></span>
    </a>
    ...
    <a className="maturity-surface-link" href="#media-understanding-and-media-generation">
      ...
      <span className="maturity-surface-meta"><span className="maturity-level-pill maturity-level-alpha"><span className="maturity-level-code">M2</span><span>Alpha</span></span><span>6 个领域 - 完成度 68%</span></span>
    </a>
    ...
    <a className="maturity-surface-link" href="#tui">
      ...
      <span className="maturity-surface-meta"><span className="maturity-level-pill maturity-level-alpha"><span className="maturity-level-code">M2</span><span>Alpha</span></span><span>5 个领域 - 完成度 66%</span></span>
    </a>

    <a className="maturity-surface-link" href="#clawhub">
      <span className="maturity-surface-title">ClawHub</span>
      <span className="maturity-surface-meta"><span className="maturity-level-pill maturity-level-alpha"><span className="maturity-level-code">M2</span><span>Alpha</span></span><span>4 个领域 - 完成度 62%</span></span>
    </a>

    <a className="maturity-surface-link" href="#openclaw-app-sdk">
      <span className="maturity-surface-title">OpenClaw 应用 SDK</span>
      <span className="maturity-surface-meta"><span className="maturity-level-pill maturity-level-alpha"><span className="maturity-level-code">M2</span><span>Alpha</span></span><span>6 个领域 - 完成度 53%</span></span>
    </a>
  ...
  <Tab title="平台">
    ...
    <a className="maturity-surface-link" href="#docker-and-podman-hosting">
      ...
      <span className="maturity-surface-meta"><span className="maturity-level-pill maturity-level-beta"><span className="maturity-level-code">M3</span><span>Beta</span></span><span>4 个领域 - 完成度 79%</span></span>
    </a>
    ...
    <a className="maturity-surface-link" href="#macos-companion-app">
      ...
      <span className="maturity-surface-meta"><span className="maturity-level-pill maturity-level-beta"><span className="maturity-level-code">M3</span><span>Beta</span></span><span>8 个领域 - 完成度 78%</span></span>
    </a>


    <a className="maturity-surface-link" href="#native-windows">
      <span className="maturity-surface-title">原生 Windows</span>
      <span className="maturity-surface-meta"><span className="maturity-level-pill maturity-level-alpha"><span className="maturity-level-code">M2</span><span>Alpha</span></span><span>4 个领域 - 完成度 66%</span></span>
    </a>

    <a className="maturity-surface-link" href="#kubernetes-hosting">
      <span className="maturity-surface-title">Kubernetes 托管</span>
      <span className="maturity-surface-meta"><span className="maturity-level-pill maturity-level-alpha"><span className="maturity-level-code">M2</span><span>Alpha</span></span><span>4 个领域 - 完成度 61%</span></span>
    </a>
  ...
  <Tab title="渠道">
    ...
    <a className="maturity-surface-link" href="#telegram">
      ...
      <span className="maturity-surface-meta"><span className="maturity-level-pill maturity-level-beta"><span className="maturity-level-code">M3</span><span>Beta</span></span><span>5 个领域 - 完成度 78%</span></span>
    </a>
    ...
    <a className="maturity-surface-link" href="#matrix">
      ...
      <span className="maturity-surface-meta"><span className="maturity-level-pill maturity-level-alpha"><span className="maturity-level-code">M2</span><span>Alpha</span></span><span>6 个领域 - 完成度 67%</span></span>
    </a>
    ...
    <a className="maturity-surface-link" href="#feishu-qq-bot-wechat-yuanbao-zalo-zalo-personal-regional-channels">
      ...
      <span className="maturity-surface-meta"><span className="maturity-level-pill maturity-level-alpha"><span className="maturity-level-code">M2</span><span>Alpha</span></span><span>4 个领域 - 完成度 58%</span></span>
    </a>
    ...
    <a className="maturity-surface-link" href="#mattermost-line-irc-nextcloud-talk-nostr-twitch-tlon-synology-chat">
      ...
      <span className="maturity-surface-meta"><span className="maturity-level-pill maturity-level-alpha"><span className="maturity-level-code">M2</span><span>Alpha</span></span><span>4 个领域 - 完成度 54%</span></span>
    </a>
  ...
  <Tab title="提供商和工具">
    ...
    <a className="maturity-surface-link" href="#browser-automation-exec-and-sandbox-tools">
      ...
      <span className="maturity-surface-meta"><span className="maturity-level-pill maturity-level-beta"><span className="maturity-level-code">M3</span><span>Beta</span></span><span>3 个领域 - 完成度 79%</span></span>
    </a>
    ...
    <a className="maturity-surface-link" href="#openrouter-provider-path">
      ...
      <span className="maturity-surface-meta"><span className="maturity-level-pill maturity-level-beta"><span className="maturity-level-code">M3</span><span>Beta</span></span><span>4 个领域 - 完成度 78%</span></span>
    </a>
    ...
    <a className="maturity-surface-link" href="#image-video-and-music-generation-tools">
      ...
      <span className="maturity-surface-meta"><span className="maturity-level-pill maturity-level-alpha"><span className="maturity-level-code">M2</span><span>Alpha</span></span><span>5 个领域 - 完成度 68%</span></span>
    </a>
    ...
    <a className="maturity-surface-link" href="#long-tail-hosted-providers">
      ...
      <span className="maturity-surface-meta"><span className="maturity-level-pill maturity-level-alpha"><span className="maturity-level-code">M2</span><span>Alpha</span></span><span>3 个领域 - 完成度 68%</span></span>
    </a>
...
<AccordionGroup>
  <Accordion title="CLI - M4 稳定版 - 7 个领域">
    ...
    常规设置和修复路径已记录在安装、CLI 和 Gateway 网关文档中。Windows 专用路径在“通过 WSL2 使用 Windows”和“原生 Windows”行中跟踪。

    <div className="maturity-surface-rollup"><span>覆盖率：实验性 - 4%</span><span>质量：稳定版 - 83%</span><span>完整度：稳定版 - 90%</span><span><span className="maturity-lts maturity-lts-partial">部分 - 6</span></span></div>
    ...
    [索引](/zh-CN/install/index)、[安装程序](/zh-CN/install/installer)、[Node](/zh-CN/install/node)、[更新](/zh-CN/install/updating)
    ...
    [引导设置](/zh-CN/cli/onboard)、[配置](/zh-CN/cli/configure)、[新手引导概览](/zh-CN/start/onboarding-overview)
    ...
    [引导设置](/zh-CN/cli/onboard)、[插件](/zh-CN/cli/plugins)、[渠道](/zh-CN/cli/channels)
    ...
    [Gateway 网关](/zh-CN/cli/gateway)、[更新](/zh-CN/install/updating)、[故障排查](/zh-CN/gateway/troubleshooting)
    ...
    [状态](/zh-CN/cli/status)、[健康状况](/zh-CN/cli/health)、[日志](/zh-CN/cli/logs)、[诊断](/zh-CN/gateway/diagnostics)
    ...
    [Doctor](/zh-CN/cli/doctor), [Doctor](/zh-CN/gateway/doctor), [密钥](/zh-CN/gateway/secrets), [故障排查](/zh-CN/gateway/troubleshooting)
    ...
    [更新](/zh-CN/install/updating), [更新](/zh-CN/cli/update), [故障排查](/zh-CN/gateway/troubleshooting)
  ...
  <Accordion title="Gateway 网关运行时 - M4 稳定 - 13 个领域">
    ...
    [协议](/zh-CN/gateway/protocol), [索引](/zh-CN/gateway/security/index)
    ...
    [索引](/zh-CN/gateway/index)、[OpenAI HTTP API](/zh-CN/gateway/openai-http-api)、[OpenResponses HTTP API](/zh-CN/gateway/openresponses-http-api)、[工具调用 HTTP API](/zh-CN/gateway/tools-invoke-http-api)、[Hooks](/zh-CN/automation/hooks)、[索引](/zh-CN/web/index)
    ...
    [索引](/zh-CN/gateway/index)、[架构](/zh-CN/concepts/architecture)、[Control UI](/zh-CN/web/control-ui)、[Web 聊天](/zh-CN/web/webchat)、[画布](/zh-CN/refactor/canvas)

    </div>
      </div>
      <div className="maturity-category-row">
        <div className="maturity-category-area">
          <span className="maturity-category-title">Gateway RPC API 和事件</span>
    ...
    [协议](/zh-CN/gateway/protocol)、[索引](/zh-CN/gateway/index)、[架构](/zh-CN/concepts/architecture)

    </div>
      </div>
      <div className="maturity-category-row">
        <div className="maturity-category-area">
          <span className="maturity-category-title">设备身份验证与配对</span>
          <span>10 项能力 / LTS 支持</span>
        </div>
        <div><span className="maturity-score maturity-score-experimental"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-experimental">实验性</span><span>0%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "0%" }} /></span></span></div>
        <div><span className="maturity-score maturity-score-beta"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-beta">Beta</span><span>75%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "75%" }} /></span></span></div>
    ...
    [协议](/zh-CN/gateway/protocol)、[配对](/zh-CN/gateway/pairing)、[索引](/zh-CN/gateway/security/index)
    ...
    [索引](/zh-CN/gateway/index)、[设备发现](/zh-CN/gateway/discovery)、[协议](/zh-CN/gateway/protocol)
    ...
    [协议](/zh-CN/gateway/protocol)、[架构](/zh-CN/concepts/architecture)、[索引](/zh-CN/nodes/index)

    </div>
      </div>
      <div className="maturity-category-row">
        <div className="maturity-category-area">
          <span className="maturity-category-title">健康状态、诊断和修复</span>
    ...
    [索引](/zh-CN/gateway/index)、[诊断](/zh-CN/gateway/diagnostics)、[Doctor](/zh-CN/gateway/doctor)
    ...
    [索引](/zh-CN/gateway/index), [架构](/zh-CN/concepts/architecture)
    ...
    [索引](/zh-CN/gateway/security/index), [协议](/zh-CN/gateway/protocol), [设备发现](/zh-CN/gateway/discovery)
  ...
  <Accordion title="Agent 运行时 - M3 测试版 - 9 个领域">
    <a id="agent-runtime" />

    主循环、模型、提供商路由和工具流式传输均为一等能力，但提供商行为每周都会变化，因此每个版本都需要进行场景验证。

    <div className="maturity-surface-rollup"><span>覆盖率：实验性 - 33%</span><span>质量：测试版 - 78%</span><span>完整度：测试版 - 79%</span><span><span className="maturity-lts maturity-lts-partial">部分支持 - 6</span></span></div>
  ...
  <Accordion title="会话、记忆和上下文引擎 - M3 Beta - 9 个领域">
    ...
    文档完善且实现工作活跃。成熟度取决于对话记录的持久性、压缩质量以及跨客户端的一致性。

    <div className="maturity-surface-rollup"><span>覆盖度 实验性 - 30%</span><span>质量 Beta - 77%</span><span>完整性 Beta - 79%</span><span><span className="maturity-lts maturity-lts-partial">部分支持 - 6</span></span></div>
    ...
    <div className="maturity-category-list">
      ...
      <div className="maturity-category-row">
        <div className="maturity-category-area">
          <span className="maturity-category-title">CLI 会话和对话记录管理</span>
    ...
    [上下文](/zh-CN/concepts/context)、[上下文引擎](/zh-CN/concepts/context-engine)

    </div>
      </div>
      <div className="maturity-category-row">
        <div className="maturity-category-area">
          <span className="maturity-category-title">跨客户端历史记录与会话一致性</span>
          <span>2 项能力</span>
        </div>
    ...
    [Webchat](/zh-CN/web/webchat)、[Android](/zh-CN/platforms/android)、[频道路由](/zh-CN/channels/channel-routing)
      ...
      <div className="maturity-category-row">
        <div className="maturity-category-area">
          <span className="maturity-category-title">诊断、维护与恢复</span>
          <span>3 项能力</span>
        </div>
        <div><span className="maturity-score maturity-score-experimental"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-experimental">实验性</span><span>40%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "40%" }} /></span></span></div>
        <div><span className="maturity-score maturity-score-beta"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-beta">Beta</span><span>79%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "79%" }} /></span></span></div>
    ...
    [诊断](/zh-CN/gateway/diagnostics)、[会话管理压缩](/zh-CN/reference/session-management-compaction)、[标志](/zh-CN/diagnostics/flags)
      ...
      <div className="maturity-category-row">
        <div className="maturity-category-area">
          <span className="maturity-category-title">核心提示词与上下文</span>
    ...
    [上下文](/zh-CN/concepts/context)、[对话记录整理](/zh-CN/reference/transcript-hygiene)、[Discord](/zh-CN/channels/discord)
    ...
    [记忆配置](/zh-CN/reference/memory-config)、[记忆 Qmd](/zh-CN/concepts/memory-qmd)、[记忆](/zh-CN/concepts/memory)、[Discord](/zh-CN/channels/discord)
    ...
    [会话管理压缩](/zh-CN/reference/session-management-compaction)、[转录记录整理](/zh-CN/reference/transcript-hygiene)
  ...
  <Accordion title="渠道框架 - M3 Beta - 8 个领域">
    ...
    许多渠道共用 Gateway 网关的交付和路由契约，但渠道行为会因上游 API 和账户策略限制而异。

    <div className="maturity-surface-rollup"><span>覆盖率：实验性 - 13%</span><span>质量：Beta - 76%</span><span>完整性：Beta - 79%</span><span><span className="maturity-lts maturity-lts-partial">部分支持 - 5</span></span></div>
    ...
    [群组](/zh-CN/channels/groups)、[Discord](/zh-CN/channels/discord)、[Google Chat](/zh-CN/channels/googlechat)、[Signal](/zh-CN/channels/signal)、[Matrix](/zh-CN/channels/matrix)
    ...
    [索引](/zh-CN/channels/index)、[配对](/zh-CN/channels/pairing)、[故障排查](/zh-CN/channels/troubleshooting)、[渠道插件 SDK](/zh-CN/plugins/sdk-channel-plugins)
    ...
    [访问群组](/zh-CN/channels/access-groups)、[群组](/zh-CN/channels/groups)、[Discord](/zh-CN/channels/discord)、[LINE](/zh-CN/channels/line)
      ...
      <div className="maturity-category-row">
        <div className="maturity-category-area">
          <span className="maturity-category-title">媒体附件和富渠道数据</span>
          <span>4 项能力</span>
        </div>
        <div><span className="maturity-score maturity-score-experimental"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-experimental">实验性</span><span>0%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "0%" }} /></span></span></div>
        <div><span className="maturity-score maturity-score-alpha"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-alpha">Alpha</span><span>68%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "68%" }} /></span></span></div>
    ...
    [LINE](/zh-CN/channels/line)、[Signal](/zh-CN/channels/signal)、[Google Chat](/zh-CN/channels/googlechat)、[Matrix](/zh-CN/channels/matrix)、[Discord](/zh-CN/channels/discord)
    ...
    [群组](/zh-CN/channels/groups)、[环境房间事件](/zh-CN/channels/ambient-room-events)、[Discord](/zh-CN/channels/discord)、[Matrix](/zh-CN/channels/matrix)、[渠道配置](/zh-CN/gateway/config-channels)
    ...
    [频道路由](/zh-CN/channels/channel-routing)、[群组](/zh-CN/channels/groups)、[Discord](/zh-CN/channels/discord)、[Matrix](/zh-CN/channels/matrix)、[故障排查](/zh-CN/channels/troubleshooting)、[配置参考](/zh-CN/gateway/configuration-reference)
    ...
    [健康](/zh-CN/gateway/health)、[配置参考](/zh-CN/gateway/configuration-reference)、[故障排查](/zh-CN/channels/troubleshooting)、[Discord](/zh-CN/channels/discord)
  ...
  <Accordion title="可观测性 - M3 Beta - 5 个领域">
    ...
    已有 OTel、Prometheus、日志和诊断文档。需要进行一次面向公众的“操作员首先应该查看什么”成熟度完善。

    <div className="maturity-surface-rollup"><span>覆盖率：实验性 - 18%</span><span>质量：Beta - 75%</span><span>完整性：Beta - 79%</span><span><span className="maturity-lts maturity-lts-partial">部分支持 - 3</span></span></div>
    ...
    [诊断](/zh-CN/gateway/diagnostics)，[健康状态](/zh-CN/gateway/health)，[Codex Harness](/zh-CN/plugins/codex-harness)，[协议](/zh-CN/gateway/protocol)
    ...
    [Hooks](/zh-CN/plugins/hooks)，[Opentelemetry](/zh-CN/gateway/opentelemetry)，[日志](/zh-CN/logging)，[SDK 子路径](/zh-CN/plugins/sdk-subpaths)，[诊断 Otel](/zh-CN/plugins/reference/diagnostics-otel)，[Prometheus](/zh-CN/gateway/prometheus)，[诊断 Prometheus](/zh-CN/plugins/reference/diagnostics-prometheus)
  ...
  <Accordion title="Gateway Web 应用 - M3 Beta - 6 个领域">
    <a id="gateway-web-app" />

    Web UI 文档涵盖配对、聊天、PWA、Talk、推送和远程 Gateway 网关流程。完成跨浏览器和移动端 PWA 评分卡后再提升其成熟度等级。

    <div className="maturity-surface-rollup"><span>覆盖率 实验性 - 4%</span><span>质量 Beta - 74%</span><span>完整性 Beta - 79%</span><span><span className="maturity-lts maturity-lts-none">无</span></span></div>
    ...
    [Control UI](/zh-CN/web/control-ui)、[协议](/zh-CN/gateway/protocol)、[Talk](/zh-CN/nodes/talk)
    ...
    [Control UI](/zh-CN/web/control-ui)、[仪表板](/zh-CN/web/dashboard)、[Tailscale](/zh-CN/gateway/tailscale)、[远程访问](/zh-CN/gateway/remote)
    ...
    [Control UI](/zh-CN/web/control-ui)、[索引](/zh-CN/web/index)、[仪表板](/zh-CN/web/dashboard)、[协议](/zh-CN/gateway/protocol)
    ...
    [Control UI](/zh-CN/web/control-ui)、[健康状态](/zh-CN/gateway/health)、[协议](/zh-CN/gateway/protocol)、[仪表板](/zh-CN/web/dashboard)
  ...
  <Accordion title="插件 - M3 Beta - 9 个领域">
    ...
    在清单、设备发现、加载、提供商/工具架构和审批边界方面，已有广泛的文档和充分的内部运行时证据。在公共 SDK API/子路径和外部分发证据得到进一步加强之前，该行应保持为 Beta。

    <div className="maturity-surface-rollup"><span>覆盖率：实验性 - 12%</span><span>质量：Beta - 72%</span><span>完整性：Beta - 79%</span><span><span className="maturity-lts maturity-lts-partial">部分支持 - 7</span></span></div>

    <div className="maturity-category-list">
      <div className="maturity-category-row maturity-category-row-header"><span>领域</span><span>覆盖率</span><span>质量</span><span>完整性</span><span>文档</span></div>
      <div className="maturity-category-row">
        <div className="maturity-category-area">
          <span className="maturity-category-title">插件创作和打包</span>
          <span>8 项能力 / LTS 支持</span>
        </div>
        <div><span className="maturity-score maturity-score-experimental"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-experimental">实验性</span><span>0%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "0%" }} /></span></span></div>
        <div><span className="maturity-score maturity-score-alpha"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-alpha">Alpha</span><span>68%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "68%" }} /></span></span></div>
    ...
    [Building Plugins](/zh-CN/plugins/building-plugins)、[插件 SDK 概览](/zh-CN/plugins/sdk-overview)、[插件入口点](/zh-CN/plugins/sdk-entrypoints)、[插件 SDK 子路径](/zh-CN/plugins/sdk-subpaths)、[插件清单](/zh-CN/plugins/manifest)、[参考](/zh-CN/plugins/reference)
    ...
    [插件清单](/zh-CN/plugins/plugin-inventory)，[插件](/zh-CN/cli/plugins)，[插件架构内部机制](/zh-CN/plugins/architecture-internals)
    ...
    [插件架构](/zh-CN/plugins/architecture)，[插件架构内部机制](/zh-CN/plugins/architecture-internals)，[插件](/zh-CN/cli/plugins)
    ...
    [SDK 渠道插件](/zh-CN/plugins/sdk-channel-plugins)，[SDK 渠道入口](/zh-CN/plugins/sdk-channel-inbound)，[SDK 渠道出站](/zh-CN/plugins/sdk-channel-outbound)
  ...
  <Accordion title="安全、身份验证、配对和机密信息 - M3 Beta - 6 个领域">
    ...
    已有完善的文档和加固机制。定期运行升级与安全场景并证明设置流程不存在回归后，再提升其成熟度。

    <div className="maturity-surface-rollup"><span>覆盖率：实验性 - 16%</span><span>质量：Beta - 72%</span><span>完整性：Beta - 79%</span><span><span className="maturity-lts maturity-lts-partial">部分支持 - 5</span></span></div>
    ...
    [索引](/zh-CN/gateway/security/index)、[Gateway 暴露运行手册](/zh-CN/gateway/security/exposure-runbook)、[可信代理身份验证](/zh-CN/gateway/trusted-proxy-auth)、[Tailscale](/zh-CN/gateway/tailscale)、[远程访问](/zh-CN/gateway/remote)、[配置参考](/zh-CN/gateway/configuration-reference)、[Gateway 网关](/zh-CN/cli/gateway)、[Doctor](/zh-CN/cli/doctor)、[Control UI](/zh-CN/web/control-ui)、[浏览器控制](/zh-CN/tools/browser-control)、[审计检查](/zh-CN/gateway/security/audit-checks)
    ...
    [协议](/zh-CN/gateway/protocol)、[设备](/zh-CN/cli/devices)、[配对](/zh-CN/channels/pairing)、[配对](/zh-CN/gateway/pairing)、[操作员权限范围](/zh-CN/gateway/operator-scopes)、[Control UI](/zh-CN/web/control-ui)、[Webchat](/zh-CN/web/webchat)、[审批](/zh-CN/cli/approvals)
    ...
    [插件清单](/zh-CN/plugins/manifest)、[插件权限请求](/zh-CN/plugins/plugin-permission-requests)、[管理插件](/zh-CN/plugins/manage-plugins)、[审计检查](/zh-CN/gateway/security/audit-checks)
  ...
  <Accordion title="自动化：定时任务、钩子、任务、轮询 - M3 Beta - 6 个领域">
    <a id="automation-cron-hooks-tasks-polling" />

    已有文档且可用，但场景验证应涵盖无人值守交付、重试和故障可见性。

    <div className="maturity-surface-rollup"><span>覆盖率：实验性 - 2%</span><span>质量：Beta - 72%</span><span>完整性：Beta - 79%</span><span><span className="maturity-lts maturity-lts-none">无</span></span></div>
    ...
    [定时任务](/zh-CN/automation/cron-jobs), [Cron](/zh-CN/cli/cron), [协议](/zh-CN/gateway/protocol), [任务](/zh-CN/automation/tasks), [Discord](/zh-CN/channels/discord)
    ...
    [Hooks](/zh-CN/automation/hooks), [Hooks](/zh-CN/cli/hooks), [Hooks](/zh-CN/plugins/hooks), [插件权限请求](/zh-CN/plugins/plugin-permission-requests), [插件 SDK 子路径](/zh-CN/plugins/sdk-subpaths)
    ...
    [任务](/zh-CN/automation/tasks), [索引](/zh-CN/automation/index), [任务](/zh-CN/cli/tasks), [Task Flow](/zh-CN/automation/taskflow), [SDK 运行时](/zh-CN/plugins/sdk-runtime)
    ...
    [索引](/zh-CN/automation/index), [Heartbeat](/zh-CN/gateway/heartbeat), [跟进承诺](/zh-CN/concepts/commitments)
    ...
    [轮询](/zh-CN/cli/message), [消息](/zh-CN/cli/message), [Telegram](/zh-CN/channels/telegram), [Microsoft Teams](/zh-CN/channels/msteams), [后台进程](/zh-CN/gateway/background-process)
  ...
  <Accordion title="媒体理解和媒体生成 - M2 Alpha - 6 个领域">
    ...
    已具备广泛的能力范围，但提供商差异、文件限制以及节点与应用之间的一致性问题使其尚未稳定。
    ...
    [媒体概览](/zh-CN/tools/media-overview), [媒体理解](/zh-CN/nodes/media-understanding), [安全文件操作](/zh-CN/gateway/security/secure-file-operations), [PDF](/zh-CN/tools/pdf), [图像生成](/zh-CN/tools/image-generation), [二维码](/zh-CN/cli/qr), [LINE](/zh-CN/channels/line), [WhatsApp](/zh-CN/channels/whatsapp)
  ...
  <Accordion title="语音和实时对话 - M2 Alpha - 6 个领域">
    ...
    Control UI、应用和提供商中存在多种实现。在进入 Beta 阶段之前，需要延迟、故障模式和设置方面的评分卡。
    ...
    [Talk](/zh-CN/nodes/talk)、[Control UI](/zh-CN/web/control-ui)
    ...
    [Talk](/zh-CN/nodes/talk)、[OpenAI](/zh-CN/providers/openai)、[Google](/zh-CN/providers/google)
    ...
    [Talk](/zh-CN/nodes/talk)、[语音唤醒](/zh-CN/platforms/mac/voicewake)

    </div>
      </div>
      <div className="maturity-category-row">
        <div className="maturity-category-area">
          <span className="maturity-category-title">语音唤醒与路由</span>
          <span>4 项能力</span>
        </div>
        <div><span className="maturity-score maturity-score-experimental"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-experimental">实验性</span><span>0%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "0%" }} /></span></span></div>
        <div><span className="maturity-score maturity-score-alpha"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-alpha">Alpha</span><span>61%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "61%" }} /></span></span></div>
    ...
    [语音唤醒](/zh-CN/nodes/voicewake)、[语音唤醒](/zh-CN/platforms/mac/voicewake)、[语音浮层](/zh-CN/platforms/mac/voice-overlay)
    ...
    [Control UI](/zh-CN/web/control-ui)、[语音浮层](/zh-CN/platforms/mac/voice-overlay)、[Talk](/zh-CN/nodes/talk)
  ...
  <Accordion title="TUI - M2 Alpha - 5 个领域">
    ...
    文档和源代码中已有相关内容，但作为主要用户工作流的可见度较低。需要明确定义场景。
    ...
    [TUI](/zh-CN/cli/tui)、[TUI](/zh-CN/web/tui)、[索引](/zh-CN/cli/index)

    </div>
      </div>
      <div className="maturity-category-row">
        <div className="maturity-category-area">
          <span className="maturity-category-title">输入与命令</span>
          <span>8 项能力</span>
        </div>
        <div><span className="maturity-score maturity-score-experimental"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-experimental">实验性</span><span>0%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "0%" }} /></span></span></div>
        <div><span className="maturity-score maturity-score-alpha"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-alpha">Alpha</span><span>59%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "59%" }} /></span></span></div>
  ...
  <Accordion title="ClawHub - M2 Alpha - 4 个领域">
    ...
    已有公开文档和生态系统概念。仍需安装、信任、更新、回滚和兼容性评分卡。
  ...
  <Accordion title="OpenClaw App SDK - M2 Alpha - 6 个领域">
    ...
    OpenClaw App SDK 是独立的外部应用契约，与 Gateway 网关运行时和插件 SDK 分离。当前评分表明存在一条真实的 `@openclaw/sdk` 路径，但在公开打包、自动发现、审批、辅助工具和兼容性方面仍有缺口。

    <div className="maturity-surface-rollup"><span>覆盖率：实验性 - 3%</span><span>质量：Alpha - 54%</span><span>完整度：Alpha - 53%</span><span><span className="maturity-lts maturity-lts-none">无</span></span></div>
    ...
    [OpenClaw SDK](/zh-CN/gateway/external-apps), [OpenClaw SDK API 设计](/zh-CN/gateway/external-apps), [协议](/zh-CN/gateway/protocol), [索引](/zh-CN/gateway/security/index)
...
<AccordionGroup>
  <Accordion title="Linux Gateway 网关主机 - M4 稳定版 - 5 个领域">
    ...
    推荐使用 Node 运行时，文档介绍了 systemd 用户服务，并提供了广泛的 VPS/容器指南。
    ...
    [索引](/zh-CN/install/index), [更新](/zh-CN/install/updating), [Linux](/zh-CN/platforms/linux), [索引](/zh-CN/platforms/index)
    ...
    [索引](/zh-CN/gateway/index), [Gateway 网关](/zh-CN/cli/gateway), [Linux](/zh-CN/platforms/linux), [VPS](/zh-CN/vps)
    ...
    [远程访问](/zh-CN/gateway/remote), [Tailscale](/zh-CN/gateway/tailscale), [暴露运行手册](/zh-CN/gateway/security/exposure-runbook), [身份验证](/zh-CN/gateway/authentication), [机密信息](/zh-CN/gateway/secrets)
    ...
    [状态](/zh-CN/cli/status)、[日志](/zh-CN/cli/logs)、[Doctor](/zh-CN/cli/doctor)、[诊断](/zh-CN/gateway/diagnostics)、[索引](/zh-CN/gateway/index)
  ...
  <Accordion title="macOS Gateway 网关主机 - M4 稳定版 - 7 个领域">
    ...
    文档涵盖 LaunchAgent 服务路径、本地/远程 Gateway 网关模式、CLI 安装以及应用集成。

    <div className="maturity-surface-rollup"><span>覆盖度：实验性 - 0%</span><span>质量：Beta - 74%</span><span>完整度：稳定版 - 88%</span><span><span className="maturity-lts maturity-lts-none">无</span></span></div>
    ...
    [macOS](/zh-CN/platforms/macos)、[内置 Gateway 网关](/zh-CN/platforms/mac/bundled-gateway)、[安装程序](/zh-CN/install/installer)、[节点](/zh-CN/install/node)
    ...
    [macOS](/zh-CN/platforms/macos)、[内置 Gateway 网关](/zh-CN/platforms/mac/bundled-gateway)、[远程](/zh-CN/platforms/mac/remote)、[索引](/zh-CN/gateway/index)、[Gateway 网关](/zh-CN/cli/gateway)、[Bonjour](/zh-CN/gateway/bonjour)
    ...
    [macOS](/zh-CN/platforms/macos)、[内置 Gateway 网关](/zh-CN/platforms/mac/bundled-gateway)、[Gateway 网关](/zh-CN/cli/gateway)、[索引](/zh-CN/gateway/index)、[更新](/zh-CN/cli/update)、[更新](/zh-CN/install/updating)、[卸载](/zh-CN/install/uninstall)、[故障排查](/zh-CN/gateway/troubleshooting)
    ...
    [内置 Gateway 网关](/zh-CN/platforms/mac/bundled-gateway)、[macOS](/zh-CN/platforms/macos)、[Gateway 网关](/zh-CN/cli/gateway)、[Doctor](/zh-CN/gateway/doctor)、[故障排查](/zh-CN/gateway/troubleshooting)
    ...
    [多个 Gateway 网关](/zh-CN/gateway/multiple-gateways), [索引](/zh-CN/gateway/index), [Gateway 网关](/zh-CN/cli/gateway)
  ...
  <Accordion title="Android 应用 - M4 稳定 - 7 个领域">
    ...
    已提供 Google Play 官方分发渠道，并持续维护从源代码构建和运行的文档；Android 应用也被作为面向用户的常规配套节点进行说明。

    <div className="maturity-surface-rollup"><span>覆盖率：实验性 - 0%</span><span>质量：稳定 - 80%</span><span>完整性：稳定 - 80%</span><span><span className="maturity-lts maturity-lts-none">无</span></span></div>
    ...
    [Android](/zh-CN/platforms/android), [相机](/zh-CN/nodes/camera)
    ...
    [Android](/zh-CN/platforms/android), [故障排查](/zh-CN/nodes/troubleshooting), [协议](/zh-CN/gateway/protocol)
  ...
  <Accordion title="iOS 应用 - M4 稳定 - 8 个领域">
    ...
    已提供 App Store 官方分发，基于中继的推送已有文档说明，并且文档将 iOS 应用描述为面向用户的常规配套节点。
  ...
  <Accordion title="Docker 和 Podman 托管 - M3 Beta - 4 个领域">
    ...
    已有安装文档，这也是常见的部署路径。在定期发布冒烟测试覆盖升级和卷行为后，将其提升至更高成熟度。
    ...
    [Podman](/zh-CN/install/podman), [Docker 虚拟机运行时](/zh-CN/install/docker-vm-runtime), [Docker](/zh-CN/install/docker), [Hetzner](/zh-CN/install/hetzner), [Hostinger](/zh-CN/install/hostinger)
    ...
    [Docker](/zh-CN/install/docker), [Docker 虚拟机运行时](/zh-CN/install/docker-vm-runtime), [完整发布验证](/zh-CN/reference/full-release-validation)
    ...
    [Docker](/zh-CN/install/docker), [Docker 虚拟机运行时](/zh-CN/install/docker-vm-runtime)
  ...
  <Accordion title="通过 WSL2 使用 Windows - M3 Beta - 6 个领域">
    ...
    推荐的 Windows 路径，包含 systemd/用户服务指导和启动链文档。在反复进行安装/更新评分后提升其成熟度。
    ...
    [Windows](/zh-CN/platforms/windows)，[入门指南](/zh-CN/start/getting-started)，[更新](/zh-CN/install/updating)，[引导设置](/zh-CN/cli/onboard)，[Doctor](/zh-CN/cli/doctor)，[状态](/zh-CN/cli/status)，[日志](/zh-CN/cli/logs)
    ...
    [Windows](/zh-CN/platforms/windows)，[索引](/zh-CN/gateway/index)，[Doctor](/zh-CN/gateway/doctor)
    ...
    [身份验证](/zh-CN/gateway/authentication)，[密钥](/zh-CN/gateway/secrets)，[远程访问](/zh-CN/gateway/remote)，[暴露运行手册](/zh-CN/gateway/security/exposure-runbook)，[Windows](/zh-CN/platforms/windows)
  ...
  <Accordion title="Raspberry Pi 和小型 Linux 设备 - M3 Beta - 4 个领域">
    ...
    已有平台文档，Gateway 网关路径基于 Linux。需要特定硬件的发布冒烟验证才能提升等级。

    <div className="maturity-surface-rollup"><span>覆盖度：实验性 - 0%</span><span>质量：Alpha - 67%</span><span>完整度：Beta - 79%</span><span><span className="maturity-lts maturity-lts-none">无</span></span></div>
    ...
    [Raspberry Pi](/zh-CN/install/raspberry-pi)、[索引](/zh-CN/install/index)、[首次运行常见问题](/zh-CN/help/faq-first-run)、[常见问题](/zh-CN/help/faq)、[Linux](/zh-CN/platforms/linux)、[安装程序](/zh-CN/install/installer)
    ...
    [Raspberry Pi](/zh-CN/install/raspberry-pi)、[身份验证](/zh-CN/gateway/authentication)、[机密信息](/zh-CN/gateway/secrets)、[配对](/zh-CN/gateway/pairing)、[设备](/zh-CN/cli/devices)、[远程访问](/zh-CN/gateway/remote)、[Tailscale](/zh-CN/gateway/tailscale)
    ...
    [索引](/zh-CN/gateway/index)、[Gateway 网关](/zh-CN/cli/gateway)、[Raspberry Pi](/zh-CN/install/raspberry-pi)、[Linux](/zh-CN/platforms/linux)、[VPS](/zh-CN/vps)
    ...
    [Raspberry Pi](/zh-CN/install/raspberry-pi)、[Linux](/zh-CN/platforms/linux)、[健康状态](/zh-CN/gateway/health)、[诊断](/zh-CN/gateway/diagnostics)
  ...
  <Accordion title="macOS 配套应用 - M3 Beta - 8 个领域">
    ...
    已具备功能丰富的菜单栏应用、权限、节点模式、Canvas、语音唤醒、WebChat 和远程模式。其变化仍然较快，因此尚不适合评为稳定版。
    ...
    [Canvas](/zh-CN/platforms/mac/canvas)、[macOS](/zh-CN/platforms/macos)、[WebChat](/zh-CN/web/webchat)
    ...
    [内置 Gateway 网关](/zh-CN/platforms/mac/bundled-gateway)、[macOS](/zh-CN/platforms/macos)、[子进程](/zh-CN/platforms/mac/child-process)、[开发环境设置](/zh-CN/platforms/mac/dev-setup)
    ...
    [菜单栏](/zh-CN/platforms/mac/menu-bar)、[图标](/zh-CN/platforms/mac/icon)、[macOS](/zh-CN/platforms/macos)、[健康状态](/zh-CN/platforms/mac/health)、[日志](/zh-CN/platforms/mac/logging)、[远程访问](/zh-CN/platforms/mac/remote)
    ...
    [远程访问](/zh-CN/platforms/mac/remote)、[macOS](/zh-CN/platforms/macos)、[远程访问](/zh-CN/gateway/remote)
    ...
    [语音唤醒](/zh-CN/platforms/mac/voicewake)、[语音浮层](/zh-CN/platforms/mac/voice-overlay)、[Talk](/zh-CN/nodes/talk)、[macOS](/zh-CN/platforms/macos)
    ...
    [Webchat](/zh-CN/platforms/mac/webchat)、[远程访问](/zh-CN/gateway/remote)、[远程访问](/zh-CN/platforms/mac/remote)
  ...
  <Accordion title="原生 Windows - M2 Alpha - 4 个领域">
    ...
    核心 CLI/Gateway 网关流程可以正常运行，但文档仍建议使用 WSL2 以获得完整体验，并列出了原生环境的注意事项。
    ...
    [索引](/zh-CN/install/index)、[安装程序](/zh-CN/install/installer)、[Windows](/zh-CN/platforms/windows)、[入门指南](/zh-CN/start/getting-started)、[引导设置](/zh-CN/cli/onboard)
    ...
    [Windows](/zh-CN/platforms/windows)、[索引](/zh-CN/gateway/index)、[Gateway 网关](/zh-CN/cli/gateway)、[Doctor](/zh-CN/cli/doctor)
    ...
    [Windows](/zh-CN/platforms/windows)、[索引](/zh-CN/gateway/index)、[Gateway 网关](/zh-CN/cli/gateway)
  ...
  <Accordion title="Kubernetes 托管 - M2 Alpha - 4 个领域">
    ...
    Kubernetes 托管是一种独立的、基于 Kustomize 的集群部署路径。当前评分表明，已具备真正可用的最小部署路径，但在 Kubernetes 专用 CI、入口/TLS/NetworkPolicy 打包、备份/恢复以及生产环境暴露加固方面仍有缺口。
    ...
    [Kubernetes](/zh-CN/install/kubernetes)、[索引](/zh-CN/install/index)
    ...
    [Kubernetes](/zh-CN/install/kubernetes)、[身份验证](/zh-CN/gateway/authentication)、[远程访问](/zh-CN/gateway/remote)、[暴露运行手册](/zh-CN/gateway/security/exposure-runbook)
    ...
    [Kubernetes](/zh-CN/install/kubernetes)、[索引](/zh-CN/gateway/index)
  ...
  <Accordion title="Nix 安装路径 - M1 实验性 - 5 个领域">
    ...
    可选安装流程。在晋升至 Alpha/Beta 之前，需要更明确地说明支持承诺。
    ...
    [Nix](/zh-CN/install/nix)、[索引](/zh-CN/install/index)、[文档目录](/zh-CN/start/docs-directory)
    ...
    [管理插件](/zh-CN/plugins/manage-plugins)、[插件](/zh-CN/tools/plugin)、[Nix](/zh-CN/install/nix)
      ...
      <div className="maturity-category-row">
        <div className="maturity-category-area">
          <span className="maturity-category-title">激活和应用用户体验</span>
          <span>7 项能力</span>
        </div>
        <div><span className="maturity-score maturity-score-experimental"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-experimental">实验性</span><span>0%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "0%" }} /></span></span></div>
        <div><span className="maturity-score maturity-score-experimental"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-experimental">实验性</span><span>41%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "41%" }} /></span></span></div>
    ...
    [Nix](/zh-CN/install/nix)、[设置](/zh-CN/cli/setup)、[环境](/zh-CN/help/environment)
      ...
      <div className="maturity-category-row">
        <div className="maturity-category-area">
          <span className="maturity-category-title">服务运行时和防护机制</span>
          <span>8 项能力</span>
        </div>
        <div><span className="maturity-score maturity-score-experimental"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-experimental">实验性</span><span>0%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "0%" }} /></span></span></div>
        <div><span className="maturity-score maturity-score-experimental"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-experimental">实验性</span><span>41%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "41%" }} /></span></span></div>
  ...
  <Accordion title="watchOS 配套界面 - M1 实验性 - 5 个领域">
    ...
    源代码中包含 Watch 应用/扩展界面；公开文档尚未将其作为面向用户的功能介绍。
  ...
  <Accordion title="Linux 配套应用 - M0 计划中 - 5 个领域">
    ...
    文档指出，原生 Linux 配套应用尚在规划中；目前在 Linux 上支持的方式是使用 Gateway 网关。
    ...
    [Linux](/zh-CN/platforms/linux), [索引](/zh-CN/platforms/index), [索引](/zh-CN/install/index)
    ...
    [Linux](/zh-CN/platforms/linux), [索引](/zh-CN/gateway/index), [配对](/zh-CN/gateway/pairing), [远程访问](/zh-CN/gateway/remote)
    ...
    [Linux](/zh-CN/platforms/linux), [协议](/zh-CN/gateway/protocol), [网页聊天](/zh-CN/web/webchat)
    ...
    [Linux](/zh-CN/platforms/linux), [Exec 审批](/zh-CN/tools/exec-approvals), [密钥](/zh-CN/gateway/secrets), [索引](/zh-CN/nodes/index), [Exec](/zh-CN/tools/exec), [Talk](/zh-CN/nodes/talk), [摄像头](/zh-CN/nodes/camera)
  ...
  <Accordion title="原生 Windows 配套应用 - M0 计划中 - 5 个领域">
    ...
    [Windows](/zh-CN/platforms/windows), [索引](/zh-CN/install/index)
    ...
    [Windows](/zh-CN/platforms/windows), [索引](/zh-CN/gateway/index), [配对](/zh-CN/gateway/pairing), [远程访问](/zh-CN/gateway/remote)
    ...
    [Windows](/zh-CN/platforms/windows), [Doctor](/zh-CN/gateway/doctor), [索引](/zh-CN/gateway/index)
    ...
    [Windows](/zh-CN/platforms/windows), [索引](/zh-CN/nodes/index), [Exec](/zh-CN/tools/exec), [Exec 审批](/zh-CN/tools/exec-approvals), [索引](/zh-CN/gateway/security/index)
...
<AccordionGroup>
  <Accordion title="Discord - M4 稳定版 - 6 个领域">
    ...
    文档深入且功能覆盖广泛。语音和委派路径应继续单独评定为 Beta/Alpha。

    <div className="maturity-surface-rollup"><span>覆盖度实验性 - 0%</span><span>质量 Beta - 73%</span><span>完整度稳定 - 87%</span><span><span className="maturity-lts maturity-lts-partial">部分支持 - 4</span></span></div>
    ...
    [Discord](/zh-CN/channels/discord), [Discord](/zh-CN/plugins/reference/discord), [Fly](/zh-CN/install/fly), [斜杠命令](/zh-CN/tools/slash-commands), [健康状态](/zh-CN/gateway/health), [渠道](/zh-CN/cli/channels), [渠道配置](/zh-CN/gateway/config-channels)
    ...
    [Discord](/zh-CN/channels/discord)、[OpenAI](/zh-CN/providers/openai)、[Elevenlabs](/zh-CN/providers/elevenlabs)、[QA 端到端自动化](/zh-CN/concepts/qa-e2e-automation)、[渠道配置](/zh-CN/gateway/config-channels)
  ...
  <Accordion title="Telegram - M3 Beta - 5 个领域">
    ...
    核心渠道已足够成熟，可供日常使用，但差异较大的用户体验和媒体边缘情况仍需定期进行场景验证。
    ...
    [Telegram](/zh-CN/channels/telegram)、[配置频道](/zh-CN/gateway/config-channels)、[频道](/zh-CN/cli/channels)
    ...
    [Telegram](/zh-CN/channels/telegram)、[配对](/zh-CN/channels/pairing)、[访问组](/zh-CN/channels/access-groups)、[群组](/zh-CN/channels/groups)、[多智能体](/zh-CN/concepts/multi-agent)

    </div>
      </div>
      <div className="maturity-category-row">
        <div className="maturity-category-area">
          <span className="maturity-category-title">对话路由与交付</span>
    ...
    [Telegram](/zh-CN/channels/telegram)、[群组](/zh-CN/channels/groups)、[多智能体](/zh-CN/concepts/multi-agent)
    ...
    [Telegram](/zh-CN/channels/telegram)，[Exec 审批](/zh-CN/tools/exec-approvals)，[表情回应](/zh-CN/tools/reactions)
  ...
  <Accordion title="Slack - M3 Beta - 5 个领域">
    ...
    <div className="maturity-surface-rollup"><span>覆盖度实验阶段 - 0%</span><span>质量 Alpha 阶段 - 66%</span><span>完整度 Beta 阶段 - 78%</span><span><span className="maturity-lts maturity-lts-full">完整 - 5</span></span></div>
    ...
    <div className="maturity-category-list">
      ...
      <div className="maturity-category-row">
        ...
        <div><span className="maturity-score maturity-score-experimental"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-experimental">实验阶段</span><span>0%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "0%" }} /></span></span></div>
    ...
    [Slack](/zh-CN/channels/slack), [Slack](/zh-CN/plugins/reference/slack), [密钥](/zh-CN/gateway/secrets), [QA 端到端自动化](/zh-CN/concepts/qa-e2e-automation), [故障排查](/zh-CN/channels/troubleshooting)
    ...
    [Slack](/zh-CN/channels/slack), [Bot 循环保护](/zh-CN/channels/bot-loop-protection), [配对](/zh-CN/channels/pairing)
    ...
    [Slack](/zh-CN/channels/slack), [QA 端到端自动化](/zh-CN/concepts/qa-e2e-automation)
  ...
  <Accordion title="iMessage 和 BlueBubbles - M3 Beta 阶段 - 5 个领域">
    <a id="imessage-and-bluebubbles" />

    受支持的 iMessage 通过已登录 macOS“信息”应用的主机上的 imsg 运行；旧版 BlueBubbles 配置需要迁移。请明确说明 macOS 权限、SSH 包装器、SIP/私有 API 和迁移方面的注意事项。

    <div className="maturity-surface-rollup"><span>覆盖度实验阶段 - 0%</span><span>质量 Alpha 阶段 - 66%</span><span>完整度 Beta 阶段 - 78%</span><span><span className="maturity-lts maturity-lts-none">无</span></span></div>
    ...
    [BlueBubbles iMessage](/zh-CN/announcements/bluebubbles-imessage), [Coming from BlueBubbles](/zh-CN/channels/imessage-from-bluebubbles), [配置渠道](/zh-CN/gateway/config-channels), [iMessage](/zh-CN/channels/imessage)
    ...
    [iMessage](/zh-CN/channels/imessage), [Coming from BlueBubbles](/zh-CN/channels/imessage-from-bluebubbles), [配置渠道](/zh-CN/gateway/config-channels)
    ...
    [iMessage](/zh-CN/channels/imessage), [从 BlueBubbles 使用 iMessage](/zh-CN/channels/imessage-from-bluebubbles), [配置频道](/zh-CN/gateway/config-channels)
  ...
  <Accordion title="WhatsApp - M3 Beta - 5 个领域">
    ...
    核心路径非常重要且已有文档说明；上游 Baileys/会话的不稳定性使其尚未达到稳定级别。
    ...
    [WhatsApp](/zh-CN/channels/whatsapp)、[配置渠道](/zh-CN/gateway/config-channels)、[QA 端到端自动化](/zh-CN/concepts/qa-e2e-automation)、[配对](/zh-CN/channels/pairing)
    ...
    [WhatsApp](/zh-CN/channels/whatsapp)
      ...
      <div className="maturity-category-row">
        <div className="maturity-category-area">
          <span className="maturity-category-title">原生控件与审批</span>
          <span>2 项能力</span>
        </div>
        <div><span className="maturity-score maturity-score-experimental"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-experimental">实验性</span><span>0%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "0%" }} /></span></span></div>
        <div><span className="maturity-score maturity-score-alpha"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-alpha">Alpha</span><span>66%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "66%" }} /></span></span></div>
  ...
  <Accordion title="Matrix - M2 Alpha - 6 个领域">
    ...
    [Matrix](/zh-CN/channels/matrix), [群组](/zh-CN/channels/groups), [Bot 循环保护](/zh-CN/channels/bot-loop-protection)
  ...
  <Accordion title="Google Chat - M2 Alpha - 5 个领域">
    ...
    [Google Chat](/zh-CN/channels/googlechat)，[Google Chat](/zh-CN/plugins/reference/googlechat)，[渠道配置](/zh-CN/gateway/config-channels)，[向导 CLI 参考](/zh-CN/start/wizard-cli-reference)，[密钥](/zh-CN/gateway/secrets)，[Secretref 凭据界面](/zh-CN/reference/secretref-credential-surface)，[健康状态](/zh-CN/gateway/health)，[插件清单](/zh-CN/plugins/plugin-inventory)，[索引](/zh-CN/channels/index)
    ...
    [Google Chat](/zh-CN/channels/googlechat)，[配对](/zh-CN/channels/pairing)，[访问组](/zh-CN/channels/access-groups)，[渠道配置](/zh-CN/gateway/config-channels)，[机器人循环保护](/zh-CN/channels/bot-loop-protection)，[频道路由](/zh-CN/channels/channel-routing)
    ...
    [Google Chat](/zh-CN/channels/googlechat)、[Bot 循环保护](/zh-CN/channels/bot-loop-protection)、[访问组](/zh-CN/channels/access-groups)、[频道路由](/zh-CN/channels/channel-routing)
    ...
    [Google Chat](/zh-CN/channels/googlechat)、[消息](/zh-CN/cli/message)、[媒体理解](/zh-CN/nodes/media-understanding)、[Secretref 凭据界面](/zh-CN/reference/secretref-credential-surface)
    ...
    [Google Chat](/zh-CN/channels/googlechat)、[消息](/zh-CN/cli/message)、[媒体理解](/zh-CN/nodes/media-understanding)、[Secretref 凭据界面](/zh-CN/reference/secretref-credential-surface)、[表情回应](/zh-CN/tools/reactions)、[斜杠命令](/zh-CN/tools/slash-commands)、[智能体配置](/zh-CN/gateway/config-agents)、[消息生命周期重构](/zh-CN/concepts/message-lifecycle-refactor)
  ...
  <Accordion title="Microsoft Teams - M2 Alpha - 5 个领域">
    ...
    [Microsoft Teams](/zh-CN/channels/msteams), [Microsoft Teams](/zh-CN/plugins/reference/msteams), [配置渠道](/zh-CN/gateway/config-channels), [健康状态](/zh-CN/gateway/health)
    ...
    [Microsoft Teams](/zh-CN/channels/msteams), [配对](/zh-CN/channels/pairing), [访问组](/zh-CN/channels/access-groups)
    ...
    [Microsoft Teams](/zh-CN/channels/msteams), [群组](/zh-CN/channels/groups), [频道路由](/zh-CN/channels/channel-routing)
    ...
    [Microsoft Teams](/zh-CN/channels/msteams), [高级 Exec 审批](/zh-CN/tools/exec-approvals-advanced)
  ...
  <Accordion title="Feishu、QQ Bot、微信、腾讯元宝、Zalo、Zalo Personal、区域渠道 - M2 Alpha - 4 个领域">
    ...
    这些渠道对区域覆盖非常重要，但应根据账号类型、上游批准情况和维护者验证来调整公开支持级别。

    <div className="maturity-surface-rollup"><span>覆盖度实验性 - 0%</span><span>质量 Alpha - 55%</span><span>完整度 Alpha - 58%</span><span><span className="maturity-lts maturity-lts-none">无</span></span></div>
    ...
    [索引](/zh-CN/channels/index)、[配对](/zh-CN/channels/pairing)、[Feishu](/zh-CN/plugins/reference/feishu)、[架构内部机制](/zh-CN/plugins/architecture-internals)
  ...
  <Accordion title="Mattermost、LINE、IRC、Nextcloud Talk、Nostr、Twitch、Tlon、Synology Chat - M2 Alpha - 4 个领域">
    ...
    已有受支持的功能界面，但成熟度可能因上游项目和维护者覆盖情况而异。后续再逐一评分。
  ...
  <Accordion title="语音通话渠道 - M1 实验性 - 5 个领域">
    ...
    具有复杂实时行为的可选/插件路径。进入公开测试版之前需要场景评分卡。
    ...
    [Voicecall](/zh-CN/cli/voicecall)、[语音通话](/zh-CN/plugins/voice-call)、[协议](/zh-CN/gateway/protocol)
    ...
    [语音通话](/zh-CN/plugins/voice-call)、[Voicecall](/zh-CN/cli/voicecall)
    ...
    [语音通话](/zh-CN/plugins/voice-call)，[插件清单](/zh-CN/plugins/plugin-inventory)
...
<AccordionGroup>
  <Accordion title="浏览器自动化、Exec 和沙箱工具 - M3 测试版 - 3 个领域">
    <a id="browser-automation-exec-and-sandbox-tools" />

    核心工具已有文档说明，但主机安全和权限用户体验仍应持续接受成熟度评分卡审查。

    <div className="maturity-surface-rollup"><span>覆盖率：实验性 - 21%</span><span>质量：测试版 - 75%</span><span>完整性：测试版 - 79%</span><span><span className="maturity-lts maturity-lts-partial">部分支持 - 2</span></span></div>
    ...
    [浏览器控制](/zh-CN/tools/browser-control)，[测试](/zh-CN/help/testing)，[浏览器](/zh-CN/tools/browser)，[索引](/zh-CN/gateway/security/index)，[审计检查](/zh-CN/gateway/security/audit-checks)
    ...
    [Exec](/zh-CN/tools/exec)、[后台进程](/zh-CN/gateway/background-process)、[工具调用 HTTP API](/zh-CN/gateway/tools-invoke-http-api)、[操作员权限范围](/zh-CN/gateway/operator-scopes)、[协议](/zh-CN/gateway/protocol)、[Exec 审批](/zh-CN/tools/exec-approvals)、[高级 Exec 审批](/zh-CN/tools/exec-approvals-advanced)、[提升权限](/zh-CN/tools/elevated)
    ...
    [沙箱隔离](/zh-CN/gateway/sandboxing)、[沙箱、工具策略和提升权限](/zh-CN/gateway/sandbox-vs-tool-policy-vs-elevated)、[多 Agent 沙盒和工具](/zh-CN/tools/multi-agent-sandbox-tools)、[Codex harness reference](/zh-CN/plugins/codex-harness-reference)、[配置工具](/zh-CN/gateway/config-tools)
  ...
  <Accordion title="OpenAI 和 Codex 提供商路径 - M3 Beta - 5 个领域">
    ...
    深入文档、OAuth/订阅路径、实时语音、图像和兼容性行为。由于提供商频繁变动，在获得发布评分卡证明之前，此部分无法达到稳定级别。

    <div className="maturity-surface-rollup"><span>覆盖率：实验性 - 26%</span><span>质量：Beta - 74%</span><span>完整度：Beta - 79%</span><span><span className="maturity-lts maturity-lts-partial">部分支持 - 3</span></span></div>
    ...
    [OpenAI](/zh-CN/providers/openai)、[Codex harness](/zh-CN/plugins/codex-harness)、[Models](/zh-CN/concepts/models)、[OAuth](/zh-CN/concepts/oauth)、[Codex harness reference](/zh-CN/plugins/codex-harness-reference)、[身份验证监控](/zh-CN/gateway/authentication)
  ...
  <Accordion title="Web 搜索工具 - M3 Beta - 4 个领域">
    ...
    已有多个提供商和相关文档。需要针对每个提供商系列提供配额、错误和 SSRF 证明。
    ...
    [Web](/zh-CN/tools/web)、[Brave 搜索](/zh-CN/tools/brave-search)、[Tavily](/zh-CN/tools/tavily)、[Exa 搜索](/zh-CN/tools/exa-search)、[Firecrawl](/zh-CN/tools/firecrawl)、[Perplexity 搜索](/zh-CN/tools/perplexity-search)、[Duckduckgo 搜索](/zh-CN/tools/duckduckgo-search)、[Searxng 搜索](/zh-CN/tools/searxng-search)、[Gemini 搜索](/zh-CN/tools/gemini-search)、[Grok 搜索](/zh-CN/tools/grok-search)、[Kimi 搜索](/zh-CN/tools/kimi-search)、[Minimax 搜索](/zh-CN/tools/minimax-search)、[Ollama 搜索](/zh-CN/tools/ollama-search)、[SDK 子路径](/zh-CN/plugins/sdk-subpaths)、[SDK 概览](/zh-CN/plugins/sdk-overview)、[清单](/zh-CN/plugins/manifest)
    ...
    [Web](/zh-CN/tools/web)、[Web 获取](/zh-CN/tools/web-fetch)、[常见问题](/zh-CN/help/faq)、[API 使用成本](/zh-CN/reference/api-usage-costs)、[Brave 搜索](/zh-CN/tools/brave-search)、[Perplexity 搜索](/zh-CN/tools/perplexity-search)、[Tavily](/zh-CN/tools/tavily)、[Firecrawl](/zh-CN/tools/firecrawl)
    ...
    [Web](/zh-CN/tools/web)、[Web 获取](/zh-CN/tools/web-fetch)、[Firecrawl](/zh-CN/tools/firecrawl)、[Searxng 搜索](/zh-CN/tools/searxng-search)
  ...
  <Accordion title="Anthropic 提供商路径 - M3 Beta - 5 个领域">
    ...
    一流的模型提供商。需要持续提供身份验证、目录和工具调用场景的证明。
    ...
    <div className="maturity-category-list">
      ...
      <div className="maturity-category-row">
        <div className="maturity-category-area">
          <span className="maturity-category-title">提供商身份验证与恢复</span>
          <span>9 项能力</span>
        </div>
        <div><span className="maturity-score maturity-score-experimental"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-experimental">实验性</span><span>0%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "0%" }} /></span></span></div>
        <div><span className="maturity-score maturity-score-alpha"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-alpha">Alpha</span><span>66%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "66%" }} /></span></span></div>
    ...
    [Anthropic](/zh-CN/providers/anthropic)、[Doctor](/zh-CN/gateway/doctor)、[配置示例](/zh-CN/gateway/configuration-examples)、[故障排查](/zh-CN/gateway/troubleshooting)、[提示词缓存](/zh-CN/reference/prompt-caching)
    ...
    [Anthropic](/zh-CN/providers/anthropic)、[Agent 配置](/zh-CN/gateway/config-agents)、[Models](/zh-CN/concepts/models)、[CLI 后端](/zh-CN/gateway/cli-backends)

    </div>
      </div>
      <div className="maturity-category-row">
        <div className="maturity-category-area">
          <span className="maturity-category-title">请求传输与轮次语义</span>
          <span>10 项能力</span>
        </div>
        <div><span className="maturity-score maturity-score-experimental"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-experimental">实验性</span><span>0%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "0%" }} /></span></span></div>
        <div><span className="maturity-score maturity-score-beta"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-beta">Beta</span><span>77%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "77%" }} /></span></span></div>
    ...
    [Anthropic](/zh-CN/providers/anthropic)、[提示词缓存](/zh-CN/reference/prompt-caching)、[故障排查](/zh-CN/gateway/troubleshooting)、[CLI 后端](/zh-CN/gateway/cli-backends)、[模型提供商](/zh-CN/concepts/model-providers)

    </div>
      </div>
      <div className="maturity-category-row">
        <div className="maturity-category-area">
          <span className="maturity-category-title">提示词缓存与上下文</span>
          <span>5 项能力</span>
        </div>
        <div><span className="maturity-score maturity-score-experimental"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-experimental">实验性</span><span>0%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "0%" }} /></span></span></div>
        <div><span className="maturity-score maturity-score-alpha"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-alpha">Alpha</span><span>66%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "66%" }} /></span></span></div>
    ...
    [Anthropic](/zh-CN/providers/anthropic)、[提示词缓存](/zh-CN/reference/prompt-caching)、[故障排查](/zh-CN/gateway/troubleshooting)、[Heartbeat](/zh-CN/gateway/heartbeat)
    ...
    [Anthropic](/zh-CN/providers/anthropic)、[Agent 配置](/zh-CN/gateway/config-agents)
  ...
  <Accordion title="Google 提供商路径 - M3 Beta - 5 个领域">
    ...
    具有模型和实时交互界面的一等提供商。需要单独进行 Live/Talk 评分。

    <div className="maturity-surface-rollup"><span>覆盖度 Experimental - 0%</span><span>质量 Alpha - 66%</span><span>完整度 Beta - 78%</span><span><span className="maturity-lts maturity-lts-none">无</span></span></div>
    ...
    [Google](/zh-CN/providers/google)、[模型提供商](/zh-CN/concepts/model-providers)、[模型常见问题](/zh-CN/help/faq-models)、[实时测试](/zh-CN/help/testing-live)
    ...
    [提示词缓存](/zh-CN/reference/prompt-caching)、[Google](/zh-CN/providers/google)、[模型提供商](/zh-CN/concepts/model-providers)、[令牌用量](/zh-CN/reference/token-use)
  ...
  <Accordion title="OpenRouter 提供商路径 - M3 Beta - 4 个领域">
    ...
    统一提供商路径已有文档说明且很有价值，但不同模型的特定行为各不相同。
    ...
    [Openrouter](/zh-CN/providers/openrouter)、[模型提供商](/zh-CN/concepts/model-providers)、[配置](/zh-CN/cli/configure)、[身份验证](/zh-CN/gateway/authentication)、[环境](/zh-CN/help/environment)、[模型](/zh-CN/cli/models)、[模型](/zh-CN/concepts/models)
    ...
    [Openrouter](/zh-CN/providers/openrouter)、[模型提供商](/zh-CN/concepts/model-providers)、[提示词缓存](/zh-CN/reference/prompt-caching)
  ...
  <Accordion title="图像、视频和音乐生成工具 - M2 Alpha - 5 个领域">
    ...
    各提供商均具备此项能力，但质量、延迟和参数兼容性的差异过大，若无各提供商的专项验证，尚无法达到 Beta 阶段。

    <div className="maturity-surface-rollup"><span>覆盖度：实验性 - 0%</span><span>质量：Alpha - 61%</span><span>完整性：Alpha - 68%</span><span><span className="maturity-lts maturity-lts-none">无</span></span></div>
    ...
    [配置智能体](/zh-CN/gateway/config-agents)、[图像生成](/zh-CN/tools/image-generation)、[视频生成](/zh-CN/tools/video-generation)、[音乐生成](/zh-CN/tools/music-generation)
      ...
      <div className="maturity-category-row">
        <div className="maturity-category-area">
          <span className="maturity-category-title">任务生命周期与交付</span>
          <span>12 项能力</span>
        </div>
        <div><span className="maturity-score maturity-score-experimental"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-experimental">实验性</span><span>0%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "0%" }} /></span></span></div>
        <div><span className="maturity-score maturity-score-alpha"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-alpha">Alpha</span><span>61%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "61%" }} /></span></span></div>
  ...
  <Accordion title="本地模型提供商：Ollama、vLLM、SGLang、LM Studio - M2 Alpha - 5 个领域">
    ...
    [本地模型](/zh-CN/gateway/local-models), [Lmstudio](/zh-CN/providers/lmstudio), [Ollama](/zh-CN/providers/ollama), [Vllm](/zh-CN/providers/vllm), [本地模型服务](/zh-CN/gateway/local-model-services), [智能体配置](/zh-CN/gateway/config-agents), [故障排查](/zh-CN/gateway/troubleshooting), [Doctor](/zh-CN/gateway/doctor)
    ...
    [记忆](/zh-CN/concepts/memory), [Doctor](/zh-CN/gateway/doctor)
      ...
      <div className="maturity-category-row">
        <div className="maturity-category-area">
          <span className="maturity-category-title">网络安全与提示词控制</span>
          <span>2 项能力</span>
        </div>
        <div><span className="maturity-score maturity-score-experimental"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-experimental">实验性</span><span>0%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "0%" }} /></span></span></div>
        <div><span className="maturity-score maturity-score-alpha"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-alpha">Alpha</span><span>61%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "61%" }} /></span></span></div>
    ...
    [索引](/zh-CN/gateway/security/index)、[配置工具](/zh-CN/gateway/config-tools)、[本地模型](/zh-CN/gateway/local-models)
  ...
  <Accordion title="长尾托管提供商 - M2 Alpha - 3 个领域">
    ...
    已有许多文档和参考页面；评分应根据提供商元数据及实时冒烟测试覆盖率生成。
    ...
    [索引](/zh-CN/providers/index)、[模型提供商](/zh-CN/concepts/model-providers)、[实时测试](/zh-CN/help/testing-live)、[引导设置](/zh-CN/cli/onboard)
    ...
    [插件清单](/zh-CN/plugins/manifest)、[实时测试](/zh-CN/help/testing-live)、[索引](/zh-CN/providers/index)
    ...
    [索引](/zh-CN/providers/index)、[模型提供商](/zh-CN/concepts/model-providers)、[插件清单](/zh-CN/plugins/manifest)、[实时测试](/zh-CN/help/testing-live)、[Models](/zh-CN/cli/models)
