...
title: TOOLS.md 模板
x-i18n:
    generated_at: "2026-07-26T06:28:34Z"
    model: gpt-5.6
...
Skills 定义工具_如何_工作。此文件用于记录_你的_具体信息——你的设置所独有的内容：摄像头名称和位置、SSH 主机和别名、首选 TTS 语音、扬声器/房间名称、设备昵称，以及任何特定于环境的信息。
...
Skills 是共享的。你的设置属于你自己。将二者分开，意味着你可以更新 Skills 而不会丢失备注，也可以分享 Skills 而不会泄露你的基础设施信息。
