...
summary: 流式传输和分块行为（分块回复、频道预览流式传输、模式映射）
title: 流式传输和分块
x-i18n:
    generated_at: "2026-07-26T05:47:23Z"
    model: gpt-5.6
...
- [消息生命周期重构](/zh-CN/concepts/message-lifecycle-refactor) - 共享预览、编辑、流式传输和最终确定的目标设计
- [进度草稿](/zh-CN/concepts/progress-drafts) - 在长轮次期间更新的可见工作进度消息
