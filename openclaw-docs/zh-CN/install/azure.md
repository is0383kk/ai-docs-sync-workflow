...
title: Azure
x-i18n:
    generated_at: "2026-07-26T06:12:14Z"
    model: gpt-5.6
...
- 已安装 Azure CLI（请参阅 [Azure CLI 安装步骤](https://learn.microsoft.com/cli/azure/install-azure-cli)）
...
<Steps>
  ...
  <Step title="创建虚拟网络和子网">
    ...
    # AzureBastionSubnet：Azure 要求使用这一确切名称
...
<Steps>
  ...
  <Step title="安装 OpenClaw（在 VM shell 中）">
    ...
    如果尚未安装 Node 和依赖项，安装程序会进行安装，然后安装 OpenClaw 并启动新手引导。有关详细信息，请参阅[安装](/zh-CN/install)。
  ...
  <Step title="验证 Gateway 网关">
    ...
    如果你的组织已有 GitHub Copilot 许可证，可在新手引导期间选择 GitHub Copilot 提供商，而无需单独的模型 API 密钥。请参阅 [GitHub Copilot 提供商](/zh-CN/providers/github-copilot)。
...
- 有关使用 GitHub Copilot 模型提供商在 Azure 上部署的更多详细信息：[在 Azure 上将 OpenClaw 与 GitHub Copilot 配合使用](https://github.com/johnsonshi/openclaw-azure-github-copilot)
