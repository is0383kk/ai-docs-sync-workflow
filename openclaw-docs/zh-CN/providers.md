...
title: 提供商目录
x-i18n:
    generated_at: "2026-07-26T06:30:24Z"
    model: gpt-5.6
...
OpenClaw 可以使用多种 LLM 提供商。选择一个提供商，完成身份验证，然后将
默认模型设置为 `provider/model`。

正在查找聊天渠道文档（WhatsApp/Telegram/Discord/Slack/Mattermost（插件）等）？请参阅[渠道](/zh-CN/channels)。

## 快速开始

1. 通过提供商完成身份验证（通常使用 `openclaw onboard`）。
2. 设置默认模型：
...
- [Featherless AI](/zh-CN/providers/featherless)
