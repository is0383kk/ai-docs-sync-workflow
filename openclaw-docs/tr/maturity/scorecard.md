---
summary: Ürün alanları, entegrasyonlar ve desteklenen iş akışları için OpenClaw sürüme hazır olma puanları.
title: Olgunluk puan kartı
x-i18n:
    generated_at: "2026-07-26T23:45:21Z"
    model: gpt-5.6
...
<div className="maturity-hero">
  <p className="maturity-kicker">sürüm hazırlığı - taksonomi + QA kanıtlarından oluşturulmuştur</p>
  ...
  <p>50 yüzey - 281 yetenek alanı - deterministik kapsamın yanı sıra insan incelemesinden geçmiş kalite ve eksiksizlik.</p>
  <p className="maturity-jump-links"><a href="#surface-explorer">Yüzeylere göz atın</a> / <a href="#qa-evidence-summary">QA kanıtlarını inceleyin</a> / <a href="/tr/maturity/taxonomy">Taksonomiyi okuyun</a></p>
</div>

## Bu sayfanın amacı

Bu sayfayı tek bir soruyu yanıtlamak için kullanın: Hangi OpenClaw yüzeyleri bir sürüm için güvenilir seçeneklerdir ve bu değerlendirmeyi hangi kanıtlar destekler? Kapsam, deterministik QA kanıtlarından gelir; kalite ve eksiksizlik ise incelenmiş olgunluk puanları olarak tutulur.
...
Kapsam bilinçli olarak kanıta dayalıdır: bir alan, yalnızca uygulaması mevcut diye "hazır" sayılmaz. Kapsam, olgunluk puanına girdi değildir; ancak OpenClaw, olgun Kararlı veya daha iyi özellikler için uçtan uca kapsamı zaman içinde 90% üzerinde tutmayı hedefler.
...
Yüzeyler olgunluk düzeyi, eksiksizlik ve kaliteye göre sıralanır. Sürüme hazır seçeneklerin kolayca karşılaştırılabilmesi için LTS desteği her satırın yanında gösterilir.
  ...
  <Tab title="Çekirdek">
    <div className="maturity-surface-table">
      ...
      <div className="maturity-surface-row">
        ...
        <div className="maturity-surface-metric"><span className="maturity-surface-metric-label">Kapsam</span><span className="maturity-score maturity-score-experimental"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-experimental">Deneysel</span><span>2%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "2%" }} /></span></span></div>
        <div className="maturity-surface-metric"><span className="maturity-surface-metric-label">Kalite</span><span className="maturity-score maturity-score-alpha"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-alpha">Alfa</span><span>64%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "64%" }} /></span></span></div>
        <div className="maturity-surface-metric"><span className="maturity-surface-metric-label">Eksiksizlik</span><span className="maturity-score maturity-score-alpha"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-alpha">Alfa</span><span>68%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "68%" }} /></span></span></div>
        <div className="maturity-surface-support"><span className="maturity-lts maturity-lts-none">Yok</span></div>
      </div>
      <div className="maturity-surface-row">
        <a className="maturity-surface-name" href="/tr/maturity/taxonomy#voice-and-realtime-talk"><span className="maturity-surface-title">Sesli ve gerçek zamanlı konuşma</span><span className="maturity-surface-meta"><span className="maturity-level-pill maturity-level-alpha"><span className="maturity-level-code">M2</span><span>Alfa</span></span><span>6 alan</span></span></a>
  ...
  <Tab title="Platform">
    <div className="maturity-surface-table">
      <div className="maturity-surface-row maturity-surface-row-header"><span>Yüzey</span><span>Kapsam</span><span>Kalite</span><span>Tamlık</span><span>Destek</span></div>
      <div className="maturity-surface-row">
        <a className="maturity-surface-name" href="/tr/maturity/taxonomy#linux-gateway-host"><span className="maturity-surface-title">Linux Gateway ana bilgisayarı</span><span className="maturity-surface-meta"><span className="maturity-level-pill maturity-level-stable"><span className="maturity-level-code">M4</span><span>Kararlı</span></span><span>5 alan</span></span></a>
        <div className="maturity-surface-metric"><span className="maturity-surface-metric-label">Kapsam</span><span className="maturity-score maturity-score-experimental"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-experimental">Deneysel</span><span>0%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "0%" }} /></span></span></div>
        <div className="maturity-surface-metric"><span className="maturity-surface-metric-label">Kalite</span><span className="maturity-score maturity-score-beta"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-beta">Beta</span><span>75%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "75%" }} /></span></span></div>
        <div className="maturity-surface-metric"><span className="maturity-surface-metric-label">Tamlık</span><span className="maturity-score maturity-score-stable"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-stable">Kararlı</span><span>89%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "89%" }} /></span></span></div>
        <div className="maturity-surface-support"><span className="maturity-lts maturity-lts-partial">Kısmi - 4</span></div>
      ...
      <div className="maturity-surface-row">
        <a className="maturity-surface-name" href="/tr/maturity/taxonomy#macos-gateway-host"><span className="maturity-surface-title">macOS Gateway ana bilgisayarı</span><span className="maturity-surface-meta"><span className="maturity-level-pill maturity-level-stable"><span className="maturity-level-code">M4</span><span>Kararlı</span></span><span>7 alan</span></span></a>
        <div className="maturity-surface-metric"><span className="maturity-surface-metric-label">Kapsam</span><span className="maturity-score maturity-score-experimental"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-experimental">Deneysel</span><span>0%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "0%" }} /></span></span></div>
        <div className="maturity-surface-metric"><span className="maturity-surface-metric-label">Kalite</span><span className="maturity-score maturity-score-beta"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-beta">Beta</span><span>74%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "74%" }} /></span></span></div>
        <div className="maturity-surface-metric"><span className="maturity-surface-metric-label">Tamlık</span><span className="maturity-score maturity-score-stable"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-stable">Kararlı</span><span>88%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "88%" }} /></span></span></div>
        <div className="maturity-surface-support"><span className="maturity-lts maturity-lts-none">Yok</span></div>
  ...
  <Tab title="Sağlayıcı ve araç">
    <div className="maturity-surface-table">
      ...
      <div className="maturity-surface-row">
        <a className="maturity-surface-name" href="/tr/maturity/taxonomy#image-video-and-music-generation-tools"><span className="maturity-surface-title">Görsel, video ve müzik oluşturma araçları</span><span className="maturity-surface-meta"><span className="maturity-level-pill maturity-level-alpha"><span className="maturity-level-code">M2</span><span>Alfa</span></span><span>5 alan</span></span></a>
        <div className="maturity-surface-metric"><span className="maturity-surface-metric-label">Kapsam</span><span className="maturity-score maturity-score-experimental"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-experimental">Deneysel</span><span>0%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "0%" }} /></span></span></div>
        <div className="maturity-surface-metric"><span className="maturity-surface-metric-label">Kalite</span><span className="maturity-score maturity-score-alpha"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-alpha">Alfa</span><span>61%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "61%" }} /></span></span></div>
        <div className="maturity-surface-metric"><span className="maturity-surface-metric-label">Tamlık</span><span className="maturity-score maturity-score-alpha"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-alpha">Alfa</span><span>68%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "68%" }} /></span></span></div>
        <div className="maturity-surface-support"><span className="maturity-lts maturity-lts-none">Yok</span></div>
...
Aşağıdaki kontroller, puan kartının hangi alanlarının QA profili kanıtlarıyla sınandığını gösterir.
...
<div className="maturity-evidence-grid">
  <div className="maturity-evidence-card">
    ...
    <span>96 kontrol - 94 başarılı, 2 engellendi</span>
...
Her kategorinin kanıt durumunu incelemek için bir yüzeyi açın. Sayfanın bir bakışta kullanışlı kalması için liste daraltılmış durumda kalır.
...
<AccordionGroup>
    ...
    <div className="maturity-readiness-list">
      ...
      <div className="maturity-readiness-row">
        <div className="maturity-readiness-area">
          <span className="maturity-readiness-title">Ajan Turunun Yürütülmesi</span>
  ...
  <Accordion title="Otomasyon: Cron, kancalar, görevler, yoklama - 6 alan">
    <p className="maturity-readiness-summary">5 tanesi inceleme gerektiriyor / 1 tanesi kısmen incelendi</p>
    <div className="maturity-readiness-list">
      <div className="maturity-readiness-row maturity-readiness-row-header"><span>Alan</span><span>Özellikler / kapsam kimlikleri</span><span>Takip</span></div>
      <div className="maturity-readiness-row">
        <div className="maturity-readiness-area">
  ...
  <Accordion title="Tarayıcı otomasyonu, yürütme ve korumalı alan araçları - 3 alan">
    <p className="maturity-readiness-summary">2 tanesi kısmen incelendi / 1 tanesi inceleme gerektiriyor</p>
    <div className="maturity-readiness-list">
      <div className="maturity-readiness-row maturity-readiness-row-header"><span>Alan</span><span>Özellikler / kapsam kimlikleri</span><span>Takip</span></div>
      <div className="maturity-readiness-row">
        <div className="maturity-readiness-area">
  ...
  <Accordion title="Gateway Web Uygulaması - 6 alan">
    <p className="maturity-readiness-summary">3 tanesi inceleme gerektiriyor / 3 tanesi kısmen incelendi</p>
    <div className="maturity-readiness-list">
      <div className="maturity-readiness-row maturity-readiness-row-header"><span>Alan</span><span>Özellikler / kapsam kimlikleri</span><span>Takip</span></div>
      <div className="maturity-readiness-row">
        <div className="maturity-readiness-area">
  ...
  <Accordion title="Kanal çerçevesi - 8 alan">
    <p className="maturity-readiness-summary">4 tanesi inceleme gerektiriyor / 4 tanesi kısmen incelendi</p>
    <div className="maturity-readiness-list">
      <div className="maturity-readiness-row maturity-readiness-row-header"><span>Alan</span><span>Özellikler / kapsam kimlikleri</span><span>Takip</span></div>
      <div className="maturity-readiness-row">
        <div className="maturity-readiness-area">
      ...
      <div className="maturity-readiness-row">
        <div className="maturity-readiness-area">
          <span className="maturity-readiness-title">Görüşme Yönlendirme ve Teslimatı</span>
          <span className="maturity-readiness-status maturity-readiness-status-partially-reviewed">Kısmen incelendi - Tam taksonomi doğrulaması</span>
        </div>
      ...
      <div className="maturity-readiness-row">
        <div className="maturity-readiness-area">
          <span className="maturity-readiness-title">Gelen Erişim ve Kimlik Geçitleri</span>
          <span className="maturity-readiness-status maturity-readiness-status-needs-review">İnceleme gerekiyor - Tam taksonomi doğrulaması</span>
        </div>
        <span>5 üzerinden 0 (0%) / 5 üzerinden 0 (0%)</span>
        <span>5 yetenek açığı</span>
      ...
      <div className="maturity-readiness-row">
        <div className="maturity-readiness-area">
          <span className="maturity-readiness-title">Giden Teslimat ve Yanıt İşlem Hattı</span>
          <span className="maturity-readiness-status maturity-readiness-status-partially-reviewed">Kısmen incelendi - Tam taksonomi doğrulaması</span>
        </div>
  ...
  <Accordion title="ClawHub - 4 alan">
    <p className="maturity-readiness-summary">4 tanesinin incelenmesi gerekiyor</p>
    <div className="maturity-readiness-list">
      <div className="maturity-readiness-row maturity-readiness-row-header"><span>Alan</span><span>Özellikler / kapsam kimlikleri</span><span>Takip</span></div>
      <div className="maturity-readiness-row">
        <div className="maturity-readiness-area">
  ...
  <Accordion title="CLI - 7 alan">
    <p className="maturity-readiness-summary">5 tanesinin incelenmesi gerekiyor / 2 tanesi kısmen incelendi</p>
    <div className="maturity-readiness-list">
      <div className="maturity-readiness-row maturity-readiness-row-header"><span>Alan</span><span>Özellikler / kapsam kimlikleri</span><span>Takip</span></div>
      <div className="maturity-readiness-row">
        <div className="maturity-readiness-area">
  ...
  <Accordion title="Discord - 6 alan">
    <p className="maturity-readiness-summary">6 tanesinin incelenmesi gerekiyor</p>
    <div className="maturity-readiness-list">
      <div className="maturity-readiness-row maturity-readiness-row-header"><span>Alan</span><span>Özellikler / kapsam kimlikleri</span><span>Takip</span></div>
      <div className="maturity-readiness-row">
        <div className="maturity-readiness-area">
  ...
  <Accordion title="Docker ve Podman barındırma - 4 alan">
    <p className="maturity-readiness-summary">3 tanesinin incelenmesi gerekiyor / 1 tanesi kısmen incelendi</p>
    <div className="maturity-readiness-list">
      <div className="maturity-readiness-row maturity-readiness-row-header"><span>Alan</span><span>Özellikler / kapsam kimlikleri</span><span>Takip</span></div>
      <div className="maturity-readiness-row">
        <div className="maturity-readiness-area">
      ...
      <div className="maturity-readiness-row">
        <div className="maturity-readiness-area">
          <span className="maturity-readiness-title">Kapsayıcı Operasyonları</span>
          <span className="maturity-readiness-status maturity-readiness-status-needs-review">İncelenmesi gerekiyor - Tam taksonomi doğrulaması</span>
        </div>
        <span>11 üzerinden 0 (%0) / 11 üzerinden 0 (%0)</span>
        <span>11 yetenek açığı</span>
  ...
  <Accordion title="Feishu, QQ Bot, WeChat, Yuanbao, Zalo, Zalo Personal, bölgesel kanallar - 4 alan">
    <p className="maturity-readiness-summary">4'ünün incelenmesi gerekiyor</p>
    <div className="maturity-readiness-list">
      <div className="maturity-readiness-row maturity-readiness-row-header"><span>Alan</span><span>Özellikler / kapsam kimlikleri</span><span>Takip</span></div>
      <div className="maturity-readiness-row">
        <div className="maturity-readiness-area">
  ...
  <Accordion title="Gateway çalışma zamanı - 13 alan">
    <p className="maturity-readiness-summary">9'unun incelenmesi gerekiyor / 4'ü kısmen incelendi</p>
    <div className="maturity-readiness-list">
      <div className="maturity-readiness-row maturity-readiness-row-header"><span>Alan</span><span>Özellikler / kapsam kimlikleri</span><span>Takip</span></div>
      <div className="maturity-readiness-row">
        <div className="maturity-readiness-area">
      ...
      <div className="maturity-readiness-row">
        ...
        <span>7'de 0 (0%) / 12'de 4 (33.3%)</span>
        <span>8 yetenek açığı</span>
      </div>
      <div className="maturity-readiness-row">
        <div className="maturity-readiness-area">
        ...
        <span>20'de 0 (0%) / 22'de 2 (9.1%)</span>
        <span>20 yetenek açığı</span>
      </div>
      <div className="maturity-readiness-row">
        <div className="maturity-readiness-area">
          <span className="maturity-readiness-title">Sistem Durumu, Tanılama ve Onarım</span>
          <span className="maturity-readiness-status maturity-readiness-status-needs-review">İncelenmesi gerekiyor - Tam taksonomi doğrulaması</span>
        </div>
  ...
  <Accordion title="Kubernetes barındırma - 4 alan">
    ...
    <div className="maturity-readiness-list">
      ...
      <div className="maturity-readiness-row">
        <div className="maturity-readiness-area">
          <span className="maturity-readiness-title">Erişim ve Dışa Açma</span>
          <span className="maturity-readiness-status maturity-readiness-status-needs-review">İncelenmesi gerekiyor - Tam taksonomi doğrulaması</span>
        </div>
        <span>5 üzerinden 0 (%0) / 5 üzerinden 0 (%0)</span>
        <span>5 yetenek açığı</span>
  ...
  <Accordion title="Yerel model sağlayıcıları: Ollama, vLLM, SGLang, LM Studio - 5 alan">
    ...
    <div className="maturity-readiness-list">
      ...
      <div className="maturity-readiness-row">
        <div className="maturity-readiness-area">
          <span className="maturity-readiness-title">Yerel Bellek ve Gömmeler</span>
          <span className="maturity-readiness-status maturity-readiness-status-needs-review">İncelenmesi gerekiyor - Tam taksonomi doğrulaması</span>
        </div>
        <span>5 üzerinden 0 (%0) / 5 üzerinden 0 (%0)</span>
        <span>5 yetenek açığı</span>
      ...
      <div className="maturity-readiness-row">
        <div className="maturity-readiness-area">
          <span className="maturity-readiness-title">Yerel Sağlayıcı Pluginleri</span>
          <span className="maturity-readiness-status maturity-readiness-status-needs-review">İncelenmesi gerekiyor - Tam taksonomi doğrulaması</span>
        </div>
        <span>10 üzerinden 0 (%0) / 10 üzerinden 0 (%0)</span>
        <span>10 yetenek açığı</span>
  ...
  <Accordion title="Uzun kuyruklu barındırılan sağlayıcılar - 3 alan">
    <p className="maturity-readiness-summary">3 tanesinin incelenmesi gerekiyor</p>
    <div className="maturity-readiness-list">
      <div className="maturity-readiness-row maturity-readiness-row-header"><span>Alan</span><span>Özellikler / kapsam kimlikleri</span><span>Takip</span></div>
      <div className="maturity-readiness-row">
        <div className="maturity-readiness-area">
      ...
      <div className="maturity-readiness-row">
        <div className="maturity-readiness-area">
          <span className="maturity-readiness-title">Sağlayıcı İşlemleri</span>
          <span className="maturity-readiness-status maturity-readiness-status-needs-review">İncelenmesi gerekiyor - Tam taksonomi doğrulaması</span>
        </div>
        <span>12 üzerinden 0 (%0) / 12 üzerinden 0 (%0)</span>
        <span>12 yetenek açığı</span>
  ...
  <Accordion title="Mattermost, LINE, IRC, Nextcloud Talk, Nostr, Twitch, Tlon, Synology Chat - 4 alan">
    <p className="maturity-readiness-summary">4'ü inceleme gerektiriyor</p>
    <div className="maturity-readiness-list">
      <div className="maturity-readiness-row maturity-readiness-row-header"><span>Alan</span><span>Özellikler / kapsam kimlikleri</span><span>Takip</span></div>
      <div className="maturity-readiness-row">
        <div className="maturity-readiness-area">
  ...
  <Accordion title="Medya anlama ve medya üretimi - 6 alan">
    <p className="maturity-readiness-summary">4'ü inceleme gerektiriyor / 2'si kısmen incelendi</p>
    <div className="maturity-readiness-list">
      <div className="maturity-readiness-row maturity-readiness-row-header"><span>Alan</span><span>Özellikler / kapsam kimlikleri</span><span>Takip</span></div>
      <div className="maturity-readiness-row">
        <div className="maturity-readiness-area">
  ...
  <Accordion title="Microsoft Teams - 5 alan">
    <p className="maturity-readiness-summary">5'i inceleme gerektiriyor</p>
    <div className="maturity-readiness-list">
      <div className="maturity-readiness-row maturity-readiness-row-header"><span>Alan</span><span>Özellikler / kapsam kimlikleri</span><span>Takip</span></div>
      <div className="maturity-readiness-row">
        <div className="maturity-readiness-area">
  ...
  <Accordion title="Nix kurulum yolu - 5 alan">
    ...
    <div className="maturity-readiness-list">
      ...
      <div className="maturity-readiness-row">
        ...
        <span>7'nin 0'ı (0%) / 7'nin 0'ı (0%)</span>
        <span>7 yetenek açığı</span>
      </div>
      <div className="maturity-readiness-row">
        <div className="maturity-readiness-area">
      ...
      <div className="maturity-readiness-row">
        ...
        <span>8'in 0'ı (0%) / 8'in 0'ı (0%)</span>
        <span>8 yetenek açığı</span>
      </div>
    </div>
  </Accordion>
  ...
  <Accordion title="OpenAI ve Codex sağlayıcı yolu - 5 alan">
    <p className="maturity-readiness-summary">2'si inceleme gerektiriyor / 3'ü kısmen incelendi</p>
    <div className="maturity-readiness-list">
      <div className="maturity-readiness-row maturity-readiness-row-header"><span>Alan</span><span>Özellikler / kapsam kimlikleri</span><span>Takip</span></div>
      <div className="maturity-readiness-row">
        <div className="maturity-readiness-area">
      ...
      <div className="maturity-readiness-row">
        ...
        <span>6'nın 1'i (16.7%) / 9'un 4'ü (44.4%)</span>
        <span>5 yetenek açığı</span>
      </div>
      <div className="maturity-readiness-row">
        <div className="maturity-readiness-area">
          <span className="maturity-readiness-title">Yerel Codex Test Sistemi</span>
          <span className="maturity-readiness-status maturity-readiness-status-partially-reviewed">Kısmen incelendi - Tam taksonomi doğrulaması</span>
        </div>
        <span>2'nin 0'ı (0%) / 9'un 4'ü (44.4%)</span>
        <span>5 yetenek açığı</span>
      </div>
      <div className="maturity-readiness-row">
        <div className="maturity-readiness-area">
        ...
        <span>4'ün 1'i (25%) / 5'in 2'si (40%)</span>
        <span>3 yetenek açığı</span>
      </div>
      <div className="maturity-readiness-row">
        <div className="maturity-readiness-area">
  ...
  <Accordion title="OpenClaw Uygulama SDK'sı - 6 alan">
    ...
    <div className="maturity-readiness-list">
      ...
      <div className="maturity-readiness-row">
        ...
        <span>6'nın 0'ı (0%) / 6'nın 0'ı (0%)</span>
        <span>6 yetenek açığı</span>
      </div>
      <div className="maturity-readiness-row">
        <div className="maturity-readiness-area">
      ...
      <div className="maturity-readiness-row">
        ...
        <span>5'in 0'ı (0%) / 6'nın 1'i (16.7%)</span>
        <span>5 yetenek açığı</span>
      </div>
    </div>
  </Accordion>
  ...
  <Accordion title="Plugin'ler - 9 alan">
    ...
    <div className="maturity-readiness-list">
      ...
      <div className="maturity-readiness-row">
        <div className="maturity-readiness-area">
          <span className="maturity-readiness-title">Birlikte sunulan plugin'ler</span>
          <span className="maturity-readiness-status maturity-readiness-status-needs-review">İncelenmesi gerekiyor - Tam taksonomi doğrulaması</span>
        </div>
        <span>5 üzerinden 0 (%0) / 5 üzerinden 0 (%0)</span>
        <span>5 yetenek açığı</span>
      ...
      <div className="maturity-readiness-row">
        <div className="maturity-readiness-area">
          <span className="maturity-readiness-title">Plugin'leri yükleme ve çalıştırma</span>
          <span className="maturity-readiness-status maturity-readiness-status-partially-reviewed">Kısmen incelendi - Tam taksonomi doğrulaması</span>
        </div>
  ...
  <Accordion title="Güvenlik, kimlik doğrulama, eşleştirme ve gizli bilgiler - 6 alan">
    ...
    <div className="maturity-readiness-list">
      ...
      <div className="maturity-readiness-row">
        <div className="maturity-readiness-area">
          <span className="maturity-readiness-title">Kimlik Bilgileri ve Gizli Bilgi Güvenliği</span>
          <span className="maturity-readiness-status maturity-readiness-status-partially-reviewed">Kısmen incelendi - Tam taksonomi doğrulaması</span>
        </div>
  ...
  <Accordion title="Oturum, bellek ve bağlam motoru - 9 alan">
    <p className="maturity-readiness-summary">2 tanesi inceleme gerektiriyor / 7 tanesi kısmen incelendi</p>
    <div className="maturity-readiness-list">
      <div className="maturity-readiness-row maturity-readiness-row-header"><span>Alan</span><span>Özellikler / kapsam kimlikleri</span><span>Takip</span></div>
      <div className="maturity-readiness-row">
        <div className="maturity-readiness-area">
      ...
      <div className="maturity-readiness-row">
        ...
        <span>2'de 0 (0%) / 7'de 4 (57.1%)</span>
        <span>3 yetenek açığı</span>
      </div>
      <div className="maturity-readiness-row">
        <div className="maturity-readiness-area">
          <span className="maturity-readiness-title">Temel İstemler ve Bağlam</span>
          <span className="maturity-readiness-status maturity-readiness-status-partially-reviewed">Kısmen incelendi - Tam taksonomi doğrulaması</span>
        </div>
        <span>2'de 0 (0%) / 8'de 3 (37.5%)</span>
        <span>5 yetenek açığı</span>
      </div>
      <div className="maturity-readiness-row">
        <div className="maturity-readiness-area">
          <span className="maturity-readiness-title">İstemciler Arası Geçmiş ve Oturum Eşdeğerliği</span>
          <span className="maturity-readiness-status maturity-readiness-status-partially-reviewed">Kısmen incelendi - Tam taksonomi doğrulaması</span>
        </div>
        <span>2'de 0 (0%) / 5'te 2 (40%)</span>
        <span>3 yetenek açığı</span>
      </div>
      <div className="maturity-readiness-row">
        <div className="maturity-readiness-area">
      ...
      <div className="maturity-readiness-row">
        ...
        <span>5'te 0 (0%) / 13'te 6 (46.2%)</span>
        <span>7 yetenek açığı</span>
      </div>
      <div className="maturity-readiness-row">
        <div className="maturity-readiness-area">
  ...
  <Accordion title="Signal - 5 alan">
    <p className="maturity-readiness-summary">5 tanesi inceleme gerektiriyor</p>
    <div className="maturity-readiness-list">
      <div className="maturity-readiness-row maturity-readiness-row-header"><span>Alan</span><span>Özellikler / kapsam kimlikleri</span><span>Takip</span></div>
      <div className="maturity-readiness-row">
        <div className="maturity-readiness-area">
  ...
  <Accordion title="Gözlemlenebilirlik - 5 alan">
    <p className="maturity-readiness-summary">3 kısmen incelendi / 2 inceleme gerekiyor</p>
    <div className="maturity-readiness-list">
      <div className="maturity-readiness-row maturity-readiness-row-header"><span>Alan</span><span>Özellikler / kapsam kimlikleri</span><span>Takip</span></div>
      <div className="maturity-readiness-row">
        <div className="maturity-readiness-area">
        ...
        <span>8 üzerinden 1 (12.5%) / 10 üzerinden 3 (30%)</span>
        <span>7 yetenek açığı</span>
      </div>
      <div className="maturity-readiness-row">
        <div className="maturity-readiness-area">
          <span className="maturity-readiness-title">Sistem Sağlığı ve Onarım</span>
          <span className="maturity-readiness-status maturity-readiness-status-partially-reviewed">Kısmen incelendi - Tam sınıflandırma doğrulaması</span>
        </div>
        <span>12 üzerinden 1 (8.3%) / 18 üzerinden 5 (27.8%)</span>
        <span>13 yetenek açığı</span>
      </div>
      <div className="maturity-readiness-row">
        <div className="maturity-readiness-area">
          <span className="maturity-readiness-title">Günlük Kaydı</span>
          <span className="maturity-readiness-status maturity-readiness-status-needs-review">İnceleme gerekiyor - Tam sınıflandırma doğrulaması</span>
        </div>
        <span>5 üzerinden 0 (0%) / 5 üzerinden 0 (0%)</span>
        <span>5 yetenek açığı</span>
      </div>
      ...
      <div className="maturity-readiness-row">
        ...
        <span>13 üzerinden 1 (7.7%) / 21 üzerinden 7 (33.3%)</span>
        <span>14 yetenek açığı</span>
      </div>
    </div>
  </Accordion>
  ...
  <Accordion title="TUI - 5 alan">
    ...
    <div className="maturity-readiness-list">
      ...
      <div className="maturity-readiness-row">
        <div className="maturity-readiness-area">
          <span className="maturity-readiness-title">Görüntüleme ve Çıktı Güvenliği</span>
          <span className="maturity-readiness-status maturity-readiness-status-needs-review">İnceleme gerekiyor - Tam sınıflandırma doğrulaması</span>
        </div>
        <span>4 üzerinden 0 (0%) / 4 üzerinden 0 (0%)</span>
        <span>4 yetenek açığı</span>
  ...
  <Accordion title="Sesli ve gerçek zamanlı konuşma - 6 alan">
  ...
  <Accordion title="Web arama araçları - 4 alan">
    <p className="maturity-readiness-summary">2 tanesi inceleme gerektiriyor / 2 tanesi kısmen incelendi</p>
    <div className="maturity-readiness-list">
      <div className="maturity-readiness-row maturity-readiness-row-header"><span>Alan</span><span>Özellikler / kapsam kimlikleri</span><span>Takip</span></div>
      <div className="maturity-readiness-row">
        <div className="maturity-readiness-area">
