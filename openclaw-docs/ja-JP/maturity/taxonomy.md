...
<div className="maturity-hero maturity-hero-compact">
  <p className="maturity-kicker">スコアカードの基盤となるモデル</p>
  <p className="maturity-hero-title">サーフェス &gt; カテゴリ &gt; 機能 &gt; エビデンス。</p>
  <p>50 のサーフェスを 4 つのファミリーに分類し、すべてのカテゴリを正規ドキュメントおよび QA カバレッジ ID に関連付けています。</p>
  <p className="maturity-jump-links"><a href="#product-areas">プロダクト領域を見る</a> / <a href="#taxonomy-details">詳細な分類を開く</a> / <a href="/ja-JP/maturity/scorecard">スコアを見る</a></p>
</div>

## このページの読み方

サーフェスとは、Gateway ランタイム、Discord、macOS アプリなどのプロダクト領域です。各サーフェスにはカテゴリがあり、各カテゴリには QA シナリオでカバーされる機能レベルのチェック項目があります。リリースレベルの判断にはスコアカードを使用し、その基盤となるモデルを確認するにはこのページを使用します。

## 成熟度レベル

<div className="maturity-level-list">
  <div className="maturity-level-row"><span className="maturity-level-title"><span className="maturity-level-pill maturity-level-experimental"><span className="maturity-level-code">M0</span><span>計画済み</span></span></span><span>方向性は決まっていますが、サポート対象のユーザー向け経路は存在しません。</span><span className="maturity-level-promotion">昇格条件：設計 Issue、オーナー、対象サーフェスが存在すること。</span></div>
  <div className="maturity-level-row"><span className="maturity-level-title"><span className="maturity-level-pill maturity-level-experimental"><span className="maturity-level-code">M1</span><span>実験的</span></span></span><span>注意事項、フラグ、ソースビルド、またはメンテナー専用フローの背後で実装されています。</span><span className="maturity-level-promotion">昇格条件：メンテナーが現在の main からシナリオを実行できること。</span></div>
  <div className="maturity-level-row"><span className="maturity-level-title"><span className="maturity-level-pill maturity-level-alpha"><span className="maturity-level-code">M2</span><span>アルファ</span></span></span><span>実際のユーザーが試せますが、破壊的変更や不完全な UX が想定されます。</span><span className="maturity-level-promotion">昇格条件：文書化されたセットアップ、基本テスト、既知の注意事項、および実環境での検証が少なくとも 1 件あること。</span></div>
  <div className="maturity-level-row"><span className="maturity-level-title"><span className="maturity-level-pill maturity-level-beta"><span className="maturity-level-code">M3</span><span>ベータ</span></span></span><span>公開された経路が存在し、主要ワークフローを限定的な注意事項のもとで利用できます。</span><span className="maturity-level-promotion">昇格条件：インストール／更新ドキュメント、回帰テスト、サポート用ランブック、および想定環境全体でシナリオ検証が成功していること。</span></div>
  <div className="maturity-level-row"><span className="maturity-level-title"><span className="maturity-level-pill maturity-level-stable"><span className="maturity-level-code">M4</span><span>安定版</span></span></span><span>一般ユーザーに推奨される経路です。不具合はリグレッションとして扱われます。</span><span className="maturity-level-promotion">昇格条件：リリースゲート、doctor／トラブルシューティング経路、広範なドキュメント、および実環境での検証が繰り返し行われていること。</span></div>
  <div className="maturity-level-row"><span className="maturity-level-title"><span className="maturity-level-pill maturity-level-clawesome"><span className="maturity-level-code">M5</span><span>Clawesome</span></span></span><span>洗練され、快適で、計測体制が充実しており、同種の最高水準のワークフローに匹敵します。</span><span className="maturity-level-promotion">昇格条件：安定版に加え、代表的なユーザー全体でユーザースコアカードに合格すること。</span></div>
</div>
...
<Tabs>
  ...
  <Tab title="プラットフォーム">
    ...
    <a className="maturity-surface-link" href="#docker-and-podman-hosting">
      <span className="maturity-surface-title">Docker および Podman でのホスティング</span>
    ...
    <a className="maturity-surface-link" href="#raspberry-pi-and-small-linux-devices">
      <span className="maturity-surface-title">Raspberry Pi および小型 Linux デバイス</span>
      <span className="maturity-surface-meta"><span className="maturity-level-pill maturity-level-beta"><span className="maturity-level-code">M3</span><span>ベータ</span></span><span>4 領域 - 79% 完了</span></span>
    </a>
    ...
    <a className="maturity-surface-link" href="#linux-companion-app">
      ...
      <span className="maturity-surface-meta"><span className="maturity-level-pill maturity-level-experimental"><span className="maturity-level-code">M0</span><span>計画中</span></span><span>5 領域 - 21% 完了</span></span>
    </a>
...
<AccordionGroup>
  <Accordion title="CLI - M4 安定版 - 7 領域">
    ...
    通常のセットアップおよび修復手順は、インストール、CLI、Gateway の各ドキュメントに記載されています。プラットフォーム固有の Windows 手順は、「WSL2 経由の Windows」と「ネイティブ Windows」の行で追跡されます。
    ...
    [概要](/ja-JP/install/index), [インストーラー](/ja-JP/install/installer), [Node](/ja-JP/install/node), [更新](/ja-JP/install/updating)
    ...
    [オンボーディング](/ja-JP/cli/onboard), [設定](/ja-JP/cli/configure), [オンボーディングの概要](/ja-JP/start/onboarding-overview)
    ...
    [オンボーディング](/ja-JP/cli/onboard), [Plugin](/ja-JP/cli/plugins), [チャンネル](/ja-JP/cli/channels)
    ...
    [Gateway](/ja-JP/cli/gateway), [更新](/ja-JP/install/updating), [トラブルシューティング](/ja-JP/gateway/troubleshooting)
      ...
      <div className="maturity-category-row">
        <div className="maturity-category-area">
          <span className="maturity-category-title">CLI の可観測性</span>
          <span>5 個の機能 / LTS 対応</span>
        </div>
        <div><span className="maturity-score maturity-score-experimental"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-experimental">実験的</span><span>0%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "0%" }} /></span></span></div>
        <div><span className="maturity-score maturity-score-stable"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-stable">安定版</span><span>89%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "89%" }} /></span></span></div>
    ...
    [ステータス](/ja-JP/cli/status), [正常性](/ja-JP/cli/health), [ログ](/ja-JP/cli/logs), [診断](/ja-JP/gateway/diagnostics)
    ...
    [Doctor](/ja-JP/cli/doctor)、[Doctor](/ja-JP/gateway/doctor)、[シークレット](/ja-JP/gateway/secrets)、[トラブルシューティング](/ja-JP/gateway/troubleshooting)
    ...
    [更新方法](/ja-JP/install/updating)、[更新](/ja-JP/cli/update)、[トラブルシューティング](/ja-JP/gateway/troubleshooting)
  ...
  <Accordion title="Gateway ランタイム - M4 安定版 - 13 領域">
    ...
    コアアーキテクチャ、認証、ペアリング、プロトコルのドキュメント、デーモンのドキュメント、CLI ランブックは広範かつ最新です。
    ...
    [プロトコル](/ja-JP/gateway/protocol)、[索引](/ja-JP/gateway/security/index)
    ...
    [索引](/ja-JP/gateway/index)、[OpenAI HTTP API](/ja-JP/gateway/openai-http-api)、[OpenResponses HTTP API](/ja-JP/gateway/openresponses-http-api)、[ツール呼び出し HTTP API](/ja-JP/gateway/tools-invoke-http-api)、[フック](/ja-JP/automation/hooks)、[索引](/ja-JP/web/index)
    ...
    [索引](/ja-JP/gateway/index)、[アーキテクチャ](/ja-JP/concepts/architecture)、[コントロール UI](/ja-JP/web/control-ui)、[Web チャット](/ja-JP/web/webchat)、[キャンバス](/ja-JP/refactor/canvas)
    ...
    [プロトコル](/ja-JP/gateway/protocol)、[索引](/ja-JP/gateway/index)、[アーキテクチャ](/ja-JP/concepts/architecture)
    ...
    [プロトコル](/ja-JP/gateway/protocol)、[ペアリング](/ja-JP/gateway/pairing)、[索引](/ja-JP/gateway/security/index)
    ...
    [索引](/ja-JP/gateway/index)、[検出](/ja-JP/gateway/discovery)、[プロトコル](/ja-JP/gateway/protocol)
    ...
    [プロトコル](/ja-JP/gateway/protocol)、[アーキテクチャ](/ja-JP/concepts/architecture)、[索引](/ja-JP/nodes/index)
    ...
    [索引](/ja-JP/gateway/index)、[診断](/ja-JP/gateway/diagnostics)、[Doctor](/ja-JP/gateway/doctor)
    ...
    [索引](/ja-JP/gateway/index)、[アーキテクチャ](/ja-JP/concepts/architecture)
    ...
    [索引](/ja-JP/gateway/security/index)、[プロトコル](/ja-JP/gateway/protocol)、[検出](/ja-JP/gateway/discovery)
  ...
  <Accordion title="Agent ランタイム - M3 ベータ - 9 領域">
    <a id="agent-runtime" />

    メインループ、モデル、プロバイダーのルーティング、ツールのストリーミングは第一級の機能ですが、プロバイダーの動作は毎週変化するため、リリースごとにシナリオによる検証が必要です。
    ...
    <div className="maturity-category-list">
      ...
      <div className="maturity-category-row">
        <div className="maturity-category-area">
          <span className="maturity-category-title">Agent ターンの実行</span>
    ...
    [Agent ループ](/ja-JP/concepts/agent-loop)、[Agent](/ja-JP/cli/agent)、[Agent ランタイム](/ja-JP/concepts/agent-runtimes)
    ...
    [Agent ランタイム](/ja-JP/concepts/agent-runtimes)、[Anthropic](/ja-JP/providers/anthropic)、[Google](/ja-JP/providers/google)、[サブエージェント](/ja-JP/tools/subagents)
    ...
    [Ollama](/ja-JP/providers/ollama)、[モデル](/ja-JP/concepts/models)、[Agent](/ja-JP/cli/agent)
    ...
    [サンドボックス、ツールポリシー、昇格の違い](/ja-JP/gateway/sandbox-vs-tool-policy-vs-elevated)、[エージェントループ](/ja-JP/concepts/agent-loop)、[サブエージェント](/ja-JP/tools/subagents)
  ...
  <Accordion title="セッション、メモリ、コンテキストエンジン - M3 ベータ - 9 領域">
    ...
    ドキュメントは充実しており、実装も活発です。成熟度は、トランスクリプトの耐久性、Compaction の品質、クライアント間の同等性に左右されます。

    <div className="maturity-surface-rollup"><span>カバレッジ 試験的 - 30%</span><span>品質 ベータ - 77%</span><span>完全性 ベータ - 79%</span><span><span className="maturity-lts maturity-lts-partial">部分的 - 6</span></span></div>
    ...
    [セッション](/ja-JP/concepts/session)、[セッション管理の Compaction](/ja-JP/reference/session-management-compaction)、[セッション](/ja-JP/cli/sessions)
      ...
      <div className="maturity-category-row">
        ...
        <div><span className="maturity-score maturity-score-experimental"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-experimental">試験的</span><span>20%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "20%" }} /></span></span></div>
        <div><span className="maturity-score maturity-score-beta"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-beta">ベータ</span><span>79%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "79%" }} /></span></span></div>
        <div><span className="maturity-score maturity-score-beta"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-beta">ベータ</span><span>79%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "79%" }} /></span></span></div>
        <div className="maturity-category-docs">

    [Compaction](/ja-JP/concepts/compaction)、[コンテキスト](/ja-JP/concepts/context)、[セッション管理の Compaction](/ja-JP/reference/session-management-compaction)
    ...
    [コンテキスト](/ja-JP/concepts/context)、[コンテキストエンジン](/ja-JP/concepts/context-engine)
    ...
    [ウェブチャット](/ja-JP/web/webchat)、[Android](/ja-JP/platforms/android)、[チャンネルルーティング](/ja-JP/channels/channel-routing)
    ...
    [診断](/ja-JP/gateway/diagnostics)、[セッション管理のCompaction](/ja-JP/reference/session-management-compaction)、[フラグ](/ja-JP/diagnostics/flags)
    ...
    [コンテキスト](/ja-JP/concepts/context)、[トランスクリプトの整理](/ja-JP/reference/transcript-hygiene)、[Discord](/ja-JP/channels/discord)
    ...
    [メモリ設定](/ja-JP/reference/memory-config)、[メモリQmd](/ja-JP/concepts/memory-qmd)、[メモリ](/ja-JP/concepts/memory)、[Discord](/ja-JP/channels/discord)
    ...
    [セッション](/ja-JP/concepts/session)、[チャンネルルーティング](/ja-JP/channels/channel-routing)、[Discord](/ja-JP/channels/discord)
    ...
    [セッション管理のCompaction](/ja-JP/reference/session-management-compaction)、[トランスクリプトの衛生管理](/ja-JP/reference/transcript-hygiene)
  ...
  <Accordion title="チャンネルフレームワーク - M3 ベータ - 8領域">
    <a id="channel-framework" />

    多くのチャンネルはGatewayの配信およびルーティング契約を共有していますが、チャンネルの動作は上流APIやアカウントポリシーの制約によって異なります。
    ...
    <div className="maturity-category-list">
      ...
      <div className="maturity-category-row">
        <div className="maturity-category-area">
          <span className="maturity-category-title">チャンネルのアクション、コマンド、承認</span>
          <span>5つの機能</span>
        </div>
        <div><span className="maturity-score maturity-score-experimental"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-experimental">実験的</span><span>0%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "0%" }} /></span></span></div>
        <div><span className="maturity-score maturity-score-beta"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-beta">ベータ</span><span>79%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "79%" }} /></span></span></div>
    ...
    [グループ](/ja-JP/channels/groups)、[Discord](/ja-JP/channels/discord)、[Google Chat](/ja-JP/channels/googlechat)、[Signal](/ja-JP/channels/signal)、[Matrix](/ja-JP/channels/matrix)
      ...
      <div className="maturity-category-row">
        <div className="maturity-category-area">
          <span className="maturity-category-title">チャンネルのセットアップ</span>
          <span>5つの機能 / LTSサポート対象</span>
        </div>
        <div><span className="maturity-score maturity-score-experimental"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-experimental">実験的</span><span>14%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "14%" }} /></span></span></div>
        <div><span className="maturity-score maturity-score-beta"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-beta">ベータ</span><span>79%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "79%" }} /></span></span></div>
    ...
    [索引](/ja-JP/channels/index)、[ペアリング](/ja-JP/channels/pairing)、[トラブルシューティング](/ja-JP/channels/troubleshooting)、[SDKチャンネルPlugin](/ja-JP/plugins/sdk-channel-plugins)
    ...
    [グループ](/ja-JP/channels/groups)、[グループメッセージ](/ja-JP/channels/group-messages)、[アンビエントルームイベント](/ja-JP/channels/ambient-room-events)、[ブロードキャストグループ](/ja-JP/channels/broadcast-groups)、[Discord](/ja-JP/channels/discord)
      ...
      <div className="maturity-category-row">
        <div className="maturity-category-area">
          <span className="maturity-category-title">受信アクセスとアイデンティティのゲート</span>
          <span>5つの機能 / LTSサポート対象</span>
        </div>
        <div><span className="maturity-score maturity-score-experimental"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-experimental">実験的</span><span>0%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "0%" }} /></span></span></div>
        <div><span className="maturity-score maturity-score-alpha"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-alpha">アルファ</span><span>68%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "68%" }} /></span></span></div>
    ...
    [グループ](/ja-JP/channels/groups)、[アンビエントルームイベント](/ja-JP/channels/ambient-room-events)、[Discord](/ja-JP/channels/discord)、[Matrix](/ja-JP/channels/matrix)、[チャネル設定](/ja-JP/gateway/config-channels)
    ...
    [チャネルルーティング](/ja-JP/channels/channel-routing)、[グループ](/ja-JP/channels/groups)、[Discord](/ja-JP/channels/discord)、[Matrix](/ja-JP/channels/matrix)、[トラブルシューティング](/ja-JP/channels/troubleshooting)、[設定リファレンス](/ja-JP/gateway/configuration-reference)

    </div>
      </div>
      <div className="maturity-category-row">
        <div className="maturity-category-area">
          <span className="maturity-category-title">ステータスの健全性と運用者向け制御</span>
          <span>4 個の機能 / LTS サポート対象</span>
        </div>
        <div><span className="maturity-score maturity-score-experimental"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-experimental">実験的</span><span>0%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "0%" }} /></span></span></div>
        <div><span className="maturity-score maturity-score-beta"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-beta">ベータ</span><span>79%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "79%" }} /></span></span></div>
    ...
    [健全性](/ja-JP/gateway/health)、[設定リファレンス](/ja-JP/gateway/configuration-reference)、[トラブルシューティング](/ja-JP/channels/troubleshooting)、[Discord](/ja-JP/channels/discord)
  ...
  <Accordion title="オブザーバビリティ - M3 ベータ - 5 領域">
    ...
    OTel、Prometheus、ロギング、診断に関するドキュメントは存在します。運用者が最初に確認すべき項目を公開するための成熟度向上が必要です。

    <div className="maturity-surface-rollup"><span>カバレッジ：実験的 - 18%</span><span>品質：ベータ - 75%</span><span>完全性：ベータ - 79%</span><span><span className="maturity-lts maturity-lts-partial">部分的 - 3</span></span></div>
    ...
    [ログ](/ja-JP/logging)、[ログ](/ja-JP/gateway/logging)、[ログ](/ja-JP/cli/logs)
    ...
    [診断](/ja-JP/gateway/diagnostics)、[ヘルス](/ja-JP/gateway/health)、[Codex ハーネス](/ja-JP/plugins/codex-harness)、[プロトコル](/ja-JP/gateway/protocol)
    ...
    [フック](/ja-JP/plugins/hooks)、[OpenTelemetry](/ja-JP/gateway/opentelemetry)、[ログ](/ja-JP/logging)、[SDK サブパス](/ja-JP/plugins/sdk-subpaths)、[診断 OpenTelemetry](/ja-JP/plugins/reference/diagnostics-otel)、[Prometheus](/ja-JP/gateway/prometheus)、[診断 Prometheus](/ja-JP/plugins/reference/diagnostics-prometheus)
  ...
  <Accordion title="Gateway Web アプリ - M3 ベータ - 6領域">
    <a id="gateway-web-app" />

    Web UI については、ペアリング、チャット、PWA、Talk、プッシュ通知、リモート Gateway のフローが文書化されています。クロスブラウザーおよびモバイル PWA のスコアカードが整った後に昇格します。
    ...
    <div className="maturity-category-list">
      ...
      <div className="maturity-category-row">
        <div className="maturity-category-area">
          <span className="maturity-category-title">ブラウザリアルタイムトーク</span>
          <span>5 個の機能</span>
        </div>
        <div><span className="maturity-score maturity-score-experimental"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-experimental">実験的</span><span>0%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "0%" }} /></span></span></div>
        <div><span className="maturity-score maturity-score-alpha"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-alpha">アルファ</span><span>68%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "68%" }} /></span></span></div>
    ...
    [コントロール UI](/ja-JP/web/control-ui)、[プロトコル](/ja-JP/gateway/protocol)、[トーク](/ja-JP/nodes/talk)
      ...
      <div className="maturity-category-row">
        <div className="maturity-category-area">
          <span className="maturity-category-title">ブラウザアクセスと信頼</span>
          <span>5 個の機能</span>
        </div>
        <div><span className="maturity-score maturity-score-experimental"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-experimental">実験的</span><span>0%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "0%" }} /></span></span></div>
        <div><span className="maturity-score maturity-score-alpha"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-alpha">アルファ</span><span>68%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "68%" }} /></span></span></div>
    ...
    [コントロール UI](/ja-JP/web/control-ui)、[設定](/ja-JP/gateway/configuration)
      ...
      <div className="maturity-category-row">
        <div className="maturity-category-area">
          <span className="maturity-category-title">ブラウザ UI</span>
          <span>10 個の機能</span>
        </div>
    ...
    [コントロール UI](/ja-JP/web/control-ui)、[索引](/ja-JP/web/index)、[ダッシュボード](/ja-JP/web/dashboard)、[プロトコル](/ja-JP/gateway/protocol)

    </div>
      </div>
      <div className="maturity-category-row">
        <div className="maturity-category-area">
          <span className="maturity-category-title">WebChat の会話</span>
          <span>15 個の機能</span>
        </div>
    ...
    [コントロール UI](/ja-JP/web/control-ui)、[Webchat](/ja-JP/web/webchat)、[はじめに](/ja-JP/start/getting-started)、[チャンネルルーティング](/ja-JP/channels/channel-routing)、[安全なファイル操作](/ja-JP/gateway/security/secure-file-operations)
  ...
  <Accordion title="Plugins - M3 ベータ - 9領域">
    ...
    マニフェスト、検出、読み込み、プロバイダー／ツールのアーキテクチャ、承認境界にわたり、幅広いドキュメントと強固な内部ランタイムのエビデンスが存在します。公開 SDK の API／サブパスと外部配布のエビデンスがさらに強固になるまでは、この行をベータのままにします。
    ...
    [Pluginの構築](/ja-JP/plugins/building-plugins)、[SDKの概要](/ja-JP/plugins/sdk-overview)、[SDKのエントリポイント](/ja-JP/plugins/sdk-entrypoints)、[SDKのサブパス](/ja-JP/plugins/sdk-subpaths)、[マニフェスト](/ja-JP/plugins/manifest)、[リファレンス](/ja-JP/plugins/reference)
    ...
    [Plugin インベントリ](/ja-JP/plugins/plugin-inventory)、[Plugin](/ja-JP/cli/plugins)、[アーキテクチャ内部構造](/ja-JP/plugins/architecture-internals)
    ...
    [アーキテクチャ](/ja-JP/plugins/architecture)、[アーキテクチャ内部構造](/ja-JP/plugins/architecture-internals)、[Plugin](/ja-JP/cli/plugins)
    ...
    [SDK チャンネル Plugin](/ja-JP/plugins/sdk-channel-plugins)、[SDK チャンネル受信](/ja-JP/plugins/sdk-channel-inbound)、[SDK チャンネル送信](/ja-JP/plugins/sdk-channel-outbound)

    </div>
      </div>
      <div className="maturity-category-row">
        <div className="maturity-category-area">
          <span className="maturity-category-title">プロバイダーおよびツール Plugin</span>
          <span>6 個の機能 / LTS サポート対象</span>
        </div>
    ...
    [SDK テスト](/ja-JP/plugins/sdk-testing)、[SDK セットアップ](/ja-JP/plugins/sdk-setup)、[Codex ハーネス](/ja-JP/plugins/codex-harness)
  ...
  <Accordion title="セキュリティ、認証、ペアリング、シークレット - M3 ベータ - 6 領域">
    ...
    優れたドキュメントと堅牢化のための機能があります。定期的なアップグレードおよびセキュリティシナリオの実行により、セットアップのリグレッションがないことを証明した後に昇格します。
    ...
    [索引](/ja-JP/gateway/security/index)、[公開対策ランブック](/ja-JP/gateway/security/exposure-runbook)、[信頼済みプロキシ認証](/ja-JP/gateway/trusted-proxy-auth)、[Tailscale](/ja-JP/gateway/tailscale)、[リモート](/ja-JP/gateway/remote)、[設定リファレンス](/ja-JP/gateway/configuration-reference)、[Gateway](/ja-JP/cli/gateway)、[診断](/ja-JP/cli/doctor)、[コントロール UI](/ja-JP/web/control-ui)、[ブラウザー制御](/ja-JP/tools/browser-control)、[監査チェック](/ja-JP/gateway/security/audit-checks)

    </div>
      </div>
      <div className="maturity-category-row">
        <div className="maturity-category-area">
          <span className="maturity-category-title">チャンネルのアクセス制御</span>
          <span>3 個の機能 / LTS サポート対象</span>
        </div>
        <div><span className="maturity-score maturity-score-experimental"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-experimental">実験的</span><span>0%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "0%" }} /></span></span></div>
        <div><span className="maturity-score maturity-score-alpha"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-alpha">アルファ</span><span>68%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "68%" }} /></span></span></div>
        <div><span className="maturity-score maturity-score-beta"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-beta">ベータ</span><span>79%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "79%" }} /></span></span></div>
    ...
    [プロトコル](/ja-JP/gateway/protocol)、[デバイス](/ja-JP/cli/devices)、[ペアリング](/ja-JP/channels/pairing)、[ペアリング](/ja-JP/gateway/pairing)、[オペレータースコープ](/ja-JP/gateway/operator-scopes)、[コントロール UI](/ja-JP/web/control-ui)、[Web チャット](/ja-JP/web/webchat)、[承認](/ja-JP/cli/approvals)

    </div>
      </div>
      <div className="maturity-category-row">
        <div className="maturity-category-area">
          <span className="maturity-category-title">Plugin の信頼性</span>
          <span>2 個の機能</span>
        </div>
        <div><span className="maturity-score maturity-score-experimental"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-experimental">実験的</span><span>0%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "0%" }} /></span></span></div>
        <div><span className="maturity-score maturity-score-alpha"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-alpha">アルファ</span><span>68%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "68%" }} /></span></span></div>
  ...
  <Accordion title="自動化：Cron、フック、タスク、ポーリング - M3 ベータ - 6領域">
    ...
    文書化され使用可能ですが、シナリオによる実証では無人配信、再試行、障害の可視性を網羅する必要があります。
    ...
    [Cron ジョブ](/ja-JP/automation/cron-jobs), [Cron](/ja-JP/cli/cron), [プロトコル](/ja-JP/gateway/protocol), [タスク](/ja-JP/automation/tasks), [Discord](/ja-JP/channels/discord)
    ...
    [フック](/ja-JP/automation/hooks), [フック](/ja-JP/cli/hooks), [フック](/ja-JP/plugins/hooks), [Plugin 権限リクエスト](/ja-JP/plugins/plugin-permission-requests), [SDK サブパス](/ja-JP/plugins/sdk-subpaths)
    ...
    [タスク](/ja-JP/automation/tasks), [索引](/ja-JP/automation/index), [タスク](/ja-JP/cli/tasks), [TaskFlow](/ja-JP/automation/taskflow), [SDK ランタイム](/ja-JP/plugins/sdk-runtime)
    ...
    [索引](/ja-JP/automation/index), [Heartbeat](/ja-JP/gateway/heartbeat), [コミットメント](/ja-JP/concepts/commitments)
    ...
    [投票](/ja-JP/cli/message), [メッセージ](/ja-JP/cli/message), [Telegram](/ja-JP/channels/telegram), [Microsoft Teams](/ja-JP/channels/msteams), [バックグラウンドプロセス](/ja-JP/gateway/background-process)
  ...
  <Accordion title="メディアの理解とメディア生成 - M2 アルファ - 6領域">
    <a id="media-understanding-and-media-generation" />

    幅広い機能領域が存在しますが、プロバイダーごとの差異、ファイル制限、Nodeとアプリ間の同等性により、まだ安定していません。
    ...
    <div className="maturity-category-list">
      ...
      <div className="maturity-category-row">
        <div className="maturity-category-area">
          <span className="maturity-category-title">メディアの受け入れとアクセス</span>
          <span>8 個の機能</span>
        </div>
        <div><span className="maturity-score maturity-score-experimental"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-experimental">実験的</span><span>0%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "0%" }} /></span></span></div>
    ...
    [メディアの概要](/ja-JP/tools/media-overview), [メディア理解](/ja-JP/nodes/media-understanding), [安全なファイル操作](/ja-JP/gateway/security/secure-file-operations), [PDF](/ja-JP/tools/pdf), [画像生成](/ja-JP/tools/image-generation), [QR](/ja-JP/cli/qr), [LINE](/ja-JP/channels/line), [WhatsApp](/ja-JP/channels/whatsapp)
      ...
      <div className="maturity-category-row">
        <div className="maturity-category-area">
          <span className="maturity-category-title">チャンネルのメディア処理</span>
          <span>5 個の機能</span>
        </div>
        <div><span className="maturity-score maturity-score-experimental"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-experimental">実験的</span><span>0%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "0%" }} /></span></span></div>
        <div><span className="maturity-score maturity-score-alpha"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-alpha">アルファ</span><span>61%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "61%" }} /></span></span></div>
    ...
    [メディアの概要](/ja-JP/tools/media-overview), [画像生成](/ja-JP/tools/image-generation), [マニフェスト](/ja-JP/plugins/manifest), [Codex ハーネス](/ja-JP/plugins/codex-harness)
    ...
    [音声](/ja-JP/nodes/audio), [メディア理解](/ja-JP/nodes/media-understanding), [メディアの概要](/ja-JP/tools/media-overview), [WhatsApp](/ja-JP/channels/whatsapp), [画像](/ja-JP/nodes/images), [推論](/ja-JP/cli/infer), [PDF](/ja-JP/tools/pdf)
  ...
  <Accordion title="音声とリアルタイム会話 - M2 アルファ - 6 領域">
    ...
    Control UI、アプリ、プロバイダーにわたって複数の実装が存在します。ベータ版に移行する前に、レイテンシー、障害モード、セットアップのスコアカードが必要です。
    ...
    <div className="maturity-category-list">
      ...
      <div className="maturity-category-row">
        <div className="maturity-category-area">
          <span className="maturity-category-title">会話プロバイダー</span>
          <span>7 個の機能</span>
        </div>
        <div><span className="maturity-score maturity-score-experimental"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-experimental">実験的</span><span>0%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "0%" }} /></span></span></div>
        <div><span className="maturity-score maturity-score-alpha"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-alpha">アルファ</span><span>61%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "61%" }} /></span></span></div>
    ...
    [OpenAI](/ja-JP/providers/openai), [Google](/ja-JP/providers/google), [SDK プロバイダー Plugin](/ja-JP/plugins/sdk-provider-plugins), [会話](/ja-JP/nodes/talk), [Control UI](/ja-JP/web/control-ui)

    </div>
      </div>
      <div className="maturity-category-row">
        <div className="maturity-category-area">
          <span className="maturity-category-title">リアルタイム会話セッション</span>
          <span>11 個の機能</span>
        </div>
        <div><span className="maturity-score maturity-score-experimental"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-experimental">実験的</span><span>0%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "0%" }} /></span></span></div>
        <div><span className="maturity-score maturity-score-alpha"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-alpha">アルファ</span><span>61%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "61%" }} /></span></span></div>
    ...
    [会話](/ja-JP/nodes/talk)、[コントロール UI](/ja-JP/web/control-ui)
    ...
    [会話](/ja-JP/nodes/talk)、[OpenAI](/ja-JP/providers/openai)、[Google](/ja-JP/providers/google)

    </div>
      </div>
      <div className="maturity-category-row">
        <div className="maturity-category-area">
          <span className="maturity-category-title">ネイティブアプリでの会話</span>
          <span>4 個の機能</span>
        </div>
        <div><span className="maturity-score maturity-score-experimental"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-experimental">実験的</span><span>0%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "0%" }} /></span></span></div>
        <div><span className="maturity-score maturity-score-alpha"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-alpha">アルファ</span><span>61%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "61%" }} /></span></span></div>
    ...
    [会話](/ja-JP/nodes/talk)、[音声起動](/ja-JP/platforms/mac/voicewake)
    ...
    [音声起動](/ja-JP/nodes/voicewake)、[音声起動](/ja-JP/platforms/mac/voicewake)、[音声オーバーレイ](/ja-JP/platforms/mac/voice-overlay)

    </div>
      </div>
      <div className="maturity-category-row">
        <div className="maturity-category-area">
          <span className="maturity-category-title">会話の可観測性</span>
          <span>5 個の機能</span>
        </div>
        <div><span className="maturity-score maturity-score-experimental"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-experimental">実験的</span><span>0%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "0%" }} /></span></span></div>
        <div><span className="maturity-score maturity-score-alpha"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-alpha">アルファ</span><span>61%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "61%" }} /></span></span></div>
    ...
    [コントロール UI](/ja-JP/web/control-ui)、[音声オーバーレイ](/ja-JP/platforms/mac/voice-overlay)、[会話](/ja-JP/nodes/talk)
  ...
  <Accordion title="TUI - M2 アルファ - 5 領域">
    ...
    [TUI](/ja-JP/cli/tui)、[TUI](/ja-JP/web/tui)、[索引](/ja-JP/cli/index)
  ...
  <Accordion title="ClawHub - M2 アルファ - 4 領域">
    <a id="clawhub" />
    ...
    [公開](/ja-JP/clawhub/publishing), [Skills の作成](/ja-JP/tools/creating-skills), [コミュニティ](/ja-JP/plugins/community)
      ...
      <div className="maturity-category-row">
        <div className="maturity-category-area">
          <span className="maturity-category-title">カタログの検索</span>
          <span>5 個の機能</span>
        </div>
        <div><span className="maturity-score maturity-score-experimental"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-experimental">実験的</span><span>0%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "0%" }} /></span></span></div>
        <div><span className="maturity-score maturity-score-alpha"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-alpha">アルファ</span><span>61%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "61%" }} /></span></span></div>
    ...
    [Plugin](/ja-JP/tools/plugin), [Plugin](/ja-JP/cli/plugins), [Skills](/ja-JP/cli/skills), [Skills](/ja-JP/tools/skills), [コミュニティ](/ja-JP/plugins/community)
    ...
    [Plugin](/ja-JP/tools/plugin), [Plugin](/ja-JP/cli/plugins), [互換性](/ja-JP/plugins/compatibility), [Plugin インベントリ](/ja-JP/plugins/plugin-inventory), [公開](/ja-JP/clawhub/publishing), [Skills](/ja-JP/tools/skills), [Skills の設定](/ja-JP/tools/skills-config)
    ...
    [Plugin](/ja-JP/tools/plugin), [Plugin](/ja-JP/cli/plugins), [Skills](/ja-JP/cli/skills), [Skills](/ja-JP/tools/skills), [プロトコル](/ja-JP/gateway/protocol), [バンドル](/ja-JP/plugins/bundles), [依存関係の解決](/ja-JP/plugins/dependency-resolution)
  ...
  <Accordion title="OpenClaw App SDK - M2 アルファ - 6 領域">
    ...
    OpenClaw App SDK は、Gateway ランタイムおよび Plugin SDK とは別個の外部アプリ契約です。現在のスコアは、公開パッケージ化、自動検出、承認、ヘルパー、互換性に課題がある、実際の `@openclaw/sdk` パスを示しています。
    ...
    [OpenClaw SDK](/ja-JP/gateway/external-apps), [OpenClaw SDK API の設計](/ja-JP/gateway/external-apps)
    ...
    [OpenClaw SDK](/ja-JP/gateway/external-apps)、[OpenClaw SDK API 設計](/ja-JP/gateway/external-apps)、[プロトコル](/ja-JP/gateway/protocol)、[索引](/ja-JP/gateway/security/index)
...
<AccordionGroup>
  <Accordion title="Linux Gateway ホスト - M4 安定版 - 5 領域">
    ...
    Node ランタイムを推奨し、systemd ユーザーサービスについて文書化しており、VPS／コンテナに関するガイダンスも幅広く提供しています。
    ...
    [索引](/ja-JP/install/index)、[更新](/ja-JP/install/updating)、[Linux](/ja-JP/platforms/linux)、[索引](/ja-JP/platforms/index)
    ...
    [索引](/ja-JP/gateway/index)、[Gateway](/ja-JP/cli/gateway)、[Linux](/ja-JP/platforms/linux)、[VPS](/ja-JP/vps)
    ...
    [リモート](/ja-JP/gateway/remote)、[Tailscale](/ja-JP/gateway/tailscale)、[公開運用手順書](/ja-JP/gateway/security/exposure-runbook)、[認証](/ja-JP/gateway/authentication)、[シークレット](/ja-JP/gateway/secrets)
    ...
    [ステータス](/ja-JP/cli/status)、[ログ](/ja-JP/cli/logs)、[Doctor](/ja-JP/cli/doctor)、[診断](/ja-JP/gateway/diagnostics)、[索引](/ja-JP/gateway/index)
  ...
  <Accordion title="macOS Gatewayホスト - M4 安定版 - 7領域">
    ...
    LaunchAgentサービスパス、ローカル/リモートGatewayモード、CLIのインストール、アプリ統合について文書化されています。
    ...
    [Macos](/ja-JP/platforms/macos)、[同梱 Gateway](/ja-JP/platforms/mac/bundled-gateway)、[リモート](/ja-JP/platforms/mac/remote)、[インデックス](/ja-JP/gateway/index)、[Gateway](/ja-JP/cli/gateway)、[Bonjour](/ja-JP/gateway/bonjour)
    ...
    [Macos](/ja-JP/platforms/macos)、[同梱 Gateway](/ja-JP/platforms/mac/bundled-gateway)、[Gateway](/ja-JP/cli/gateway)、[インデックス](/ja-JP/gateway/index)、[更新](/ja-JP/cli/update)、[アップデート](/ja-JP/install/updating)、[アンインストール](/ja-JP/install/uninstall)、[トラブルシューティング](/ja-JP/gateway/troubleshooting)
    ...
    [同梱 Gateway](/ja-JP/platforms/mac/bundled-gateway)、[Macos](/ja-JP/platforms/macos)、[Gateway](/ja-JP/cli/gateway)、[診断](/ja-JP/gateway/doctor)、[トラブルシューティング](/ja-JP/gateway/troubleshooting)
    ...
    [複数の Gateway](/ja-JP/gateway/multiple-gateways), [索引](/ja-JP/gateway/index), [Gateway](/ja-JP/cli/gateway)
  ...
  <Accordion title="Android アプリ - M4 安定版 - 7 領域">
    ...
    Google Play による公式配布が提供され、ソースからのビルドおよび実行に関するドキュメントが保守されており、Android アプリはユーザー向けの通常のコンパニオン Node として文書化されています。
  ...
  <Accordion title="iOSアプリ - M4 安定版 - 8領域">
    ...
    App Storeで公式に配布され、リレーを利用したプッシュ通知が文書化されており、iOSアプリはユーザー向けの通常のコンパニオンNodeとして文書化されています。
    ...
    [iOS](/ja-JP/platforms/ios)、[Webチャット](/ja-JP/web/webchat)、[プロトコル](/ja-JP/gateway/protocol)
    ...
    [iOS](/ja-JP/platforms/ios)、[会話](/ja-JP/nodes/talk)
  ...
  <Accordion title="DockerおよびPodmanによるホスティング - M3 ベータ - 4領域">
    <a id="docker-and-podman-hosting" />

    インストールドキュメントが用意されており、一般的なデプロイ方法となっています。定期的なリリーススモークテストでアップグレードとボリュームの動作が記録されるようになった後、昇格します。
    ...
    [Podman](/ja-JP/install/podman), [Docker VM ランタイム](/ja-JP/install/docker-vm-runtime), [Docker](/ja-JP/install/docker), [Hetzner](/ja-JP/install/hetzner), [Hostinger](/ja-JP/install/hostinger)
    ...
    [Docker](/ja-JP/install/docker), [Docker VM ランタイム](/ja-JP/install/docker-vm-runtime), [完全なリリース検証](/ja-JP/reference/full-release-validation)
    ...
    [Docker](/ja-JP/install/docker), [Docker VM ランタイム](/ja-JP/install/docker-vm-runtime)
  ...
  <Accordion title="WSL2 経由の Windows - M3 ベータ - 6 領域">
    ...
    systemd/ユーザーサービスのガイダンスとブートチェーンのドキュメントを備えた、推奨される Windows 向けパス。インストール/更新のスコアカードを繰り返し確認した後に昇格します。

    <div className="maturity-surface-rollup"><span>カバレッジ 実験的 - 6%</span><span>品質 アルファ - 69%</span><span>完全性 ベータ - 79%</span><span><span className="maturity-lts maturity-lts-partial">部分対応 - 5</span></span></div>
    ...
    [Windows](/ja-JP/platforms/windows)、[はじめに](/ja-JP/start/getting-started)、[更新](/ja-JP/install/updating)、[オンボーディング](/ja-JP/cli/onboard)、[診断](/ja-JP/cli/doctor)、[ステータス](/ja-JP/cli/status)、[ログ](/ja-JP/cli/logs)
    ...
    [Windows](/ja-JP/platforms/windows)、[索引](/ja-JP/gateway/index)、[診断](/ja-JP/gateway/doctor)

    </div>
      </div>
      <div className="maturity-category-row">
        <div className="maturity-category-area">
          <span className="maturity-category-title">Gateway へのアクセスと公開</span>
    ...
    [Windows](/ja-JP/platforms/windows)、[ステータス](/ja-JP/cli/status)、[ログ](/ja-JP/cli/logs)、[Doctor](/ja-JP/cli/doctor)、[Doctor](/ja-JP/gateway/doctor)
      ...
      <div className="maturity-category-row">
        <div className="maturity-category-area">
          <span className="maturity-category-title">ブラウザとコントロールUI</span>
          <span>6つの機能</span>
        </div>
        <div><span className="maturity-score maturity-score-experimental"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-experimental">実験的</span><span>0%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "0%" }} /></span></span></div>
        <div><span className="maturity-score maturity-score-alpha"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-alpha">アルファ</span><span>67%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "67%" }} /></span></span></div>
    ...
    [WindowsのWSL2におけるリモートCDPブラウザのトラブルシューティング](/ja-JP/tools/browser-wsl2-windows-remote-cdp-troubleshooting)、[ブラウザ](/ja-JP/tools/browser)、[コントロールUI](/ja-JP/web/control-ui)
  ...
  <Accordion title="Raspberry Piと小型Linuxデバイス - M3ベータ - 4領域">
    <a id="raspberry-pi-and-small-linux-devices" />

    プラットフォームのドキュメントが用意されており、Gatewayの経路はLinuxベースです。さらに上の段階へ移行するには、ハードウェア固有のリリーススモークテストによる実証が必要です。
    ...
    [Raspberry Pi](/ja-JP/install/raspberry-pi)、[索引](/ja-JP/install/index)、[初回実行に関するFAQ](/ja-JP/help/faq-first-run)、[FAQ](/ja-JP/help/faq)、[Linux](/ja-JP/platforms/linux)、[インストーラー](/ja-JP/install/installer)
    ...
    [索引](/ja-JP/gateway/index)、[Gateway](/ja-JP/cli/gateway)、[Raspberry Pi](/ja-JP/install/raspberry-pi)、[Linux](/ja-JP/platforms/linux)、[VPS](/ja-JP/vps)
  ...
  <Accordion title="macOSコンパニオンアプリ - M3ベータ - 8領域">
    ...
    高機能なメニューバーアプリ、権限、Nodeモード、Canvas、音声ウェイク、WebChat、リモートモードが用意されています。依然として変化が速いため、Stableへの移行は見送られています。
    ...
    [Canvas](/ja-JP/platforms/mac/canvas)、[macOS](/ja-JP/platforms/macos)、[WebChat](/ja-JP/web/webchat)
    ...
    [バンドル版 Gateway](/ja-JP/platforms/mac/bundled-gateway)、[macOS](/ja-JP/platforms/macos)、[子プロセス](/ja-JP/platforms/mac/child-process)、[開発環境のセットアップ](/ja-JP/platforms/mac/dev-setup)
    ...
    [メニューバー](/ja-JP/platforms/mac/menu-bar)、[アイコン](/ja-JP/platforms/mac/icon)、[macOS](/ja-JP/platforms/macos)、[ヘルスチェック](/ja-JP/platforms/mac/health)、[ログ](/ja-JP/platforms/mac/logging)、[リモート](/ja-JP/platforms/mac/remote)
    ...
    [音声起動](/ja-JP/platforms/mac/voicewake)、[音声オーバーレイ](/ja-JP/platforms/mac/voice-overlay)、[会話](/ja-JP/nodes/talk)、[macOS](/ja-JP/platforms/macos)
  ...
  <Accordion title="ネイティブ Windows - M2 アルファ - 4 領域">
    ...
    コアの CLI/Gateway フローは動作しますが、完全なエクスペリエンスを得るため、ドキュメントでは引き続き WSL2 を推奨し、ネイティブ環境の注意事項を記載しています。
    ...
    [索引](/ja-JP/install/index)、[インストーラー](/ja-JP/install/installer)、[Windows](/ja-JP/platforms/windows)、[はじめに](/ja-JP/start/getting-started)、[オンボーディング](/ja-JP/cli/onboard)
    ...
    [Windows](/ja-JP/platforms/windows)、[索引](/ja-JP/gateway/index)、[Gateway](/ja-JP/cli/gateway)、[Doctor](/ja-JP/cli/doctor)
    ...
    [Windows](/ja-JP/platforms/windows)、[索引](/ja-JP/gateway/index)、[Gateway](/ja-JP/cli/gateway)
  ...
  <Accordion title="Kubernetes ホスティング - M2 アルファ - 4 分野">
    <a id="kubernetes-hosting" />

    Kubernetes ホスティングは、Kustomize を基盤とする独立したクラスターデプロイパスです。現在のスコアは、実用的な最小構成のデプロイパスが存在する一方、Kubernetes 固有の CI、Ingress/TLS/NetworkPolicy のパッケージ化、バックアップと復元、本番環境への公開に関する堅牢化に不足があることを示しています。

    <div className="maturity-surface-rollup"><span>カバレッジ：実験的 - 0%</span><span>品質：アルファ - 55%</span><span>完全性：アルファ - 61%</span><span><span className="maturity-lts maturity-lts-none">なし</span></span></div>

    <div className="maturity-category-list">
      <div className="maturity-category-row maturity-category-row-header"><span>分野</span><span>カバレッジ</span><span>品質</span><span>完全性</span><span>ドキュメント</span></div>
      <div className="maturity-category-row">
        <div className="maturity-category-area">
          <span className="maturity-category-title">デプロイのセットアップ</span>
          <span>5 個の機能</span>
        </div>
        <div><span className="maturity-score maturity-score-experimental"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-experimental">実験的</span><span>0%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "0%" }} /></span></span></div>
        <div><span className="maturity-score maturity-score-alpha"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-alpha">アルファ</span><span>55%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "55%" }} /></span></span></div>
    ...
    [Kubernetes](/ja-JP/install/kubernetes)、[索引](/ja-JP/install/index)
    ...
    [Kubernetes](/ja-JP/install/kubernetes)、[索引](/ja-JP/gateway/index)
  ...
  <Accordion title="Nix インストールパス - M1 実験的 - 5 分野">
    <a id="nix-install-path" />

    オプションのインストールフローです。アルファまたはベータへ昇格する前に、サポート方針をより明確にする必要があります。
    ...
    [Nix](/ja-JP/install/nix)、[索引](/ja-JP/install/index)、[ドキュメントディレクトリ](/ja-JP/start/docs-directory)
    ...
    [Pluginの管理](/ja-JP/plugins/manage-plugins)、[Plugin](/ja-JP/tools/plugin)、[Nix](/ja-JP/install/nix)

    </div>
      </div>
      <div className="maturity-category-row">
        <div className="maturity-category-area">
          <span className="maturity-category-title">アクティベーションとアプリUX</span>
          <span>7個の機能</span>
        </div>
        <div><span className="maturity-score maturity-score-experimental"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-experimental">実験的</span><span>0%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "0%" }} /></span></span></div>
        <div><span className="maturity-score maturity-score-experimental"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-experimental">実験的</span><span>41%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "41%" }} /></span></span></div>
    ...
    [Nix](/ja-JP/install/nix)、[セットアップ](/ja-JP/cli/setup)、[診断](/ja-JP/cli/doctor)、[更新](/ja-JP/cli/update)
  ...
  <Accordion title="watchOS コンパニオンサーフェス - M1 実験的 - 5 領域">
    <a id="watchos-companion-surfaces" />

    ソースには Watch アプリ／拡張機能のサーフェスがありますが、公開ドキュメントではまだユーザー向け機能として紹介されていません。
    ...
    [iOS](/ja-JP/platforms/ios)
      ...
      <div className="maturity-category-row">
        <div className="maturity-category-area">
          <span className="maturity-category-title">Watch アプリの UI</span>
          <span>3 個の機能</span>
        </div>
        <div><span className="maturity-score maturity-score-experimental"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-experimental">実験的</span><span>0%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "0%" }} /></span></span></div>
        <div><span className="maturity-score maturity-score-experimental"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-experimental">実験的</span><span>41%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "41%" }} /></span></span></div>
  ...
  <Accordion title="Linux コンパニオンアプリ - M0 計画済み - 5 領域">
    <a id="linux-companion-app" />

    ドキュメントではネイティブ Linux コンパニオンアプリが計画されているとされています。現在サポートされている Linux 向けの方法は Gateway です。
    ...
    <div className="maturity-category-list">
      ...
      <div className="maturity-category-row">
        <div className="maturity-category-area">
          <span className="maturity-category-title">アプリの配布</span>
          <span>3 個の機能</span>
        </div>
        <div><span className="maturity-score maturity-score-experimental"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-experimental">実験的</span><span>0%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "0%" }} /></span></span></div>
        <div><span className="maturity-score maturity-score-experimental"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-experimental">実験的</span><span>19%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "19%" }} /></span></span></div>
    ...
    [Linux](/ja-JP/platforms/linux)、[概要](/ja-JP/platforms/index)、[概要](/ja-JP/install/index)
    ...
    [Linux](/ja-JP/platforms/linux)、[概要](/ja-JP/gateway/index)、[ペアリング](/ja-JP/gateway/pairing)、[リモート](/ja-JP/gateway/remote)
    ...
    [Linux](/ja-JP/platforms/linux)、[プロトコル](/ja-JP/gateway/protocol)、[Web チャット](/ja-JP/web/webchat)
    ...
    [Linux](/ja-JP/platforms/linux)、[実行の承認](/ja-JP/tools/exec-approvals)、[シークレット](/ja-JP/gateway/secrets)、[概要](/ja-JP/nodes/index)、[実行](/ja-JP/tools/exec)、[音声会話](/ja-JP/nodes/talk)、[カメラ](/ja-JP/nodes/camera)
  ...
  <Accordion title="ネイティブ Windows コンパニオンアプリ - M0 計画済み - 5 領域">
    ...
    [Windows](/ja-JP/platforms/windows), [索引](/ja-JP/install/index)
    ...
    [Windows](/ja-JP/platforms/windows), [索引](/ja-JP/gateway/index), [ペアリング](/ja-JP/gateway/pairing), [リモート](/ja-JP/gateway/remote)
    ...
    [Windows](/ja-JP/platforms/windows), [診断](/ja-JP/gateway/doctor), [索引](/ja-JP/gateway/index)
    ...
    [Windows](/ja-JP/platforms/windows), [索引](/ja-JP/nodes/index), [実行](/ja-JP/tools/exec), [実行の承認](/ja-JP/tools/exec-approvals), [索引](/ja-JP/gateway/security/index)
...
<AccordionGroup>
  <Accordion title="Discord - M4 安定版 - 6領域">
    ...
    詳細なドキュメントと幅広い機能を提供しています。音声および委任の経路は、引き続きベータ版／アルファ版として個別に評価する必要があります。

    <div className="maturity-surface-rollup"><span>カバレッジ 試験的 - 0%</span><span>品質 ベータ版 - 73%</span><span>完全性 安定版 - 87%</span><span><span className="maturity-lts maturity-lts-partial">部分対応 - 4</span></span></div>
    ...
    <div className="maturity-category-list">
      ...
      <div className="maturity-category-row">
        ...
        <div><span className="maturity-score maturity-score-experimental"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-experimental">試験的</span><span>0%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "0%" }} /></span></span></div>
        <div><span className="maturity-score maturity-score-beta"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-beta">ベータ版</span><span>73%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "73%" }} /></span></span></div>
        <div><span className="maturity-score maturity-score-stable"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-stable">安定版</span><span>87%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "87%" }} /></span></span></div>
        <div className="maturity-category-docs">

    [Discord](/ja-JP/channels/discord), [Discord](/ja-JP/plugins/reference/discord), [Fly](/ja-JP/install/fly), [スラッシュコマンド](/ja-JP/tools/slash-commands), [ヘルス](/ja-JP/gateway/health), [チャネル](/ja-JP/cli/channels), [チャネル設定](/ja-JP/gateway/config-channels)
    ...
    [Discord](/ja-JP/channels/discord)、[OpenAI](/ja-JP/providers/openai)、[Elevenlabs](/ja-JP/providers/elevenlabs)、[QA E2E 自動化](/ja-JP/concepts/qa-e2e-automation)、[チャンネル設定](/ja-JP/gateway/config-channels)
  ...
  <Accordion title="Telegram - M3 ベータ - 5 領域">
    ...
    コアチャンネルは通常利用に十分な成熟度に達していますが、ばらつきの大きい UX とメディアのエッジケースについては、継続的なシナリオ検証が必要です。
  ...
  <Accordion title="Slack - M3 ベータ - 5 領域">
    ...
    <div className="maturity-surface-rollup"><span>カバレッジ Experimental - 0%</span><span>品質 Alpha - 66%</span><span>完全性 Beta - 78%</span><span><span className="maturity-lts maturity-lts-full">完全対応 - 5</span></span></div>
    ...
    [Slack](/ja-JP/channels/slack), [Bot ループ保護](/ja-JP/channels/bot-loop-protection), [ペアリング](/ja-JP/channels/pairing)
    ...
    [Slack](/ja-JP/channels/slack), [スラッシュコマンド](/ja-JP/tools/slash-commands), [実行の承認](/ja-JP/tools/exec-approvals)
  ...
  <Accordion title="iMessageとBlueBubbles - M3 Beta - 5領域">
    <a id="imessage-and-bluebubbles" />

    サポート対象のiMessageは、サインイン済みのmacOS Messagesホスト上でimsgを介して動作します。従来のBlueBubbles設定には移行が必要です。macOSの権限、SSHラッパー、SIP／プライベートAPI、および移行に関する注意事項を明示してください。

    <div className="maturity-surface-rollup"><span>カバレッジ Experimental - 0%</span><span>品質 Alpha - 66%</span><span>完全性 Beta - 78%</span><span><span className="maturity-lts maturity-lts-none">なし</span></span></div>
    ...
    [BlueBubbles版iMessage](/ja-JP/announcements/bluebubbles-imessage), [BlueBubblesからiMessageへ](/ja-JP/channels/imessage-from-bluebubbles), [チャネル設定](/ja-JP/gateway/config-channels), [iMessage](/ja-JP/channels/imessage)
    ...
    [iMessage](/ja-JP/channels/imessage), [BlueBubblesからiMessageへ](/ja-JP/channels/imessage-from-bluebubbles), [チャネル設定](/ja-JP/gateway/config-channels)
    ...
    [iMessage](/ja-JP/channels/imessage), [BlueBubblesからのiMessage](/ja-JP/channels/imessage-from-bluebubbles), [チャンネルの設定](/ja-JP/gateway/config-channels)
  ...
  <Accordion title="WhatsApp - M3 ベータ - 5領域">
    ...
    コアパスは重要であり、文書化されていますが、アップストリームのBaileysおよびセッションの不安定性により、安定版には達していません。
    ...
    [WhatsApp](/ja-JP/channels/whatsapp), [チャンネルの設定](/ja-JP/gateway/config-channels), [WhatsApp](/ja-JP/plugins/reference/whatsapp), [QA E2E自動化](/ja-JP/concepts/qa-e2e-automation), [Doctor](/ja-JP/gateway/doctor)
  ...
  <Accordion title="Matrix - M2 アルファ - 6領域">
    <a id="matrix" />
    ...
    [Matrix](/ja-JP/channels/matrix), [Matrix の移行](/ja-JP/channels/matrix-migration)
    ...
    [Matrix](/ja-JP/channels/matrix), [グループ](/ja-JP/channels/groups), [Bot ループ保護](/ja-JP/channels/bot-loop-protection)
  ...
  <Accordion title="Google Chat - M2 アルファ - 5つの領域">
    <a id="google-chat" />

    ドキュメント化されたチャンネルですが、エンタープライズおよび管理者向けのセットアップにより成熟度のリスクが高まります。
    ...
    [Google Chat](/ja-JP/channels/googlechat), [Google Chat](/ja-JP/plugins/reference/googlechat), [チャンネル設定](/ja-JP/gateway/config-channels), [ウィザード CLI リファレンス](/ja-JP/start/wizard-cli-reference), [シークレット](/ja-JP/gateway/secrets), [Secretref 認証情報サーフェス](/ja-JP/reference/secretref-credential-surface), [ヘルス](/ja-JP/gateway/health), [Plugin インベントリ](/ja-JP/plugins/plugin-inventory), [インデックス](/ja-JP/channels/index)
    ...
    [Google Chat](/ja-JP/channels/googlechat), [ペアリング](/ja-JP/channels/pairing), [アクセスグループ](/ja-JP/channels/access-groups), [チャンネル設定](/ja-JP/gateway/config-channels), [Bot ループ保護](/ja-JP/channels/bot-loop-protection), [チャンネルルーティング](/ja-JP/channels/channel-routing)
    ...
    [Google Chat](/ja-JP/channels/googlechat), [Bot ループ保護](/ja-JP/channels/bot-loop-protection), [アクセスグループ](/ja-JP/channels/access-groups), [チャンネルルーティング](/ja-JP/channels/channel-routing)
    ...
    [Google Chat](/ja-JP/channels/googlechat), [メッセージ](/ja-JP/cli/message), [メディア理解](/ja-JP/nodes/media-understanding), [Secretref 認証情報サーフェス](/ja-JP/reference/secretref-credential-surface)
    ...
    [Google Chat](/ja-JP/channels/googlechat), [メッセージ](/ja-JP/cli/message), [メディア理解](/ja-JP/nodes/media-understanding), [Secretref 認証情報サーフェス](/ja-JP/reference/secretref-credential-surface), [リアクション](/ja-JP/tools/reactions), [スラッシュコマンド](/ja-JP/tools/slash-commands), [エージェント設定](/ja-JP/gateway/config-agents), [メッセージライフサイクルのリファクタリング](/ja-JP/concepts/message-lifecycle-refactor)
  ...
  <Accordion title="Microsoft Teams - M2 アルファ - 5 領域">
    ...
    エンタープライズ認証および管理フローには、明示的なシナリオの実証が必要です。
    ...
    [Microsoft Teams](/ja-JP/channels/msteams), [Microsoft Teams](/ja-JP/plugins/reference/msteams), [チャンネル設定](/ja-JP/gateway/config-channels), [ヘルス](/ja-JP/gateway/health)
    ...
    [Microsoft Teams](/ja-JP/channels/msteams), [ペアリング](/ja-JP/channels/pairing), [アクセスグループ](/ja-JP/channels/access-groups)
    ...
    [Microsoft Teams](/ja-JP/channels/msteams), [グループ](/ja-JP/channels/groups), [チャンネルルーティング](/ja-JP/channels/channel-routing)
    ...
    [Microsoft Teams](/ja-JP/channels/msteams), [高度な実行承認](/ja-JP/tools/exec-approvals-advanced)
  ...
  <Accordion title="Signal - M2 アルファ - 5 領域">
    ...
    対応チャンネルのドキュメントは存在しますが、インストールと再接続について、より確実な検証が必要です。
  ...
  <Accordion title="Feishu、QQ Bot、WeChat、Yuanbao、Zalo、Zalo Personal、地域別チャンネル - M2 Alpha - 4領域">
    <a id="feishu-qq-bot-wechat-yuanbao-zalo-zalo-personal-regional-channels" />

    重要な地域をカバーしていますが、公開サポートレベルは、アカウント種別、アップストリームの承認、メンテナーによる実証に応じて調整する必要があります。

    <div className="maturity-surface-rollup"><span>カバレッジ Experimental - 0%</span><span>品質 Alpha - 55%</span><span>完全性 Alpha - 58%</span><span><span className="maturity-lts maturity-lts-none">なし</span></span></div>
    ...
    [索引](/ja-JP/channels/index)、[ペアリング](/ja-JP/channels/pairing)、[Feishu](/ja-JP/plugins/reference/feishu)、[アーキテクチャ内部構造](/ja-JP/plugins/architecture-internals)
  ...
  <Accordion title="Mattermost、LINE、IRC、Nextcloud Talk、Nostr、Twitch、Tlon、Synology Chat - M2 アルファ - 4 領域">
    ...
    対応するサーフェスは存在しますが、成熟度はアップストリームやメンテナーの対応範囲によって異なる可能性があります。後で個別に評価します。

    <div className="maturity-surface-rollup"><span>対応範囲：実験的 - 0%</span><span>品質：アルファ - 53%</span><span>完全性：アルファ - 54%</span><span><span className="maturity-lts maturity-lts-none">なし</span></span></div>
  ...
  <Accordion title="音声通話チャネル - M1 実験的 - 5 領域">
    ...
    複雑なリアルタイム動作を伴うオプションの Plugin パスです。公開ベータ版の前にシナリオスコアカードが必要です。
    ...
    [Voicecall](/ja-JP/cli/voicecall)、[音声通話](/ja-JP/plugins/voice-call)、[プロトコル](/ja-JP/gateway/protocol)
    ...
    [音声通話](/ja-JP/plugins/voice-call)、[Voicecall](/ja-JP/cli/voicecall)
...
<AccordionGroup>
  <Accordion title="ブラウザー自動化、exec、サンドボックスツール - M3 ベータ - 3 領域">
    ...
    コアツールは文書化されていますが、ホストのセキュリティと権限に関する UX は、引き続きスコアカードで継続的にレビューする必要があります。
    ...
    [ブラウザー制御](/ja-JP/tools/browser-control)、[テスト](/ja-JP/help/testing)、[ブラウザー](/ja-JP/tools/browser)、[索引](/ja-JP/gateway/security/index)、[監査チェック](/ja-JP/gateway/security/audit-checks)
    ...
    [実行](/ja-JP/tools/exec)、[バックグラウンドプロセス](/ja-JP/gateway/background-process)、[ツール呼び出し HTTP API](/ja-JP/gateway/tools-invoke-http-api)、[オペレータースコープ](/ja-JP/gateway/operator-scopes)、[プロトコル](/ja-JP/gateway/protocol)、[実行の承認](/ja-JP/tools/exec-approvals)、[実行の承認（高度）](/ja-JP/tools/exec-approvals-advanced)、[昇格実行](/ja-JP/tools/elevated)
    ...
    [サンドボックス化](/ja-JP/gateway/sandboxing)、[サンドボックス、ツールポリシー、昇格実行の比較](/ja-JP/gateway/sandbox-vs-tool-policy-vs-elevated)、[マルチエージェントのサンドボックスツール](/ja-JP/tools/multi-agent-sandbox-tools)、[Codex Harness リファレンス](/ja-JP/plugins/codex-harness-reference)、[設定ツール](/ja-JP/gateway/config-tools)
  ...
  <Accordion title="OpenAI と Codex のプロバイダーパス - M3 ベータ - 5領域">
    ...
    詳細なドキュメント、OAuth／サブスクリプション経路、リアルタイム音声、画像、互換性に関する動作を扱います。プロバイダーの変化が続いているため、リリーススコアカードによる実証なしでは Stable とみなされません。
    ...
    [OpenAI](/ja-JP/providers/openai)、[Codex Harness](/ja-JP/plugins/codex-harness)、[モデル](/ja-JP/concepts/models)、[OAuth](/ja-JP/concepts/oauth)、[Codex Harness リファレンス](/ja-JP/plugins/codex-harness-reference)、[認証の監視](/ja-JP/gateway/authentication)
    ...
    [OpenAI](/ja-JP/providers/openai)、[OpenResponses HTTP API](/ja-JP/gateway/openresponses-http-api)、[OpenAI HTTP API](/ja-JP/gateway/openai-http-api)、[Codex ネイティブ Plugin](/ja-JP/plugins/codex-native-plugins)
    ...
    [Codex ハーネス](/ja-JP/plugins/codex-harness), [Codex ハーネスランタイム](/ja-JP/plugins/codex-harness-runtime), [Codex ハーネスリファレンス](/ja-JP/plugins/codex-harness-reference), [Codex ネイティブ Plugin](/ja-JP/plugins/codex-native-plugins)
  ...
  <Accordion title="Web 検索ツール - M3 ベータ - 4 領域">
    ...
    複数のプロバイダーとドキュメントが存在します。プロバイダーファミリーごとにクォータ、エラー、SSRF の検証が必要です。
    ...
    [Web](/ja-JP/tools/web), [Web 取得](/ja-JP/tools/web-fetch), [よくある質問](/ja-JP/help/faq), [API 利用コスト](/ja-JP/reference/api-usage-costs), [Brave Search](/ja-JP/tools/brave-search), [Perplexity Search](/ja-JP/tools/perplexity-search), [Tavily](/ja-JP/tools/tavily), [Firecrawl](/ja-JP/tools/firecrawl)
    ...
    [Web](/ja-JP/tools/web), [Web 取得](/ja-JP/tools/web-fetch), [Firecrawl](/ja-JP/tools/firecrawl), [Searxng Search](/ja-JP/tools/searxng-search)
    ...
    [設定ツール](/ja-JP/gateway/config-tools), [Web 取得](/ja-JP/tools/web-fetch), [Web](/ja-JP/tools/web), [よくある質問](/ja-JP/help/faq)
  ...
  <Accordion title="Anthropic プロバイダーパス - M3 ベータ - 5 領域">
    ...
    ファーストクラスのモデルプロバイダーです。認証、カタログ、ツール呼び出しのシナリオを定期的に検証する必要があります。
    ...
    [Anthropic](/ja-JP/providers/anthropic)、[Doctor](/ja-JP/gateway/doctor)、[設定例](/ja-JP/gateway/configuration-examples)、[トラブルシューティング](/ja-JP/gateway/troubleshooting)、[プロンプトキャッシュ](/ja-JP/reference/prompt-caching)
  ...
  <Accordion title="Google プロバイダーパス - M3 ベータ - 5 領域">
    ...
    モデルとリアルタイムのサーフェスを備えた第一級プロバイダーです。Live/Talk は個別にスコアリングする必要があります。
    ...
    [Google](/ja-JP/providers/google)、[モデルプロバイダー](/ja-JP/concepts/model-providers)、[Google](/ja-JP/plugins/reference/google)、[Gemini 検索](/ja-JP/tools/gemini-search)
      ...
      <div className="maturity-category-row">
        <div className="maturity-category-area">
          <span className="maturity-category-title">Gemini ダイレクトランタイム</span>
          <span>9 機能</span>
        </div>
        <div><span className="maturity-score maturity-score-experimental"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-experimental">実験的</span><span>0%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "0%" }} /></span></span></div>
        <div><span className="maturity-score maturity-score-alpha"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-alpha">アルファ</span><span>66%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "66%" }} /></span></span></div>
  ...
  <Accordion title="OpenRouter プロバイダーパス - M3 ベータ - 4 領域">
    ...
    統合されたプロバイダーパスは文書化されており有用ですが、モデル固有の動作は異なります。
    ...
    [モデルのフェイルオーバー](/ja-JP/concepts/model-failover)、[Openrouter](/ja-JP/providers/openrouter)、[モデル](/ja-JP/cli/models)
  ...
  <Accordion title="画像、動画、音楽の生成ツール - M2 アルファ - 5領域">
    <a id="image-video-and-music-generation-tools" />

    この機能は複数のプロバイダーで利用できますが、品質、レイテンシ、パラメーターの互換性の差が大きすぎるため、プロバイダーごとの検証なしではベータにできません。
    ...
    [エージェント設定](/ja-JP/gateway/config-agents)、[画像生成](/ja-JP/tools/image-generation)、[動画生成](/ja-JP/tools/video-generation)、[音楽生成](/ja-JP/tools/music-generation)
  ...
  <Accordion title="ローカルモデルプロバイダー: Ollama、vLLM、SGLang、LM Studio - M2 アルファ - 5 分野">
    ...
    [索引](/ja-JP/gateway/security/index)、[設定ツール](/ja-JP/gateway/config-tools)、[ローカルモデル](/ja-JP/gateway/local-models)
  ...
  <Accordion title="ロングテールのホステッドプロバイダー - M2 アルファ - 3 領域">
    ...
    多数のドキュメントおよびリファレンスページが存在します。スコアは、プロバイダーのメタデータとライブスモークテストのカバレッジから生成する必要があります。
    ...
    [索引](/ja-JP/providers/index)、[モデルプロバイダー](/ja-JP/concepts/model-providers)、[ライブテスト](/ja-JP/help/testing-live)、[オンボーディング](/ja-JP/cli/onboard)
    ...
    [マニフェスト](/ja-JP/plugins/manifest)、[ライブテスト](/ja-JP/help/testing-live)、[索引](/ja-JP/providers/index)
    ...
    [索引](/ja-JP/providers/index)、[モデルプロバイダー](/ja-JP/concepts/model-providers)、[マニフェスト](/ja-JP/plugins/manifest)、[ライブテスト](/ja-JP/help/testing-live)、[モデル](/ja-JP/cli/models)
