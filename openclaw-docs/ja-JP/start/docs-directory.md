...
- [ペアリング（DM と Node）](/ja-JP/channels/pairing)
...
- [Node（iOS と Android）](/ja-JP/nodes)
- [Web インターフェース（コントロール UI）](/ja-JP/web)
- [検出とトランスポート](/ja-JP/gateway/discovery)
- [リモートアクセス](/ja-JP/gateway/remote)

## チャンネルと UX

- [コントロール UI（ブラウザー）](/ja-JP/web/control-ui)
...
- [WhatsApp のグループメッセージ](/ja-JP/channels/group-messages)
