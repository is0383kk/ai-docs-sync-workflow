---
read_when:
    - iMessage Plugin のインストール、設定、または監査を行う場合です
summary: OpenClaw メッセージを送受信するための iMessage チャンネルサーフェスを追加します。
title: iMessage Plugin
x-i18n:
    generated_at: "2026-07-26T10:24:54Z"
    model: gpt-5.6
...
OpenClaw メッセージを送受信するための iMessage チャネルサーフェスを追加します。
