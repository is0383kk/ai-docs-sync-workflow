...
title: WeChat
x-i18n:
    generated_at: "2026-07-27T17:27:09Z"
    model: gpt-5.6
...
मीडिया समर्थित हैं। समूह चैट का प्रचार Plugin क्षमता
मेटाडेटा में नहीं किया गया है (यह केवल सीधे चैट घोषित करता है)।
...
WeChat का कोड OpenClaw की कोर रिपॉज़िटरी में नहीं रहता। OpenClaw सामान्य
चैनल Plugin अनुबंध प्रदान करता है और बाहरी Plugin
WeChat-विशिष्ट रनटाइम प्रदान करता है:

1. `openclaw plugins install`, `@tencent-weixin/openclaw-weixin` को इंस्टॉल करता है।
2. Gateway, Plugin मैनिफ़ेस्ट खोजता है और Plugin एंट्रीपॉइंट लोड करता है।
...
5. Plugin, खाता क्रेडेंशियल OpenClaw स्थिति डायरेक्टरी में संग्रहीत करता है
...
7. आने वाले WeChat संदेशों को चैनल अनुबंध के माध्यम से सामान्यीकृत किया जाता है, चयनित
   OpenClaw एजेंट को भेजा जाता है और Plugin के आउटबाउंड पथ के माध्यम से वापस भेजा जाता है।

यह पृथक्करण महत्वपूर्ण है: OpenClaw कोर चैनल-अज्ञेय रहता है। WeChat लॉगिन,
Tencent iLink API कॉल, मीडिया अपलोड/डाउनलोड, संदर्भ टोकन और खाता
...
अपने फ़ोन पर WeChat से QR कोड स्कैन करें और लॉगिन की पुष्टि करें। सफल स्कैन के
बाद Plugin खाता टोकन को स्थानीय रूप से सहेजता है।

दूसरा WeChat खाता जोड़ने के लिए वही लॉगिन कमांड फिर से चलाएँ। एकाधिक
खातों के लिए सीधे-संदेश सत्रों को खाते, चैनल और प्रेषक के अनुसार अलग रखें:
...
सीधे संदेश चैनल Plugins के लिए सामान्य OpenClaw पेयरिंग और अनुमति-सूची मॉडल
का उपयोग करते हैं।

नए प्रेषकों को स्वीकृति दें:
...
Plugin स्टार्टअप के समय होस्ट OpenClaw संस्करण की जाँच करता है।

| Plugin शृंखला | OpenClaw संस्करण                                                | npm टैग  |
| ----------- | --------------------------------------------------------------- | -------- |
| `2.x`       | `>=2026.5.12` (वर्तमान 2.4.6; शुरुआती 2.x ने `>=2026.3.22` स्वीकार किया था) | `latest` |
| `1.x`       | `>=2026.1.0 <2026.3.22`                                         | `legacy` |

यदि Plugin रिपोर्ट करता है कि आपका OpenClaw संस्करण बहुत पुराना है, तो या तो
...
Gateway प्रक्रिया को साफ़ करने का प्रयास कर सकती थी, जिससे systemd जैसे प्रक्रिया प्रबंधकों के अंतर्गत पुनः आरंभ चक्र उत्पन्न होते थे।

वर्तमान OpenClaw स्टार्टअप सफ़ाई में मौजूदा प्रक्रिया और उसके पूर्वज शामिल नहीं होते,
इसलिए कोई चैनल सहायक उसे शुरू करने वाले Gateway को समाप्त नहीं कर सकता। यह सुधार
सामान्य है; यह कोर में WeChat-विशिष्ट पथ नहीं है।
...
यदि चैनल इंस्टॉल दिखता है, लेकिन कनेक्ट नहीं होता, तो पुष्टि करें कि Plugin
सक्षम है और पुनः आरंभ करें:
...
यदि स्टार्टअप रिपोर्ट करता है कि इंस्टॉल किया गया Plugin पैकेज `requires compiled runtime
output for TypeScript entry`, तो npm पैकेज उन संकलित
JavaScript रनटाइम फ़ाइलों के बिना प्रकाशित हुआ था जिनकी OpenClaw को आवश्यकता है। Plugin
