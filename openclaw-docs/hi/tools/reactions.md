...
read_when:
    ...
    - विभिन्न प्लेटफ़ॉर्मों पर इमोजी प्रतिक्रियाओं के अंतर को समझना
summary: सभी समर्थित चैनलों में प्रतिक्रिया टूल के अर्थ-विज्ञान
title: प्रतिक्रियाएँ
x-i18n:
    generated_at: "2026-07-27T19:11:34Z"
    model: gpt-5.6
...
- किसी एक विशिष्ट इमोजी को हटाने के लिए `remove: true` सेट करें (गैर-रिक्त
  `emoji` आवश्यक है)।
- स्थिति प्रतिक्रियाओं वाले चैनलों पर, किसी प्रतिक्रिया में `trackToolCalls: true` होने से
  ...
  प्रतिक्रियाओं के लिए उस प्रतिक्रिया वाले संदेश का फिर से उपयोग कर सकता है।
...
<AccordionGroup>
  <Accordion title="Discord और Slack">
    ...
    - `remove: true` केवल निर्दिष्ट इमोजी हटाता है।

  </Accordion>

  <Accordion title="Nextcloud Talk">
    - केवल प्रतिक्रियाएँ जोड़ना: `emoji` आवश्यक है और गैर-रिक्त होना चाहिए।
    - प्रतिक्रिया हटाना अभी डिलीट कॉल से जुड़ा नहीं है; चुपचाप कोई कार्रवाई न करने के बजाय `remove: true` को स्पष्ट त्रुटि के साथ अस्वीकार किया जाता है।
  ...
  <Accordion title="WhatsApp">
    ...
    - `remove: true` को आंतरिक रूप से रिक्त इमोजी में मैप किया जाता है (टूल कॉल में फिर भी `emoji` आवश्यक है)।
    - WhatsApp में प्रत्येक संदेश के लिए बॉट प्रतिक्रिया का एक स्लॉट होता है; नई प्रतिक्रिया भेजने पर वह कई इमोजी एकत्रित करने के बजाय मौजूदा प्रतिक्रिया को बदल देती है।
  ...
  <Accordion title="Feishu/Lark">
    - यह अलग टूल के बजाय अन्य चैनलों जैसी ही `react` कार्रवाई का उपयोग करता है (संदेश प्रतिक्रिया आईडी के माध्यम से जोड़ना/हटाना/सूचीबद्ध करना)।
    - जोड़ने के लिए गैर-रिक्त `emoji` आवश्यक है (इसे Feishu `emoji_type` में मैप किया जाता है, जैसे `SMILE`, `THUMBSUP`, `HEART`)।
  ...
  <Accordion title="Signal">
    - आने वाली प्रतिक्रिया सूचनाएँ `channels.signal.reactionNotifications` द्वारा नियंत्रित होती हैं: `"off"` उन्हें अक्षम करता है, `"own"` (डिफ़ॉल्ट) तब इवेंट उत्सर्जित करता है जब उपयोगकर्ता बॉट संदेशों पर प्रतिक्रिया देते हैं, `"all"` सभी प्रतिक्रियाओं के लिए इवेंट उत्सर्जित करता है, और `"allowlist"` केवल `channels.signal.reactionAllowlist` में मौजूद प्रेषकों के लिए इवेंट उत्सर्जित करता है।

  </Accordion>

  <Accordion title="iMessage">
    - बाहर भेजी जाने वाली प्रतिक्रियाएँ iMessage टैपबैक हैं (`love`, `like`, `dislike`, `laugh`, `emphasize`, और `question`); प्रतिक्रिया जोड़ने के लिए `emoji` को इनमें से किसी एक प्रकार से मैप होना चाहिए।
...
प्रति-चैनल `reactionLevel` यह सीमित करता है कि एजेंट अपनी प्रतिक्रियाएँ कितनी बार भेजता है।
मान: `off`, `ack`, `minimal`, या `extensive`।
