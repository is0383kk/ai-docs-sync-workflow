...
read_when:
    ...
    - आपको यह समझना होगा कि Tokenjuice क्या बदलता है और किसे अपरिवर्तित छोड़ता है
summary: वैकल्पिक Tokenjuice Plugin के साथ शोरपूर्ण exec और bash टूल परिणामों को संक्षिप्त करें
title: Tokenjuice
x-i18n:
    generated_at: "2026-07-27T19:12:46Z"
    model: gpt-5.6
...
दोबारा नहीं लिखता, कमांड को फिर से नहीं चलाता और एग्ज़िट कोड नहीं बदलता।

फ़िलहाल यह Codex ऐप-सर्वर हार्नेस में OpenClaw एम्बेडेड रन और OpenClaw डायनेमिक टूल पर लागू होता है।
Tokenjuice, OpenClaw के टूल-परिणाम मिडलवेयर से जुड़ता है और आउटपुट के सक्रिय हार्नेस
सत्र में वापस जाने से पहले उसे छोटा करता है।
...
यदि आप कॉन्फ़िगरेशन को सीधे संपादित करना पसंद करते हैं:
...
- सत्र में वापस भेजे जाने से पहले शोरपूर्ण `exec` और `bash` परिणामों को संक्षिप्त करता है।
...
- वैकल्पिक बना रहता है: यदि आप हर जगह शब्दशः आउटपुट चाहते हैं, तो Plugin अक्षम करें।

## सत्यापित करें कि यह काम कर रहा है

1. Plugin सक्षम करें।
2. ऐसा सत्र शुरू करें जो `exec` को कॉल कर सके।
3. `git status` जैसा कोई शोरपूर्ण कमांड चलाएँ।
