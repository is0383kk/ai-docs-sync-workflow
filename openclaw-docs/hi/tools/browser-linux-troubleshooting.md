...
x-i18n:
    generated_at: "2026-07-27T21:46:24Z"
    model: gpt-5.6
...
Ubuntu और अधिकांश Linux डिस्ट्रो पर, `apt install chromium` वास्तविक ब्राउज़र नहीं, बल्कि snap
...
Snap का AppArmor परिसीमन OpenClaw द्वारा ब्राउज़र प्रक्रिया शुरू करने और उसकी निगरानी करने के
तरीके में हस्तक्षेप करता है।
...
- `The profile appears to be in use by another Chromium process`: प्रबंधित प्रोफ़ाइल डायरेक्टरी में पुरानी
  ...
  अलग होस्ट की प्रक्रिया की ओर संकेत करता है, तो OpenClaw इन लॉक को हटाकर एक बार
  फिर प्रयास करता है।
- `Missing X server or $DISPLAY`: डेस्कटॉप सत्र के बिना किसी होस्ट पर दृश्यमान ब्राउज़र का स्पष्ट रूप से अनुरोध
  किया गया था। जब `DISPLAY` और `WAYLAND_DISPLAY` दोनों सेट नहीं होते, तो Linux पर स्थानीय प्रबंधित प्रोफ़ाइल
  हेडलेस मोड पर वापस चली जाती हैं।
  यदि आपने `OPENCLAW_BROWSER_HEADLESS=0`, `browser.headless: false`, या
  `browser.profiles.<name>.headless: false` सेट किया है, तो उस हेडेड ओवरराइड को हटाएँ, या
  `OPENCLAW_BROWSER_HEADLESS=1` सेट करें, `Xvfb` शुरू करें, एक बार के प्रबंधित लॉन्च के लिए
  `openclaw browser start --headless` चलाएँ, अथवा
...
वैकल्पिक रूप से, इसे systemd उपयोगकर्ता सेवा से स्वतः शुरू करें:
...
| `browser.executablePath`    | Chromium-आधारित ब्राउज़र बाइनरी का पथ (Chrome/Brave/Edge/Chromium) | स्वतः पता लगाया जाता है (यदि OS का डिफ़ॉल्ट ब्राउज़र Chromium-आधारित हो, तो उसे प्राथमिकता दी जाती है) |
...
एंडपॉइंट उपलब्ध कराने या तैयार होने में प्रबंधित-ब्राउज़र की समय-सीमा से अधिक समय लगता है, तो `attachOnly` के साथ मैन्युअल रूप से लॉन्च किए गए
ब्राउज़र का उपयोग करें।

### समस्या: profile="user" के लिए कोई Chrome टैब नहीं मिला

आप `user` (`existing-session` / Chrome MCP) प्रोफ़ाइल का उपयोग कर रहे हैं और अटैच होने के लिए कोई
टैब खुला नहीं है।
...
2. स्थानीय Chrome को कम-से-कम एक खुले टैब के साथ चालू रखें, फिर
   `--browser-profile user` के साथ पुनः प्रयास करें।

टिप्पणियाँ:

- `user` केवल होस्ट के लिए है। Linux सर्वर, कंटेनर या रिमोट होस्ट पर इसके बजाय
  CDP प्रोफ़ाइल को प्राथमिकता दें।
- `user` और अन्य `existing-session` प्रोफ़ाइल वर्तमान Chrome MCP
  सीमाएँ साझा करती हैं: केवल संदर्भ-संचालित क्रियाएँ, प्रति अपलोड एक फ़ाइल, कोई डायलॉग `timeoutMs`
  ओवरराइड नहीं, कोई `wait --load networkidle` नहीं, और कोई `responsebody`, PDF निर्यात,
  डाउनलोड इंटरसेप्शन या बैच क्रियाएँ नहीं।
- स्थानीय `openclaw`-ड्राइवर प्रोफ़ाइल स्वतः `cdpPort`/`cdpUrl` असाइन करती हैं; इन्हें केवल
  रिमोट CDP के लिए मैन्युअल रूप से सेट करें।
- रिमोट CDP प्रोफ़ाइल `http://`, `https://`, `ws://`, और `wss://` स्वीकार करती हैं।
  ...
  सेवा आपको प्रत्यक्ष DevTools सॉकेट URL देती है, तब WS(S) का उपयोग करें।
