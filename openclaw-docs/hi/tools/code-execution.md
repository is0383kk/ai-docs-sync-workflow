...
summary: 'code_execution: xAI के साथ सैंडबॉक्स किए गए रिमोट Python विश्लेषण को चलाएँ'
title: कोड निष्पादन
x-i18n:
    generated_at: "2026-07-27T18:40:29Z"
    model: gpt-5.6
...
`code_execution` xAI के Responses API पर सैंडबॉक्सयुक्त रिमोट Python विश्लेषण चलाता है
...
<Warning>
  ...
  और साथ में मॉडल के इनपुट तथा आउटपुट टोकन का शुल्क लेता है।
</Warning>
...
स्थानीय फ़ाइलों, आपके शेल, आपके रेपो या युग्मित डिवाइसों तक कोई
पहुँच नहीं है, और यह कॉल के बीच स्थिति को बनाए नहीं रखता, इसलिए प्रत्येक कॉल को क्षणिक विश्लेषण मानें,
न कि नोटबुक सत्र। नवीनतम X डेटा के लिए, पहले [`x_search`](/hi/tools/web#x_search)
चलाएँ और परिणाम को इसमें पाइप करें।
...
<Steps>
  <Step title="xAI क्रेडेंशियल प्रदान करें">
    OAuth के लिए योग्य SuperGrok या X Premium सदस्यता आवश्यक है
    (डिवाइस-कोड सत्यापन, इसलिए यह localhost कॉलबैक के बिना रिमोट होस्ट से
    काम करता है):
    ...
    इन तीनों में से कोई भी `x_search` और Grok `web_search` को भी संचालित करता है।

  </Step>

  <Step title="code_execution सक्षम और अनुकूलित करें">
    `enabled` को छोड़ देने पर, `code_execution` केवल तभी उपलब्ध कराया जाता है जब सक्रिय
    मॉडल का प्रदाता `xai` हो और xAI क्रेडेंशियल उपलब्ध हों। ज्ञात गैर-xAI प्रदाता वाले सक्रिय मॉडल
    के लिए, क्रॉस-प्रदाता उपयोग को स्वीकार करने हेतु
    `plugins.entries.xai.config.codeExecution.enabled` को `true` पर सेट करें।
    यदि सक्रिय मॉडल प्रदाता अनुपस्थित है या उसका समाधान नहीं हो पाता,
    तो टूल छिपा रहता है। इसे प्रत्येक प्रदाता के लिए अक्षम करने हेतु `enabled` को `false` पर सेट करें।
  ...
  <Step title="Gateway पुनः आरंभ करें">
    ...
    xAI Plugin के पुनः पंजीकृत होने और ऊपर दिए गए प्रदाता, सक्षमता तथा प्रमाणीकरण जाँचों के सफल होने पर
    `code_execution` एजेंट की टूल सूची में दिखाई देता है।
...
विश्लेषण के उद्देश्य को स्पष्ट बनाएँ; टूल एकल `task` पैरामीटर लेता है,
इसलिए पूरा अनुरोध और कोई भी इनलाइन डेटा एक ही प्रॉम्प्ट में भेजें:

```text
इन संख्याओं के लिए 7-दिवसीय मूविंग एवरेज की गणना करने हेतु code_execution का उपयोग करें: ...
```

```text
इस सप्ताह OpenClaw का उल्लेख करने वाली पोस्ट खोजने हेतु x_search का उपयोग करें, फिर उन्हें दिन के अनुसार गिनने हेतु code_execution का उपयोग करें।
```

```text
नवीनतम AI बेंचमार्क संख्याएँ एकत्र करने हेतु web_search का उपयोग करें, फिर प्रतिशत परिवर्तनों की तुलना करने हेतु code_execution का उपयोग करें।
```
