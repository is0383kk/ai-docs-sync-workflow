...
read_when:
    ...
    - आप अपने VPS पर उत्पादन-स्तरीय, हमेशा चालू रहने वाला Gateway चाहते हैं
...
summary: टिकाऊ स्थिति और पहले से शामिल बाइनरी के साथ सस्ते Hetzner VPS (Docker) पर OpenClaw Gateway 24/7 चलाएँ
title: Hetzner
x-i18n:
    generated_at: "2026-07-27T19:51:47Z"
    model: gpt-5.6
...
यह मार्गदर्शिका Hetzner पर Ubuntu या Debian मानकर चलती है। किसी अन्य Linux VPS पर पैकेजों को उसके अनुसार मैप करें। सामान्य Docker प्रवाह के लिए [Docker](/hi/install/docker) देखें।
...
<Steps>
  ...
  <Step title="स्थायी होस्ट डायरेक्टरी बनाएँ">
    ...
    # स्वामित्व कंटेनर उपयोगकर्ता (uid 1000) को दें:
    ...
    services:
      openclaw-gateway:
        ...
        ports:
          ...
          # इसे सार्वजनिक रूप से उजागर करने के लिए `127.0.0.1:` उपसर्ग हटाएँ और उसके अनुसार फ़ायरवॉल कॉन्फ़िगर करें।
