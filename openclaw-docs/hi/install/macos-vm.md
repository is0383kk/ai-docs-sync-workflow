...
read_when:
    ...
    - आप एक रीसेट की जा सकने वाली macOS परिवेश चाहते हैं जिसे आप क्लोन कर सकें
    - आप स्थानीय बनाम होस्ट किए गए macOS VM विकल्पों की तुलना करना चाहते हैं
summary: जब आपको आइसोलेशन या iMessage की आवश्यकता हो, तो OpenClaw को सैंडबॉक्स किए गए macOS VM (स्थानीय या होस्ट किए गए) में चलाएँ
title: macOS वर्चुअल मशीनें
x-i18n:
    generated_at: "2026-07-27T18:28:09Z"
    model: gpt-5.6
...
- यदि आप पूर्ण नियंत्रण और ब्राउज़र ऑटोमेशन के लिए **आवासीय IP** चाहते हैं, तो **समर्पित हार्डवेयर** (Mac mini या Linux बॉक्स)। कई साइटें डेटा सेंटर IP को ब्लॉक करती हैं, इसलिए स्थानीय ब्राउज़िंग अक्सर बेहतर काम करती है।
- **हाइब्रिड**: Gateway को सस्ते VPS पर रखें और जब आपको ब्राउज़र/UI ऑटोमेशन की आवश्यकता हो, तब अपने Mac को **Node** के रूप में कनेक्ट करें। [Nodes](/hi/nodes) और [Gateway रिमोट](/hi/gateway/remote) देखें।

macOS VM का उपयोग केवल तभी करें, जब आपको विशेष रूप से iMessage जैसी केवल macOS पर उपलब्ध क्षमताओं की आवश्यकता हो या आप अपने दैनिक उपयोग वाले Mac से पूर्ण अलगाव चाहते हों।

## macOS VM विकल्प

### आपके Apple Silicon Mac पर स्थानीय VM (Lume)

[Lume](https://cua.ai/docs/lume) का उपयोग करके अपने मौजूदा Apple Silicon Mac पर सैंडबॉक्स किए गए macOS VM में OpenClaw चलाएँ। इससे आपको ये सुविधाएँ मिलती हैं:

- अलगाव में पूर्ण macOS परिवेश (आपका होस्ट साफ़ रहता है)
- `imsg` के माध्यम से iMessage समर्थन; डिफ़ॉल्ट स्थानीय पथ Linux/Windows पर संभव नहीं है
- VM क्लोन करके तुरंत रीसेट
...
macOS VM का SSH एक्सेस मिलने के बाद, नीचे दिए गए [OpenClaw इंस्टॉल करें](#6-install-openclaw) से आगे बढ़ें।
...
- प्रत्येक VM के लिए ~60 GB खाली डिस्क स्थान
- ~20 मिनट
...
यह macOS डाउनलोड करता है और VM बनाता है। एक VNC विंडो अपने-आप खुलती है।
...
2. Apple ID छोड़ दें (या यदि आप बाद में iMessage चाहते हैं, तो साइन इन करें)।
3. एक उपयोगकर्ता खाता बनाएँ (उपयोगकर्ता नाम और पासवर्ड याद रखें)।
4. सभी वैकल्पिक सुविधाएँ छोड़ दें।

सेटअप पूरा होने के बाद:

1. SSH सक्षम करें: System Settings -> General -> Sharing में जाकर "Remote Login" सक्षम करें।
2. हेडलेस VM उपयोग के लिए ऑटो-लॉगिन सक्षम करें: System Settings -> Users & Groups में "Automatically log in as:" चुनें और VM उपयोगकर्ता को चुनें।
...
IP पता खोजें (आमतौर पर `192.168.64.x`)।
...
2. `imsg` इंस्टॉल करें।
3. OpenClaw/`imsg` चलाने वाली प्रक्रिया को Full Disk Access और Automation अनुमति दें।
...
Gateway पुनः आरंभ करें। आपका एजेंट अब iMessages भेज और प्राप्त कर सकता है। सेटअप का पूरा विवरण: [iMessage चैनल](/hi/channels/imessage)।

## गोल्डन इमेज सहेजें

आगे अनुकूलन करने से पहले अपनी साफ़ स्थिति का स्नैपशॉट लें:
...
- अपने Mac को बिजली से जुड़ा रखें
- System Settings -> Energy Saver में स्लीप अक्षम करें
- आवश्यकता होने पर `caffeinate` का उपयोग करें

वास्तव में हमेशा चालू रखने के लिए, समर्पित Mac mini या छोटे VPS पर विचार करें। [VPS होस्टिंग](/hi/vps) देखें।

## समस्या निवारण

| समस्या                  | समाधान                                                                            |
| ------------------------ | ----------------------------------------------------------------------------------- |
| VM में SSH से कनेक्ट नहीं हो पा रहा | जाँचें कि VM की System Settings में "Remote Login" सक्षम है                         |
| VM का IP दिखाई नहीं दे रहा        | VM के पूरी तरह बूट होने की प्रतीक्षा करें, फिर `lume get openclaw` दोबारा चलाएँ                            |
| Lume कमांड नहीं मिली   | `~/.local/bin` को अपने PATH में जोड़ें                                                     |
...
- [Lume त्वरित शुरुआत](https://cua.ai/docs/lume/guide/getting-started/quickstart)
...
- [Docker सैंडबॉक्सिंग](/hi/install/docker) (वैकल्पिक अलगाव तरीका)
