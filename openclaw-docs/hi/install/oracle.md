...
read_when:
    ...
    - एक छोटे सर्वर पर 24/7 OpenClaw चाहते हैं
summary: Oracle Cloud के Always Free ARM टियर पर OpenClaw होस्ट करें
title: Oracle Cloud
x-i18n:
    generated_at: "2026-07-27T18:29:23Z"
    model: gpt-5.6
...
- Oracle Cloud खाता ([साइन अप](https://www.oracle.com/cloud/free/)) -- यदि समस्याएँ आएँ, तो [समुदाय साइनअप गाइड](https://gist.github.com/rssnyder/51e3cfedd730e7dd5f4a816143b25dbd) देखें
...
<Steps>
  ...
  <Step title="VCN सुरक्षा सुदृढ़ करें">
...
- [Tailscale admin console](https://login.tailscale.com/admin) में डिवाइसों की समय-समय पर समीक्षा करें।
...
# वैकल्पिक: Tailscale SSH के ठीक से काम करने की पुष्टि होने के बाद sshd को पूरी तरह अक्षम करें
