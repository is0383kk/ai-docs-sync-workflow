...
title: LongCat
x-i18n:
    generated_at: "2026-07-27T18:25:55Z"
    model: gpt-5.6
...
कोडिंग और एजेंटिक कार्यभारों के लिए बनाया गया एक रीजनिंग मॉडल है। OpenClaw, LongCat के OpenAI-संगत एंडपॉइंट के लिए
आधिकारिक `longcat` plugin प्रदान करता है।

| गुण         | मान                                |
| ----------- | ---------------------------------- |
| प्रदाता     | `longcat`                 |
| प्रमाणीकरण  | `LONGCAT_API_KEY`                 |
| API         | OpenAI-संगत चैट कम्प्लीशन्स        |
...
आधिकारिक पैकेज इंस्टॉल करें, फिर Gateway पुनः आरंभ करें:
...
यदि कोई प्राथमिक मॉडल पहले से कॉन्फ़िगर नहीं है, तो ऑनबोर्डिंग होस्टेड कैटलॉग जोड़ती है और
`longcat/LongCat-2.0` चुनती है।
...
LongCat, `reasoning_content` में रीजनिंग लौटाता है। सहायक के टूल-कॉल टर्न दोबारा चलाते समय
OpenClaw उस फ़ील्ड को बनाए रखता है, ताकि बहु-टर्न एजेंट सत्रों में
प्रदाता की अपेक्षित संदेश संरचना बनी रहे।

## मूल्य निर्धारण

अंतर्निहित कैटलॉग प्रति दस लाख टोकन के लिए LongCat की उपयोग-के-अनुसार-भुगतान वाली USD सूची कीमतों का उपयोग करता है:
अनकैश्ड इनपुट के लिए $0.75, कैश्ड इनपुट के लिए $0.015 और आउटपुट के लिए $2.95। LongCat
अस्थायी छूट दे सकता है; [मूल्य निर्धारण पृष्ठ](https://longcat.chat/platform/docs/Pricing/LongCat-2.0.html)
...
<AccordionGroup>
  <Accordion title="कुंजी शेल में काम करती है, लेकिन Gateway में नहीं">
    डेमन-प्रबंधित Gateway प्रक्रियाएँ प्रत्येक इंटरैक्टिव शेल
    वेरिएबल को इनहेरिट नहीं करतीं। `LONGCAT_API_KEY` को `~/.openclaw/.env` में रखें, इसे
    ऑनबोर्डिंग के माध्यम से कॉन्फ़िगर करें या किसी अनुमोदित सीक्रेट संदर्भ का उपयोग करें।
  </Accordion>
  ...
  <Accordion title="अनुरोध 402 या 429 के साथ विफल होते हैं">
    ...
    कुंजी ने दर सीमा छू ली है। [LongCat उपयोग](https://longcat.chat/platform/usage)
    जाँचें और प्रदाता की बैकऑफ़ अवधि के बाद दर-सीमित अनुरोधों को पुनः आज़माएँ।
  </Accordion>
...
<CardGroup cols={2}>
  ...
  <Card title="सीक्रेट" href="/hi/gateway/secrets" icon="key">
    कॉन्फ़िगरेशन में प्लेनटेक्स्ट एम्बेड किए बिना प्रदाता क्रेडेंशियल संग्रहीत करें।
  </Card>
</CardGroup>
