...
x-i18n:
    generated_at: "2026-07-27T21:37:54Z"
    model: gpt-5.6
...
| API           | Anthropic Messages के साथ संगत         |
| आधार URL      | `https://ai-gateway.vercel.sh`         |
...
`openclaw models list --provider vercel-ai-gateway` दोनों में `vercel-ai-gateway/openai/gpt-5.5` और
`vercel-ai-gateway/moonshotai/kimi-k2.6` जैसे वर्तमान मॉडल
रेफ़ शामिल होते हैं।
</Tip>
...
`anthropic/...` रेफ़ को स्वचालित रूप से हल करता है।
</Tip>
...
<AccordionGroup>
  <Accordion title="डेमन प्रक्रियाओं के लिए पर्यावरण चर">
    ...
    `AI_GATEWAY_API_KEY` उस प्रक्रिया के लिए उपलब्ध है।

    <Warning>
    केवल संवादात्मक शेल में एक्सपोर्ट की गई कुंजी launchd/systemd डेमन को तब तक
    दिखाई नहीं देगी, जब तक उस पर्यावरण को स्पष्ट रूप से इम्पोर्ट न किया जाए। यह सुनिश्चित
    करने के लिए कि Gateway प्रक्रिया कुंजी पढ़ सके, कुंजी को `~/.openclaw/.env` में या
    `env.shellEnv` के माध्यम से सेट करें।
    </Warning>

  </Accordion>

  <Accordion title="प्रदाता रूटिंग">
    Vercel AI Gateway प्रत्येक अनुरोध को मॉडल रेफ़ उपसर्ग में नामित अपस्ट्रीम प्रदाता तक
    रूट करता है। उदाहरण के लिए, `vercel-ai-gateway/anthropic/claude-opus-4.6`
    Anthropic के माध्यम से रूट होता है, `vercel-ai-gateway/openai/gpt-5.5`
    OpenAI के माध्यम से रूट होता है, और `vercel-ai-gateway/moonshotai/kimi-k2.6`
    MoonshotAI के माध्यम से रूट होता है। एक `AI_GATEWAY_API_KEY` सभी अपस्ट्रीम प्रदाताओं को प्रमाणित करता है।
  </Accordion>
  <Accordion title="विचार स्तर">
    जब OpenClaw अपस्ट्रीम मॉडल उपसर्ग को पहचानता है, तो `/think` विकल्प
    उसका अनुसरण करते हैं। `vercel-ai-gateway/anthropic/...` Claude विचार प्रोफ़ाइल का उपयोग करता है,
    जिसमें Claude 4.6 मॉडल के लिए अनुकूली डिफ़ॉल्ट शामिल है। विश्वसनीय
    `vercel-ai-gateway/openai/...` रेफ़ (`gpt-5.2` और नए, साथ ही
    `gpt-5.1-codex` तक के Codex संस्करण) `/think xhigh` उपलब्ध कराते हैं। अन्य नेमस्पेसयुक्त
    रेफ़ मानक तर्क स्तर बनाए रखते हैं, जब तक उनका कैटलॉग मेटाडेटा अधिक स्तर
    घोषित न करे।
  </Accordion>
</AccordionGroup>
