...
read_when:
    ...
    - आप Voice Call या Google Meet के लिए ElevenLabs रीयल-टाइम ट्रांसक्रिप्शन चाहते हैं
summary: OpenClaw के साथ ElevenLabs वॉइस, Scribe STT और रीयल-टाइम ट्रांसक्रिप्शन का उपयोग करें
title: ElevenLabs
x-i18n:
...
और Scribe v2 Realtime के साथ स्ट्रीमिंग STT का उपयोग करता है। Plugin बंडल किया गया है और
डिफ़ॉल्ट रूप से सक्षम है; किसी `plugins install` चरण की आवश्यकता नहीं है।

| क्षमता                   | OpenClaw सतह                                                          | डिफ़ॉल्ट                 |
| ------------------------ | -------------------------------------------------------------------- | ------------------------ |
| टेक्स्ट-टू-स्पीच         | `tts` / `talk`                                                       | `eleven_multilingual_v2` |
...
इंस्टॉलेशन के लिए `eleven_multilingual_v2` को डिफ़ॉल्ट बनाए रखता है।

जब ElevenLabs चयनित `voice.tts`/`tts` प्रदाता होता है, तब Discord वॉइस चैनल
ElevenLabs के स्ट्रीमिंग TTS एंडपॉइंट का उपयोग करते हैं: OpenClaw द्वारा पहले पूरी
ऑडियो फ़ाइल डाउनलोड किए जाने की प्रतीक्षा करने के बजाय, लौटाई गई ऑडियो स्ट्रीम से प्लेबैक शुरू हो जाता है।
इसे स्वीकार करने वाले मॉडल के लिए `latencyTier`, ElevenLabs के `optimize_streaming_latency`
क्वेरी पैरामीटर से मैप होता है; `eleven_v3` के लिए OpenClaw उस पैरामीटर को छोड़ देता है,
क्योंकि वह इसे अस्वीकार करता है।

## स्पीच-टू-टेक्स्ट

इनबाउंड ऑडियो अटैचमेंट और छोटे रिकॉर्ड किए गए वॉइस खंडों के लिए Scribe v2 का उपयोग करें:
...
OpenClaw `model_id: "scribe_v2"` के साथ ElevenLabs `/v1/speech-to-text` पर
मल्टीपार्ट ऑडियो भेजता है। उपलब्ध होने पर भाषा संकेत `language_code` से मैप होते हैं।

## स्ट्रीमिंग STT

बंडल किया गया `elevenlabs` Plugin, Voice Call और Google Meet एजेंट-मोड स्ट्रीमिंग ट्रांसक्रिप्शन के लिए
Scribe v2 Realtime को पंजीकृत करता है।
...
<Note>
Voice Call, Twilio मीडिया को 8 kHz G.711 u-law के रूप में प्राप्त करता है। ElevenLabs रियलटाइम
...
`plugins.entries.google-meet.config.realtime.providers.elevenlabs` के अंतर्गत उसी प्रदाता ब्लॉक को कॉन्फ़िगर करें।
