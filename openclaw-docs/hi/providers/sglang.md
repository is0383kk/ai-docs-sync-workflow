...
summary: OpenClaw को SGLang के साथ चलाएँ (OpenAI-संगत स्व-होस्टेड सर्वर)
title: SGLang
x-i18n:
    generated_at: "2026-07-27T18:32:04Z"
    model: gpt-5.6
...
SGLang, OpenAI-संगत HTTP API के माध्यम से ओपन-वेट मॉडल उपलब्ध कराता है। OpenClaw, उपलब्ध मॉडलों की स्वतः खोज के साथ `openai-completions` प्रोवाइडर फ़ैमिली का उपयोग करके SGLang से जुड़ता है।
...
जब आप `SGLANG_API_KEY` के साथ ऑप्ट इन करते हैं, तो OpenClaw SGLang से उपलब्ध मॉडलों की **स्वतः खोज** भी करता है। कस्टम SGLang बेस URL कॉन्फ़िगर करते समय खोज को डायनेमिक बनाए रखने के लिए `agents.defaults.models` में `sglang/*` का उपयोग करें। नीचे [मॉडल खोज (अंतर्निहित प्रोवाइडर)](#model-discovery-implicit-provider) देखें।
...
`models.providers.sglang` को परिभाषित **नहीं** करते हैं, तो OpenClaw यह क्वेरी करता है:
...
मॉडलों का उपयोग करता है। जब आप चाहते हैं कि OpenClaw उस कॉन्फ़िगर किए गए प्रोवाइडर के
`/models` एंडपॉइंट को क्वेरी करे और सभी विज्ञापित SGLang मॉडल शामिल करे, तब
`agents.defaults.models` में `"sglang/*": {}` जोड़ें।
</Note>
...
- आप `contextWindow`/`maxTokens` मान नियत करना चाहते हों।
...
<AccordionGroup>
  <Accordion title="प्रॉक्सी-जैसा व्यवहार">
    SGLang को मूल OpenAI एंडपॉइंट के बजाय प्रॉक्सी-जैसे OpenAI-संगत
    `/v1` बैकएंड के रूप में माना जाता है।

    | व्यवहार | SGLang |
    |----------|--------|
    | केवल OpenAI के लिए अनुरोध संरचना | लागू नहीं |
    | `service_tier`, Responses `store`, प्रॉम्प्ट-कैश संकेत | नहीं भेजे जाते |
  ...
  <Accordion title="समस्या निवारण">
    ...
    **प्रमाणीकरण त्रुटियाँ**
    ...
    यदि प्रमाणीकरण त्रुटियों के कारण अनुरोध विफल होते हैं, तो अपने सर्वर कॉन्फ़िगरेशन से मेल खाने वाला वास्तविक
    `SGLANG_API_KEY` सेट करें या `models.providers.sglang` के अंतर्गत प्रोवाइडर को
    स्पष्ट रूप से कॉन्फ़िगर करें।

    <Tip>
    यदि आप SGLang को प्रमाणीकरण के बिना चलाते हैं, तो मॉडल खोज में ऑप्ट इन करने के लिए
...
<CardGroup cols={2}>
  ...
  <Card title="कॉन्फ़िगरेशन संदर्भ" href="/hi/gateway/configuration-reference" icon="gear">
    प्रोवाइडर प्रविष्टियों सहित पूर्ण कॉन्फ़िगरेशन स्कीमा।
  </Card>
</CardGroup>
