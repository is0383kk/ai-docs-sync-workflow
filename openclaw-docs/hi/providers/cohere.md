...
read_when:
    ...
    - आपको Cohere API कुंजी के लिए env var या CLI प्रमाणीकरण विकल्प चाहिए
summary: Cohere सेटअप (प्रमाणीकरण + मॉडल चयन)
title: Cohere
x-i18n:
    generated_at: "2026-07-27T18:27:09Z"
    model: gpt-5.6
...
[Cohere](https://cohere.com) अपने Compatibility API के माध्यम से OpenAI-संगत इन्फ़रेंस प्रदान करता है। OpenClaw, Cohere प्रदाता के बाह्यकरण संक्रमण के दौरान उसे बंडल करता है और इसे एक आधिकारिक बाहरी Plugin के रूप में भी प्रकाशित करता है।
...
| `cohere/command-a-vision-07-2025`    | टेक्स्ट, इमेज | 128,000 | 8,000      | विज़न और दस्तावेज़ विश्लेषण; टूल का उपयोग नहीं |
| `cohere/north-mini-code-1-0`         | टेक्स्ट, इमेज | 256,000 | 64,000     | एजेंटिक कोडिंग; रीजनिंग; निःशुल्क सीमाएँ     |

रीजनिंग-सक्षम Cohere मॉडल दो Compatibility API रीजनिंग मोड का समर्थन करते हैं। OpenClaw **बंद** को `none` और प्रत्येक सक्षम चिंतन स्तर को `high` से मैप करता है। Command A Vision टूल के उपयोग का समर्थन नहीं करता, इसलिए OpenClaw उस मॉडल के लिए एजेंट टूल अक्षम रखता है।

## शुरू करें

1. Cohere वर्तमान OpenClaw पैकेजों के साथ आता है। यदि यह मौजूद नहीं है, तो बाहरी पैकेज इंस्टॉल करें और Gateway को पुनः आरंभ करें:
...
ऑनबोर्डिंग Cohere को प्राथमिक मॉडल के रूप में केवल तभी सेट करती है, जब कोई प्राथमिक मॉडल पहले से कॉन्फ़िगर न हो।

## केवल परिवेश द्वारा सेटअप
...
<Note>
यदि Gateway डेमन के रूप में या Docker में चलता है, तो उस सेवा के लिए `COHERE_API_KEY` सेट करें। इसे केवल इंटरैक्टिव शेल में निर्यात करने से यह पहले से चल रहे Gateway के लिए उपलब्ध नहीं होता।
</Note>
