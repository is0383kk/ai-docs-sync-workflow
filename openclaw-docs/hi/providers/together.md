...
title: Together AI
x-i18n:
    generated_at: "2026-07-27T20:26:14Z"
    model: gpt-5.6
...
| मॉडल संदर्भ                                          | नाम                         | इनपुट       | संदर्भ | अधिकतम आउटपुट | लागत (इन/आउट) | टिप्पणियाँ               |
| -------------------------------------------------- | ---------------------------- | ----------- | ------- | ---------- | ------------- | ------------------- |
...
| `together/moonshotai/Kimi-K2.6`                    | Kimi K2.6 FP4                | टेक्स्ट, छवि | 262,144 | 32,768     | 1.20 / 4.50   | रीजनिंग मॉडल     |
...
`video_generate` टूल के माध्यम से वीडियो जनरेशन को भी पंजीकृत करता है।

| गुण             | मान                                                                                     |
| -------------------- | ----------------------------------------------------------------------------------------- |
| डिफ़ॉल्ट वीडियो मॉडल  | `Wan-AI/Wan2.2-T2V-A14B`                                                                  |
| अन्य मॉडल         | `Wan-AI/Wan2.2-I2V-A14B`, `minimax/hailuo-02`, `kwaivgI/kling-2.1-master`                 |
| मोड                | टेक्स्ट-से-वीडियो; केवल `Wan-AI/Wan2.2-I2V-A14B` के साथ छवि-से-वीडियो (एक संदर्भ छवि) |
| अवधि             | 1-10 सेकंड                                                                              |
| समर्थित पैरामीटर | `size` (`<width>x<height>` के रूप में पार्स किया गया); `aspectRatio`/`resolution` को नहीं पढ़ा जाता            |
...
<AccordionGroup>
  <Accordion title="एनवायरनमेंट संबंधी टिप्पणी">
    ...
    <Warning>
    केवल आपके इंटरैक्टिव शेल में सेट की गई कुंजियाँ डेमन द्वारा प्रबंधित
