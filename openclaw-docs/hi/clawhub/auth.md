...
x-i18n:
    generated_at: "2026-07-27T18:58:40Z"
    model: gpt-5.6
...
यदि साइन-इन करने के बाद आप फिर से लॉग-आउट स्थिति में पहुँच जाते हैं, तो संभव है कि आपका खाता अच्छी स्थिति में न हो। यदि आपका खाता प्रतिबंधित या अक्षम कर दिया गया था और आपको लगता है कि यह एक गलती है, तो
...
5. CLI टोकन को आपकी ClawHub कॉन्फ़िगरेशन फ़ाइल में संग्रहीत करता है।
...
ClawHub वेब UI में एक टोकन बनाएँ, फिर उसे CLI को प्रदान करें:
...
ऐसे रिमोट शेल के लिए, जहाँ आप किसी दूसरी जगह ब्राउज़र खोल सकते हैं, यह चलाएँ:

```bash
clawhub login --device
```

CLI एक बार उपयोग होने वाला कोड दिखाता है और तब तक प्रतीक्षा करता है, जब तक आप इसे
`https://clawhub.ai/cli/device` पर अधिकृत नहीं कर देते।

## टोकन संग्रहण

डिफ़ॉल्ट कॉन्फ़िगरेशन पथ:

- macOS: `~/Library/Application Support/clawhub/config.json`
- Linux/XDG: `$XDG_CONFIG_HOME/clawhub/config.json` या `~/.config/clawhub/config.json`
- Windows: `%APPDATA%\\clawhub\\config.json`

इससे पथ को ओवरराइड करें:

```bash
export CLAWHUB_CONFIG_PATH=/path/to/config.json
```

CI सेटअप के लिए संग्रहीत टोकन को प्रिंट करने हेतु यह चलाएँ:
