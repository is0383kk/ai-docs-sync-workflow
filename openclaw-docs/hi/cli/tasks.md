---
read_when:
    - आप पृष्ठभूमि कार्य रिकॉर्ड का निरीक्षण, ऑडिट या उन्हें रद्द करना चाहते हैं
...
x-i18n:
    generated_at: "2026-07-27T20:42:12Z"
    model: gpt-5.6
...
टिकाऊ बैकग्राउंड कार्यों और Task Flow स्थिति का निरीक्षण करें। कोई उपकमांड न होने पर,
...
ट्रैक किए गए बैकग्राउंड कार्यों को नवीनतम पहले क्रम में सूचीबद्ध करता है।
...
Task Flow रिकॉर्ड सामने लाता है। `cleanupAfter` तक रखे गए खोए हुए कार्य चेतावनियाँ हैं;
समय-सीमा समाप्त या बिना टाइमस्टैम्प वाले खोए हुए कार्य त्रुटियाँ हैं।
...
कार्य और Task Flow के मिलान, क्लीनअप टाइमस्टैम्पिंग,
छँटाई और पुराने cron रन सत्र रजिस्ट्री क्लीनअप का पूर्वावलोकन करता है या उन्हें लागू करता है।

cron कार्यों के लिए, किसी पुराने सक्रिय कार्य को `lost` चिह्नित करने से पहले
मिलान स्थायी रन लॉग/जॉब स्थिति का उपयोग करता है, ताकि केवल इन-मेमोरी Gateway रनटाइम
स्थिति समाप्त हो जाने के कारण पूर्ण हो चुके cron रन गलत ऑडिट त्रुटियाँ न बनें।
ऑफ़लाइन CLI ऑडिट, Gateway के प्रोसेस-लोकल cron सक्रिय-जॉब सेट के लिए प्रामाणिक नहीं है।
रन ID/स्रोत ID वाले CLI कार्यों को तब `lost` चिह्नित किया जाता है, जब उनका
लाइव Gateway रन संदर्भ समाप्त हो जाता है, भले ही कोई पुरानी चाइल्ड-सत्र पंक्ति
बची रहे।

लागू किए जाने पर, रखरखाव वर्तमान में चल रहे cron
जॉब को संरक्षित रखते हुए और गैर-cron सत्र पंक्तियों को अछूता छोड़ते हुए, 7 दिन से पुरानी
`cron:<jobId>:run:<uuid>` सत्र रजिस्ट्री पंक्तियों की छँटाई भी करता है।
