...
title: TUI
x-i18n:
    generated_at: "2026-07-27T17:38:12Z"
    model: gpt-5.6
...
Gateway से कनेक्ट किया गया टर्मिनल UI खोलें, या इसे स्थानीय एम्बेडेड
मोड में चलाएँ।
...
| `--token <token>`            | (कोई नहीं)                                    | यदि आवश्यक हो, तो Gateway टोकन।                                                         |
| `--password <pass>`          | (कोई नहीं)                                    | यदि आवश्यक हो, तो Gateway पासवर्ड।                                                      |
| `--tls-fingerprint <sha256>` | `gateway.remote.tlsFingerprint`           | पिन किए गए `wss://` Gateway के लिए अपेक्षित TLS प्रमाणपत्र फ़िंगरप्रिंट।                |
| `--session <key>`            | `main` (या जब दायरा वैश्विक हो तब `global`) | सत्र कुंजी। एजेंट वर्कस्पेस के भीतर, उपसर्ग न होने पर यह उस एजेंट को स्वतः चुनता है। |
| `--deliver`                  | `false`                                   | कॉन्फ़िगर किए गए चैनलों के माध्यम से सहायक के उत्तर भेजें।                             |
...
- जहाँ संभव हो, `tui` टोकन/पासवर्ड प्रमाणीकरण के लिए कॉन्फ़िगर किए गए Gateway प्रमाणीकरण SecretRefs को
  रिज़ॉल्व करता है (`env`/`file`/`exec` प्रदाता)।
- कोई स्पष्ट URL या पोर्ट न होने पर, `tui` चल रहे Gateway द्वारा दर्ज सक्रिय स्थानीय Gateway पोर्ट का
  अनुसरण करता है। स्पष्ट `--url`, `OPENCLAW_GATEWAY_URL`,
  `OPENCLAW_GATEWAY_PORT`, और दूरस्थ Gateway कॉन्फ़िगरेशन को प्राथमिकता मिलती है।
- कॉन्फ़िगर की गई एजेंट वर्कस्पेस डायरेक्टरी के भीतर से लॉन्च किए जाने पर, TUI सत्र कुंजी के डिफ़ॉल्ट के लिए
  उस एजेंट को स्वतः चुनता है (जब तक कि `--session` को स्पष्ट रूप से
  `agent:<id>:...` न किया गया हो)।
- स्थानीय मोड सीधे एम्बेडेड एजेंट रनटाइम का उपयोग करता है। अधिकांश स्थानीय टूल काम करते हैं,
  लेकिन केवल Gateway वाली सुविधाएँ उपलब्ध नहीं होतीं।
...
- Plugin अनुमोदन गेट स्थानीय मोड में भी लागू होते हैं: अनुमोदन की आवश्यकता वाले टूल
  टर्मिनल में निर्णय का संकेत देते हैं, किसी भी चीज़ को बिना बताए स्वतः अनुमोदित नहीं किया जाता।
- सत्र के [लक्ष्य](/hi/tools/goal) फ़ुटर में दिखाई देते हैं और उन्हें
...
openclaw chat --message "मेरे कॉन्फ़िगरेशन की दस्तावेज़ों से तुलना करें और मुझे बताएँ कि क्या ठीक करना है"
# एजेंट वर्कस्पेस के भीतर चलाने पर, उस एजेंट का स्वतः अनुमान लगाता है
openclaw tui --session bugfix
```

## कॉन्फ़िगरेशन सुधार लूप

एम्बेडेड एजेंट से वर्तमान कॉन्फ़िगरेशन का निरीक्षण कराने, उसकी दस्तावेज़ों से तुलना करने
