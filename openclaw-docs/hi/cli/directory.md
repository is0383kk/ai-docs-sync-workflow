...
summary: '`openclaw directory` (स्वयं, पीयर्स, समूहों) के लिए CLI संदर्भ'
title: निर्देशिका
x-i18n:
    generated_at: "2026-07-27T19:27:02Z"
    model: gpt-5.6
...
उन चैनलों के लिए डायरेक्टरी लुकअप जो इनका समर्थन करते हैं: संपर्क/पीयर, समूह और "मैं" (स्वयं)।
...
डिफ़ॉल्ट (गैर-JSON) आउटपुट में `id` (और कभी-कभी `name`) टैब से अलग किए जाते हैं।
...
- WhatsApp समूह सूची लाइव होती है। Gateway लुकअप उसके स्वामित्व वाले कनेक्शन का पुनः उपयोग करते हैं; कोई स्वतंत्र कमांड लिंक किया हुआ सत्र केवल तभी खोलता है जब उस खाते का स्वामित्व किसी अन्य प्रक्रिया के पास न हो, अन्यथा यह सूचित करता है कि लाइव समूह उपलब्ध नहीं हैं।
- पहले से इंस्टॉल किए गए चैनल Plugin में डायरेक्टरी समर्थन नहीं हो सकता। ऐसी स्थिति में कमांड असमर्थित कार्रवाई की सूचना देता है; वह समर्थन जोड़ने के लिए Plugin को पुनः इंस्टॉल या अपग्रेड करने का प्रयास नहीं करता।
...
| Telegram                            | `@username` या अंकीय चैट आईडी; समूह अंकीय आईडी का उपयोग करते हैं                                                                      |
