---
summary: उत्पाद क्षेत्रों, एकीकरणों और समर्थित कार्यप्रवाहों के लिए OpenClaw रिलीज़ तत्परता स्कोर।
title: परिपक्वता स्कोरकार्ड
x-i18n:
    generated_at: "2026-07-27T19:55:36Z"
    model: gpt-5.6
...
<div className="maturity-hero">
  <p className="maturity-kicker">रिलीज़ की तैयारी - वर्गीकरण + QA साक्ष्य से जनरेट किया गया</p>
  <p className="maturity-hero-title">क्या तैयार है, क्या प्रमाणित है और किस पर अभी भी काम करने की आवश्यकता है, इसका व्यावहारिक अवलोकन।</p>
  <p>50 सतहें - 281 क्षमता क्षेत्र - नियतात्मक कवरेज के साथ मानव-समीक्षित गुणवत्ता और पूर्णता।</p>
  <p className="maturity-jump-links"><a href="#surface-explorer">सतहें ब्राउज़ करें</a> / <a href="#qa-evidence-summary">QA साक्ष्य का निरीक्षण करें</a> / <a href="/hi/maturity/taxonomy">वर्गीकरण पढ़ें</a></p>
</div>

## यह पृष्ठ किसलिए है

एक प्रश्न का उत्तर पाने के लिए इस पृष्ठ का उपयोग करें: रिलीज़ के लिए OpenClaw की कौन-सी सतहें विश्वसनीय विकल्प हैं और कौन-से साक्ष्य उस निर्णय का समर्थन करते हैं? कवरेज नियतात्मक QA साक्ष्य से प्राप्त होती है; गुणवत्ता और पूर्णता को समीक्षित परिपक्वता स्कोर के रूप में बनाए रखा जाता है।
...
<div className="maturity-summary-grid">
  <div className="maturity-summary-item maturity-score-alpha">
    ...
    <div className="maturity-summary-meta">
      ...
      <span>कवरेज प्रयोगात्मक - 4%</span>
      <span>गुणवत्ता अल्फ़ा - 64%</span>
      <span>पूर्णता बीटा - 71%</span>
    </div>
  </div>
</div>

कवरेज को जानबूझकर साक्ष्य-आधारित रखा गया है: केवल कार्यान्वयन मौजूद होने से कोई क्षेत्र "तैयार" नहीं हो जाता। यह परिपक्वता स्कोर का इनपुट नहीं है, लेकिन OpenClaw का लक्ष्य समय के साथ परिपक्व स्थिर-या-बेहतर सुविधाओं के लिए शुरू से अंत तक कवरेज को 90% से अधिक बनाए रखना है।

## स्कोर श्रेणियाँ

<div className="maturity-band-list">
  <div className="maturity-band maturity-band-experimental"><span className="maturity-band-title"><span className="maturity-level-pill maturity-level-experimental">प्रयोगात्मक</span></span><span>0-50%</span></div>
  ...
  <div className="maturity-band maturity-band-clawesome"><span className="maturity-band-title"><span className="maturity-level-pill maturity-level-clawesome">क्लॉसम</span></span><span>95-100%</span></div>
</div>
...
सतहों को परिपक्वता स्तर, पूर्णता और गुणवत्ता के अनुसार क्रमबद्ध किया गया है। प्रत्येक पंक्ति के साथ LTS समर्थन दिखाया गया है, ताकि रिलीज़ के लिए तैयार विकल्पों की तुलना आसानी से की जा सके।
  ...
  <Tab title="सभी सतहें">
    <div className="maturity-surface-table">
      ...
      <div className="maturity-surface-row">
        <a className="maturity-surface-name" href="/hi/maturity/taxonomy#browser-automation-exec-and-sandbox-tools"><span className="maturity-surface-title">ब्राउज़र स्वचालन, निष्पादन और सैंडबॉक्स टूल</span><span className="maturity-surface-meta"><span className="maturity-level-pill maturity-level-beta"><span className="maturity-level-code">M3</span><span>बीटा</span></span><span>3 क्षेत्र</span></span></a>
      ...
      <div className="maturity-surface-row">
        <a className="maturity-surface-name" href="/hi/maturity/taxonomy#security-auth-pairing-and-secrets"><span className="maturity-surface-title">सुरक्षा, प्रमाणीकरण, पेयरिंग और सीक्रेट</span><span className="maturity-surface-meta"><span className="maturity-level-pill maturity-level-beta"><span className="maturity-level-code">M3</span><span>बीटा</span></span><span>6 क्षेत्र</span></span></a>
      ...
      <div className="maturity-surface-row">
        <a className="maturity-surface-name" href="/hi/maturity/taxonomy#automation-cron-hooks-tasks-polling"><span className="maturity-surface-title">स्वचालन: Cron, हुक, कार्य, पोलिंग</span><span className="maturity-surface-meta"><span className="maturity-level-pill maturity-level-beta"><span className="maturity-level-code">M3</span><span>बीटा</span></span><span>6 क्षेत्र</span></span></a>
      ...
      <div className="maturity-surface-row">
        <a className="maturity-surface-name" href="/hi/maturity/taxonomy#raspberry-pi-and-small-linux-devices"><span className="maturity-surface-title">Raspberry Pi और छोटे Linux उपकरण</span><span className="maturity-surface-meta"><span className="maturity-level-pill maturity-level-beta"><span className="maturity-level-code">M3</span><span>बीटा</span></span><span>4 क्षेत्र</span></span></a>
        <div className="maturity-surface-metric"><span className="maturity-surface-metric-label">कवरेज</span><span className="maturity-score maturity-score-experimental"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-experimental">प्रायोगिक</span><span>0%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "0%" }} /></span></span></div>
      ...
      <div className="maturity-surface-row">
        <a className="maturity-surface-name" href="/hi/maturity/taxonomy#media-understanding-and-media-generation"><span className="maturity-surface-title">मीडिया की समझ और मीडिया निर्माण</span><span className="maturity-surface-meta"><span className="maturity-level-pill maturity-level-alpha"><span className="maturity-level-code">M2</span><span>अल्फ़ा</span></span><span>6 क्षेत्र</span></span></a>
        <div className="maturity-surface-metric"><span className="maturity-surface-metric-label">कवरेज</span><span className="maturity-score maturity-score-experimental"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-experimental">प्रायोगिक</span><span>2%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "2%" }} /></span></span></div>
        <div className="maturity-surface-metric"><span className="maturity-surface-metric-label">गुणवत्ता</span><span className="maturity-score maturity-score-alpha"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-alpha">अल्फ़ा</span><span>64%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "64%" }} /></span></span></div>
      ...
      <div className="maturity-surface-row">
        <a className="maturity-surface-name" href="/hi/maturity/taxonomy#image-video-and-music-generation-tools"><span className="maturity-surface-title">छवि, वीडियो और संगीत निर्माण टूल</span><span className="maturity-surface-meta"><span className="maturity-level-pill maturity-level-alpha"><span className="maturity-level-code">M2</span><span>अल्फ़ा</span></span><span>5 क्षेत्र</span></span></a>
        <div className="maturity-surface-metric"><span className="maturity-surface-metric-label">कवरेज</span><span className="maturity-score maturity-score-experimental"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-experimental">प्रायोगिक</span><span>0%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "0%" }} /></span></span></div>
      ...
      <div className="maturity-surface-row">
        <a className="maturity-surface-name" href="/hi/maturity/taxonomy#local-model-providers-ollama-vllm-sglang-lm-studio"><span className="maturity-surface-title">स्थानीय मॉडल प्रदाता: Ollama, vLLM, SGLang, LM Studio</span><span className="maturity-surface-meta"><span className="maturity-level-pill maturity-level-alpha"><span className="maturity-level-code">M2</span><span>अल्फ़ा</span></span><span>5 क्षेत्र</span></span></a>
        <div className="maturity-surface-metric"><span className="maturity-surface-metric-label">कवरेज</span><span className="maturity-score maturity-score-experimental"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-experimental">प्रायोगिक</span><span>0%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "0%" }} /></span></span></div>
        <div className="maturity-surface-metric"><span className="maturity-surface-metric-label">गुणवत्ता</span><span className="maturity-score maturity-score-alpha"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-alpha">अल्फ़ा</span><span>61%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "61%" }} /></span></span></div>
        <div className="maturity-surface-metric"><span className="maturity-surface-metric-label">पूर्णता</span><span className="maturity-score maturity-score-alpha"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-alpha">अल्फ़ा</span><span>68%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "68%" }} /></span></span></div>
        <div className="maturity-surface-support"><span className="maturity-lts maturity-lts-none">कोई नहीं</span></div>
      ...
      <div className="maturity-surface-row">
        <a className="maturity-surface-name" href="/hi/maturity/taxonomy#long-tail-hosted-providers"><span className="maturity-surface-title">कम प्रचलित होस्टेड प्रदाता</span><span className="maturity-surface-meta"><span className="maturity-level-pill maturity-level-alpha"><span className="maturity-level-code">M2</span><span>अल्फ़ा</span></span><span>3 क्षेत्र</span></span></a>
        <div className="maturity-surface-metric"><span className="maturity-surface-metric-label">कवरेज</span><span className="maturity-score maturity-score-experimental"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-experimental">प्रायोगिक</span><span>0%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "0%" }} /></span></span></div>
        <div className="maturity-surface-metric"><span className="maturity-surface-metric-label">गुणवत्ता</span><span className="maturity-score maturity-score-alpha"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-alpha">अल्फ़ा</span><span>61%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "61%" }} /></span></span></div>
        <div className="maturity-surface-metric"><span className="maturity-surface-metric-label">पूर्णता</span><span className="maturity-score maturity-score-alpha"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-alpha">अल्फ़ा</span><span>68%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "68%" }} /></span></span></div>
        <div className="maturity-surface-support"><span className="maturity-lts maturity-lts-none">कोई नहीं</span></div>
      ...
      <div className="maturity-surface-row">
        <a className="maturity-surface-name" href="/hi/maturity/taxonomy#voice-and-realtime-talk"><span className="maturity-surface-title">वॉइस और रीयल-टाइम वार्तालाप</span><span className="maturity-surface-meta"><span className="maturity-level-pill maturity-level-alpha"><span className="maturity-level-code">M2</span><span>अल्फ़ा</span></span><span>6 क्षेत्र</span></span></a>
        <div className="maturity-surface-metric"><span className="maturity-surface-metric-label">कवरेज</span><span className="maturity-score maturity-score-experimental"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-experimental">प्रायोगिक</span><span>0%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "0%" }} /></span></span></div>
        <div className="maturity-surface-metric"><span className="maturity-surface-metric-label">गुणवत्ता</span><span className="maturity-score maturity-score-alpha"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-alpha">अल्फ़ा</span><span>61%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "61%" }} /></span></span></div>
        <div className="maturity-surface-metric"><span className="maturity-surface-metric-label">पूर्णता</span><span className="maturity-score maturity-score-alpha"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-alpha">अल्फ़ा</span><span>68%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "68%" }} /></span></span></div>
        <div className="maturity-surface-support"><span className="maturity-lts maturity-lts-none">कोई नहीं</span></div>
      ...
      <div className="maturity-surface-row">
        <a className="maturity-surface-name" href="/hi/maturity/taxonomy#native-windows"><span className="maturity-surface-title">मूल Windows</span><span className="maturity-surface-meta"><span className="maturity-level-pill maturity-level-alpha"><span className="maturity-level-code">M2</span><span>अल्फ़ा</span></span><span>4 क्षेत्र</span></span></a>
        <div className="maturity-surface-metric"><span className="maturity-surface-metric-label">कवरेज</span><span className="maturity-score maturity-score-experimental"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-experimental">प्रायोगिक</span><span>0%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "0%" }} /></span></span></div>
      ...
      <div className="maturity-surface-row">
        <a className="maturity-surface-name" href="/hi/maturity/taxonomy#watchos-companion-surfaces"><span className="maturity-surface-title">watchOS सहयोगी सतहें</span><span className="maturity-surface-meta"><span className="maturity-level-pill maturity-level-experimental"><span className="maturity-level-code">M1</span><span>प्रायोगिक</span></span><span>5 क्षेत्र</span></span></a>
        <div className="maturity-surface-metric"><span className="maturity-surface-metric-label">कवरेज</span><span className="maturity-score maturity-score-experimental"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-experimental">प्रायोगिक</span><span>0%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "0%" }} /></span></span></div>
        <div className="maturity-surface-metric"><span className="maturity-surface-metric-label">गुणवत्ता</span><span className="maturity-score maturity-score-experimental"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-experimental">प्रायोगिक</span><span>41%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "41%" }} /></span></span></div>
        <div className="maturity-surface-metric"><span className="maturity-surface-metric-label">पूर्णता</span><span className="maturity-score maturity-score-experimental"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-experimental">प्रायोगिक</span><span>44%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "44%" }} /></span></span></div>
        <div className="maturity-surface-support"><span className="maturity-lts maturity-lts-none">कोई नहीं</span></div>
      ...
      <div className="maturity-surface-row">
        <a className="maturity-surface-name" href="/hi/maturity/taxonomy#linux-companion-app"><span className="maturity-surface-title">Linux सहयोगी ऐप</span><span className="maturity-surface-meta"><span className="maturity-level-pill maturity-level-experimental"><span className="maturity-level-code">M0</span><span>नियोजित</span></span><span>5 क्षेत्र</span></span></a>
        <div className="maturity-surface-metric"><span className="maturity-surface-metric-label">कवरेज</span><span className="maturity-score maturity-score-experimental"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-experimental">प्रायोगिक</span><span>0%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "0%" }} /></span></span></div>
      ...
      <div className="maturity-surface-row">
        <a className="maturity-surface-name" href="/hi/maturity/taxonomy#native-windows-companion-app"><span className="maturity-surface-title">नेटिव Windows सहयोगी ऐप</span><span className="maturity-surface-meta"><span className="maturity-level-pill maturity-level-experimental"><span className="maturity-level-code">M0</span><span>नियोजित</span></span><span>5 क्षेत्र</span></span></a>
        <div className="maturity-surface-metric"><span className="maturity-surface-metric-label">कवरेज</span><span className="maturity-score maturity-score-experimental"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-experimental">प्रायोगिक</span><span>0%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "0%" }} /></span></span></div>
        <div className="maturity-surface-metric"><span className="maturity-surface-metric-label">गुणवत्ता</span><span className="maturity-score maturity-score-experimental"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-experimental">प्रायोगिक</span><span>19%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "19%" }} /></span></span></div>
        <div className="maturity-surface-metric"><span className="maturity-surface-metric-label">पूर्णता</span><span className="maturity-score maturity-score-experimental"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-experimental">प्रायोगिक</span><span>21%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "21%" }} /></span></span></div>
        <div className="maturity-surface-support"><span className="maturity-lts maturity-lts-none">कोई नहीं</span></div>
  ...
  <Tab title="प्लेटफ़ॉर्म">
    <div className="maturity-surface-table">
      ...
      <div className="maturity-surface-row">
        <a className="maturity-surface-name" href="/hi/maturity/taxonomy#macos-companion-app"><span className="maturity-surface-title">macOS सहायक ऐप</span><span className="maturity-surface-meta"><span className="maturity-level-pill maturity-level-beta"><span className="maturity-level-code">M3</span><span>बीटा</span></span><span>8 क्षेत्र</span></span></a>
        <div className="maturity-surface-metric"><span className="maturity-surface-metric-label">कवरेज</span><span className="maturity-score maturity-score-experimental"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-experimental">प्रायोगिक</span><span>0%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "0%" }} /></span></span></div>
        <div className="maturity-surface-metric"><span className="maturity-surface-metric-label">गुणवत्ता</span><span className="maturity-score maturity-score-alpha"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-alpha">अल्फ़ा</span><span>66%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "66%" }} /></span></span></div>
        <div className="maturity-surface-metric"><span className="maturity-surface-metric-label">पूर्णता</span><span className="maturity-score maturity-score-beta"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-beta">बीटा</span><span>78%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "78%" }} /></span></span></div>
        <div className="maturity-surface-support"><span className="maturity-lts maturity-lts-none">कोई नहीं</span></div>
      ...
      <div className="maturity-surface-row">
        <a className="maturity-surface-name" href="/hi/maturity/taxonomy#nix-install-path"><span className="maturity-surface-title">Nix इंस्टॉल पथ</span><span className="maturity-surface-meta"><span className="maturity-level-pill maturity-level-experimental"><span className="maturity-level-code">M1</span><span>प्रयोगात्मक</span></span><span>5 क्षेत्र</span></span></a>
        <div className="maturity-surface-metric"><span className="maturity-surface-metric-label">कवरेज</span><span className="maturity-score maturity-score-experimental"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-experimental">प्रयोगात्मक</span><span>0%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "0%" }} /></span></span></div>
      ...
      <div className="maturity-surface-row">
        <a className="maturity-surface-name" href="/hi/maturity/taxonomy#watchos-companion-surfaces"><span className="maturity-surface-title">watchOS सहायक सतहें</span><span className="maturity-surface-meta"><span className="maturity-level-pill maturity-level-experimental"><span className="maturity-level-code">M1</span><span>प्रयोगात्मक</span></span><span>5 क्षेत्र</span></span></a>
        <div className="maturity-surface-metric"><span className="maturity-surface-metric-label">कवरेज</span><span className="maturity-score maturity-score-experimental"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-experimental">प्रयोगात्मक</span><span>0%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "0%" }} /></span></span></div>
        <div className="maturity-surface-metric"><span className="maturity-surface-metric-label">गुणवत्ता</span><span className="maturity-score maturity-score-experimental"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-experimental">प्रयोगात्मक</span><span>41%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "41%" }} /></span></span></div>
        <div className="maturity-surface-metric"><span className="maturity-surface-metric-label">पूर्णता</span><span className="maturity-score maturity-score-experimental"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-experimental">प्रयोगात्मक</span><span>44%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "44%" }} /></span></span></div>
        <div className="maturity-surface-support"><span className="maturity-lts maturity-lts-none">कोई नहीं</span></div>
      ...
      <div className="maturity-surface-row">
        <a className="maturity-surface-name" href="/hi/maturity/taxonomy#linux-companion-app"><span className="maturity-surface-title">Linux सहायक ऐप</span><span className="maturity-surface-meta"><span className="maturity-level-pill maturity-level-experimental"><span className="maturity-level-code">M0</span><span>नियोजित</span></span><span>5 क्षेत्र</span></span></a>
        <div className="maturity-surface-metric"><span className="maturity-surface-metric-label">कवरेज</span><span className="maturity-score maturity-score-experimental"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-experimental">प्रयोगात्मक</span><span>0%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "0%" }} /></span></span></div>
        <div className="maturity-surface-metric"><span className="maturity-surface-metric-label">गुणवत्ता</span><span className="maturity-score maturity-score-experimental"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-experimental">प्रयोगात्मक</span><span>19%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "19%" }} /></span></span></div>
        <div className="maturity-surface-metric"><span className="maturity-surface-metric-label">पूर्णता</span><span className="maturity-score maturity-score-experimental"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-experimental">प्रयोगात्मक</span><span>21%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "21%" }} /></span></span></div>
        <div className="maturity-surface-support"><span className="maturity-lts maturity-lts-none">कोई नहीं</span></div>
      </div>
      <div className="maturity-surface-row">
        <a className="maturity-surface-name" href="/hi/maturity/taxonomy#native-windows-companion-app"><span className="maturity-surface-title">नेटिव Windows सहायक ऐप</span><span className="maturity-surface-meta"><span className="maturity-level-pill maturity-level-experimental"><span className="maturity-level-code">M0</span><span>नियोजित</span></span><span>5 क्षेत्र</span></span></a>
        <div className="maturity-surface-metric"><span className="maturity-surface-metric-label">कवरेज</span><span className="maturity-score maturity-score-experimental"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-experimental">प्रयोगात्मक</span><span>0%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "0%" }} /></span></span></div>
        <div className="maturity-surface-metric"><span className="maturity-surface-metric-label">गुणवत्ता</span><span className="maturity-score maturity-score-experimental"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-experimental">प्रयोगात्मक</span><span>19%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "19%" }} /></span></span></div>
        <div className="maturity-surface-metric"><span className="maturity-surface-metric-label">पूर्णता</span><span className="maturity-score maturity-score-experimental"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-experimental">प्रयोगात्मक</span><span>21%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "21%" }} /></span></span></div>
        <div className="maturity-surface-support"><span className="maturity-lts maturity-lts-none">कोई नहीं</span></div>
  ...
  <Tab title="प्रदाता और टूल">
    <div className="maturity-surface-table">
      <div className="maturity-surface-row maturity-surface-row-header"><span>सतह</span><span>कवरेज</span><span>गुणवत्ता</span><span>पूर्णता</span><span>समर्थन</span></div>
      <div className="maturity-surface-row">
        <a className="maturity-surface-name" href="/hi/maturity/taxonomy#browser-automation-exec-and-sandbox-tools"><span className="maturity-surface-title">ब्राउज़र ऑटोमेशन, exec और sandbox टूल</span><span className="maturity-surface-meta"><span className="maturity-level-pill maturity-level-beta"><span className="maturity-level-code">M3</span><span>बीटा</span></span><span>3 क्षेत्र</span></span></a>
        <div className="maturity-surface-metric"><span className="maturity-surface-metric-label">कवरेज</span><span className="maturity-score maturity-score-experimental"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-experimental">प्रायोगिक</span><span>21%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "21%" }} /></span></span></div>
        <div className="maturity-surface-metric"><span className="maturity-surface-metric-label">गुणवत्ता</span><span className="maturity-score maturity-score-beta"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-beta">बीटा</span><span>75%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "75%" }} /></span></span></div>
        <div className="maturity-surface-metric"><span className="maturity-surface-metric-label">पूर्णता</span><span className="maturity-score maturity-score-beta"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-beta">बीटा</span><span>79%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "79%" }} /></span></span></div>
        <div className="maturity-surface-support"><span className="maturity-lts maturity-lts-partial">आंशिक - 2</span></div>
      ...
      <div className="maturity-surface-row">
        <a className="maturity-surface-name" href="/hi/maturity/taxonomy#image-video-and-music-generation-tools"><span className="maturity-surface-title">छवि, वीडियो और संगीत निर्माण उपकरण</span><span className="maturity-surface-meta"><span className="maturity-level-pill maturity-level-alpha"><span className="maturity-level-code">M2</span><span>अल्फ़ा</span></span><span>5 क्षेत्र</span></span></a>
        <div className="maturity-surface-metric"><span className="maturity-surface-metric-label">कवरेज</span><span className="maturity-score maturity-score-experimental"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-experimental">प्रायोगिक</span><span>0%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "0%" }} /></span></span></div>
        <div className="maturity-surface-metric"><span className="maturity-surface-metric-label">गुणवत्ता</span><span className="maturity-score maturity-score-alpha"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-alpha">अल्फ़ा</span><span>61%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "61%" }} /></span></span></div>
        <div className="maturity-surface-metric"><span className="maturity-surface-metric-label">पूर्णता</span><span className="maturity-score maturity-score-alpha"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-alpha">अल्फ़ा</span><span>68%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "68%" }} /></span></span></div>
        <div className="maturity-surface-support"><span className="maturity-lts maturity-lts-none">कोई नहीं</span></div>
...
नीचे दी गई जाँचें दिखाती हैं कि QA प्रोफ़ाइल साक्ष्य द्वारा स्कोरकार्ड के किन क्षेत्रों का परीक्षण किया गया।

<div className="maturity-evidence-grid">
  <div className="maturity-evidence-card">
    <span className="maturity-evidence-title">पूर्ण वर्गीकरण सत्यापन</span>
    <span>2026-06-23T07:24:36.128Z</span>
    <span>96 जाँचें - 94 सफल, 2 अवरुद्ध</span>
    <span>281 में से 0 (0%) क्षेत्र - 1675 में से 20 (1.2%) सुविधाएँ - 1665 में से 77 (4.6%) कवरेज ID</span>
  </div>
</div>

### क्षेत्र के अनुसार तत्परता

  प्रत्येक श्रेणी की साक्ष्य स्थिति का निरीक्षण करने के लिए एक सतह खोलें। सूची संक्षिप्त रहती है ताकि पृष्ठ एक नज़र में उपयोगी बना रहे।

  <AccordionGroup>
  <Accordion title="एजेंट रनटाइम - 9 क्षेत्र">
    <p className="maturity-readiness-summary">8 की आंशिक समीक्षा हुई / 1 को समीक्षा की आवश्यकता है</p>
    <div className="maturity-readiness-list">
      ...
      <div className="maturity-readiness-row">
        <div className="maturity-readiness-area">
          <span className="maturity-readiness-title">बाहरी रनटाइम और उप-एजेंट</span>
          <span className="maturity-readiness-status maturity-readiness-status-partially-reviewed">आंशिक समीक्षा हुई - पूर्ण वर्गीकरण सत्यापन</span>
        </div>
      ...
      <div className="maturity-readiness-row">
        <div className="maturity-readiness-area">
          <span className="maturity-readiness-title">स्थानीय और स्व-होस्टेड प्रदाता</span>
          <span className="maturity-readiness-status maturity-readiness-status-needs-review">समीक्षा की आवश्यकता है - पूर्ण वर्गीकरण सत्यापन</span>
        </div>
  ...
  <Accordion title="Android ऐप - 7 क्षेत्र">
    ...
    <div className="maturity-readiness-list">
      ...
      <div className="maturity-readiness-row">
        <div className="maturity-readiness-area">
          <span className="maturity-readiness-title">ध्वनि</span>
          <span className="maturity-readiness-status maturity-readiness-status-needs-review">समीक्षा की आवश्यकता है - पूर्ण वर्गीकरण सत्यापन</span>
        </div>
        <span>1 में से 0 (0%) / 1 में से 0 (0%)</span>
        <span>1 क्षमता अंतराल</span>
  ...
  <Accordion title="Anthropic प्रदाता पथ - 5 क्षेत्र">
    ...
    <div className="maturity-readiness-list">
      ...
      <div className="maturity-readiness-row">
        <div className="maturity-readiness-area">
          <span className="maturity-readiness-title">प्रदाता प्रमाणीकरण और पुनर्प्राप्ति</span>
          <span className="maturity-readiness-status maturity-readiness-status-needs-review">समीक्षा की आवश्यकता है - पूर्ण वर्गीकरण सत्यापन</span>
        </div>
      ...
      <div className="maturity-readiness-row">
        <div className="maturity-readiness-area">
          <span className="maturity-readiness-title">अनुरोध परिवहन और टर्न सिमैंटिक्स</span>
          <span className="maturity-readiness-status maturity-readiness-status-needs-review">समीक्षा की आवश्यकता है - पूर्ण वर्गीकरण सत्यापन</span>
        </div>
  ...
  <Accordion title="ऑटोमेशन: Cron, हुक, टास्क, पोलिंग - 6 क्षेत्र">
    <p className="maturity-readiness-summary">5 की समीक्षा आवश्यक / 1 की आंशिक समीक्षा हुई</p>
    <div className="maturity-readiness-list">
      <div className="maturity-readiness-row maturity-readiness-row-header"><span>क्षेत्र</span><span>सुविधाएँ / कवरेज आईडी</span><span>अनुवर्ती कार्रवाई</span></div>
      <div className="maturity-readiness-row">
        <div className="maturity-readiness-area">
          <span className="maturity-readiness-title">ऑटोमेशन हुक</span>
          <span className="maturity-readiness-status maturity-readiness-status-needs-review">समीक्षा आवश्यक - संपूर्ण वर्गीकरण सत्यापन</span>
        </div>
      ...
      <div className="maturity-readiness-row">
        <div className="maturity-readiness-area">
          <span className="maturity-readiness-title">पृष्ठभूमि टास्क और प्रवाह</span>
          <span className="maturity-readiness-status maturity-readiness-status-needs-review">समीक्षा आवश्यक - संपूर्ण वर्गीकरण सत्यापन</span>
        </div>
        <span>10 में से 0 (0%) / 10 में से 0 (0%)</span>
        <span>10 क्षमता अंतराल</span>
      ...
      <div className="maturity-readiness-row">
        <div className="maturity-readiness-area">
          <span className="maturity-readiness-title">इवेंट प्रवेश</span>
          <span className="maturity-readiness-status maturity-readiness-status-needs-review">समीक्षा आवश्यक - संपूर्ण वर्गीकरण सत्यापन</span>
        </div>
        <span>15 में से 0 (0%) / 15 में से 0 (0%)</span>
        <span>15 क्षमता अंतराल</span>
      ...
      <div className="maturity-readiness-row">
        <div className="maturity-readiness-area">
          ...
          <span className="maturity-readiness-status maturity-readiness-status-partially-reviewed">आंशिक समीक्षा हुई - संपूर्ण वर्गीकरण सत्यापन</span>
        </div>
  ...
  <Accordion title="ब्राउज़र ऑटोमेशन, निष्पादन और सैंडबॉक्स टूल - 3 क्षेत्र">
  ...
  <Accordion title="Gateway वेब ऐप - 6 क्षेत्र">
    ...
    <div className="maturity-readiness-list">
      ...
      <div className="maturity-readiness-row">
        <div className="maturity-readiness-area">
          <span className="maturity-readiness-title">ब्राउज़र पहुँच और भरोसा</span>
          <span className="maturity-readiness-status maturity-readiness-status-needs-review">समीक्षा आवश्यक - संपूर्ण वर्गीकरण सत्यापन</span>
        </div>
        <span>5 में से 0 (0%) / 5 में से 0 (0%)</span>
        <span>5 क्षमता अंतराल</span>
      ...
      <div className="maturity-readiness-row">
        <div className="maturity-readiness-area">
          <span className="maturity-readiness-title">ब्राउज़र रीयल-टाइम वार्ता</span>
          <span className="maturity-readiness-status maturity-readiness-status-needs-review">समीक्षा आवश्यक - संपूर्ण वर्गीकरण सत्यापन</span>
        </div>
        <span>5 में से 0 (0%) / 5 में से 0 (0%)</span>
        <span>5 क्षमता अंतराल</span>
      ...
      <div className="maturity-readiness-row">
        <div className="maturity-readiness-area">
          <span className="maturity-readiness-title">ब्राउज़र यूआई</span>
          <span className="maturity-readiness-status maturity-readiness-status-partially-reviewed">आंशिक समीक्षा हुई - संपूर्ण वर्गीकरण सत्यापन</span>
        </div>
  ...
  <Accordion title="चैनल फ़्रेमवर्क - 8 क्षेत्र">
    ...
    <div className="maturity-readiness-list">
      ...
      <div className="maturity-readiness-row">
        <div className="maturity-readiness-area">
          <span className="maturity-readiness-title">चैनल कार्रवाई, कमांड और अनुमोदन</span>
          <span className="maturity-readiness-status maturity-readiness-status-needs-review">समीक्षा आवश्यक - संपूर्ण वर्गीकरण सत्यापन</span>
        </div>
        <span>5 में से 0 (0%) / 5 में से 0 (0%)</span>
        <span>5 क्षमता अंतराल</span>
      ...
      <div className="maturity-readiness-row">
        <div className="maturity-readiness-area">
          <span className="maturity-readiness-title">वार्तालाप रूटिंग और वितरण</span>
          <span className="maturity-readiness-status maturity-readiness-status-partially-reviewed">आंशिक समीक्षा हुई - संपूर्ण वर्गीकरण सत्यापन</span>
        </div>
      ...
      <div className="maturity-readiness-row">
        <div className="maturity-readiness-area">
          <span className="maturity-readiness-title">समूह थ्रेड और परिवेशी कक्ष का व्यवहार</span>
          <span className="maturity-readiness-status maturity-readiness-status-partially-reviewed">आंशिक समीक्षा हुई - संपूर्ण वर्गीकरण सत्यापन</span>
        </div>
      ...
      <div className="maturity-readiness-row">
        <div className="maturity-readiness-area">
          <span className="maturity-readiness-title">इनबाउंड पहुँच और पहचान गेट</span>
          <span className="maturity-readiness-status maturity-readiness-status-needs-review">समीक्षा आवश्यक - संपूर्ण वर्गीकरण सत्यापन</span>
        </div>
        <span>5 में से 0 (0%) / 5 में से 0 (0%)</span>
        <span>5 क्षमता अंतराल</span>
      ...
      <div className="maturity-readiness-row">
        <div className="maturity-readiness-area">
          <span className="maturity-readiness-title">मीडिया अनुलग्नक और समृद्ध चैनल डेटा</span>
          <span className="maturity-readiness-status maturity-readiness-status-needs-review">समीक्षा आवश्यक - संपूर्ण वर्गीकरण सत्यापन</span>
        </div>
        <span>4 में से 0 (0%) / 4 में से 0 (0%)</span>
        <span>4 क्षमता अंतराल</span>
      ...
      <div className="maturity-readiness-row">
        <div className="maturity-readiness-area">
          <span className="maturity-readiness-title">आउटबाउंड वितरण और उत्तर पाइपलाइन</span>
          <span className="maturity-readiness-status maturity-readiness-status-partially-reviewed">आंशिक समीक्षा हुई - संपूर्ण वर्गीकरण सत्यापन</span>
        </div>
  ...
  <Accordion title="ClawHub - 4 क्षेत्र">
    ...
    <div className="maturity-readiness-list">
      ...
      <div className="maturity-readiness-row">
        <div className="maturity-readiness-area">
          <span className="maturity-readiness-title">संगतता और विश्वास</span>
          <span className="maturity-readiness-status maturity-readiness-status-needs-review">समीक्षा आवश्यक - संपूर्ण वर्गीकरण सत्यापन</span>
        </div>
  ...
  <Accordion title="CLI - 7 क्षेत्र">
    <p className="maturity-readiness-summary">5 की समीक्षा आवश्यक है / 2 की आंशिक समीक्षा हुई है</p>
    <div className="maturity-readiness-list">
      <div className="maturity-readiness-row maturity-readiness-row-header"><span>क्षेत्र</span><span>सुविधाएँ / कवरेज ID</span><span>अनुवर्ती कार्रवाई</span></div>
      <div className="maturity-readiness-row">
        <div className="maturity-readiness-area">
      ...
      <div className="maturity-readiness-row">
        <div className="maturity-readiness-area">
          <span className="maturity-readiness-title">निदान</span>
          <span className="maturity-readiness-status maturity-readiness-status-needs-review">समीक्षा आवश्यक - संपूर्ण वर्गीकरण सत्यापन</span>
        </div>
        <span>10 में से 0 (0%) / 10 में से 0 (0%)</span>
        <span>10 क्षमता अंतराल</span>
      ...
      <div className="maturity-readiness-row">
        <div className="maturity-readiness-area">
          <span className="maturity-readiness-title">आरंभिक सेटअप और प्रमाणीकरण सेटअप</span>
          <span className="maturity-readiness-status maturity-readiness-status-needs-review">समीक्षा आवश्यक - संपूर्ण वर्गीकरण सत्यापन</span>
        </div>
        <span>5 में से 0 (0%) / 5 में से 0 (0%)</span>
        <span>5 क्षमता अंतराल</span>
  ...
  <Accordion title="Discord - 6 क्षेत्र">
    ...
    <div className="maturity-readiness-list">
      ...
      <div className="maturity-readiness-row">
        <div className="maturity-readiness-area">
          <span className="maturity-readiness-title">रीयल-टाइम वॉइस और कॉल</span>
          <span className="maturity-readiness-status maturity-readiness-status-needs-review">समीक्षा आवश्यक - संपूर्ण वर्गीकरण सत्यापन</span>
        </div>
        <span>5 में से 0 (0%) / 5 में से 0 (0%)</span>
        <span>5 क्षमता अंतराल</span>
  ...
  <Accordion title="Docker और Podman होस्टिंग - 4 क्षेत्र">
    <p className="maturity-readiness-summary">3 की समीक्षा आवश्यक है / 1 की आंशिक समीक्षा हुई है</p>
    <div className="maturity-readiness-list">
      <div className="maturity-readiness-row maturity-readiness-row-header"><span>क्षेत्र</span><span>सुविधाएँ / कवरेज ID</span><span>अनुवर्ती कार्रवाई</span></div>
      <div className="maturity-readiness-row">
        <div className="maturity-readiness-area">
  ...
  <Accordion title="Feishu, QQ Bot, WeChat, Yuanbao, Zalo, Zalo Personal, क्षेत्रीय चैनल - 4 क्षेत्र">
    ...
    <div className="maturity-readiness-list">
      ...
      <div className="maturity-readiness-row">
        <div className="maturity-readiness-area">
          <span className="maturity-readiness-title">पहुँच और पहचान</span>
          <span className="maturity-readiness-status maturity-readiness-status-needs-review">समीक्षा आवश्यक है - पूर्ण वर्गीकरण सत्यापन</span>
        </div>
        <span>1 में से 0 (0%) / 1 में से 0 (0%)</span>
  ...
  <Accordion title="Gateway रनटाइम - 13 क्षेत्र">
    <p className="maturity-readiness-summary">9 की समीक्षा आवश्यक है / 4 की आंशिक समीक्षा हुई है</p>
    <div className="maturity-readiness-list">
      <div className="maturity-readiness-row maturity-readiness-row-header"><span>क्षेत्र</span><span>सुविधाएँ / कवरेज ID</span><span>अनुवर्ती कार्रवाई</span></div>
      <div className="maturity-readiness-row">
        <div className="maturity-readiness-area">
      ...
      <div className="maturity-readiness-row">
        <div className="maturity-readiness-area">
          ...
          <span className="maturity-readiness-status maturity-readiness-status-partially-reviewed">आंशिक समीक्षा हुई है - पूर्ण वर्गीकरण सत्यापन</span>
        </div>
      ...
      <div className="maturity-readiness-row">
        <div className="maturity-readiness-area">
          <span className="maturity-readiness-title">Gateway RPC API और इवेंट</span>
          <span className="maturity-readiness-status maturity-readiness-status-partially-reviewed">आंशिक समीक्षा हुई है - पूर्ण वर्गीकरण सत्यापन</span>
        </div>
      ...
      <div className="maturity-readiness-row">
        <div className="maturity-readiness-area">
          <span className="maturity-readiness-title">स्वास्थ्य, निदान और सुधार</span>
          <span className="maturity-readiness-status maturity-readiness-status-needs-review">समीक्षा आवश्यक है - पूर्ण वर्गीकरण सत्यापन</span>
        </div>
        <span>7 में से 0 (0%) / 7 में से 0 (0%)</span>
      ...
      <div className="maturity-readiness-row">
        <div className="maturity-readiness-area">
          <span className="maturity-readiness-title">होस्ट किया गया वेब इंटरफ़ेस</span>
          <span className="maturity-readiness-status maturity-readiness-status-needs-review">समीक्षा आवश्यक है - पूर्ण वर्गीकरण सत्यापन</span>
        </div>
        <span>4 में से 0 (0%) / 4 में से 0 (0%)</span>
      ...
      <div className="maturity-readiness-row">
        <div className="maturity-readiness-area">
          <span className="maturity-readiness-title">Node और दूरस्थ क्षमताएँ</span>
          <span className="maturity-readiness-status maturity-readiness-status-needs-review">समीक्षा आवश्यक है - पूर्ण वर्गीकरण सत्यापन</span>
        </div>
  ...
  <Accordion title="Google प्रदाता पथ - 5 क्षेत्र">
    ...
    <div className="maturity-readiness-list">
      ...
      <div className="maturity-readiness-row">
        <div className="maturity-readiness-area">
          <span className="maturity-readiness-title">मीडिया, खोज और रीयलटाइम</span>
          <span className="maturity-readiness-status maturity-readiness-status-needs-review">समीक्षा आवश्यक है - पूर्ण वर्गीकरण सत्यापन</span>
        </div>
        <span>10 में से 0 (0%) / 10 में से 0 (0%)</span>
        <span>10 क्षमता अंतराल</span>
      ...
      <div className="maturity-readiness-row">
        <div className="maturity-readiness-area">
          <span className="maturity-readiness-title">प्रदाता सेटअप और क्रेडेंशियल</span>
          <span className="maturity-readiness-status maturity-readiness-status-needs-review">समीक्षा आवश्यक है - पूर्ण वर्गीकरण सत्यापन</span>
        </div>
        <span>10 में से 0 (0%) / 10 में से 0 (0%)</span>
        <span>10 क्षमता अंतराल</span>
  ...
  <Accordion title="छवि, वीडियो और संगीत निर्माण टूल - 5 क्षेत्र">
    <p className="maturity-readiness-summary">5 की समीक्षा आवश्यक है</p>
    <div className="maturity-readiness-list">
      <div className="maturity-readiness-row maturity-readiness-row-header"><span>क्षेत्र</span><span>सुविधाएँ / कवरेज आईडी</span><span>अनुवर्ती कार्रवाई</span></div>
      <div className="maturity-readiness-row">
        <div className="maturity-readiness-area">
          <span className="maturity-readiness-title">छवि निर्माण</span>
          <span className="maturity-readiness-status maturity-readiness-status-needs-review">समीक्षा आवश्यक है - पूर्ण वर्गीकरण सत्यापन</span>
        </div>
        <span>9 में से 0 (0%) / 9 में से 0 (0%)</span>
        <span>9 क्षमता अंतराल</span>
      ...
      <div className="maturity-readiness-row">
        <div className="maturity-readiness-area">
          <span className="maturity-readiness-title">कार्य जीवनचक्र और वितरण</span>
          <span className="maturity-readiness-status maturity-readiness-status-needs-review">समीक्षा आवश्यक है - पूर्ण वर्गीकरण सत्यापन</span>
        </div>
        <span>12 में से 0 (0%) / 12 में से 0 (0%)</span>
        <span>12 क्षमता अंतराल</span>
  ...
  <Accordion title="iOS ऐप - 8 क्षेत्र">
    ...
    <div className="maturity-readiness-list">
      ...
      <div className="maturity-readiness-row">
        <div className="maturity-readiness-area">
          <span className="maturity-readiness-title">कैनवस और स्क्रीन</span>
          <span className="maturity-readiness-status maturity-readiness-status-needs-review">समीक्षा आवश्यक है - पूर्ण वर्गीकरण सत्यापन</span>
        </div>
        <span>1 में से 0 (0%) / 1 में से 0 (0%)</span>
        <span>1 क्षमता अंतराल</span>
      ...
      <div className="maturity-readiness-row">
        <div className="maturity-readiness-area">
          <span className="maturity-readiness-title">Gateway सेटअप और निदान</span>
          <span className="maturity-readiness-status maturity-readiness-status-needs-review">समीक्षा आवश्यक है - पूर्ण वर्गीकरण सत्यापन</span>
        </div>
        <span>7 में से 0 (0%) / 7 में से 0 (0%)</span>
        <span>7 क्षमता अंतराल</span>
      ...
      <div className="maturity-readiness-row">
        <div className="maturity-readiness-area">
          <span className="maturity-readiness-title">सूचनाएँ और पृष्ठभूमि</span>
          <span className="maturity-readiness-status maturity-readiness-status-needs-review">समीक्षा आवश्यक है - पूर्ण वर्गीकरण सत्यापन</span>
        </div>
        <span>1 में से 0 (0%) / 1 में से 0 (0%)</span>
        <span>1 क्षमता अंतराल</span>
  ...
  <Accordion title="Kubernetes होस्टिंग - 4 क्षेत्र">
    ...
    <div className="maturity-readiness-list">
      ...
      <div className="maturity-readiness-row">
        <div className="maturity-readiness-area">
          <span className="maturity-readiness-title">पहुँच और एक्सपोज़र</span>
          <span className="maturity-readiness-status maturity-readiness-status-needs-review">समीक्षा आवश्यक - संपूर्ण वर्गीकरण सत्यापन</span>
        </div>
        <span>5 में से 0 (0%) / 5 में से 0 (0%)</span>
        <span>क्षमता में 5 कमियाँ</span>
      </div>
      <div className="maturity-readiness-row">
        <div className="maturity-readiness-area">
      ...
      <div className="maturity-readiness-row">
        <div className="maturity-readiness-area">
          <span className="maturity-readiness-title">कॉन्फ़िगरेशन और सीक्रेट</span>
          <span className="maturity-readiness-status maturity-readiness-status-needs-review">समीक्षा आवश्यक - संपूर्ण वर्गीकरण सत्यापन</span>
        </div>
        <span>5 में से 0 (0%) / 5 में से 0 (0%)</span>
        <span>क्षमता में 5 कमियाँ</span>
  ...
  <Accordion title="Linux सहायक ऐप - 5 क्षेत्र">
    ...
    <div className="maturity-readiness-list">
      ...
      <div className="maturity-readiness-row">
        ...
        <span>4 में से 0 (0%) / 4 में से 0 (0%)</span>
        <span>क्षमता में 4 कमियाँ</span>
      </div>
      <div className="maturity-readiness-row">
        <div className="maturity-readiness-area">
          <span className="maturity-readiness-title">स्थिति और निदान</span>
          <span className="maturity-readiness-status maturity-readiness-status-needs-review">समीक्षा आवश्यक - संपूर्ण वर्गीकरण सत्यापन</span>
        </div>
        <span>7 में से 0 (0%) / 7 में से 0 (0%)</span>
        <span>क्षमता में 7 कमियाँ</span>
      </div>
    </div>
  </Accordion>
  ...
  <Accordion title="Linux Gateway होस्ट - 5 क्षेत्र">
    ...
    <div className="maturity-readiness-list">
      ...
      <div className="maturity-readiness-row">
        <div className="maturity-readiness-area">
          <span className="maturity-readiness-title">निदान और सुधार</span>
          <span className="maturity-readiness-status maturity-readiness-status-needs-review">समीक्षा आवश्यक - संपूर्ण वर्गीकरण सत्यापन</span>
        </div>
        <span>4 में से 0 (0%) / 4 में से 0 (0%)</span>
        <span>क्षमता में 4 कमियाँ</span>
      ...
      <div className="maturity-readiness-row">
        <div className="maturity-readiness-area">
          <span className="maturity-readiness-title">दूरस्थ पहुँच और सुरक्षा</span>
          <span className="maturity-readiness-status maturity-readiness-status-needs-review">समीक्षा आवश्यक - संपूर्ण वर्गीकरण सत्यापन</span>
        </div>
        <span>6 में से 0 (0%) / 6 में से 0 (0%)</span>
        <span>क्षमता में 6 कमियाँ</span>
  ...
  <Accordion title="स्थानीय मॉडल प्रदाता: Ollama, vLLM, SGLang, LM Studio - 5 क्षेत्र">
    ...
    <div className="maturity-readiness-list">
      ...
      <div className="maturity-readiness-row">
        <div className="maturity-readiness-area">
          <span className="maturity-readiness-title">स्थानीय मेमोरी और एम्बेडिंग</span>
          <span className="maturity-readiness-status maturity-readiness-status-needs-review">समीक्षा आवश्यक - संपूर्ण वर्गीकरण सत्यापन</span>
        </div>
        <span>5 में से 0 (0%) / 5 में से 0 (0%)</span>
        <span>क्षमता में 5 कमियाँ</span>
      ...
      <div className="maturity-readiness-row">
        ...
        <span>10 में से 0 (0%) / 10 में से 0 (0%)</span>
        <span>क्षमता में 10 कमियाँ</span>
      </div>
      <div className="maturity-readiness-row">
        <div className="maturity-readiness-area">
        ...
        <span>2 में से 0 (0%) / 2 में से 0 (0%)</span>
        <span>क्षमता में 2 कमियाँ</span>
      </div>
      <div className="maturity-readiness-row">
        <div className="maturity-readiness-area">
          <span className="maturity-readiness-title">OpenAI-संगत रनटाइम अनुकूलता</span>
          <span className="maturity-readiness-status maturity-readiness-status-needs-review">समीक्षा आवश्यक - संपूर्ण वर्गीकरण सत्यापन</span>
        </div>
        <span>8 में से 0 (0%) / 8 में से 0 (0%)</span>
        <span>क्षमता में 8 कमियाँ</span>
      </div>
      <div className="maturity-readiness-row">
        <div className="maturity-readiness-area">
          <span className="maturity-readiness-title">प्रदाता सेटअप, जीवनचक्र और निदान</span>
          <span className="maturity-readiness-status maturity-readiness-status-needs-review">समीक्षा आवश्यक - संपूर्ण वर्गीकरण सत्यापन</span>
        </div>
        <span>12 में से 0 (0%) / 12 में से 0 (0%)</span>
        <span>क्षमता में 12 कमियाँ</span>
      </div>
    </div>
  </Accordion>

  <Accordion title="कम प्रचलित होस्टेड प्रदाता - 3 क्षेत्र">
    <p className="maturity-readiness-summary">3 की समीक्षा आवश्यक है</p>
    <div className="maturity-readiness-list">
      <div className="maturity-readiness-row maturity-readiness-row-header"><span>क्षेत्र</span><span>सुविधाएँ / कवरेज आईडी</span><span>अनुवर्ती कार्रवाई</span></div>
      <div className="maturity-readiness-row">
        <div className="maturity-readiness-area">
  ...
  <Accordion title="macOS सहयोगी ऐप - 8 क्षेत्र">
    <p className="maturity-readiness-summary">8 की समीक्षा आवश्यक है</p>
    <div className="maturity-readiness-list">
      <div className="maturity-readiness-row maturity-readiness-row-header"><span>क्षेत्र</span><span>सुविधाएँ / कवरेज ID</span><span>अनुवर्ती कार्रवाई</span></div>
      <div className="maturity-readiness-row">
        <div className="maturity-readiness-area">
          <span className="maturity-readiness-title">कैनवस</span>
      ...
      <div className="maturity-readiness-row">
        <div className="maturity-readiness-area">
          <span className="maturity-readiness-title">दूरस्थ WebChat</span>
          <span className="maturity-readiness-status maturity-readiness-status-needs-review">समीक्षा आवश्यक - पूर्ण वर्गीकरण सत्यापन</span>
        </div>
        <span>5 में से 0 (0%) / 5 में से 0 (0%)</span>
        <span>क्षमता में 5 कमियाँ</span>
      ...
      <div className="maturity-readiness-row">
        <div className="maturity-readiness-area">
          <span className="maturity-readiness-title">आवाज़ और वार्तालाप</span>
          <span className="maturity-readiness-status maturity-readiness-status-needs-review">समीक्षा आवश्यक - पूर्ण वर्गीकरण सत्यापन</span>
        </div>
        <span>3 में से 0 (0%) / 3 में से 0 (0%)</span>
        <span>क्षमता में 3 कमियाँ</span>
  ...
  <Accordion title="macOS Gateway होस्ट - 7 क्षेत्र">
    <p className="maturity-readiness-summary">7 की समीक्षा आवश्यक है</p>
    <div className="maturity-readiness-list">
      <div className="maturity-readiness-row maturity-readiness-row-header"><span>क्षेत्र</span><span>सुविधाएँ / कवरेज ID</span><span>अनुवर्ती कार्रवाई</span></div>
      <div className="maturity-readiness-row">
        <div className="maturity-readiness-area">
      ...
      <div className="maturity-readiness-row">
        <div className="maturity-readiness-area">
          <span className="maturity-readiness-title">निदान और प्रेक्षणीयता</span>
          <span className="maturity-readiness-status maturity-readiness-status-needs-review">समीक्षा आवश्यक - पूर्ण वर्गीकरण सत्यापन</span>
        </div>
        <span>4 में से 0 (0%) / 4 में से 0 (0%)</span>
        <span>क्षमता में 4 कमियाँ</span>
      ...
      <div className="maturity-readiness-row">
        <div className="maturity-readiness-area">
          <span className="maturity-readiness-title">प्रोफ़ाइल और पृथक्करण</span>
          <span className="maturity-readiness-status maturity-readiness-status-needs-review">समीक्षा आवश्यक - पूर्ण वर्गीकरण सत्यापन</span>
        </div>
        <span>5 में से 0 (0%) / 5 में से 0 (0%)</span>
        <span>क्षमता में 5 कमियाँ</span>
  ...
  <Accordion title="मीडिया की समझ और मीडिया निर्माण - 6 क्षेत्र">
    <p className="maturity-readiness-summary">4 की समीक्षा आवश्यक है / 2 की आंशिक समीक्षा हुई है</p>
    <div className="maturity-readiness-list">
      <div className="maturity-readiness-row maturity-readiness-row-header"><span>क्षेत्र</span><span>सुविधाएँ / कवरेज ID</span><span>अनुवर्ती कार्रवाई</span></div>
      <div className="maturity-readiness-row">
        <div className="maturity-readiness-area">
          <span className="maturity-readiness-title">चैनल मीडिया प्रबंधन</span>
          <span className="maturity-readiness-status maturity-readiness-status-needs-review">समीक्षा आवश्यक - पूर्ण वर्गीकरण सत्यापन</span>
        </div>
        <span>5 में से 0 (0%) / 5 में से 0 (0%)</span>
        <span>5 क्षमता अंतर</span>
      ...
      <div className="maturity-readiness-row">
        <div className="maturity-readiness-area">
          <span className="maturity-readiness-title">मीडिया निर्माण</span>
          <span className="maturity-readiness-status maturity-readiness-status-partially-reviewed">आंशिक समीक्षा हुई - पूर्ण वर्गीकरण सत्यापन</span>
        </div>
      ...
      <div className="maturity-readiness-row">
        <div className="maturity-readiness-area">
          <span className="maturity-readiness-title">मीडिया ग्रहण और पहुँच</span>
          <span className="maturity-readiness-status maturity-readiness-status-needs-review">समीक्षा आवश्यक - पूर्ण वर्गीकरण सत्यापन</span>
        </div>
        <span>8 में से 0 (0%) / 8 में से 0 (0%)</span>
        <span>8 क्षमता अंतर</span>
      ...
      <div className="maturity-readiness-row">
        <div className="maturity-readiness-area">
          <span className="maturity-readiness-title">मीडिया की समझ</span>
          <span className="maturity-readiness-status maturity-readiness-status-partially-reviewed">आंशिक समीक्षा हुई - पूर्ण वर्गीकरण सत्यापन</span>
        </div>
      ...
      <div className="maturity-readiness-row">
        <div className="maturity-readiness-area">
          <span className="maturity-readiness-title">टेक्स्ट-टू-स्पीच वितरण</span>
          <span className="maturity-readiness-status maturity-readiness-status-needs-review">समीक्षा आवश्यक - पूर्ण वर्गीकरण सत्यापन</span>
        </div>
        <span>2 में से 0 (0%) / 2 में से 0 (0%)</span>
  ...
  <Accordion title="मूल Windows - 4 क्षेत्र">
    <p className="maturity-readiness-summary">4 की समीक्षा आवश्यक है</p>
    <div className="maturity-readiness-list">
      <div className="maturity-readiness-row maturity-readiness-row-header"><span>क्षेत्र</span><span>सुविधाएँ / कवरेज ID</span><span>अनुवर्ती कार्रवाई</span></div>
      <div className="maturity-readiness-row">
  ...
  <Accordion title="नेटिव Windows सहायक ऐप - 5 क्षेत्र">
    <p className="maturity-readiness-summary">5 की समीक्षा आवश्यक</p>
    <div className="maturity-readiness-list">
      <div className="maturity-readiness-row maturity-readiness-row-header"><span>क्षेत्र</span><span>सुविधाएँ / कवरेज ID</span><span>अनुवर्ती कार्रवाई</span></div>
      <div className="maturity-readiness-row">
        <div className="maturity-readiness-area">
  ...
  <Accordion title="Nix इंस्टॉल पथ - 5 क्षेत्र">
    ...
    <div className="maturity-readiness-list">
      ...
      <div className="maturity-readiness-row">
        <div className="maturity-readiness-area">
          <span className="maturity-readiness-title">सक्रियण और ऐप उपयोगकर्ता अनुभव</span>
          <span className="maturity-readiness-status maturity-readiness-status-needs-review">समीक्षा आवश्यक - पूर्ण वर्गीकरण सत्यापन</span>
        </div>
        <span>7 में से 0 (0%) / 7 में से 0 (0%)</span>
        <span>7 क्षमता अंतराल</span>
      ...
      <div className="maturity-readiness-row">
        <div className="maturity-readiness-area">
          <span className="maturity-readiness-title">इंस्टॉल हस्तांतरण</span>
          <span className="maturity-readiness-status maturity-readiness-status-needs-review">समीक्षा आवश्यक - पूर्ण वर्गीकरण सत्यापन</span>
        </div>
        <span>4 में से 0 (0%) / 4 में से 0 (0%)</span>
        <span>4 क्षमता अंतराल</span>
      ...
      <div className="maturity-readiness-row">
        <div className="maturity-readiness-area">
          <span className="maturity-readiness-title">सेवा रनटाइम और सुरक्षा नियंत्रण</span>
          <span className="maturity-readiness-status maturity-readiness-status-needs-review">समीक्षा आवश्यक - पूर्ण वर्गीकरण सत्यापन</span>
        </div>
        <span>8 में से 0 (0%) / 8 में से 0 (0%)</span>
        <span>8 क्षमता अंतराल</span>
  ...
  <Accordion title="OpenAI और Codex प्रदाता पथ - 5 क्षेत्र">
    <p className="maturity-readiness-summary">2 की समीक्षा आवश्यक / 3 की आंशिक समीक्षा हुई</p>
    <div className="maturity-readiness-list">
      <div className="maturity-readiness-row maturity-readiness-row-header"><span>क्षेत्र</span><span>सुविधाएँ / कवरेज ID</span><span>अनुवर्ती कार्रवाई</span></div>
      <div className="maturity-readiness-row">
        <div className="maturity-readiness-area">
          <span className="maturity-readiness-title">छवि और बहुविध इनपुट</span>
          <span className="maturity-readiness-status maturity-readiness-status-needs-review">समीक्षा आवश्यक - पूर्ण वर्गीकरण सत्यापन</span>
        </div>
        <span>2 में से 0 (0%) / 2 में से 0 (0%)</span>
        <span>2 क्षमता अंतराल</span>
      ...
      <div className="maturity-readiness-row">
        <div className="maturity-readiness-area">
          <span className="maturity-readiness-title">प्रतिक्रियाएँ और टूल संगतता</span>
          <span className="maturity-readiness-status maturity-readiness-status-partially-reviewed">आंशिक समीक्षा हुई - पूर्ण वर्गीकरण सत्यापन</span>
        </div>
      ...
      <div className="maturity-readiness-row">
        <div className="maturity-readiness-area">
          <span className="maturity-readiness-title">वॉइस और रीयल-टाइम ऑडियो</span>
          <span className="maturity-readiness-status maturity-readiness-status-needs-review">समीक्षा आवश्यक - पूर्ण वर्गीकरण सत्यापन</span>
        </div>
        <span>2 में से 0 (0%) / 2 में से 0 (0%)</span>
        <span>2 क्षमता अंतराल</span>
  ...
  <Accordion title="OpenClaw ऐप SDK - 6 क्षेत्र">
    ...
    <div className="maturity-readiness-list">
      ...
      <div className="maturity-readiness-row">
        <div className="maturity-readiness-area">
          <span className="maturity-readiness-title">ईवेंट और अनुमोदन</span>
          <span className="maturity-readiness-status maturity-readiness-status-needs-review">समीक्षा आवश्यक - पूर्ण वर्गीकरण सत्यापन</span>
        </div>
        <span>5 में से 0 (0%) / 5 में से 0 (0%)</span>
        <span>5 क्षमता अंतराल</span>
      ...
      <div className="maturity-readiness-row">
        <div className="maturity-readiness-area">
          <span className="maturity-readiness-title">संसाधन सहायक</span>
          <span className="maturity-readiness-status maturity-readiness-status-partially-reviewed">आंशिक समीक्षा हुई - पूर्ण वर्गीकरण सत्यापन</span>
        </div>
  ...
  <Accordion title="OpenRouter प्रोवाइडर पथ - 4 क्षेत्र">
    <p className="maturity-readiness-summary">4 की समीक्षा आवश्यक है</p>
    <div className="maturity-readiness-list">
      <div className="maturity-readiness-row maturity-readiness-row-header"><span>क्षेत्र</span><span>सुविधाएँ / कवरेज आईडी</span><span>अनुवर्ती कार्रवाई</span></div>
      <div className="maturity-readiness-row">
      ...
      <div className="maturity-readiness-row">
        <div className="maturity-readiness-area">
          <span className="maturity-readiness-title">मीडिया जनरेशन और वाक्</span>
          <span className="maturity-readiness-status maturity-readiness-status-needs-review">समीक्षा आवश्यक - पूर्ण वर्गीकरण सत्यापन</span>
        </div>
        <span>7 में से 0 (0%) / 7 में से 0 (0%)</span>
        <span>7 क्षमता अंतराल</span>
      ...
      <div className="maturity-readiness-row">
        <div className="maturity-readiness-area">
          <span className="maturity-readiness-title">प्रोवाइडर पुनर्प्राप्ति और निदान</span>
          <span className="maturity-readiness-status maturity-readiness-status-needs-review">समीक्षा आवश्यक - पूर्ण वर्गीकरण सत्यापन</span>
        </div>
        <span>5 में से 0 (0%) / 5 में से 0 (0%)</span>
        <span>5 क्षमता अंतराल</span>
      ...
      <div className="maturity-readiness-row">
        <div className="maturity-readiness-area">
          <span className="maturity-readiness-title">प्रोवाइडर सेटअप और प्रमाणीकरण</span>
          <span className="maturity-readiness-status maturity-readiness-status-needs-review">समीक्षा आवश्यक - पूर्ण वर्गीकरण सत्यापन</span>
        </div>
  ...
  <Accordion title="Plugins - 9 क्षेत्र">
    <p className="maturity-readiness-summary">6 की समीक्षा आवश्यक है / 3 की आंशिक समीक्षा हुई है</p>
    <div className="maturity-readiness-list">
      <div className="maturity-readiness-row maturity-readiness-row-header"><span>क्षेत्र</span><span>सुविधाएँ / कवरेज आईडी</span><span>अनुवर्ती कार्रवाई</span></div>
      <div className="maturity-readiness-row">
        <div className="maturity-readiness-area">
          <span className="maturity-readiness-title">Plugins का निर्माण और पैकेजिंग</span>
          <span className="maturity-readiness-status maturity-readiness-status-needs-review">समीक्षा आवश्यक - पूर्ण वर्गीकरण सत्यापन</span>
        </div>
        <span>8 में से 0 (0%) / 8 में से 0 (0%)</span>
        <span>8 क्षमता अंतराल</span>
      ...
      <div className="maturity-readiness-row">
        <div className="maturity-readiness-area">
          <span className="maturity-readiness-title">कैनवास Plugin</span>
          <span className="maturity-readiness-status maturity-readiness-status-needs-review">समीक्षा आवश्यक - पूर्ण वर्गीकरण सत्यापन</span>
        </div>
        <span>6 में से 0 (0%) / 6 में से 0 (0%)</span>
        <span>6 क्षमता अंतराल</span>
      ...
      <div className="maturity-readiness-row">
        <div className="maturity-readiness-area">
          <span className="maturity-readiness-title">Plugins को इंस्टॉल और चलाना</span>
          <span className="maturity-readiness-status maturity-readiness-status-partially-reviewed">आंशिक समीक्षा हुई - पूर्ण वर्गीकरण सत्यापन</span>
        </div>
      ...
      <div className="maturity-readiness-row">
        <div className="maturity-readiness-area">
          <span className="maturity-readiness-title">प्रोवाइडर और टूल Plugins</span>
          <span className="maturity-readiness-status maturity-readiness-status-partially-reviewed">आंशिक समीक्षा हुई - पूर्ण वर्गीकरण सत्यापन</span>
        </div>
  ...
  <Accordion title="सुरक्षा, प्रमाणीकरण, पेयरिंग और सीक्रेट - 6 क्षेत्र">
    <p className="maturity-readiness-summary">2 की आंशिक समीक्षा हुई है / 4 की समीक्षा आवश्यक है</p>
    <div className="maturity-readiness-list">
      <div className="maturity-readiness-row maturity-readiness-row-header"><span>क्षेत्र</span><span>सुविधाएँ / कवरेज आईडी</span><span>अनुवर्ती कार्रवाई</span></div>
      <div className="maturity-readiness-row">
        <div className="maturity-readiness-area">
      ...
      <div className="maturity-readiness-row">
        <div className="maturity-readiness-area">
          <span className="maturity-readiness-title">क्रेडेंशियल और सीक्रेट की स्वच्छता</span>
          <span className="maturity-readiness-status maturity-readiness-status-partially-reviewed">आंशिक समीक्षा हुई - पूर्ण वर्गीकरण सत्यापन</span>
        </div>
      ...
      <div className="maturity-readiness-row">
        <div className="maturity-readiness-area">
          <span className="maturity-readiness-title">Plugin विश्वसनीयता</span>
          <span className="maturity-readiness-status maturity-readiness-status-needs-review">समीक्षा आवश्यक - पूर्ण वर्गीकरण सत्यापन</span>
        </div>
        <span>2 में से 0 (0%) / 2 में से 0 (0%)</span>
        <span>2 क्षमता अंतराल</span>
  ...
  <Accordion title="सेशन, मेमोरी और कॉन्टेक्स्ट इंजन - 9 क्षेत्र">
    <p className="maturity-readiness-summary">2 की समीक्षा आवश्यक / 7 की आंशिक समीक्षा हुई</p>
    <div className="maturity-readiness-list">
      <div className="maturity-readiness-row maturity-readiness-row-header"><span>क्षेत्र</span><span>फ़ीचर / कवरेज ID</span><span>फ़ॉलो-अप</span></div>
      <div className="maturity-readiness-row">
        <div className="maturity-readiness-area">
          <span className="maturity-readiness-title">CLI सेशन और ट्रांसक्रिप्ट प्रबंधन</span>
          <span className="maturity-readiness-status maturity-readiness-status-needs-review">समीक्षा आवश्यक - पूर्ण वर्गीकरण सत्यापन</span>
        </div>
        <span>2 में से 0 (0%) / 2 में से 0 (0%)</span>
        <span>2 क्षमता अंतराल</span>
      ...
      <div className="maturity-readiness-row">
        <div className="maturity-readiness-area">
          <span className="maturity-readiness-title">कॉन्टेक्स्ट इंजन</span>
          <span className="maturity-readiness-status maturity-readiness-status-partially-reviewed">आंशिक समीक्षा हुई - पूर्ण वर्गीकरण सत्यापन</span>
        </div>
      ...
      <div className="maturity-readiness-row">
        <div className="maturity-readiness-area">
          <span className="maturity-readiness-title">मुख्य प्रॉम्प्ट और कॉन्टेक्स्ट</span>
          <span className="maturity-readiness-status maturity-readiness-status-partially-reviewed">आंशिक समीक्षा हुई - पूर्ण वर्गीकरण सत्यापन</span>
        </div>
      ...
      <div className="maturity-readiness-row">
        <div className="maturity-readiness-area">
          <span className="maturity-readiness-title">विभिन्न क्लाइंट में इतिहास और सेशन की समानता</span>
          <span className="maturity-readiness-status maturity-readiness-status-partially-reviewed">आंशिक समीक्षा हुई - पूर्ण वर्गीकरण सत्यापन</span>
        </div>
      ...
      <div className="maturity-readiness-row">
        <div className="maturity-readiness-area">
          <span className="maturity-readiness-title">सेशन रूटिंग</span>
          <span className="maturity-readiness-status maturity-readiness-status-partially-reviewed">आंशिक समीक्षा हुई - पूर्ण वर्गीकरण सत्यापन</span>
        </div>
  ...
  <Accordion title="अवलोकनीयता - 5 क्षेत्र">
    <p className="maturity-readiness-summary">3 की आंशिक समीक्षा हुई / 2 को समीक्षा की आवश्यकता है</p>
    <div className="maturity-readiness-list">
      <div className="maturity-readiness-row maturity-readiness-row-header"><span>क्षेत्र</span><span>सुविधाएँ / कवरेज ID</span><span>अनुवर्ती कार्रवाई</span></div>
      <div className="maturity-readiness-row">
        <div className="maturity-readiness-area">
          <span className="maturity-readiness-title">नैदानिक संग्रह</span>
          <span className="maturity-readiness-status maturity-readiness-status-partially-reviewed">आंशिक समीक्षा हुई - पूर्ण वर्गीकरण सत्यापन</span>
        </div>
      ...
      <div className="maturity-readiness-row">
        <div className="maturity-readiness-area">
          <span className="maturity-readiness-title">स्वास्थ्य और सुधार</span>
          <span className="maturity-readiness-status maturity-readiness-status-partially-reviewed">आंशिक समीक्षा हुई - पूर्ण वर्गीकरण सत्यापन</span>
        </div>
  ...
  <Accordion title="TUI - 5 क्षेत्र">
    ...
    <div className="maturity-readiness-list">
      ...
      <div className="maturity-readiness-row">
        <div className="maturity-readiness-area">
          <span className="maturity-readiness-title">स्थानीय शेल निष्पादन</span>
          <span className="maturity-readiness-status maturity-readiness-status-needs-review">समीक्षा की आवश्यकता है - पूर्ण वर्गीकरण सत्यापन</span>
        </div>
        <span>4 में से 0 (0%) / 4 में से 0 (0%)</span>
        <span>4 क्षमता अंतराल</span>
  ...
  <Accordion title="वॉइस और रियलटाइम वार्तालाप - 6 क्षेत्र">
    <p className="maturity-readiness-summary">6 को समीक्षा की आवश्यकता है</p>
    <div className="maturity-readiness-list">
      <div className="maturity-readiness-row maturity-readiness-row-header"><span>क्षेत्र</span><span>सुविधाएँ / कवरेज ID</span><span>अनुवर्ती कार्रवाई</span></div>
      <div className="maturity-readiness-row">
        <div className="maturity-readiness-area">
          <span className="maturity-readiness-title">नेटिव ऐप वार्तालाप</span>
          <span className="maturity-readiness-status maturity-readiness-status-needs-review">समीक्षा की आवश्यकता है - पूर्ण वर्गीकरण सत्यापन</span>
        </div>
        <span>4 में से 0 (0%) / 4 में से 0 (0%)</span>
        <span>4 क्षमता अंतराल</span>
      ...
      <div className="maturity-readiness-row">
        <div className="maturity-readiness-area">
          <span className="maturity-readiness-title">रियलटाइम वार्तालाप सत्र</span>
          <span className="maturity-readiness-status maturity-readiness-status-needs-review">समीक्षा की आवश्यकता है - पूर्ण वर्गीकरण सत्यापन</span>
        </div>
        <span>11 में से 0 (0%) / 11 में से 0 (0%)</span>
        <span>11 क्षमता अंतराल</span>
      ...
      <div className="maturity-readiness-row">
        <div className="maturity-readiness-area">
          <span className="maturity-readiness-title">वाक् और प्रतिलेखन</span>
          <span className="maturity-readiness-status maturity-readiness-status-needs-review">समीक्षा की आवश्यकता है - पूर्ण वर्गीकरण सत्यापन</span>
        </div>
        <span>5 में से 0 (0%) / 5 में से 0 (0%)</span>
        <span>5 क्षमता अंतराल</span>
      ...
      <div className="maturity-readiness-row">
        <div className="maturity-readiness-area">
          <span className="maturity-readiness-title">वार्तालाप अवलोकनीयता</span>
          <span className="maturity-readiness-status maturity-readiness-status-needs-review">समीक्षा की आवश्यकता है - पूर्ण वर्गीकरण सत्यापन</span>
        </div>
        <span>5 में से 0 (0%) / 5 में से 0 (0%)</span>
        <span>5 क्षमता अंतराल</span>
      ...
      <div className="maturity-readiness-row">
        <div className="maturity-readiness-area">
          <span className="maturity-readiness-title">वार्तालाप प्रदाता</span>
          <span className="maturity-readiness-status maturity-readiness-status-needs-review">समीक्षा की आवश्यकता है - पूर्ण वर्गीकरण सत्यापन</span>
        </div>
        <span>7 में से 0 (0%) / 7 में से 0 (0%)</span>
        <span>7 क्षमता अंतराल</span>
  ...
  <Accordion title="वॉइस कॉल चैनल - 5 क्षेत्र">
    ...
    <div className="maturity-readiness-list">
      ...
      <div className="maturity-readiness-row">
        <div className="maturity-readiness-area">
          <span className="maturity-readiness-title">रियलटाइम वॉइस और कॉल</span>
          <span className="maturity-readiness-status maturity-readiness-status-needs-review">समीक्षा की आवश्यकता है - पूर्ण वर्गीकरण सत्यापन</span>
        </div>
        <span>2 में से 0 (0%) / 2 में से 0 (0%)</span>
        <span>2 क्षमता अंतराल</span>
  ...
  <Accordion title="watchOS सहायक सतहें - 5 क्षेत्र">
    <p className="maturity-readiness-summary">5 की समीक्षा आवश्यक है</p>
    <div className="maturity-readiness-list">
      <div className="maturity-readiness-row maturity-readiness-row-header"><span>क्षेत्र</span><span>सुविधाएँ / कवरेज ID</span><span>अनुवर्ती कार्रवाई</span></div>
      <div className="maturity-readiness-row">
        <div className="maturity-readiness-area">
          <span className="maturity-readiness-title">वितरण और पुनर्प्राप्ति</span>
          <span className="maturity-readiness-status maturity-readiness-status-needs-review">समीक्षा आवश्यक - पूर्ण वर्गीकरण सत्यापन</span>
        </div>
        <span>7 में से 0 (0%) / 7 में से 0 (0%)</span>
        <span>7 क्षमता अंतराल</span>
      ...
      <div className="maturity-readiness-row">
        <div className="maturity-readiness-area">
          <span className="maturity-readiness-title">निष्पादन अनुमोदन</span>
          <span className="maturity-readiness-status maturity-readiness-status-needs-review">समीक्षा आवश्यक - पूर्ण वर्गीकरण सत्यापन</span>
        </div>
        <span>3 में से 0 (0%) / 3 में से 0 (0%)</span>
        <span>3 क्षमता अंतराल</span>
  ...
  <Accordion title="वेब खोज टूल - 4 क्षेत्र">
    <p className="maturity-readiness-summary">2 की समीक्षा आवश्यक है / 2 की आंशिक समीक्षा हुई है</p>
    <div className="maturity-readiness-list">
      <div className="maturity-readiness-row maturity-readiness-row-header"><span>क्षेत्र</span><span>सुविधाएँ / कवरेज ID</span><span>अनुवर्ती कार्रवाई</span></div>
      <div className="maturity-readiness-row">
        <div className="maturity-readiness-area">
      ...
      <div className="maturity-readiness-row">
        <div className="maturity-readiness-area">
          <span className="maturity-readiness-title">टूल उपलब्धता और प्राप्ति</span>
          <span className="maturity-readiness-status maturity-readiness-status-partially-reviewed">आंशिक समीक्षा हुई - पूर्ण वर्गीकरण सत्यापन</span>
        </div>
  ...
  <Accordion title="WSL2 के माध्यम से Windows - 6 क्षेत्र">
    <p className="maturity-readiness-summary">5 की समीक्षा आवश्यक है / 1 की आंशिक समीक्षा हुई है</p>
    <div className="maturity-readiness-list">
      <div className="maturity-readiness-row maturity-readiness-row-header"><span>क्षेत्र</span><span>सुविधाएँ / कवरेज ID</span><span>अनुवर्ती कार्रवाई</span></div>
      <div className="maturity-readiness-row">
        <div className="maturity-readiness-area">
      ...
      <div className="maturity-readiness-row">
        <div className="maturity-readiness-area">
          <span className="maturity-readiness-title">Gateway पहुँच और अनावरण</span>
          <span className="maturity-readiness-status maturity-readiness-status-needs-review">समीक्षा आवश्यक - पूर्ण वर्गीकरण सत्यापन</span>
        </div>
        <span>11 में से 0 (0%) / 11 में से 0 (0%)</span>
        <span>11 क्षमता अंतराल</span>
