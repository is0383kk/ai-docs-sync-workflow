...
read_when:
    ...
    - Instances UI में डिवाइस के नाम प्रदर्शित करने का तरीका बदलना
summary: OpenClaw macOS ऐप में उपयोगकर्ता-अनुकूल नामों के लिए Apple डिवाइस मॉडल पहचानकर्ताओं को कैसे वेंडर करता है।
title: डिवाइस मॉडल डेटाबेस
x-i18n:
    generated_at: "2026-07-27T18:29:18Z"
    model: gpt-5.6
...
macOS सहयोगी ऐप का **Instances** UI, Apple मॉडल पहचानकर्ताओं को सरल नामों से मैप करता है (`iPad16,6` -> "iPad Pro 13-इंच (M4)", `Mac16,6` -> "MacBook Pro (14-इंच, 2024)")। `DeviceModelCatalog` प्रत्येक डिवाइस के लिए SF Symbol चुनने हेतु पहचानकर्ता प्रीफ़िक्स (और उपलब्ध न होने पर डिवाइस परिवार) का भी उपयोग करता है।
...
2. नए SHA के साथ `apps/macos/Sources/OpenClaw/Resources/DeviceModels/NOTICE.md` अपडेट करें।
3. उन कमिट पर पिन की गई JSON फ़ाइलें फिर से डाउनलोड करें:
...
4. पुष्टि करें कि `LICENSE.apple-device-identifiers.txt` अब भी अपस्ट्रीम से मेल खाता है; यदि अपस्ट्रीम लाइसेंस बदल गया हो, तो इसे बदलें।
