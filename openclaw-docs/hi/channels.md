...
title: चैट चैनल
x-i18n:
    generated_at: "2026-07-27T19:07:04Z"
    model: gpt-5.6
...
OpenClaw आपके द्वारा पहले से उपयोग किए जाने वाले किसी भी चैट ऐप पर आपसे बात कर सकता है। प्रत्येक चैनल Gateway के माध्यम से जुड़ता है।
...
या `openclaw onboard` / `openclaw channels add` के दौरान आवश्यकता पड़ने पर इंस्टॉल होते हैं, फिर Gateway को
पुनः आरंभ करना पड़ता है। "बाहरी Plugin" चैनलों का रखरखाव OpenClaw रेपो के बाहर किया जाता है।
...
- [iMessage](/hi/channels/imessage) - कोर में शामिल। साइन-इन किए हुए Mac पर `imsg` ब्रिज के माध्यम से मूल macOS एकीकरण (या जब Gateway कहीं और चलता है, तब SSH रैपर), जिसमें जवाबों, टैपबैक, प्रभावों, अटैचमेंट और समूह प्रबंधन के लिए निजी API कार्रवाइयाँ शामिल हैं।
...
- [Nextcloud Talk](/hi/channels/nextcloud-talk) - Nextcloud Talk के माध्यम से स्वयं होस्ट की गई चैट (आधिकारिक Plugin)।
...
- [Reef](/hi/channels/reef) - अलग-अलग लोगों के OpenClaw एजेंटों के बीच सुरक्षित, एंड-टू-एंड एन्क्रिप्टेड क्लॉ-टू-क्लॉ संदेश सेवा (बंडल किया गया Plugin)।
...
- [WhatsApp](/hi/channels/whatsapp) - सबसे लोकप्रिय; Baileys का उपयोग करता है और QR पेयरिंग आवश्यक है (आधिकारिक Plugin)।
...
- [Zalo ClawBot](/hi/channels/zaloclawbot) - QR लॉगिन के माध्यम से निजी Zalo सहायक; स्वामी से संबद्ध (बाहरी Plugin)।
- [Zalo Personal](/hi/channels/zalouser) - QR लॉगिन के माध्यम से Zalo निजी खाता (आधिकारिक Plugin)।

## डिलीवरी संबंधी टिप्पणियाँ

- Telegram के जिन जवाबों में `![alt](url)` जैसा Markdown इमेज सिंटैक्स होता है,
  उन्हें संभव होने पर अंतिम आउटबाउंड पथ पर मीडिया जवाबों में बदला जाता है।
- Slack में कई लोगों वाले DM समूह चैट के रूप में रूट होते हैं, इसलिए MPIM वार्तालापों पर समूह नीति, उल्लेख
  व्यवहार और समूह-सत्र नियम लागू होते हैं।
- WhatsApp सेटअप आवश्यकता पड़ने पर इंस्टॉल होता है: ऑनबोर्डिंग Plugin पैकेज इंस्टॉल होने से पहले
  सेटअप प्रवाह दिखा सकती है, और Gateway बाहरी
  ClawHub/npm Plugin को केवल तभी लोड करता है जब चैनल वास्तव में सक्रिय हो।
- बॉट द्वारा लिखे गए इनबाउंड संदेश स्वीकार करने वाले चैनल, बॉट जोड़ियों को
  अनिश्चित काल तक एक-दूसरे को जवाब देने से रोकने के लिए साझा
  [बॉट लूप सुरक्षा](/hi/channels/bot-loop-protection) का उपयोग कर सकते हैं।
- समर्थित हमेशा-सक्रिय रूम [परिवेशी रूम इवेंट](/hi/channels/ambient-room-events)
  का उपयोग कर सकते हैं, ताकि बिना उल्लेख वाली रूम बातचीत शांत संदर्भ बन जाए, जब तक कि एजेंट
  `message` टूल से संदेश न भेजे।

## टिप्पणियाँ

- चैनल एक साथ चल सकते हैं; एक से अधिक चैनल कॉन्फ़िगर करें और OpenClaw प्रत्येक चैट के अनुसार रूट करेगा।
- सबसे तेज़ सेटअप आमतौर पर **Telegram** है (सरल बॉट टोकन, Plugin इंस्टॉल करने की आवश्यकता नहीं)। WhatsApp
  को QR पेयरिंग की आवश्यकता होती है और वह डिस्क पर अधिक स्थिति संग्रहीत करता है।
- समूह व्यवहार चैनल के अनुसार बदलता है; [समूह](/hi/channels/groups) देखें।
...
- मॉडल प्रदाताओं का दस्तावेज़ अलग से उपलब्ध है; [मॉडल प्रदाता](/hi/providers/models) देखें।
