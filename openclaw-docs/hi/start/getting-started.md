...
title: शुरू करना
x-i18n:
    generated_at: "2026-07-27T18:37:34Z"
    model: gpt-5.6
...
- मॉडल प्रदाता (Anthropic, OpenAI, Google आदि) से **एक API कुंजी** — ऑनबोर्डिंग के दौरान आपसे इसके लिए पूछा जाएगा
...
/>
  ...
  <Step title="ऑनबोर्डिंग चलाएँ">
    ...
    विज़ार्ड मॉडल प्रदाता चुनने, API कुंजी सेट करने और Gateway कॉन्फ़िगर करने में आपका मार्गदर्शन करता है। QuickStart में आम तौर पर केवल कुछ मिनट लगते हैं, लेकिन प्रदाता में साइन-इन, चैनल पेयरिंग, डेमन इंस्टॉलेशन, नेटवर्क डाउनलोड, Skills या वैकल्पिक plugins के कारण पूर्ण ऑनबोर्डिंग में अधिक समय लग सकता है। वैकल्पिक चरण छोड़ें और बाद में `openclaw configure` के साथ वापस आएँ।
  ...
  <Step title="अपना पहला संदेश भेजें">
    Control UI चैट में कोई संदेश लिखें और आपको AI से उत्तर मिलना चाहिए।
...
<Accordion title="उन्नत: कस्टम Control UI बिल्ड माउंट करें">
  यदि आप स्थानीयकृत या अनुकूलित डैशबोर्ड बिल्ड का रखरखाव करते हैं, तो `gateway.controlUi.root` को उस डायरेक्टरी पर इंगित करें जिसमें आपकी बिल्ड की गई स्टैटिक एसेट और `index.html` मौजूद हों।

```bash
mkdir -p "$HOME/.openclaw/control-ui-custom"
# अपनी बिल्ड की गई स्टैटिक फ़ाइलों को उस डायरेक्टरी में कॉपी करें।
```
...
<Columns>
  <Card title="चैनल कनेक्ट करें" href="/hi/channels" icon="message-square">
...
<Accordion title="उन्नत: पर्यावरण चर">
  यदि आप OpenClaw को सेवा खाते के रूप में चलाते हैं या कस्टम पाथ चाहते हैं:

- `OPENCLAW_HOME` — आंतरिक पाथ रिज़ॉल्यूशन के लिए होम डायरेक्टरी
- `OPENCLAW_STATE_DIR` — स्टेट डायरेक्टरी को ओवरराइड करें
- `OPENCLAW_CONFIG_PATH` — कॉन्फ़िगरेशन फ़ाइल पाथ को ओवरराइड करें
