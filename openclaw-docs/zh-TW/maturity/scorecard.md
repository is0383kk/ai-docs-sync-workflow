---
summary: OpenClaw 產品領域、整合與支援工作流程的發布就緒度評分。
title: 成熟度評分卡
x-i18n:
    generated_at: "2026-07-26T08:22:15Z"
    model: gpt-5.6
...
<div className="maturity-hero">
  <p className="maturity-kicker">發布就緒程度 - 根據分類體系與 QA 證據產生</p>
  <p className="maturity-hero-title">以實用角度檢視哪些項目已就緒、哪些已獲驗證，以及哪些仍需改進。</p>
  <p>50 個介面 - 281 個功能領域 - 確定性涵蓋率，加上經人工審查的品質與完整性。</p>
  <p className="maturity-jump-links"><a href="#surface-explorer">瀏覽介面</a> / <a href="#qa-evidence-summary">檢視 QA 證據</a> / <a href="/zh-TW/maturity/taxonomy">閱讀分類體系</a></p>
</div>

## 本頁用途

使用本頁回答一個問題：哪些 OpenClaw 介面是發布時可信賴的選擇，而哪些證據支持這項判斷？涵蓋率來自確定性的 QA 證據；品質與完整性則以經審查的成熟度分數維護。
...
涵蓋率刻意以證據為依據：某個領域不會僅因實作存在就變成「就緒」。涵蓋率不會納入成熟度分數，但 OpenClaw 的目標是讓成熟且達 Stable 或更高等級的功能，其端對端涵蓋率能長期維持在 90% 以上。
...
介面依成熟度等級、完整性與品質排序。每列也會顯示 LTS 支援，方便比較適合發布的選項。
  ...
  <Tab title="所有介面">
    <div className="maturity-surface-table">
      ...
      <div className="maturity-surface-row">
        <a className="maturity-surface-name" href="/zh-TW/maturity/taxonomy#agent-runtime"><span className="maturity-surface-title">代理程式執行階段</span><span className="maturity-surface-meta"><span className="maturity-level-pill maturity-level-beta"><span className="maturity-level-code">M3</span><span>Beta</span></span><span>9 個領域</span></span></a>
      ...
      <div className="maturity-surface-row">
        <a className="maturity-surface-name" href="/zh-TW/maturity/taxonomy#browser-automation-exec-and-sandbox-tools"><span className="maturity-surface-title">瀏覽器自動化、執行與沙箱工具</span><span className="maturity-surface-meta"><span className="maturity-level-pill maturity-level-beta"><span className="maturity-level-code">M3</span><span>Beta</span></span><span>3 個領域</span></span></a>
      ...
      <div className="maturity-surface-row">
        <a className="maturity-surface-name" href="/zh-TW/maturity/taxonomy#security-auth-pairing-and-secrets"><span className="maturity-surface-title">安全性、驗證、配對與祕密</span><span className="maturity-surface-meta"><span className="maturity-level-pill maturity-level-beta"><span className="maturity-level-code">M3</span><span>測試版</span></span><span>6 個領域</span></span></a>
      ...
      <div className="maturity-surface-row">
        <a className="maturity-surface-name" href="/zh-TW/maturity/taxonomy#windows-via-wsl2"><span className="maturity-surface-title">透過 WSL2 使用 Windows</span><span className="maturity-surface-meta"><span className="maturity-level-pill maturity-level-beta"><span className="maturity-level-code">M3</span><span>Beta</span></span><span>6 個領域</span></span></a>
        <div className="maturity-surface-metric"><span className="maturity-surface-metric-label">涵蓋率</span><span className="maturity-score maturity-score-experimental"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-experimental">實驗性</span><span>6%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "6%" }} /></span></span></div>
        <div className="maturity-surface-metric"><span className="maturity-surface-metric-label">品質</span><span className="maturity-score maturity-score-alpha"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-alpha">Alpha</span><span>69%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "69%" }} /></span></span></div>
        <div className="maturity-surface-metric"><span className="maturity-surface-metric-label">完整度</span><span className="maturity-score maturity-score-beta"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-beta">Beta</span><span>79%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "79%" }} /></span></span></div>
        <div className="maturity-surface-support"><span className="maturity-lts maturity-lts-partial">部分 - 5</span></div>
      </div>
      <div className="maturity-surface-row">
        <a className="maturity-surface-name" href="/zh-TW/maturity/taxonomy#raspberry-pi-and-small-linux-devices"><span className="maturity-surface-title">Raspberry Pi 與小型 Linux 裝置</span><span className="maturity-surface-meta"><span className="maturity-level-pill maturity-level-beta"><span className="maturity-level-code">M3</span><span>Beta</span></span><span>4 個領域</span></span></a>
        <div className="maturity-surface-metric"><span className="maturity-surface-metric-label">涵蓋率</span><span className="maturity-score maturity-score-experimental"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-experimental">實驗性</span><span>0%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "0%" }} /></span></span></div>
        <div className="maturity-surface-metric"><span className="maturity-surface-metric-label">品質</span><span className="maturity-score maturity-score-alpha"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-alpha">Alpha</span><span>67%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "67%" }} /></span></span></div>
        <div className="maturity-surface-metric"><span className="maturity-surface-metric-label">完整度</span><span className="maturity-score maturity-score-beta"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-beta">Beta</span><span>79%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "79%" }} /></span></span></div>
        <div className="maturity-surface-support"><span className="maturity-lts maturity-lts-none">無</span></div>
      </div>
      <div className="maturity-surface-row">
      ...
      <div className="maturity-surface-row">
        <a className="maturity-surface-name" href="/zh-TW/maturity/taxonomy#imessage-and-bluebubbles"><span className="maturity-surface-title">iMessage 與 BlueBubbles</span><span className="maturity-surface-meta"><span className="maturity-level-pill maturity-level-beta"><span className="maturity-level-code">M3</span><span>Beta</span></span><span>5 個領域</span></span></a>
        <div className="maturity-surface-metric"><span className="maturity-surface-metric-label">涵蓋率</span><span className="maturity-score maturity-score-experimental"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-experimental">實驗性</span><span>0%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "0%" }} /></span></span></div>
        <div className="maturity-surface-metric"><span className="maturity-surface-metric-label">品質</span><span className="maturity-score maturity-score-alpha"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-alpha">Alpha</span><span>66%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "66%" }} /></span></span></div>
        <div className="maturity-surface-metric"><span className="maturity-surface-metric-label">完整度</span><span className="maturity-score maturity-score-beta"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-beta">Beta</span><span>78%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "78%" }} /></span></span></div>
        <div className="maturity-surface-support"><span className="maturity-lts maturity-lts-none">無</span></div>
      ...
      <div className="maturity-surface-row">
        <a className="maturity-surface-name" href="/zh-TW/maturity/taxonomy#macos-companion-app"><span className="maturity-surface-title">macOS 伴隨應用程式</span><span className="maturity-surface-meta"><span className="maturity-level-pill maturity-level-beta"><span className="maturity-level-code">M3</span><span>Beta</span></span><span>8 個領域</span></span></a>
        <div className="maturity-surface-metric"><span className="maturity-surface-metric-label">涵蓋率</span><span className="maturity-score maturity-score-experimental"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-experimental">實驗性</span><span>0%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "0%" }} /></span></span></div>
        <div className="maturity-surface-metric"><span className="maturity-surface-metric-label">品質</span><span className="maturity-score maturity-score-alpha"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-alpha">Alpha</span><span>66%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "66%" }} /></span></span></div>
        <div className="maturity-surface-metric"><span className="maturity-surface-metric-label">完整度</span><span className="maturity-score maturity-score-beta"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-beta">Beta</span><span>78%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "78%" }} /></span></span></div>
        <div className="maturity-surface-support"><span className="maturity-lts maturity-lts-none">無</span></div>
      ...
      <div className="maturity-surface-row">
        <a className="maturity-surface-name" href="/zh-TW/maturity/taxonomy#long-tail-hosted-providers"><span className="maturity-surface-title">長尾託管供應商</span><span className="maturity-surface-meta"><span className="maturity-level-pill maturity-level-alpha"><span className="maturity-level-code">M2</span><span>Alpha</span></span><span>3 個領域</span></span></a>
        <div className="maturity-surface-metric"><span className="maturity-surface-metric-label">涵蓋率</span><span className="maturity-score maturity-score-experimental"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-experimental">實驗性</span><span>0%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "0%" }} /></span></span></div>
        <div className="maturity-surface-metric"><span className="maturity-surface-metric-label">品質</span><span className="maturity-score maturity-score-alpha"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-alpha">Alpha</span><span>61%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "61%" }} /></span></span></div>
        <div className="maturity-surface-metric"><span className="maturity-surface-metric-label">完整度</span><span className="maturity-score maturity-score-alpha"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-alpha">Alpha</span><span>68%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "68%" }} /></span></span></div>
        <div className="maturity-surface-support"><span className="maturity-lts maturity-lts-none">無</span></div>
      ...
      <div className="maturity-surface-row">
        <a className="maturity-surface-name" href="/zh-TW/maturity/taxonomy#watchos-companion-surfaces"><span className="maturity-surface-title">watchOS 隨附介面</span><span className="maturity-surface-meta"><span className="maturity-level-pill maturity-level-experimental"><span className="maturity-level-code">M1</span><span>實驗性</span></span><span>5 個領域</span></span></a>
        <div className="maturity-surface-metric"><span className="maturity-surface-metric-label">涵蓋率</span><span className="maturity-score maturity-score-experimental"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-experimental">實驗性</span><span>0%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "0%" }} /></span></span></div>
        <div className="maturity-surface-metric"><span className="maturity-surface-metric-label">品質</span><span className="maturity-score maturity-score-experimental"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-experimental">實驗性</span><span>41%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "41%" }} /></span></span></div>
        <div className="maturity-surface-metric"><span className="maturity-surface-metric-label">完整度</span><span className="maturity-score maturity-score-experimental"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-experimental">實驗性</span><span>44%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "44%" }} /></span></span></div>
        <div className="maturity-surface-support"><span className="maturity-lts maturity-lts-none">無</span></div>
      ...
      <div className="maturity-surface-row">
        <a className="maturity-surface-name" href="/zh-TW/maturity/taxonomy#linux-companion-app"><span className="maturity-surface-title">Linux 隨附應用程式</span><span className="maturity-surface-meta"><span className="maturity-level-pill maturity-level-experimental"><span className="maturity-level-code">M0</span><span>規劃中</span></span><span>5 個領域</span></span></a>
        <div className="maturity-surface-metric"><span className="maturity-surface-metric-label">涵蓋率</span><span className="maturity-score maturity-score-experimental"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-experimental">實驗性</span><span>0%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "0%" }} /></span></span></div>
      ...
      <div className="maturity-surface-row">
        <a className="maturity-surface-name" href="/zh-TW/maturity/taxonomy#native-windows-companion-app"><span className="maturity-surface-title">原生 Windows 隨附應用程式</span><span className="maturity-surface-meta"><span className="maturity-level-pill maturity-level-experimental"><span className="maturity-level-code">M0</span><span>規劃中</span></span><span>5 個領域</span></span></a>
        <div className="maturity-surface-metric"><span className="maturity-surface-metric-label">涵蓋率</span><span className="maturity-score maturity-score-experimental"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-experimental">實驗性</span><span>0%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "0%" }} /></span></span></div>
        <div className="maturity-surface-metric"><span className="maturity-surface-metric-label">品質</span><span className="maturity-score maturity-score-experimental"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-experimental">實驗性</span><span>19%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "19%" }} /></span></span></div>
        <div className="maturity-surface-metric"><span className="maturity-surface-metric-label">完整度</span><span className="maturity-score maturity-score-experimental"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-experimental">實驗性</span><span>21%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "21%" }} /></span></span></div>
        <div className="maturity-surface-support"><span className="maturity-lts maturity-lts-none">無</span></div>
  ...
  <Tab title="核心">
    <div className="maturity-surface-table">
      ...
      <div className="maturity-surface-row">
        <a className="maturity-surface-name" href="/zh-TW/maturity/taxonomy#security-auth-pairing-and-secrets"><span className="maturity-surface-title">安全性、驗證、配對與機密資訊</span><span className="maturity-surface-meta"><span className="maturity-level-pill maturity-level-beta"><span className="maturity-level-code">M3</span><span>Beta</span></span><span>6 個領域</span></span></a>
        <div className="maturity-surface-metric"><span className="maturity-surface-metric-label">涵蓋率</span><span className="maturity-score maturity-score-experimental"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-experimental">實驗性</span><span>16%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "16%" }} /></span></span></div>
        <div className="maturity-surface-metric"><span className="maturity-surface-metric-label">品質</span><span className="maturity-score maturity-score-beta"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-beta">Beta</span><span>72%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "72%" }} /></span></span></div>
        <div className="maturity-surface-metric"><span className="maturity-surface-metric-label">完整度</span><span className="maturity-score maturity-score-beta"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-beta">Beta</span><span>79%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "79%" }} /></span></span></div>
        <div className="maturity-surface-support"><span className="maturity-lts maturity-lts-partial">部分支援 - 5</span></div>
  ...
  <Tab title="平台">
    <div className="maturity-surface-table">
      ...
      <div className="maturity-surface-row">
        <a className="maturity-surface-name" href="/zh-TW/maturity/taxonomy#windows-via-wsl2"><span className="maturity-surface-title">透過 WSL2 執行 Windows</span><span className="maturity-surface-meta"><span className="maturity-level-pill maturity-level-beta"><span className="maturity-level-code">M3</span><span>Beta 版</span></span><span>6 個領域</span></span></a>
        <div className="maturity-surface-metric"><span className="maturity-surface-metric-label">涵蓋率</span><span className="maturity-score maturity-score-experimental"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-experimental">實驗性</span><span>6%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "6%" }} /></span></span></div>
      ...
      <div className="maturity-surface-row">
        <a className="maturity-surface-name" href="/zh-TW/maturity/taxonomy#linux-companion-app"><span className="maturity-surface-title">Linux 伴隨應用程式</span><span className="maturity-surface-meta"><span className="maturity-level-pill maturity-level-experimental"><span className="maturity-level-code">M0</span><span>規劃中</span></span><span>5 個領域</span></span></a>
        <div className="maturity-surface-metric"><span className="maturity-surface-metric-label">涵蓋率</span><span className="maturity-score maturity-score-experimental"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-experimental">實驗性</span><span>0%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "0%" }} /></span></span></div>
        <div className="maturity-surface-metric"><span className="maturity-surface-metric-label">品質</span><span className="maturity-score maturity-score-experimental"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-experimental">實驗性</span><span>19%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "19%" }} /></span></span></div>
        <div className="maturity-surface-metric"><span className="maturity-surface-metric-label">完整度</span><span className="maturity-score maturity-score-experimental"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-experimental">實驗性</span><span>21%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "21%" }} /></span></span></div>
        <div className="maturity-surface-support"><span className="maturity-lts maturity-lts-none">無</span></div>
      ...
      <div className="maturity-surface-row">
        <a className="maturity-surface-name" href="/zh-TW/maturity/taxonomy#native-windows-companion-app"><span className="maturity-surface-title">原生 Windows 伴隨應用程式</span><span className="maturity-surface-meta"><span className="maturity-level-pill maturity-level-experimental"><span className="maturity-level-code">M0</span><span>規劃中</span></span><span>5 個領域</span></span></a>
        <div className="maturity-surface-metric"><span className="maturity-surface-metric-label">涵蓋率</span><span className="maturity-score maturity-score-experimental"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-experimental">實驗性</span><span>0%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "0%" }} /></span></span></div>
        <div className="maturity-surface-metric"><span className="maturity-surface-metric-label">品質</span><span className="maturity-score maturity-score-experimental"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-experimental">實驗性</span><span>19%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "19%" }} /></span></span></div>
        <div className="maturity-surface-metric"><span className="maturity-surface-metric-label">完整度</span><span className="maturity-score maturity-score-experimental"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-experimental">實驗性</span><span>21%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "21%" }} /></span></span></div>
        <div className="maturity-surface-support"><span className="maturity-lts maturity-lts-none">無</span></div>
...
### 各領域的就緒狀態
  ...
  開啟各個介面以檢視每個類別的證據狀態。清單會維持收合，讓頁面仍可一目瞭然。

  <AccordionGroup>
  <Accordion title="代理程式執行階段 - 9 個領域">
    ...
    <div className="maturity-readiness-list">
      ...
      <div className="maturity-readiness-row">
        <div className="maturity-readiness-area">
          <span className="maturity-readiness-title">代理程式回合執行</span>
          <span className="maturity-readiness-status maturity-readiness-status-partially-reviewed">已部分審查 - 完整分類法驗證</span>
        </div>
        <span>3 個中有 0 個 (0%) / 24 個中有 7 個 (29.2%)</span>
        <span>17 個能力缺口</span>
      </div>
      <div className="maturity-readiness-row">
        <div className="maturity-readiness-area">
          <span className="maturity-readiness-title">外部執行階段與子代理程式</span>
          <span className="maturity-readiness-status maturity-readiness-status-partially-reviewed">已部分審查 - 完整分類法驗證</span>
        </div>
        <span>4 個中有 0 個 (0%) / 10 個中有 3 個 (30%)</span>
        <span>7 個能力缺口</span>
      </div>
      <div className="maturity-readiness-row">
        <div className="maturity-readiness-area">
          <span className="maturity-readiness-title">託管供應商執行</span>
          <span className="maturity-readiness-status maturity-readiness-status-partially-reviewed">已部分審查 - 完整分類法驗證</span>
        </div>
        <span>5 個中有 1 個 (20%) / 5 個中有 1 個 (20%)</span>
        <span>4 個能力缺口</span>
      </div>
      <div className="maturity-readiness-row">
        <div className="maturity-readiness-area">
          <span className="maturity-readiness-title">本機與自行託管的供應商</span>
          <span className="maturity-readiness-status maturity-readiness-status-needs-review">需要審查 - 完整分類法驗證</span>
        </div>
        <span>5 個中有 0 個 (0%) / 5 個中有 0 個 (0%)</span>
        <span>5 個能力缺口</span>
      </div>
      <div className="maturity-readiness-row">
        <div className="maturity-readiness-area">
        ...
        <span>4 個中有 0 個 (0%) / 8 個中有 2 個 (25%)</span>
        <span>6 個能力缺口</span>
      </div>
      <div className="maturity-readiness-row">
        <div className="maturity-readiness-area">
          <span className="maturity-readiness-title">供應商驗證</span>
          <span className="maturity-readiness-status maturity-readiness-status-partially-reviewed">已部分審查 - 完整分類法驗證</span>
        </div>
        <span>10 個中有 0 個 (0%) / 17 個中有 4 個 (23.5%)</span>
        <span>13 個能力缺口</span>
      </div>
      <div className="maturity-readiness-row">
        <div className="maturity-readiness-area">
        ...
        <span>2 個中有 0 個 (0%) / 9 個中有 5 個 (55.6%)</span>
        <span>4 個能力缺口</span>
      </div>
      <div className="maturity-readiness-row">
        <div className="maturity-readiness-area">
        ...
        <span>3 個中有 0 個 (0%) / 23 個中有 15 個 (65.2%)</span>
        <span>8 個能力缺口</span>
      </div>
      <div className="maturity-readiness-row">
        <div className="maturity-readiness-area">
        ...
        <span>6 個中有 0 個 (0%) / 12 個中有 6 個 (50%)</span>
        <span>6 個能力缺口</span>
      </div>
    </div>
  </Accordion>
  ...
  <Accordion title="Android 應用程式 - 7 個領域">
    ...
    <div className="maturity-readiness-list">
      ...
      <div className="maturity-readiness-row">
        ...
        <span>1 個中有 0 個 (0%) / 1 個中有 0 個 (0%)</span>
        <span>1 個能力缺口</span>
      </div>
      <div className="maturity-readiness-row">
        <div className="maturity-readiness-area">
        ...
        <span>2 個中有 0 個 (0%) / 2 個中有 0 個 (0%)</span>
        <span>2 個能力缺口</span>
      </div>
      <div className="maturity-readiness-row">
        <div className="maturity-readiness-area">
          <span className="maturity-readiness-title">散布</span>
          <span className="maturity-readiness-status maturity-readiness-status-needs-review">需要審查 - 完整分類法驗證</span>
        </div>
        <span>3 個中有 0 個 (0%) / 3 個中有 0 個 (0%)</span>
        <span>3 個能力缺口</span>
      </div>
      <div className="maturity-readiness-row">
        <div className="maturity-readiness-area">
      ...
      <div className="maturity-readiness-row">
        <div className="maturity-readiness-area">
          <span className="maturity-readiness-title">行動裝置聊天</span>
          <span className="maturity-readiness-status maturity-readiness-status-needs-review">需要審查 - 完整分類法驗證</span>
        </div>
        <span>1 個中有 0 個 (0%) / 1 個中有 0 個 (0%)</span>
        <span>1 個能力缺口</span>
  ...
  <Accordion title="Anthropic 供應商路徑 - 5 個領域">
    ...
    <div className="maturity-readiness-list">
      ...
      <div className="maturity-readiness-row">
        ...
        <span>4 個中有 0 個 (0%) / 4 個中有 0 個 (0%)</span>
        <span>4 個能力缺口</span>
      </div>
      <div className="maturity-readiness-row">
        <div className="maturity-readiness-area">
        ...
        <span>10 個中有 0 個 (0%) / 12 個中有 0 個 (0%)</span>
        <span>12 個能力缺口</span>
      </div>
      <div className="maturity-readiness-row">
        <div className="maturity-readiness-area">
          <span className="maturity-readiness-title">提示快取與情境</span>
          <span className="maturity-readiness-status maturity-readiness-status-needs-review">需要審查 - 完整分類法驗證</span>
        </div>
        <span>5 個中有 0 個 (0%) / 5 個中有 0 個 (0%)</span>
        <span>5 個能力缺口</span>
      ...
      <div className="maturity-readiness-row">
        <div className="maturity-readiness-area">
          <span className="maturity-readiness-title">供應商驗證與復原</span>
          <span className="maturity-readiness-status maturity-readiness-status-needs-review">需要審查 - 完整分類法驗證</span>
        </div>
        <span>9 個中有 0 個 (0%) / 9 個中有 0 個 (0%)</span>
        <span>9 個能力缺口</span>
      </div>
      <div className="maturity-readiness-row">
        <div className="maturity-readiness-area">
        ...
        <span>10 個中有 0 個 (0%) / 10 個中有 0 個 (0%)</span>
        <span>10 個能力缺口</span>
      </div>
    </div>
  </Accordion>

  <Accordion title="自動化：排程、掛鉤、任務、輪詢 - 6 個領域">
    ...
    <div className="maturity-readiness-list">
      ...
      <div className="maturity-readiness-row">
        <div className="maturity-readiness-area">
          <span className="maturity-readiness-title">自動化掛鉤</span>
      ...
      <div className="maturity-readiness-row">
        <div className="maturity-readiness-area">
          <span className="maturity-readiness-title">事件傳入</span>
          <span className="maturity-readiness-status maturity-readiness-status-needs-review">需要審查 - 完整分類體系驗證</span>
        </div>
        <span>15 項中的 0 項 (0%) / 15 項中的 0 項 (0%)</span>
        <span>15 項能力缺口</span>
  ...
  <Accordion title="頻道框架 - 8 個領域">
    ...
    <div className="maturity-readiness-list">
      ...
      <div className="maturity-readiness-row">
        <div className="maturity-readiness-area">
          <span className="maturity-readiness-title">媒體附件與頻道豐富資料</span>
          <span className="maturity-readiness-status maturity-readiness-status-needs-review">需要審查 - 完整分類體系驗證</span>
        </div>
      ...
      <div className="maturity-readiness-row">
        <div className="maturity-readiness-area">
          <span className="maturity-readiness-title">傳出傳遞與回覆流水線</span>
          <span className="maturity-readiness-status maturity-readiness-status-partially-reviewed">已部分審查 - 完整分類體系驗證</span>
        </div>
      ...
      <div className="maturity-readiness-row">
        <div className="maturity-readiness-area">
          <span className="maturity-readiness-title">狀態健全性與操作員控制</span>
          <span className="maturity-readiness-status maturity-readiness-status-needs-review">需要審查 - 完整分類體系驗證</span>
        </div>
  ...
  <Accordion title="ClawHub - 4 個領域">
    ...
    <div className="maturity-readiness-list">
      ...
      <div className="maturity-readiness-row">
        ...
        <span>12 項中有 0 項 (0%)／12 項中有 0 項 (0%)</span>
        <span>12 個能力缺口</span>
      </div>
      <div className="maturity-readiness-row">
        <div className="maturity-readiness-area">
        ...
        <span>26 項中有 0 項 (0%)／26 項中有 0 項 (0%)</span>
        <span>26 個能力缺口</span>
      </div>
      <div className="maturity-readiness-row">
        <div className="maturity-readiness-area">
  ...
  <Accordion title="命令列介面 - 7 個領域">
    ...
    <div className="maturity-readiness-list">
      ...
      <div className="maturity-readiness-row">
        ...
        <span>6 項中有 1 項 (16.7%)／6 項中有 1 項 (16.7%)</span>
        <span>5 個能力缺口</span>
      </div>
      <div className="maturity-readiness-row">
        <div className="maturity-readiness-area">
          <span className="maturity-readiness-title">診斷工具</span>
          <span className="maturity-readiness-status maturity-readiness-status-needs-review">需要審查 - 完整分類驗證</span>
        </div>
  ...
  <Accordion title="Docker 與 Podman 託管 - 4 個領域">
    ...
    <div className="maturity-readiness-list">
      ...
      <div className="maturity-readiness-row">
        ...
        <span>5 項中有 1 項 (20%)／7 項中有 2 項 (28.6%)</span>
        <span>5 個能力缺口</span>
      </div>
    </div>
  </Accordion>

  <Accordion title="Feishu、QQ Bot、微信、騰訊元寶、Zalo、Zalo Personal、區域性頻道 - 4 個領域">
    <p className="maturity-readiness-summary">4 個需要審查</p>
    <div className="maturity-readiness-list">
      <div className="maturity-readiness-row maturity-readiness-row-header"><span>領域</span><span>功能／涵蓋範圍 ID</span><span>後續處理</span></div>
      <div className="maturity-readiness-row">
  ...
  <Accordion title="閘道執行階段 - 13 個領域">
    ...
    <div className="maturity-readiness-list">
      ...
      <div className="maturity-readiness-row">
        <div className="maturity-readiness-area">
          <span className="maturity-readiness-title">通訊協定相容性</span>
          <span className="maturity-readiness-status maturity-readiness-status-needs-review">需要審查 - 完整分類體系驗證</span>
        </div>
        <span>0 of 7 (0%) / 0 of 7 (0%)</span>
        <span>7 個能力缺口</span>
      ...
      <div className="maturity-readiness-row">
        <div className="maturity-readiness-area">
          <span className="maturity-readiness-title">安全性控制</span>
          <span className="maturity-readiness-status maturity-readiness-status-needs-review">需要審查 - 完整分類體系驗證</span>
        </div>
        <span>0 of 6 (0%) / 0 of 6 (0%)</span>
        <span>6 個能力缺口</span>
  ...
  <Accordion title="Google 供應商路徑 - 5 個領域">
    <p className="maturity-readiness-summary">5 個需要審查</p>
    <div className="maturity-readiness-list">
      <div className="maturity-readiness-row maturity-readiness-row-header"><span>領域</span><span>功能／涵蓋範圍 ID</span><span>後續處理</span></div>
      <div className="maturity-readiness-row">
      ...
      <div className="maturity-readiness-row">
        <div className="maturity-readiness-area">
          <span className="maturity-readiness-title">供應商設定與認證資訊</span>
          <span className="maturity-readiness-status maturity-readiness-status-needs-review">需要審查 - 完整分類體系驗證</span>
        </div>
        <span>0 of 10 (0%) / 0 of 10 (0%)</span>
        <span>10 個能力缺口</span>
  ...
  <Accordion title="長尾託管供應商 - 3 個領域">
    ...
    <div className="maturity-readiness-list">
      ...
      <div className="maturity-readiness-row">
        <div className="maturity-readiness-area">
          <span className="maturity-readiness-title">託管 LLM 供應商</span>
          <span className="maturity-readiness-status maturity-readiness-status-needs-review">需要審查 - 完整分類體系驗證</span>
        </div>
        <span>12 項中的 0 項 (0%) / 12 項中的 0 項 (0%)</span>
        <span>12 個能力缺口</span>
      ...
      <div className="maturity-readiness-row">
        <div className="maturity-readiness-area">
          <span className="maturity-readiness-title">託管媒體供應商</span>
          <span className="maturity-readiness-status maturity-readiness-status-needs-review">需要審查 - 完整分類體系驗證</span>
        </div>
        <span>8 項中的 0 項 (0%) / 8 項中的 0 項 (0%)</span>
        <span>8 個能力缺口</span>
  ...
  <Accordion title="Matrix - 6 個領域">
    ...
    <div className="maturity-readiness-list">
      ...
      <div className="maturity-readiness-row">
        <div className="maturity-readiness-area">
          <span className="maturity-readiness-title">對話路由與遞送</span>
          <span className="maturity-readiness-status maturity-readiness-status-needs-review">需要審查 - 完整分類驗證</span>
        </div>
        <span>0 of 1 (0%) / 0 of 1 (0%)</span>
        <span>1 個能力缺口</span>
  ...
  <Accordion title="安全性、驗證、配對與密鑰 - 6 個領域">
    ...
    <div className="maturity-readiness-list">
      ...
      <div className="maturity-readiness-row">
        <div className="maturity-readiness-area">
          <span className="maturity-readiness-title">認證資訊與密鑰管理</span>
          <span className="maturity-readiness-status maturity-readiness-status-partially-reviewed">已部分審查 - 完整分類體系驗證</span>
        </div>
  ...
  <Accordion title="工作階段、記憶與上下文引擎 - 9 個領域">
    ...
    <div className="maturity-readiness-list">
      <div className="maturity-readiness-row maturity-readiness-row-header"><span>領域</span><span>功能 / 覆蓋範圍 ID</span><span>後續處理</span></div>
      <div className="maturity-readiness-row">
        <div className="maturity-readiness-area">
  ...
  <Accordion title="終端介面 - 5 個領域">
    ...
    <div className="maturity-readiness-list">
      ...
      <div className="maturity-readiness-row">
        <div className="maturity-readiness-area">
          <span className="maturity-readiness-title">呈現與輸出安全性</span>
          <span className="maturity-readiness-status maturity-readiness-status-needs-review">需要審查 - 完整分類驗證</span>
        </div>
        <span>0 of 4 (0%) / 0 of 4 (0%)</span>
        <span>4 個能力缺口</span>
  ...
  <Accordion title="語音與即時對話 - 6 個領域">
    ...
    <div className="maturity-readiness-list">
      ...
      <div className="maturity-readiness-row">
        <div className="maturity-readiness-area">
          <span className="maturity-readiness-title">對話服務供應商</span>
          <span className="maturity-readiness-status maturity-readiness-status-needs-review">需要審查 - 完整分類驗證</span>
        </div>
        <span>0 of 7 (0%) / 0 of 7 (0%)</span>
        <span>7 個能力缺口</span>
  ...
  <Accordion title="watchOS 輔助介面 - 5 個領域">
    <p className="maturity-readiness-summary">5 個需要審查</p>
    <div className="maturity-readiness-list">
      <div className="maturity-readiness-row maturity-readiness-row-header"><span>領域</span><span>功能／涵蓋範圍 ID</span><span>後續處理</span></div>
      <div className="maturity-readiness-row">
  ...
  <Accordion title="WhatsApp - 5 個領域">
    ...
    <div className="maturity-readiness-list">
      ...
      <div className="maturity-readiness-row">
        <div className="maturity-readiness-area">
          <span className="maturity-readiness-title">頻道設定與作業</span>
          <span className="maturity-readiness-status maturity-readiness-status-needs-review">需要審查 - 完整分類體系驗證</span>
        </div>
        <span>0 of 5 (0%) / 0 of 5 (0%)</span>
        <span>5 個能力缺口</span>
