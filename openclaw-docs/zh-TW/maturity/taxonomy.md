---
summary: OpenClaw 成熟度評分卡所涵蓋的產品領域與檢查項目的詳細參考資料。
title: 成熟度分類法
x-i18n:
    generated_at: "2026-07-26T08:30:05Z"
    model: gpt-5.6
...
<div className="maturity-hero maturity-hero-compact">
  ...
  <p>將 50 個介面分為 4 個系列，每個類別都連結至標準文件和 QA 涵蓋範圍 ID。</p>
...
介面是產品領域，例如閘道執行階段、Discord 或 macOS 應用程式。每個介面包含多個類別，而每個類別包含 QA 情境所涵蓋的能力層級檢查。請使用評分卡進行發行版本層級的判斷；使用本頁檢視其底層模型。

## 成熟度等級

<div className="maturity-level-list">
  <div className="maturity-level-row"><span className="maturity-level-title"><span className="maturity-level-pill maturity-level-experimental"><span className="maturity-level-code">M0</span><span>規劃中</span></span></span><span>方向已確定，但尚無受支援的使用者操作路徑。</span><span className="maturity-level-promotion">晉級條件：已有設計議題、負責人和目標介面。</span></div>
  <div className="maturity-level-row"><span className="maturity-level-title"><span className="maturity-level-pill maturity-level-experimental"><span className="maturity-level-code">M1</span><span>實驗性</span></span></span><span>已實作，但受限於注意事項、旗標、原始碼建置或僅限維護者的流程。</span><span className="maturity-level-promotion">晉級條件：維護者能從目前的 main 執行該情境。</span></div>
  <div className="maturity-level-row"><span className="maturity-level-title"><span className="maturity-level-pill maturity-level-alpha"><span className="maturity-level-code">M2</span><span>Alpha</span></span></span><span>實際使用者可以試用，但預期會有破壞性變更和不完整的使用者體驗。</span><span className="maturity-level-promotion">晉級條件：具備設定文件、基本測試、已知注意事項，以及至少一項真實環境證明。</span></div>
  <div className="maturity-level-row"><span className="maturity-level-title"><span className="maturity-level-pill maturity-level-beta"><span className="maturity-level-code">M3</span><span>Beta</span></span></span><span>已有公開操作路徑，且主要工作流程在有限的注意事項下可正常使用。</span><span className="maturity-level-promotion">晉級條件：具備安裝／更新文件、迴歸測試、支援操作手冊，以及在預期環境中成功完成的情境證明。</span></div>
  <div className="maturity-level-row"><span className="maturity-level-title"><span className="maturity-level-pill maturity-level-stable"><span className="maturity-level-code">M4</span><span>穩定</span></span></span><span>一般使用者的建議操作路徑。失敗會被視為迴歸問題。</span><span className="maturity-level-promotion">晉級條件：具備發行關卡、doctor／疑難排解路徑、廣泛的文件，以及多次真實環境證明。</span></div>
  <div className="maturity-level-row"><span className="maturity-level-title"><span className="maturity-level-pill maturity-level-clawesome"><span className="maturity-level-code">M5</span><span>Clawesome</span></span></span><span>精緻、令人愉悅、具備完善的可觀測性，且能與最佳的同類工作流程競爭。</span><span className="maturity-level-promotion">晉級條件：達到穩定等級，且代表性使用者皆通過使用者評分卡。</span></div>
</div>
...
<Tabs>
  <Tab title="核心">
    ...
    <a className="maturity-surface-link" href="#session-memory-and-context-engine">
      <span className="maturity-surface-title">工作階段、記憶與脈絡引擎</span>
      <span className="maturity-surface-meta"><span className="maturity-level-pill maturity-level-beta"><span className="maturity-level-code">M3</span><span>Beta</span></span><span>9 個領域－完成度 79%</span></span>
    </a>
    ...
    <a className="maturity-surface-link" href="#gateway-web-app">
      ...
      <span className="maturity-surface-meta"><span className="maturity-level-pill maturity-level-beta"><span className="maturity-level-code">M3</span><span>Beta</span></span><span>6 個領域 - 完成 79%</span></span>
    </a>

    <a className="maturity-surface-link" href="#plugins">
      <span className="maturity-surface-title">外掛</span>
      <span className="maturity-surface-meta"><span className="maturity-level-pill maturity-level-beta"><span className="maturity-level-code">M3</span><span>Beta</span></span><span>9 個領域 - 完成 79%</span></span>
    </a>
    ...
    <a className="maturity-surface-link" href="#media-understanding-and-media-generation">
      ...
      <span className="maturity-surface-meta"><span className="maturity-level-pill maturity-level-alpha"><span className="maturity-level-code">M2</span><span>Alpha</span></span><span>6 個領域 - 完成 68%</span></span>
    </a>
    ...
    <a className="maturity-surface-link" href="#clawhub">
      ...
      <span className="maturity-surface-meta"><span className="maturity-level-pill maturity-level-alpha"><span className="maturity-level-code">M2</span><span>Alpha</span></span><span>4 個領域 - 完成 62%</span></span>
    </a>

    <a className="maturity-surface-link" href="#openclaw-app-sdk">
      <span className="maturity-surface-title">OpenClaw 應用程式 SDK</span>
      <span className="maturity-surface-meta"><span className="maturity-level-pill maturity-level-alpha"><span className="maturity-level-code">M2</span><span>Alpha</span></span><span>6 個領域 - 完成 53%</span></span>
    </a>
  ...
  <Tab title="平台">
    ...
    <a className="maturity-surface-link" href="#android-app">
      ...
      <span className="maturity-surface-meta"><span className="maturity-level-pill maturity-level-stable"><span className="maturity-level-code">M4</span><span>穩定版</span></span><span>7 個領域 - 完成 80%</span></span>
    </a>
    <a className="maturity-surface-link" href="#ios-app">
      <span className="maturity-surface-title">iOS 應用程式</span>
      <span className="maturity-surface-meta"><span className="maturity-level-pill maturity-level-stable"><span className="maturity-level-code">M4</span><span>穩定版</span></span><span>8 個領域 - 完成 80%</span></span>
    </a>
...
<AccordionGroup>
  <Accordion title="命令列介面 - M4 穩定版 - 7 個領域">
    ...
    一般設定與修復路徑已記載於安裝、命令列介面與閘道文件中。Windows 的平台特定路徑則追蹤於「透過 WSL2 使用 Windows」與「原生 Windows」資料列中。

    <div className="maturity-surface-rollup"><span>涵蓋度：實驗性 - 4%</span><span>品質：穩定版 - 83%</span><span>完整度：穩定版 - 90%</span><span><span className="maturity-lts maturity-lts-partial">部分支援 - 6</span></span></div>
    ...
    [初始設定](/zh-TW/cli/onboard)、[設定](/zh-TW/cli/configure)、[初始設定概覽](/zh-TW/start/onboarding-overview)
    ...
    [初始設定](/zh-TW/cli/onboard)、[外掛](/zh-TW/cli/plugins)、[頻道](/zh-TW/cli/channels)
    ...
    [Doctor](/zh-TW/cli/doctor)、[Doctor](/zh-TW/gateway/doctor)、[密鑰](/zh-TW/gateway/secrets)、[疑難排解](/zh-TW/gateway/troubleshooting)
  ...
  <Accordion title="閘道執行環境 - M4 穩定 - 13 個領域">
    <a id="gateway-runtime" />

    核心架構、驗證、配對、通訊協定文件、常駐程式文件與命令列介面操作手冊的涵蓋範圍廣泛，且內容為最新狀態。
    ...
    [通訊協定](/zh-TW/gateway/protocol)、[架構](/zh-TW/concepts/architecture)、[索引](/zh-TW/nodes/index)
      ...
      <div className="maturity-category-row">
        <div className="maturity-category-area">
          <span className="maturity-category-title">健全狀態、診斷與修復</span>
    ...
    [索引](/zh-TW/gateway/index)、[診斷](/zh-TW/gateway/diagnostics)、[修復工具](/zh-TW/gateway/doctor)
    ...
    [索引](/zh-TW/gateway/security/index), [通訊協定](/zh-TW/gateway/protocol), [探索](/zh-TW/gateway/discovery)
  ...
  <Accordion title="代理執行階段 - M3 Beta - 9 個領域">
    ...
    主迴圈、模型、供應商路由與工具串流皆屬第一級功能，但供應商行為每週都會變動，因此每個版本都需要情境驗證。

    <div className="maturity-surface-rollup"><span>涵蓋度實驗性 - 33%</span><span>品質 Beta - 78%</span><span>完整度 Beta - 79%</span><span><span className="maturity-lts maturity-lts-partial">部分 - 6</span></span></div>
    ...
    [模型](/zh-TW/concepts/models)、[模型](/zh-TW/cli/models)、[OpenAI](/zh-TW/providers/openai)、[代理程式執行環境](/zh-TW/concepts/agent-runtimes)
    ...
    [模型](/zh-TW/concepts/models)、[代理程式](/zh-TW/cli/agent)、[模型](/zh-TW/cli/models)、[OpenAI](/zh-TW/providers/openai)、[Anthropic](/zh-TW/providers/anthropic)、[Google](/zh-TW/providers/google)、[子代理程式](/zh-TW/tools/subagents)
    ...
    [串流](/zh-TW/concepts/streaming)、[代理程式迴圈](/zh-TW/concepts/agent-loop)
    ...
    [代理程式迴圈](/zh-TW/concepts/agent-loop)、[Ollama](/zh-TW/providers/ollama)
    ...
    [沙箱、工具政策與提升權限的比較](/zh-TW/gateway/sandbox-vs-tool-policy-vs-elevated)、[代理程式迴圈](/zh-TW/concepts/agent-loop)、[子代理程式](/zh-TW/tools/subagents)
  ...
  <Accordion title="工作階段、記憶與情境引擎 - M3 Beta - 9 個領域">
    ...
    文件完善且持續積極實作中。成熟度取決於逐字稿的持久性、壓縮品質，以及跨用戶端的一致性。
    ...
    [壓縮](/zh-TW/concepts/compaction)、[情境](/zh-TW/concepts/context)、[工作階段管理壓縮](/zh-TW/reference/session-management-compaction)

    </div>
      </div>
      <div className="maturity-category-row">
        <div className="maturity-category-area">
          <span className="maturity-category-title">情境引擎</span>
          <span>2 項功能 / 支援 LTS</span>
        </div>
    ...
    [情境](/zh-TW/concepts/context)、[情境引擎](/zh-TW/concepts/context-engine)
    ...
    [上下文](/zh-TW/concepts/context)、[轉錄記錄清理](/zh-TW/reference/transcript-hygiene)、[Discord](/zh-TW/channels/discord)
    ...
    [工作階段管理壓縮](/zh-TW/reference/session-management-compaction)、[逐字稿衛生管理](/zh-TW/reference/transcript-hygiene)
  ...
  <Accordion title="通道框架 - M3 Beta - 8 個領域">
    ...
    許多通道共用閘道的傳遞與路由合約，但通道行為會因上游 API 和帳戶政策限制而有所不同。
    ...
    <div className="maturity-category-list">
      ...
      <div className="maturity-category-row">
        <div className="maturity-category-area">
          <span className="maturity-category-title">通道動作、命令與核准</span>
          <span>5 項能力</span>
        </div>
        <div><span className="maturity-score maturity-score-experimental"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-experimental">實驗性</span><span>0%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "0%" }} /></span></span></div>
        <div><span className="maturity-score maturity-score-beta"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-beta">Beta</span><span>79%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "79%" }} /></span></span></div>
    ...
    [索引](/zh-TW/channels/index)、[配對](/zh-TW/channels/pairing)、[疑難排解](/zh-TW/channels/troubleshooting)、[SDK 通道外掛](/zh-TW/plugins/sdk-channel-plugins)
    ...
    [LINE](/zh-TW/channels/line)、[Signal](/zh-TW/channels/signal)、[Google Chat](/zh-TW/channels/googlechat)、[Matrix](/zh-TW/channels/matrix)、[Discord](/zh-TW/channels/discord)
      ...
      <div className="maturity-category-row">
        <div className="maturity-category-area">
          <span className="maturity-category-title">對外傳遞與回覆流程</span>
    ...
    [頻道路由](/zh-TW/channels/channel-routing)、[群組](/zh-TW/channels/groups)、[Discord](/zh-TW/channels/discord)、[Matrix](/zh-TW/channels/matrix)、[疑難排解](/zh-TW/channels/troubleshooting)、[設定參考](/zh-TW/gateway/configuration-reference)
      ...
      <div className="maturity-category-row">
        <div className="maturity-category-area">
          <span className="maturity-category-title">狀態健全度與操作員控制</span>
          <span>4 項能力／支援 LTS</span>
        </div>
        <div><span className="maturity-score maturity-score-experimental"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-experimental">實驗性</span><span>0%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "0%" }} /></span></span></div>
        <div><span className="maturity-score maturity-score-beta"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-beta">Beta</span><span>79%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "79%" }} /></span></span></div>
    ...
    [健全度](/zh-TW/gateway/health)、[設定參考](/zh-TW/gateway/configuration-reference)、[疑難排解](/zh-TW/channels/troubleshooting)、[Discord](/zh-TW/channels/discord)
  ...
  <Accordion title="可觀測性 - M3 Beta - 5 個領域">
    ...
    已有 OTel、Prometheus、日誌記錄和診斷文件。仍需進行一輪公開的「操作員應優先查看什麼」成熟度完善作業。

    <div className="maturity-surface-rollup"><span>涵蓋度：實驗性 - 18%</span><span>品質：Beta - 75%</span><span>完整度：Beta - 79%</span><span><span className="maturity-lts maturity-lts-partial">部分 - 3</span></span></div>

    <div className="maturity-category-list">
      <div className="maturity-category-row maturity-category-row-header"><span>領域</span><span>涵蓋度</span><span>品質</span><span>完整度</span><span>文件</span></div>
      <div className="maturity-category-row">
        <div className="maturity-category-area">
          <span className="maturity-category-title">健全度與修復</span>
    ...
    [健全度](/zh-TW/gateway/health)、[Telegram](/zh-TW/channels/telegram)、[Doctor](/zh-TW/cli/doctor)、[Doctor](/zh-TW/gateway/doctor)、[SDK 子路徑](/zh-TW/plugins/sdk-subpaths)、[健全度](/zh-TW/cli/health)、[通訊協定](/zh-TW/gateway/protocol)
    ...
    [記錄](/zh-TW/logging)、[記錄](/zh-TW/gateway/logging)、[日誌](/zh-TW/cli/logs)
    ...
    [鉤子](/zh-TW/plugins/hooks)、[OpenTelemetry](/zh-TW/gateway/opentelemetry)、[記錄](/zh-TW/logging)、[SDK 子路徑](/zh-TW/plugins/sdk-subpaths)、[診斷 OpenTelemetry](/zh-TW/plugins/reference/diagnostics-otel)、[Prometheus](/zh-TW/gateway/prometheus)、[診斷 Prometheus](/zh-TW/plugins/reference/diagnostics-prometheus)
  ...
  <Accordion title="閘道 Web 應用程式 - M3 Beta - 6 個領域">
    ...
    <div className="maturity-surface-rollup"><span>涵蓋率 實驗階段 - 4%</span><span>品質 Beta - 74%</span><span>完整度 Beta - 79%</span><span><span className="maturity-lts maturity-lts-none">無</span></span></div>
    ...
    [控制介面](/zh-TW/web/control-ui), [通訊協定](/zh-TW/gateway/protocol), [通話](/zh-TW/nodes/talk)
    ...
    [控制介面](/zh-TW/web/control-ui), [設定](/zh-TW/gateway/configuration)
      ...
      <div className="maturity-category-row">
        ...
        <div><span className="maturity-score maturity-score-experimental"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-experimental">實驗階段</span><span>8%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "8%" }} /></span></span></div>
        <div><span className="maturity-score maturity-score-beta"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-beta">Beta</span><span>79%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "79%" }} /></span></span></div>
        <div><span className="maturity-score maturity-score-beta"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-beta">Beta</span><span>79%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "79%" }} /></span></span></div>
        <div className="maturity-category-docs">

    [控制介面](/zh-TW/web/control-ui), [索引](/zh-TW/web/index), [儀表板](/zh-TW/web/dashboard), [通訊協定](/zh-TW/gateway/protocol)
      ...
      <div className="maturity-category-row">
        ...
        <div><span className="maturity-score maturity-score-experimental"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-experimental">實驗階段</span><span>10%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "10%" }} /></span></span></div>
        <div><span className="maturity-score maturity-score-beta"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-beta">Beta</span><span>79%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "79%" }} /></span></span></div>
        <div><span className="maturity-score maturity-score-beta"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-beta">Beta</span><span>79%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "79%" }} /></span></span></div>
        <div className="maturity-category-docs">
  ...
  <Accordion title="外掛 - M3 Beta - 9 個領域">
    ...
    在資訊清單、探索、載入、提供者／工具架構及核准邊界方面，已有廣泛的文件和有力的內部執行階段佐證。在公開 SDK API／子路徑與外部分發佐證更加充分之前，請將此列維持在 Beta 階段。
    ...
    <div className="maturity-category-list">
      ...
      <div className="maturity-category-row">
        <div className="maturity-category-area">
          <span className="maturity-category-title">外掛製作與封裝</span>
    ...
    [架構](/zh-TW/plugins/architecture)、[架構內部機制](/zh-TW/plugins/architecture-internals)、[外掛](/zh-TW/cli/plugins)
      ...
      <div className="maturity-category-row">
        <div className="maturity-category-area">
          <span className="maturity-category-title">通道外掛</span>
          <span>5 項功能 / 支援 LTS</span>
        </div>
        <div><span className="maturity-score maturity-score-experimental"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-experimental">實驗性</span><span>0%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "0%" }} /></span></span></div>
        <div><span className="maturity-score maturity-score-alpha"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-alpha">Alpha</span><span>68%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "68%" }} /></span></span></div>
    ...
    [SDK 通道外掛](/zh-TW/plugins/sdk-channel-plugins)、[SDK 通道輸入](/zh-TW/plugins/sdk-channel-inbound)、[SDK 通道輸出](/zh-TW/plugins/sdk-channel-outbound)
    ...
    [外掛權限要求](/zh-TW/plugins/plugin-permission-requests)、[執行核准](/zh-TW/tools/exec-approvals)、[SDK 頻道外掛](/zh-TW/plugins/sdk-channel-plugins)
  ...
  <Accordion title="安全性、驗證、配對與密鑰 - M3 Beta - 6 個領域">
    ...
    已具備完善的文件與強化機制。在定期升級與安全性情境執行證明設定未發生退步後，即可晉級。

    <div className="maturity-surface-rollup"><span>涵蓋度：實驗性 - 16%</span><span>品質：Beta - 72%</span><span>完整度：Beta - 79%</span><span><span className="maturity-lts maturity-lts-partial">部分 - 5</span></span></div>
    ...
    [執行核准](/zh-TW/tools/exec-approvals)、[核准](/zh-TW/cli/approvals)、[外掛權限要求](/zh-TW/plugins/plugin-permission-requests)、[稽核檢查](/zh-TW/gateway/security/audit-checks)
    ...
    [索引](/zh-TW/gateway/security/index)、[暴露應變手冊](/zh-TW/gateway/security/exposure-runbook)、[受信任的 Proxy 驗證](/zh-TW/gateway/trusted-proxy-auth)、[Tailscale](/zh-TW/gateway/tailscale)、[遠端](/zh-TW/gateway/remote)、[設定參考](/zh-TW/gateway/configuration-reference)、[閘道](/zh-TW/cli/gateway)、[診斷工具](/zh-TW/cli/doctor)、[控制介面](/zh-TW/web/control-ui)、[瀏覽器控制](/zh-TW/tools/browser-control)、[稽核檢查](/zh-TW/gateway/security/audit-checks)
    ...
    [通訊協定](/zh-TW/gateway/protocol)、[裝置](/zh-TW/cli/devices)、[配對](/zh-TW/channels/pairing)、[配對](/zh-TW/gateway/pairing)、[操作者範圍](/zh-TW/gateway/operator-scopes)、[控制介面](/zh-TW/web/control-ui)、[網頁聊天](/zh-TW/web/webchat)、[核准](/zh-TW/cli/approvals)
    ...
    [資訊清單](/zh-TW/plugins/manifest)、[外掛權限要求](/zh-TW/plugins/plugin-permission-requests)、[管理外掛](/zh-TW/plugins/manage-plugins)、[稽核檢查](/zh-TW/gateway/security/audit-checks)
  ...
  <Accordion title="自動化：排程、掛鉤、工作、輪詢 - M3 Beta - 6 個領域">
    ...
    已有文件且可供使用，但情境驗證應涵蓋無人值守傳遞、重試及失敗可見性。

    <div className="maturity-surface-rollup"><span>涵蓋率：實驗性 - 2%</span><span>品質：Beta - 72%</span><span>完整度：Beta - 79%</span><span><span className="maturity-lts maturity-lts-none">無</span></span></div>
  ...
  <Accordion title="媒體理解與媒體生成 - M2 Alpha - 6 個領域">
    ...
    已具備廣泛的能力介面，但供應商差異、檔案限制，以及節點／應用程式之間的一致性，使其目前仍不穩定。
    ...
    [媒體概觀](/zh-TW/tools/media-overview), [媒體理解](/zh-TW/nodes/media-understanding), [安全檔案操作](/zh-TW/gateway/security/secure-file-operations), [PDF](/zh-TW/tools/pdf), [影像生成](/zh-TW/tools/image-generation), [QR](/zh-TW/cli/qr), [LINE](/zh-TW/channels/line), [WhatsApp](/zh-TW/channels/whatsapp)
    ...
    [影像](/zh-TW/nodes/images), [媒體概觀](/zh-TW/tools/media-overview), [Discord](/zh-TW/channels/discord)
    ...
    [媒體概觀](/zh-TW/tools/media-overview), [影像生成](/zh-TW/tools/image-generation), [資訊清單](/zh-TW/plugins/manifest), [Codex 測試框架](/zh-TW/plugins/codex-harness)
    ...
    [文字轉語音](/zh-TW/tools/tts), [媒體概觀](/zh-TW/tools/media-overview), [Discord](/zh-TW/channels/discord)
    ...
    [音訊](/zh-TW/nodes/audio), [媒體理解](/zh-TW/nodes/media-understanding), [媒體概觀](/zh-TW/tools/media-overview), [WhatsApp](/zh-TW/channels/whatsapp), [影像](/zh-TW/nodes/images), [推論](/zh-TW/cli/infer), [PDF](/zh-TW/tools/pdf)
    ...
    [影像生成](/zh-TW/tools/image-generation), [媒體概觀](/zh-TW/tools/media-overview), [Skills](/zh-TW/tools/skills), [音樂生成](/zh-TW/tools/music-generation), [影片生成](/zh-TW/tools/video-generation)
  ...
  <Accordion title="語音與即時對話 - M2 Alpha - 6 個領域">
    ...
    控制介面、應用程式和供應商中存在多種實作。進入 Beta 前，需要延遲、失敗模式和設定評分卡。
    ...
    <div className="maturity-category-list">
      ...
      <div className="maturity-category-row">
        <div className="maturity-category-area">
          <span className="maturity-category-title">對話供應商</span>
          <span>7 項功能</span>
        </div>
        <div><span className="maturity-score maturity-score-experimental"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-experimental">實驗性</span><span>0%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "0%" }} /></span></span></div>
        <div><span className="maturity-score maturity-score-alpha"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-alpha">Alpha</span><span>61%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "61%" }} /></span></span></div>
    ...
    [OpenAI](/zh-TW/providers/openai), [Google](/zh-TW/providers/google), [SDK 供應商外掛](/zh-TW/plugins/sdk-provider-plugins), [對話](/zh-TW/nodes/talk), [控制介面](/zh-TW/web/control-ui)
  ...
  <Accordion title="終端介面 - M2 Alpha - 5 個領域">
    ...
    文件與原始碼中已有此功能，但作為主要使用者工作流程並不顯眼。需要明確定義情境。
    ...
    [終端介面](/zh-TW/web/tui), [QR 碼](/zh-TW/cli/qr), [日誌](/zh-TW/cli/logs), [自動補全](/zh-TW/cli/completion)
  ...
  <Accordion title="ClawHub - M2 Alpha - 4 個領域">
    ...
    已有公開文件與生態系概念。仍需安裝、信任、更新、回復及相容性評分卡。
    ...
    [外掛](/zh-TW/tools/plugin), [外掛](/zh-TW/cli/plugins), [相容性](/zh-TW/plugins/compatibility), [外掛清冊](/zh-TW/plugins/plugin-inventory), [發布](/zh-TW/clawhub/publishing), [Skills](/zh-TW/tools/skills), [Skills 設定](/zh-TW/tools/skills-config)
  ...
  <Accordion title="OpenClaw App SDK - M2 Alpha - 6 個領域">
    ...
    OpenClaw App SDK 是獨立的外部應用程式合約，與閘道執行階段及外掛 SDK 分開。目前的評分顯示一條實際的 `@openclaw/sdk` 路徑，但在公開封裝、自動探索、核准、輔助工具及相容性方面仍有缺口。
    ...
    [OpenClaw SDK](/zh-TW/gateway/external-apps), [OpenClaw SDK API 設計](/zh-TW/gateway/external-apps), [協定](/zh-TW/gateway/protocol), [索引](/zh-TW/gateway/security/index)
    ...
    [OpenClaw SDK](/zh-TW/gateway/external-apps), [OpenClaw SDK API 設計](/zh-TW/gateway/external-apps), [協定](/zh-TW/gateway/protocol)
    ...
    [OpenClaw SDK API 設計](/zh-TW/gateway/external-apps), [TypeBox](/zh-TW/concepts/typebox), [協定](/zh-TW/gateway/protocol)
...
<AccordionGroup>
  <Accordion title="Linux 閘道主機 - M4 穩定版 - 5 個領域">
    ...
    建議使用 Node 執行階段，文件說明了 systemd 使用者服務，並廣泛涵蓋 VPS／容器指引。
    ...
    [遠端存取](/zh-TW/gateway/remote), [Tailscale](/zh-TW/gateway/tailscale), [暴露風險操作手冊](/zh-TW/gateway/security/exposure-runbook), [驗證](/zh-TW/gateway/authentication), [機密資訊](/zh-TW/gateway/secrets)
  ...
  <Accordion title="macOS 閘道主機 - M4 穩定版 - 7 個領域">
    ...
    <div className="maturity-surface-rollup"><span>涵蓋率：實驗性 - 0%</span><span>品質：Beta - 74%</span><span>完整度：穩定版 - 88%</span><span><span className="maturity-lts maturity-lts-none">無</span></span></div>
  ...
  <Accordion title="Android 應用程式 - M4 穩定版 - 7 個領域">
    ...
    已提供 Google Play 官方發行版本，並持續維護從原始碼建置與執行的文件；Android 應用程式也記載為供使用者使用的一般伴隨節點。

    <div className="maturity-surface-rollup"><span>涵蓋度：實驗性 - 0%</span><span>品質：穩定版 - 80%</span><span>完整度：穩定版 - 80%</span><span><span className="maturity-lts maturity-lts-none">無</span></span></div>
    ...
    <div className="maturity-category-list">
      ...
      <div className="maturity-category-row">
        ...
        <div><span className="maturity-score maturity-score-experimental"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-experimental">實驗性</span><span>0%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "0%" }} /></span></span></div>
        <div><span className="maturity-score maturity-score-stable"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-stable">穩定版</span><span>80%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "80%" }} /></span></span></div>
        <div><span className="maturity-score maturity-score-stable"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-stable">穩定版</span><span>80%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "80%" }} /></span></span></div>
        <div className="maturity-category-docs">
    ...
    [Android](/zh-TW/platforms/android), [對話](/zh-TW/nodes/talk)
      ...
      <div className="maturity-category-row">
        <div className="maturity-category-area">
          <span className="maturity-category-title">裝置執行階段</span>
          <span>2 項能力</span>
        </div>
        <div><span className="maturity-score maturity-score-experimental"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-experimental">實驗性</span><span>0%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "0%" }} /></span></span></div>
        <div><span className="maturity-score maturity-score-stable"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-stable">穩定</span><span>80%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "80%" }} /></span></span></div>
  ...
  <Accordion title="iOS 應用程式 - M4 穩定 - 8 個領域">
    ...
    已透過官方 App Store 發布，文件說明了由中繼服務支援的推播功能，並將 iOS 應用程式描述為供使用者使用的一般配套節點。
  ...
  <Accordion title="Docker 與 Podman 託管 - M3 Beta - 4 個領域">
    ...
    已有安裝文件，且這些是常見的部署路徑。待定期發布冒煙測試能涵蓋升級與儲存卷行為後，即可提升成熟度。
    ...
    [Podman](/zh-TW/install/podman), [Docker VM 執行環境](/zh-TW/install/docker-vm-runtime), [Docker](/zh-TW/install/docker), [Hetzner](/zh-TW/install/hetzner), [Hostinger](/zh-TW/install/hostinger)
    ...
    [Docker](/zh-TW/install/docker), [Docker VM 執行環境](/zh-TW/install/docker-vm-runtime), [完整發布驗證](/zh-TW/reference/full-release-validation)
    ...
    [Docker](/zh-TW/install/docker), [Docker VM 執行環境](/zh-TW/install/docker-vm-runtime)
  ...
  <Accordion title="透過 WSL2 使用 Windows - M3 Beta - 6 個領域">
    ...
    建議採用的 Windows 路徑，包含 systemd／使用者服務指引與開機鏈文件。經過多次安裝／更新評分後再提升成熟度。

    <div className="maturity-surface-rollup"><span>涵蓋率：實驗性 - 6%</span><span>品質：Alpha - 69%</span><span>完整度：Beta - 79%</span><span><span className="maturity-lts maturity-lts-partial">部分支援 - 5</span></span></div>
    ...
    [驗證](/zh-TW/gateway/authentication)、[機密資訊](/zh-TW/gateway/secrets)、[遠端存取](/zh-TW/gateway/remote)、[公開操作手冊](/zh-TW/gateway/security/exposure-runbook)、[Windows](/zh-TW/platforms/windows)
    ...
    [Windows](/zh-TW/platforms/windows)、[狀態](/zh-TW/cli/status)、[日誌](/zh-TW/cli/logs)、[診斷工具](/zh-TW/cli/doctor)、[診斷工具](/zh-TW/gateway/doctor)
  ...
  <Accordion title="Raspberry Pi 與小型 Linux 裝置 - M3 Beta - 4 個領域">
    ...
    已有平台文件，且閘道路徑以 Linux 為基礎。需要針對特定硬體的發行煙霧測試證明，才能提升至更高等級。
    ...
    [Raspberry Pi](/zh-TW/install/raspberry-pi)、[索引](/zh-TW/install/index)、[首次執行常見問題](/zh-TW/help/faq-first-run)、[常見問題](/zh-TW/help/faq)、[Linux](/zh-TW/platforms/linux)、[安裝程式](/zh-TW/install/installer)
    ...
    [Raspberry Pi](/zh-TW/install/raspberry-pi)、[驗證](/zh-TW/gateway/authentication)、[機密資料](/zh-TW/gateway/secrets)、[配對](/zh-TW/gateway/pairing)、[裝置](/zh-TW/cli/devices)、[遠端](/zh-TW/gateway/remote)、[Tailscale](/zh-TW/gateway/tailscale)
  ...
  <Accordion title="macOS 輔助應用程式 - M3 Beta - 8 個領域">
    ...
    已具備功能豐富的選單列應用程式、權限、節點模式、Canvas、語音喚醒、WebChat 與遠端模式。其變動速度仍然很快，因此尚不適合列為穩定版。
  ...
  <Accordion title="原生 Windows - M2 Alpha - 4 個領域">
    ...
    核心命令列介面／閘道流程可以運作，但文件仍建議使用 WSL2 以獲得完整體驗，並列出原生環境的注意事項。
  ...
  <Accordion title="Kubernetes 託管 - M2 Alpha - 4 個領域">
    ...
    Kubernetes 託管是一種獨立、以 Kustomize 為基礎的叢集部署路徑。目前的評分顯示已有可實際運作的最小部署路徑，但在 Kubernetes 專用 CI、入口/TLS/NetworkPolicy 封裝、備份/還原，以及正式環境對外開放的強化方面仍有缺口。
    ...
    [Kubernetes](/zh-TW/install/kubernetes)、[密鑰](/zh-TW/gateway/secrets)、[環境](/zh-TW/help/environment)

    </div>
      </div>
      <div className="maturity-category-row">
        <div className="maturity-category-area">
          <span className="maturity-category-title">存取與對外開放</span>
          <span>5 項能力</span>
        </div>
        <div><span className="maturity-score maturity-score-experimental"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-experimental">實驗性</span><span>0%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "0%" }} /></span></span></div>
        <div><span className="maturity-score maturity-score-alpha"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-alpha">Alpha</span><span>55%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "55%" }} /></span></span></div>
    ...
    [Kubernetes](/zh-TW/install/kubernetes)、[驗證](/zh-TW/gateway/authentication)、[遠端存取](/zh-TW/gateway/remote)、[對外開放操作手冊](/zh-TW/gateway/security/exposure-runbook)
  ...
  <Accordion title="Nix 安裝路徑 - M1 實驗性 - 5 個領域">
    ...
    選用的安裝流程。在提升至 Alpha/Beta 階段前，需要更明確的支援承諾。
    ...
    [Nix](/zh-TW/install/nix)、[設定](/zh-TW/cli/setup)、[環境](/zh-TW/help/environment)
      ...
      <div className="maturity-category-row">
        <div className="maturity-category-area">
          <span className="maturity-category-title">服務執行環境與防護機制</span>
          <span>8 項功能</span>
        </div>
        <div><span className="maturity-score maturity-score-experimental"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-experimental">實驗性</span><span>0%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "0%" }} /></span></span></div>
        <div><span className="maturity-score maturity-score-experimental"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-experimental">實驗性</span><span>41%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "41%" }} /></span></span></div>
  ...
  <Accordion title="watchOS 伴隨介面 - M1 實驗性 - 5 個領域">
    ...
    原始碼包含 Watch App／擴充功能介面；公開文件尚未將其呈現為使用者功能。
  ...
  <Accordion title="Linux 輔助 App - M0 規劃中 - 5 個領域">
    ...
    文件指出原生 Linux 輔助 App 尚在規劃中；目前 Linux 支援的使用方式是透過閘道。
    ...
    <div className="maturity-category-list">
      ...
      <div className="maturity-category-row">
        <div className="maturity-category-area">
          <span className="maturity-category-title">App 發行</span>
          <span>3 項功能</span>
        </div>
        <div><span className="maturity-score maturity-score-experimental"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-experimental">實驗性</span><span>0%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "0%" }} /></span></span></div>
        <div><span className="maturity-score maturity-score-experimental"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-experimental">實驗性</span><span>19%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "19%" }} /></span></span></div>
    ...
    [Linux](/zh-TW/platforms/linux), [執行核准](/zh-TW/tools/exec-approvals), [機密資訊](/zh-TW/gateway/secrets), [索引](/zh-TW/nodes/index), [執行](/zh-TW/tools/exec), [語音交談](/zh-TW/nodes/talk), [相機](/zh-TW/nodes/camera)
  ...
  <Accordion title="原生 Windows 輔助 App - M0 規劃中 - 5 個領域">
    ...
    [Windows](/zh-TW/platforms/windows), [診斷工具](/zh-TW/gateway/doctor), [索引](/zh-TW/gateway/index)
...
<AccordionGroup>
  <Accordion title="Discord - M4 穩定版 - 6 個領域">
    ...
    文件深入，功能涵蓋廣泛。語音／委派路徑應維持分別評定為 Beta／Alpha。

    <div className="maturity-surface-rollup"><span>涵蓋度實驗性 - 0%</span><span>品質 Beta - 73%</span><span>完整度穩定 - 87%</span><span><span className="maturity-lts maturity-lts-partial">部分支援 - 4</span></span></div>
  ...
  <Accordion title="Telegram - M3 Beta - 5 個領域">
    ...
    核心頻道已足夠成熟，可供日常使用，但差異幅度較大的使用者體驗和媒體邊界情況仍需定期進行情境驗證。
  ...
  <Accordion title="Slack - M3 Beta - 5 個領域">
    ...
    第一級的頻道文件與路由介面。需要工作區安裝／管理員情境評分卡。

    <div className="maturity-surface-rollup"><span>涵蓋率實驗階段 - 0%</span><span>品質 Alpha - 66%</span><span>完整度 Beta - 78%</span><span><span className="maturity-lts maturity-lts-full">完整 - 5</span></span></div>
  ...
  <Accordion title="iMessage 與 BlueBubbles - M3 Beta - 5 個領域">
    ...
    支援的 iMessage 會透過已登入 macOS「訊息」的主機上的 imsg 執行；舊版 BlueBubbles 設定需要遷移。請清楚標示 macOS 權限、SSH 包裝函式、SIP／私有 API，以及遷移注意事項。

    <div className="maturity-surface-rollup"><span>涵蓋率實驗階段 - 0%</span><span>品質 Alpha - 66%</span><span>完整度 Beta - 78%</span><span><span className="maturity-lts maturity-lts-none">無</span></span></div>
    ...
    [BlueBubbles iMessage](/zh-TW/announcements/bluebubbles-imessage), [從 BlueBubbles 遷移至 iMessage](/zh-TW/channels/imessage-from-bluebubbles), [頻道設定](/zh-TW/gateway/config-channels), [iMessage](/zh-TW/channels/imessage)
    ...
    [iMessage](/zh-TW/channels/imessage), [從 BlueBubbles 遷移至 iMessage](/zh-TW/channels/imessage-from-bluebubbles), [頻道設定](/zh-TW/gateway/config-channels)
  ...
  <Accordion title="WhatsApp - M3 Beta - 5 個領域">
    ...
    核心路徑十分重要且已有文件說明；上游 Baileys／工作階段的不穩定性使其尚未達到穩定版等級。
    ...
    [WhatsApp](/zh-TW/channels/whatsapp), [設定頻道](/zh-TW/gateway/config-channels), [WhatsApp](/zh-TW/plugins/reference/whatsapp), [QA 端對端自動化](/zh-TW/concepts/qa-e2e-automation), [診斷工具](/zh-TW/gateway/doctor)
    ...
    [WhatsApp](/zh-TW/channels/whatsapp)、[頻道設定](/zh-TW/gateway/config-channels)、[QA 端對端自動化](/zh-TW/concepts/qa-e2e-automation)、[配對](/zh-TW/channels/pairing)
  ...
  <Accordion title="Google Chat - M2 Alpha - 5 個領域">
    ...
    [Google Chat](/zh-TW/channels/googlechat)、[Google Chat](/zh-TW/plugins/reference/googlechat)、[設定頻道](/zh-TW/gateway/config-channels)、[精靈命令列介面參考](/zh-TW/start/wizard-cli-reference)、[祕密](/zh-TW/gateway/secrets)、[Secretref 認證資訊介面](/zh-TW/reference/secretref-credential-surface)、[健康狀態](/zh-TW/gateway/health)、[外掛清單](/zh-TW/plugins/plugin-inventory)、[索引](/zh-TW/channels/index)
    ...
    [Google Chat](/zh-TW/channels/googlechat)、[訊息](/zh-TW/cli/message)、[媒體理解](/zh-TW/nodes/media-understanding)、[Secretref 認證資訊介面](/zh-TW/reference/secretref-credential-surface)、[回應](/zh-TW/tools/reactions)、[斜線命令](/zh-TW/tools/slash-commands)、[代理程式設定](/zh-TW/gateway/config-agents)、[訊息生命週期重構](/zh-TW/concepts/message-lifecycle-refactor)
  ...
  <Accordion title="Microsoft Teams - M2 Alpha - 5 個領域">
    ...
    [Microsoft Teams](/zh-TW/channels/msteams), [Microsoft Teams](/zh-TW/plugins/reference/msteams), [設定頻道](/zh-TW/gateway/config-channels), [健康狀態](/zh-TW/gateway/health)
    ...
    [Microsoft Teams](/zh-TW/channels/msteams), [群組](/zh-TW/channels/groups), [頻道路由](/zh-TW/channels/channel-routing)
  ...
  <Accordion title="Feishu、QQ Bot、微信、騰訊元寶、Zalo、Zalo Personal、區域性頻道 - M2 Alpha - 4 個領域">
    <a id="feishu-qq-bot-wechat-yuanbao-zalo-zalo-personal-regional-channels" />

    此區域涵蓋範圍相當重要，但公開支援等級應依帳號類型、上游核准狀況及維護者提供的證明進行調整。

    <div className="maturity-surface-rollup"><span>涵蓋範圍：實驗性 - 0%</span><span>品質：Alpha - 55%</span><span>完整度：Alpha - 58%</span><span><span className="maturity-lts maturity-lts-none">無</span></span></div>
    ...
    [索引](/zh-TW/channels/index)、[配對](/zh-TW/channels/pairing)、[Feishu](/zh-TW/plugins/reference/feishu)、[架構內部機制](/zh-TW/plugins/architecture-internals)

    </div>
      </div>
      <div className="maturity-category-row">
        <div className="maturity-category-area">
          <span className="maturity-category-title">存取權與身分</span>
          <span>1 項功能</span>
        </div>
        <div><span className="maturity-score maturity-score-experimental"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-experimental">實驗性</span><span>0%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "0%" }} /></span></span></div>
        <div><span className="maturity-score maturity-score-alpha"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-alpha">Alpha</span><span>53%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "53%" }} /></span></span></div>
  ...
  <Accordion title="Mattermost、LINE、IRC、Nextcloud Talk、Nostr、Twitch、Tlon、Synology Chat - M2 Alpha - 4 個領域">
    ...
    已有支援介面，但成熟度可能因上游和維護者支援程度而異。稍後再個別評分。
    ...
    無連結的文件
      ...
      <div className="maturity-category-row">
        <div className="maturity-category-area">
          <span className="maturity-category-title">對話路由與傳送</span>
          <span>1 項功能</span>
        </div>
        <div><span className="maturity-score maturity-score-experimental"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-experimental">實驗性</span><span>0%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "0%" }} /></span></span></div>
        <div><span className="maturity-score maturity-score-alpha"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-alpha">Alpha</span><span>53%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "53%" }} /></span></span></div>
  ...
  <Accordion title="語音通話頻道 - M1 實驗性 - 5 個領域">
    ...
    具備複雜即時行為的選用／外掛路徑。在公開測試版之前需要情境評分卡。
    ...
    [語音通話命令列介面](/zh-TW/cli/voicecall), [語音通話](/zh-TW/plugins/voice-call), [通訊協定](/zh-TW/gateway/protocol)

    </div>
      </div>
      <div className="maturity-category-row">
        <div className="maturity-category-area">
          <span className="maturity-category-title">存取權與身分識別</span>
          <span>1 項能力</span>
        </div>
        <div><span className="maturity-score maturity-score-experimental"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-experimental">實驗性</span><span>0%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "0%" }} /></span></span></div>
        <div><span className="maturity-score maturity-score-experimental"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-experimental">實驗性</span><span>41%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "41%" }} /></span></span></div>
    ...
    [語音通話](/zh-TW/plugins/voice-call), [語音通話命令列介面](/zh-TW/cli/voicecall)
...
<AccordionGroup>
  <Accordion title="瀏覽器自動化、執行與沙箱工具 - M3 Beta - 3 個領域">
    ...
    核心工具已有文件說明，但主機安全性與權限使用者體驗應持續納入評分卡審查。

    <div className="maturity-surface-rollup"><span>涵蓋度：實驗性 - 21%</span><span>品質：Beta - 75%</span><span>完整度：Beta - 79%</span><span><span className="maturity-lts maturity-lts-partial">部分支援 - 2</span></span></div>
    ...
    [執行](/zh-TW/tools/exec)、[背景程序](/zh-TW/gateway/background-process)、[工具呼叫 HTTP API](/zh-TW/gateway/tools-invoke-http-api)、[操作員範圍](/zh-TW/gateway/operator-scopes)、[通訊協定](/zh-TW/gateway/protocol)、[執行核准](/zh-TW/tools/exec-approvals)、[進階執行核准](/zh-TW/tools/exec-approvals-advanced)、[提升權限](/zh-TW/tools/elevated)
    ...
    [沙箱隔離](/zh-TW/gateway/sandboxing)、[沙箱、工具政策與提升權限的比較](/zh-TW/gateway/sandbox-vs-tool-policy-vs-elevated)、[多代理程式沙箱工具](/zh-TW/tools/multi-agent-sandbox-tools)、[Codex 執行環境參考](/zh-TW/plugins/codex-harness-reference)、[設定工具](/zh-TW/gateway/config-tools)
  ...
  <Accordion title="OpenAI 與 Codex 提供者路徑 - M3 Beta - 5 個領域">
    ...
    深入文件、OAuth／訂閱路徑、即時語音、影像與相容性行為。提供者持續變動，因此在缺乏發行評分卡證明的情況下，尚無法達到穩定版。
    ...
    [OpenAI](/zh-TW/providers/openai)、[Codex 執行環境](/zh-TW/plugins/codex-harness)、[模型](/zh-TW/concepts/models)、[OAuth](/zh-TW/concepts/oauth)、[Codex 執行環境參考](/zh-TW/plugins/codex-harness-reference)、[驗證監控](/zh-TW/gateway/authentication)
    ...
    [Codex Harness](/zh-TW/plugins/codex-harness)、[Codex Harness 執行階段](/zh-TW/plugins/codex-harness-runtime)、[Codex Harness 參考資料](/zh-TW/plugins/codex-harness-reference)、[Codex 原生外掛](/zh-TW/plugins/codex-native-plugins)
    ...
    [OpenAI](/zh-TW/providers/openai)、[圖片生成](/zh-TW/tools/image-generation)、[圖片](/zh-TW/nodes/images)
  ...
  <Accordion title="網頁搜尋工具 - M3 Beta - 4 個領域">
    ...
    已有多個供應商與相關文件。每個供應商系列都需要配額、錯誤與 SSRF 的驗證證據。
    ...
    [網頁](/zh-TW/tools/web)、[網頁擷取](/zh-TW/tools/web-fetch)、[常見問題](/zh-TW/help/faq)、[API 使用成本](/zh-TW/reference/api-usage-costs)、[Brave 搜尋](/zh-TW/tools/brave-search)、[Perplexity 搜尋](/zh-TW/tools/perplexity-search)、[Tavily](/zh-TW/tools/tavily)、[Firecrawl](/zh-TW/tools/firecrawl)
    ...
    [網頁](/zh-TW/tools/web)、[網頁擷取](/zh-TW/tools/web-fetch)、[Firecrawl](/zh-TW/tools/firecrawl)、[SearXNG 搜尋](/zh-TW/tools/searxng-search)
  ...
  <Accordion title="Google 提供者路徑 - M3 Beta - 5 個領域">
    <a id="google-provider-path" />

    具備模型與即時介面的第一級提供者。需要分別對 Live/Talk 評分。

    <div className="maturity-surface-rollup"><span>涵蓋率實驗性 - 0%</span><span>品質 Alpha - 66%</span><span>完整度 Beta - 78%</span><span><span className="maturity-lts maturity-lts-none">無</span></span></div>

    <div className="maturity-category-list">
      <div className="maturity-category-row maturity-category-row-header"><span>領域</span><span>涵蓋率</span><span>品質</span><span>完整度</span><span>文件</span></div>
      <div className="maturity-category-row">
        <div className="maturity-category-area">
          <span className="maturity-category-title">提供者設定與認證資訊</span>
          <span>10 項功能</span>
        </div>
        <div><span className="maturity-score maturity-score-experimental"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-experimental">實驗性</span><span>0%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "0%" }} /></span></span></div>
        <div><span className="maturity-score maturity-score-alpha"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-alpha">Alpha</span><span>66%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "66%" }} /></span></span></div>
    ...
    [Google](/zh-TW/providers/google)、[模型提供者](/zh-TW/concepts/model-providers)
    ...
    [Google](/zh-TW/providers/google)、[模型提供者](/zh-TW/concepts/model-providers)、[Google](/zh-TW/plugins/reference/google)、[Gemini 搜尋](/zh-TW/tools/gemini-search)
    ...
    [提示詞快取](/zh-TW/reference/prompt-caching)、[Google](/zh-TW/providers/google)、[模型供應商](/zh-TW/concepts/model-providers)、[Token 用量](/zh-TW/reference/token-use)
  ...
  <Accordion title="OpenRouter 供應商路徑 - M3 Beta - 4 個領域">
    ...
    統一供應商路徑已有文件說明且具實用價值，但各模型的特定行為有所不同。
    ...
    [OpenRouter](/zh-TW/providers/openrouter)、[模型供應商](/zh-TW/concepts/model-providers)、[設定](/zh-TW/cli/configure)、[驗證](/zh-TW/gateway/authentication)、[環境](/zh-TW/help/environment)、[模型](/zh-TW/cli/models)、[模型](/zh-TW/concepts/models)
  ...
  <Accordion title="圖片、影片與音樂生成工具 - M2 Alpha - 5 個領域">
    ...
    此能力已存在於各供應商，但若沒有各供應商個別的證明，其品質、延遲和參數相容性差異過大，尚無法進入 Beta。
    ...
    [設定代理程式](/zh-TW/gateway/config-agents)、[圖片生成](/zh-TW/tools/image-generation)、[影片生成](/zh-TW/tools/video-generation)、[音樂生成](/zh-TW/tools/music-generation)
  ...
  <Accordion title="長尾託管供應商 - M2 Alpha - 3 個領域">
    ...
    已有許多文件／參考頁面；分數應根據供應商中繼資料及即時冒煙測試涵蓋率產生。
    ...
    [資訊清單](/zh-TW/plugins/manifest)、[即時測試](/zh-TW/help/testing-live)、[索引](/zh-TW/providers/index)
      ...
      <div className="maturity-category-row">
        <div className="maturity-category-area">
          <span className="maturity-category-title">供應商營運</span>
          <span>12 項功能</span>
        </div>
        <div><span className="maturity-score maturity-score-experimental"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-experimental">實驗性</span><span>0%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "0%" }} /></span></span></div>
        <div><span className="maturity-score maturity-score-alpha"><span className="maturity-score-label"><span className="maturity-level-pill maturity-level-alpha">Alpha</span><span>61%</span></span><span className="maturity-meter" aria-hidden="true"><span style={{ width: "61%" }} /></span></span></div>
