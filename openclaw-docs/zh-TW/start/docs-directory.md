...
read_when:
    - 你想要快速存取重要的文件頁面
summary: 精選最常用的 OpenClaw 文件連結。
title: 文件目錄
x-i18n:
    generated_at: "2026-07-26T08:48:38Z"
    model: gpt-5.6
...
<Note>
本頁是精選索引。如果你是新手，請從[開始使用](/zh-TW/start/getting-started)著手。
如需完整的文件導覽，請參閱[文件中心](/zh-TW/start/hubs)。
</Note>

## 從這裡開始

- [文件中心（連結至所有頁面）](/zh-TW/start/hubs)
- [說明](/zh-TW/help)
...
- [配對（私訊與節點）](/zh-TW/channels/pairing)
...
- [節點（iOS 與 Android）](/zh-TW/nodes)
- [Web 介面（控制介面）](/zh-TW/web)
- [探索與傳輸方式](/zh-TW/gateway/discovery)
- [遠端存取](/zh-TW/gateway/remote)

## 頻道與使用者體驗

- [控制介面（瀏覽器）](/zh-TW/web/control-ui)
