...
title: Synthetic
x-i18n:
    generated_at: "2026-07-26T08:11:07Z"
    model: gpt-5.6
...
OpenClaw 將其內建為 `synthetic` 供應商，並使用 Anthropic
Messages API。
...
<Warning>
OpenClaw 的 Anthropic 用戶端會自動將 `/v1` 附加至基礎 URL，因此請使用
...
所有 Synthetic 模型的成本（輸入／輸出／快取）皆為 `0`。如需瞭解服務可用性，請參閱 Synthetic 的
