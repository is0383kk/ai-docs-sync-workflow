...
title: 認證監控
x-i18n:
    generated_at: "2026-07-26T08:06:41Z"
    model: gpt-5.6
...
此頁面已移動。模型供應商的驗證資訊位於[驗證](/zh-TW/gateway/authentication)；用於監控驗證狀態的維運指令碼位於[驗證監控指令碼](/zh-TW/help/scripts#auth-monitoring-scripts)。
