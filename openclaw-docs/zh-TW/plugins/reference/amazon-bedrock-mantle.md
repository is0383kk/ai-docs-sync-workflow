...
summary: 適用於 OpenAI 相容模型路由的 OpenClaw Amazon Bedrock Mantle 提供者外掛。
title: Amazon Bedrock Mantle 外掛
x-i18n:
    generated_at: "2026-07-26T08:34:18Z"
    model: gpt-5.6
...
OpenClaw Amazon Bedrock Mantle 供應商外掛，用於與 OpenAI 相容的模型路由。
