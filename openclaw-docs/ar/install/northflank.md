...
read_when:
    ...
    - تريد نشرًا سحابيًا بنقرة واحدة مع واجهة Control UI مستندة إلى المتصفح
summary: نشر OpenClaw على Northflank باستخدام قالب بنقرة واحدة
title: Northflank
x-i18n:
    generated_at: "2026-04-23T07:26:33Z"
    model: gpt-5.4
    provider: openai
...
انشر OpenClaw على Northflank باستخدام قالب بنقرة واحدة وادخل إليه عبر واجهة Control UI على الويب.
هذا هو أسهل مسار "من دون طرفية على الخادم": إذ يقوم Northflank بتشغيل Gateway نيابةً عنك.
...
- تخزين دائم عبر Northflank Volume ‏(`/data`) بحيث تبقى `openclaw.json`،
  و`auth-profiles.json` لكل وكيل، وحالة القنوات/المزوّدات، والجلسات،
