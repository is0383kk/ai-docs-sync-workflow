...
x-i18n:
    generated_at: "2026-07-27T05:59:27Z"
    model: gpt-5.6
...
Voegt ondersteuning voor de Fireworks-modelprovider toe aan OpenClaw.

## Distributie

- Pakket: `@openclaw/fireworks-provider`
- Installatieroute: npm; ClawHub: `clawhub:@openclaw/fireworks-provider`
