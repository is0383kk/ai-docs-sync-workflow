...
read_when:
    ...
    - Je hebt de runtimemodelreferenties nodig voor modellen die op Go worden gehost
summary: Gebruik de OpenCode Go-catalogus met de gedeelde OpenCode-configuratie
title: OpenCode Go
x-i18n:
    generated_at: "2026-07-27T06:09:48Z"
    model: gpt-5.6
...
runtimeprovider-id (`opencode-go`), zodat upstream routering per model
correct blijft.
...
<AccordionGroup>
  <Accordion title="Routeringsgedrag">
    OpenClaw routeert elke `opencode-go/...`-modelreferentie automatisch. Er is geen
    aanvullende providerconfiguratie vereist.
  </Accordion>

  <Accordion title="Conventie voor runtimereferenties">
    Runtimereferenties blijven expliciet: `opencode/...` voor Zen, `opencode-go/...` voor
    Go. Hierdoor blijft upstream routering per model voor beide catalogi correct.
  </Accordion>

  <Accordion title="Gedeelde referenties">
    Eén `OPENCODE_API_KEY` geldt voor zowel de Zen- als de Go-catalogus. Wanneer je de
...
<CardGroup cols={2}>
  ...
  <Card title="Modelselectie" href="/nl/concepts/model-providers" icon="layers">
    Providers en modelreferenties kiezen en het failovergedrag instellen.
  </Card>
</CardGroup>
