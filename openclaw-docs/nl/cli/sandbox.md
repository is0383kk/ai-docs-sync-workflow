...
status: active
summary: Beheer sandboxruntimes en inspecteer het effectieve sandboxbeleid
title: Sandbox-CLI
x-i18n:
...
openclaw sandbox recreate --agent mybot        # omvat agent:mybot:*-subsessies
  ...
  "agents": {
    "defaults": {
      "sandbox": {
        ...
        "prune": {
          "idleHours": 24, // automatisch opruimen na 24h inactiviteit
          "maxAgeDays": 7, // automatisch opruimen na 7 dagen
        },
      },
    },
  },
